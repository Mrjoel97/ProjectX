...
`executive-router`, `email-drafter`, `cockpit-agent`, `document-drafter`, `attachment-extractor`. The active row's `version` is part of the LLM
`executive-router`, `email-drafter`, `cockpit-agent`, `document-drafter`, `graph-extractor`. The active row's `version` is part of the LLM
