...
`graph-extractor`, `inbox-digest`, `reply-drafter`, `voice-session`, `voice-brief` (06-02; the dead
...
(03.7-03), `reply-drafter` (03.11-02 — the two skills whose INPUT is untrusted third-party mail).
