...
| 18. Document & Content Creation | 3/10 | In Progress (wave 1 complete: 18-01 pure-core format parameterization + `renderHtmlDocument`, 18-02 schema/trace registration surfaces, 18-03 ungated `content-drafter` v1; wave 2 next at 18-04) | 2026-08-01 |
