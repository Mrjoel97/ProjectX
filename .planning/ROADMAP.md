...
Plans:
- [ ] 03.9-01-PLAN.md — the `agentSteps` table + adapter (record/finish/latestTurn) + unit tests; mint CKPT-05
- [ ] 03.9-02-PLAN.md — emit from ai@7's onToolExecution* callbacks + the SMOKE path; turn lifecycle in both cockpit drivers; §4 static scans
- [ ] 03.9-03-PLAN.md — the UI: ActivityCard (LATEST TRACE) + the in-progress chat bubble, off one query
