...
| 15.3 Vault Folders - Folder Ingest, Synthesis & Drill-In (INSERTED) | 7/9 | In Progress (15.3-07 landed the folder surface; the verify pass exposed that `apps/web` has no unit-test runner, so anything asserted there is asserted by nobody; next 15.3-08 wave 8, document identity classification) | - |
