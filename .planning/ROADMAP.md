...
| 15.3 Vault Folders - Folder Ingest, Synthesis & Drill-In (INSERTED) | 6/9 | In Progress (15.3-06 landed the folder digest as an ingested vault document plus exact staleness, and an adversarial verify pass caught three post-green defects; next 15.3-07 wave 7, the folder UI) | - |
