...
| 20. Media Canvas | 7/19 | In Progress (20-01 pure media core + price table, 20-02 schema/trace freeze, 20-13 the assemble contract, 20-03 the `media-director` skill row, 20-04 the media budget rail + the transactional job reservation, 20-18 the D5 reconciliation readers, 20-19 the scheduled vendor-drift detector; next is 20-05, the fal submit adapter) | 2026-08-02 |
