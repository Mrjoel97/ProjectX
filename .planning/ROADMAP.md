...
| 15.3 Vault Folders - Folder Ingest, Synthesis & Drill-In (INSERTED) | 5/9 | In Progress (15.3-05 sealed folder members from retrieval at all four read sites behind one predicate; next 15.3-06 wave 6, the folder digest) | - |
