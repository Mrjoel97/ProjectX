...
**Requirements**: none minted (UAT gap closure) — internal defect labels UAT-A (panel desync) / UAT-B (stalled-resolution recovery) / UAT-C (propose-while-pending deadlock + tall-brief clutter), per 03.10-CONTEXT.md
**Plans:** 5 plans (01-03 core; 04/05 gap closure inserted post-UAT 2026-07-19)
