...
| 15.3 Vault Folders - Folder Ingest, Synthesis & Drill-In (INSERTED) | 8/9 | In Progress (15.3-08 landed document identity: a closed union with a working compile bridge, an ungated classifier that degrades rather than fails, and user-set precedence as an absence; next 15.3-09 wave 9, the Google Drive rail) | - |
