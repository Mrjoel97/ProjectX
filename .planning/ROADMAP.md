...
| 3.11 Inbox Reply (INSERTED) | 4/6 | In Progress (Wave 4 done — replyToMessage tool: server-side resolve + recipient-by-ref + Re:/threading + toolless draft, RPLY-01 spine writer complete; NEXT Wave 5 skill eval gate + Wave 6 live human-verify) | - |
