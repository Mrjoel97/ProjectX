# Graph Report - pikar-ai  (2026-08-09)

## Corpus Check
- 1563 files · ~2,695,485 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14162 nodes · 16194 edges · 1413 communities (1337 shown, 76 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38ac3d24`
...
- Task 2 Report — The activity row, populated from delivered sends
- finance.test.ts
...
1. `internal` - 95 edges
2. `api` - 93 edges
3. `internalMutation` - 40 edges
4. `base()` - 29 edges
5. `tenantQuery` - 28 edges
6. `internalQuery` - 28 edges
7. `contentHash()` - 26 edges
8. `buildCockpitTools()` - 25 edges
9. `Phase Details - Milestone v2.0` - 24 edges
10. `Playbook: Media Canvas (finished reels and standalone images)` - 24 edges
...
- `coerceScorecardValue()` --references--> `numeric`  [EXTRACTED]
  packages/backend/convex/evaluations.ts → apps/web/app/(app)/dashboard/finance/FinanceView.tsx

## Import Cycles
- None detected.

## Communities (1413 total, 76 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.09
Nodes (24): briefingSheet, capsTeal, snippetSheet, traceText, typeBadge, ArtDirection, Block, BlockTile() (+16 more)

### Community 1 - "package.json"
Cohesion: 0.06
Nodes (38): crons, deliverApprovedPlan, markPlanDone, internal, vaultIngestPool, workflow, BlockReason, LABELS (+30 more)

### Community 2 - "page.tsx"
Cohesion: 0.04
Nodes (34): Activity, attRow, box, Briefing, BriefingItem, btn, categoryTag, chip (+26 more)
...
Cohesion: 0.11
Nodes (21): BlueprintPanel(), BlueprintReport(), EMPTY_BLUEPRINT, formatConfirmedAt(), secondaryButton(), SegmentLedger(), BlueprintField, aggregatePulse() (+13 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.06
Nodes (34): assertSubmitRateLimited, boom, briefingCountForThread, briefingSynopsisPresent, createdDocCountForThread, drainDailySpend, evaluationCountForThread, failingPipeline (+26 more)
...
Cohesion: 0.07
Nodes (19): aggregateModules, code, modules, profileText(), sources, aggregateModules, cancelQueued(), migrationsModules (+11 more)

### Community 9 - "emailIntent.ts"
Cohesion: 0.13
Nodes (23): buildAgentContext(), buildCockpitTools(), fmtSendInstant(), stripRePrefix(), applyRecipientEdit(), buildRecipientView(), classify(), ContactMatch (+15 more)

### Community 10 - "Project State"
Cohesion: 0.05
Nodes (35): RFC-2045, RFC-2047, RFC-2822, ActionCtx, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies (+27 more)

### Community 11 - "scan.ts"
Cohesion: 0.03
Nodes (86): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, activity (+78 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.12
Nodes (22): modules, layoutRuns(), markdownToPdf(), wrapText(), word(), buildDocFilename(), DocFormat, DocToken (+14 more)

### Community 13 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.11
Nodes (26): seedMediaPlan(), seedDeck(), ArtDirection, Block, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, fail() (+18 more)
...
Cohesion: 0.10
Nodes (14): aggregateModules, ALL_SLOTS, asTenant(), COMPLETE_FACTS, converse(), modules, PROFILE, rateLimiterModules (+6 more)
...
Cohesion: 0.06
Nodes (30): browserTimeZone(), button, caps, card, cardTitle, ControlsResult, FinanceState, GlobalRailsResult (+22 more)
...
Cohesion: 0.03
Nodes (66): tenantAction, applyClassification, countTerminal(), deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText (+58 more)
...
Cohesion: 0.06
Nodes (35): numeric, notifyIfAgentTimeout(), ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer() (+27 more)
...
Cohesion: 0.18
Nodes (13): AttachmentPicker(), UploadedAttachment, REJECTION_COPY, Attachment, EXT_MIME, isValidEmail(), MIME_ALLOWLIST, RejectionReason (+5 more)
...
Cohesion: 0.03
Nodes (33): DisconnectGoogle(), KIND_HREF, NotificationsBanner(), readSeen(), ReconnectBanner(), Crumb, Entry, Node (+25 more)
...
Cohesion: 0.06
Nodes (32): BusyRange, createEvent, CreateEventResult, freeBusy, FreeBusyResult, GoogleError, GoogleFreeBusy, RFC-3339 (+24 more)
...
Cohesion: 0.08
Nodes (38): batchToRender, burnCaptions, captionsToBurn, markRendering, recordCaptionBurn, recordRender, RenderInputs, renderReel (+30 more)
...
Cohesion: 0.04
Nodes (63): DatabaseReader, admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots() (+55 more)
...
Cohesion: 0.26
Nodes (8): diagnose(), gateOrder(), leverageRank(), Prescription, emptyScorecard, Scorecard, ValueEquation, SpecialistRoute
...
Cohesion: 0.05
Nodes (46): patchControls(), getGuardrailConfig(), assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine (+38 more)

### Community 72 - "getActiveSkill"
Cohesion: 0.14
Nodes (7): aggregateModules, modules, rateLimiterModules, withDelivery(), withMedia(), workflowModules, workpoolModules
...
Cohesion: 0.11
Nodes (15): answerDecision, blockedSummary, listAwaiting, listCleared, listDecisions, listInFlight, listScheduled, numericField (+7 more)
...
Cohesion: 0.08
Nodes (29): bumpLanded(), classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch(), DriveFile (+21 more)
...
Cohesion: 0.05
Nodes (39): { auth, signIn, signOut, store, isAuthenticated }, password, persistNextStepMemo(), httpAction, ASSET_PATH, FAL_ASSET_HOSTS, http, INLINE_ASSET (+31 more)
...
Cohesion: 0.07
Nodes (36): DriveBrowser(), Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions(), maybeStartCaptions() (+28 more)

### Community 97 - "proactiveReview.ts"
Cohesion: 0.04
Nodes (53): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult (+45 more)

### Community 98 - "index.ts"
Cohesion: 0.23
Nodes (12): activity(), AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn (+4 more)
...
Cohesion: 0.07
Nodes (45): buildTrajectoryExport, scrub(), buildGeminiEmbedRequest(), buildOpenAIEmbedRequest(), embeddingContentHash(), embeddingV2, embedDoc, l2Normalize() (+37 more)
...
Cohesion: 0.10
Nodes (31): docLabel(), fmtSize(), failureCopy, confirmedDelete(), dangerButtonStyle, fieldStyle, PreviewActionDescriptor, previewActionDescriptors() (+23 more)
...
Cohesion: 0.14
Nodes (13): CategoryTabs(), VaultDoc, VaultFolder, FolderBreadcrumb(), VaultErrorBoundary, DigestRebuildControl(), FolderOpenControl(), VaultBrowseAction (+5 more)
...
Cohesion: 0.12
Nodes (11): agentModules, aggregateModules, EDIT_SCRIPT, modules, provUsage(), rateLimiterModules, T, textStep() (+3 more)
...
Cohesion: 0.07
Nodes (33): POST(), ADR-0011, SH, SH, bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes (+25 more)
...
Cohesion: 0.06
Nodes (31): SubmittableSpec, aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules (+23 more)
...
Cohesion: 0.12
Nodes (17): aggregateModules, BLUEPRINT_WITH_CONTRADICTING_CAC, cancelQueued(), frameworkFor(), MALFORMED_PERSONA_DOC, modules, profileDocText(), rateLimiterModules (+9 more)
...
Cohesion: 0.06
Nodes (30): backfillRequestDefaults, migrations, run, assertAtReview, assertBlocked, assertDeadLetter, assertDeadLetterReason, assertEvalCaseClean (+22 more)

### Community 169 - "page.tsx"
Cohesion: 0.18
Nodes (10): followUpIsDue(), needsAttention(), normalizeAddress(), renderFooter(), BreachConfig, BreachInput, BreachReason, BreachResult (+2 more)
...
Cohesion: 0.03
Nodes (72): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildHistoryBlock(), buildTurnPrompt() (+64 more)
...
Cohesion: 0.09
Nodes (22): Data flow, Dependencies & blast radius, Extraction lifecycle (Phase 3.8), How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work (+14 more)
...
Cohesion: 0.11
Nodes (19): A failed render dead-letters, and does not retry, Dependencies & blast radius, How to change this safely, Invariants — what must never break, Playbook: Media Canvas (finished reels and standalone images), Playbook ownership for Phase 20, Rate observation (dated, vendor-direct), Reconciliation (+11 more)
...
Cohesion: 0.25
Nodes (5): button, connectPage, data, panel, profilePage

### Community 184 - "extractKind.ts"
Cohesion: 0.33
Nodes (6): 15.3-05 — sealing (VALT-07), Accepted limitation — structural, not content, How to verify, The predicate, Three sites, and why one is not enough, What was deliberately NOT done
...
Cohesion: 0.05
Nodes (37): devDependencies, @biomejs/biome, turbo, typescript, engines, node, name, packageManager (+29 more)
...
Cohesion: 0.12
Nodes (23): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), ConnectionsPanel(), pill, row, NarrativePanel() (+15 more)
...
Cohesion: 0.33
Nodes (7): internalAction, exportAudit, s3, retainUntilDate(), serializeAuditNdjson(), sortKeys(), wormObjectKey()
...
### Community 213 - "COCKPIT_AGENT_SKILL"
Cohesion: 0.18
Nodes (9): aggregateModules, asTenant(), harness(), ingest(), modules, rateLimiterModules, seeded(), workflowModules (+1 more)
...
### Community 217 - "blueprintPulse.ts"
Cohesion: 0.06
...
Cohesion: 0.22
Nodes (5): ActivitySection(), cardTitle, muted, stack, CashActivity

### Community 224 - "vaultGraph.test.ts"
Cohesion: 0.11
Nodes (18): Backend page adapters, Cash — business finance, Connected page gates, Data flow, Dependencies & blast radius, Focused backend gates, Frontend and connected browser evidence, How to change safely (+10 more)

### Community 226 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.20
Nodes (9): auditCounts, backfillAuditCounts, countAudit, log, components, AuditHash, AuditPayload, AuditPayloadValue (+1 more)

### Community 227 - "vaultExtract.ts"
Cohesion: 0.07
...
### Community 229 - "vaultGraph.test.ts"
Cohesion: 0.31
...
Cohesion: 0.13
Nodes (14): discussPillStyle(), DocGrid(), folderChip(), pillAnchor(), pillShape, statusBadge(), StatusChip(), VaultContentState (+6 more)
...
### Community 241 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.29
...
### Community 245 - "dashboardSchema.test.ts"
Cohesion: 0.07
...
### Community 247 - "vaultGraph.test.ts"
Cohesion: 0.33
Nodes (3): Edge, modules, Node

### Community 248 - "agentSteps.test.ts"
Cohesion: 0.07
...
### Community 250 - "burnCapsScript.test.ts"
Cohesion: 0.08
...
### Community 251 - "bfsNeighbors"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)

### Community 252 - "Hot Path Rules"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)

### Community 253 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 254 - "Phase Details - Milestone v2.0"
Cohesion: 0.08
Nodes (24): Phase 10: Vault->Agent Grounding, Phase 11: Persona Onboarding & Business Profile, Phase 12: Business Evaluation Engine, Phase 13: Proactive In-App Review, Phase 14: Flagship Voice-Doc Workflow, Phase 15.1: Fact-Derived Tier & Conversational Onboarding (INSERTED), Phase 15.2: Vault Universal Format Recognition & Extraction Fan-Out (INSERTED), Phase 15.3: Vault Folders - Folder Ingest, Synthesis and Drill-In (INSERTED) (+16 more)

### Community 255 - "skillBodies.test.ts"
Cohesion: 0.04
Nodes (53): activateCandidate, activateSkill, activateSkillVersion(), archiveSkill, candidatesForReview, getActiveSkill, getSkillVersion, insertCandidate (+45 more)

### Community 256 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 258 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 259 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 260 - "vaultFolders.test.ts"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (16): classifyDoc, classifySchema, DocIdentity, _docToDocType, ExtractedGraph, extractGraph, getDocText, GraphEdge (+8 more)

### Community 262 - "owner.test.ts"
Cohesion: 0.33
...
### Community 263 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 264 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (23): cancelScheduledPlan, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, listThreadMessages (+15 more)

### Community 266 - "vaultTranscribe.test.ts"
Cohesion: 0.17
Nodes (6): aggregateModules, modules, rateLimiterModules, T, workflowModules, workpoolModules

### Community 267 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 269 - "tenant.ts"
Cohesion: 0.03
Nodes (29): modules, T, aggregateModules, modules, modules, modules, NOTE: no `@ts-expect-error` above this line, unlike its 37 siblings. tsconfig.js, modules (+21 more)
...
### Community 271 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 272 - "Architecture Research"
Cohesion: 0.09
...
Cohesion: 0.33
Nodes (4): convexBin, convexRun(), Movement, record()

### Community 276 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 277 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (43): bubble(), ChatPane(), messageText(), IntakeControls(), StorageId, NAV, OptimizerPanel(), REVIEW_OUTCOMES (+35 more)

### Community 280 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 282 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 283 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 284 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 285 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 286 - "buildTelemetry.ts"
Cohesion: 0.13
Nodes (24): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+16 more)

### Community 287 - "pipeline.test.ts"
Cohesion: 0.18
Nodes (6): activityFromSends(), CashFigure, CashOrigin, CashUnit, NOW, utcDayStart()
...
### Community 289 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (38): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsErrorBoundary, ApprovalsStateNotice(), ApprovalsView(), AwaitingCard(), AwaitingItem (+30 more)

### Community 291 - "audit.test.ts"
Cohesion: 0.14
Nodes (18): Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME, StorageId, fmtReady() (+10 more)
...
### Community 294 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 295 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 297 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 299 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 301 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 302 - "Fix Order"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 303 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 304 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 305 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 306 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 307 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 308 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 309 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 310 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 311 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 312 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 313 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 314 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
Nodes (18): Evidence Review, Focused Validation, Gaps and Limitations, Goal Achievement, Human Approve and Exactly-Once Path, Human Verification Steps, M1 — Widened Google Grant, M2 — Real Availability (+10 more)

### Community 315 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 320 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 321 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 322 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 323 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 324 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 325 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 326 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 327 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 328 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 329 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 330 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 333 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 334 - "officeText.ts"
Cohesion: 0.11
Nodes (11): agentBubble, card, Draft, DRAFT_VERSION, field, label, StorageId, Turn (+3 more)

### Community 335 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 336 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 337 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 338 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 339 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 340 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 341 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 342 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 343 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 344 - "scripts"
Cohesion: 0.12
Nodes (17): scripts, check:fal-catalog, codegen, dev, eval:golden, probe:gemini, probe:gemini:grounded, seed (+9 more)

### Community 345 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 346 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 347 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 348 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 349 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 350 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 351 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 352 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 354 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 355 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 356 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 357 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 358 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 359 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 360 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 362 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 363 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 364 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 365 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 366 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 368 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 369 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 370 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 371 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 372 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 373 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 374 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 375 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 377 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 378 - "Task 4: Canvas Pulse — Breathing, Dimming, Readout"
Cohesion: 0.12
...
### Community 379 - "2. SegmentAnatomy.tsx"
Cohesion: 0.12
...
### Community 380 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 381 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 382 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 383 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 384 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 386 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 387 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 388 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 389 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 390 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 391 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 392 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 393 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 394 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 395 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 396 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 398 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 399 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 400 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 401 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 402 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 403 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 406 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 407 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 408 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 409 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 410 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 411 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 413 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 414 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 415 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 416 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 417 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 418 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 419 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 420 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 421 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 422 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 424 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 425 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 426 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 427 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 429 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 430 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 432 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 433 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 434 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 435 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 437 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 438 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 440 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 441 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 442 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 443 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 444 - "Changes Per File"
Cohesion: 0.13
...
### Community 446 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 447 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 448 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 449 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 450 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 451 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 452 - "Feature Research"
Cohesion: 0.12
...
### Community 453 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 455 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 456 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 457 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 458 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 459 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 460 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 461 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 462 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 467 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 468 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 469 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 471 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 472 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 473 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 474 - "Task 3 Report: Extract the two form panels"
Cohesion: 0.15
...
### Community 475 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 477 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 482 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 485 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 487 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 492 - "What changed"
Cohesion: 0.17
...
### Community 493 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 494 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 495 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 496 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 497 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 498 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 499 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 508 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 509 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 510 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 512 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 514 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 515 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 521 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 522 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 523 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 524 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 525 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 526 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 533 - "Task 6: Full verification — report"
Cohesion: 0.18
...
### Community 543 - "Goal Achievement"
Cohesion: 0.15
...
### Community 545 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 546 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 547 - "Goal Achievement"
Cohesion: 0.15
...
### Community 548 - "Goal Achievement"
Cohesion: 0.15
...
### Community 549 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 550 - "Goal Achievement"
Cohesion: 0.15
...
### Community 551 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 553 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 555 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 557 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 560 - "Final-review fix wave — 7 small fixes, one commit"
Cohesion: 0.15
...
### Community 562 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 563 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 564 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 565 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 566 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 567 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 568 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 570 - "vaultExtract.ts"
Cohesion: 0.21
Nodes (9): extractDoc, Extracted, extractHosted(), ExtractPath, extractPdf(), fanOutPages(), pdfPages(), PromiseCtor (+1 more)
...
### Community 572 - "External Integrations"
Cohesion: 0.17
...
### Community 574 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 575 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 576 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 577 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 578 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 579 - "Goal Achievement"
Cohesion: 0.17
...
### Community 580 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 581 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 582 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 586 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 603 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 607 - "Repository Structure"
Cohesion: 0.18
...
### Community 608 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 609 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 612 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 613 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 614 - "Goal Achievement"
Cohesion: 0.18
...
### Community 617 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 618 - "Goal Achievement"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (11): CardList(), ErrorBoundary, CanvasPane(), capsTeal, panel, REVIEW_TAB, Tab, clamp() (+3 more)

### Community 620 - "Goal Achievement"
Cohesion: 0.18
...
### Community 623 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 624 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 638 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 639 - "Goal Achievement"
Cohesion: 0.18
...
### Community 640 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 643 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 644 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 650 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 651 - "Task 2 Report: Core pulse module (TDD)"
Cohesion: 0.18
...
### Community 652 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 653 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
Nodes (10): Manual-Only Verifications, Per-Task Verification Map, Phase 20 — Validation Strategy, Sampling Rate, Success-Criteria → Test Map, Test Infrastructure, The cut line, The three offline seams (+2 more)
...
### Community 656 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 657 - "Roadmap: Pikar-AI"
Cohesion: 0.18
Nodes (10): EXTERNAL BLOCKER (non-code, unscheduled): the legal entity, Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07, Milestone v2.0 - Platform -> Private Beta (Phases 10-25), Overview, Phase 26: Connected product pages, Phase 31: Marketing surface and funnel v0 (TRANCHE A — buildable now), Phase 32: Channel connection, publishing and metrics (TRANCHE B — GATED), Phases (+2 more)

### Community 658 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 664 - "Code Conventions"
Cohesion: 0.20
...
### Community 665 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 666 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 667 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 668 - "Goal Achievement"
Cohesion: 0.20
...
### Community 669 - "Goal Achievement"
Cohesion: 0.20
...
### Community 670 - "Goal Achievement"
Cohesion: 0.20
...
### Community 671 - "Goal Achievement"
Cohesion: 0.20
...
### Community 672 - "Goal Achievement"
Cohesion: 0.20
...
### Community 673 - "Goal Achievement"
Cohesion: 0.20
...
### Community 674 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 675 - "Goal Achievement"
Cohesion: 0.20
...
### Community 676 - "Goal Achievement"
Cohesion: 0.20
...
### Community 677 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 679 - "Goal Achievement"
Cohesion: 0.20
...
### Community 683 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 686 - "Goal Achievement"
Cohesion: 0.20
...
### Community 687 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 688 - "Goal Achievement"
Cohesion: 0.20
...
### Community 689 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 690 - "Goal Achievement"
Cohesion: 0.20
...
### Community 691 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 696 - "Goal Achievement"
Cohesion: 0.20
...
### Community 697 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 698 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 699 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 702 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 703 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 705 - "Task 1 Report — Amend the living-map spec (attribution via dispatch trace)"
Cohesion: 0.20
...
### Community 706 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 708 - "Final fix report — profile tabs / blueprint segments residual findings"
Cohesion: 0.25
...
### Community 709 - "Task 4 report — the tab shell"
Cohesion: 0.25
...
### Community 712 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 713 - "Validation Architecture"
Cohesion: 0.20
...
### Community 716 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 717 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 718 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 719 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 720 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 721 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 722 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 723 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 724 - "Task 2 Report — The activity row, populated from delivered sends"
Cohesion: 0.20
Nodes (9): Concerns, Files changed, Full verification (Step 13, second part, plus my own review), Self-review findings, Status: DONE, Task 2 Report — The activity row, populated from delivered sends, TDD evidence, What I implemented (+1 more)

### Community 725 - "finance.test.ts"
Cohesion: 0.22
Nodes (4): aggregateModules, modules, rateLimiterModules, T

### Community 726 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 727 - "Locked Decisions"
Cohesion: 0.22
...
### Community 729 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 734 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 736 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 737 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 738 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 739 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 751 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 754 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
Nodes (8): Manual-Only Verifications, Per-Task Verification Map, Phase 15.1 — Validation Strategy, Plan Ownership (added by planning, 2026-07-26), Sampling Rate, Test Infrastructure, Validation Sign-Off, Wave 0 Requirements

### Community 755 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 756 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 758 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 759 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 760 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 761 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 767 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 768 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 769 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 771 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 772 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 773 - "Task 3 report: `blueprintPulse` query + `agentSteps` index"
Cohesion: 0.22
...
### Community 777 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 778 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
Nodes (8): Manual-Only Verifications, Mutation Checks, Per-Task Verification Map, Phase 22 — Validation Strategy, Sampling Rate, Test Infrastructure, Validation Sign-Off, Wave 0 Requirements

### Community 779 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 780 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 781 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 783 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 784 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 785 - "Invariants — what must never break"
Cohesion: 0.25
Nodes (8): Approvals — owner-APPROVED (Plan 26-05, Task 2 closed 2026-08-08), Approvals read contract, Approvals type scale — inline styles must quote the mockup, not invent, Finance becomes a three-tab shell (cash-business-finance Task 1), Finance ledger contract, Finance projections and owner controls (26-09), Invariants — what must never break, The connected Cost route (26-10)

### Community 786 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 787 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 788 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 789 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 790 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 792 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 793 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 794 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 795 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 796 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 797 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 798 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 799 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 800 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 801 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 802 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 803 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 804 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 805 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 806 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 807 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 808 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 809 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 810 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 812 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 813 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 814 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 815 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 816 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 817 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 818 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 819 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 820 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 821 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 822 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 823 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 825 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 826 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 827 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 829 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 830 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 831 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 832 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 833 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 838 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 839 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 840 - "Phase 19 — Validation Strategy"
Cohesion: 0.25
...
### Community 843 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 844 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 845 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 846 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 847 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 848 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 850 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 851 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 852 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 853 - "failureCopy.ts"
Cohesion: 0.29
Nodes (6): COPY, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED

### Community 854 - "xlsText.ts"
Cohesion: 0.38
Nodes (5): rows(), SALES, workbook(), xlsBytes(), xlsText()

### Community 855 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 856 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 858 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 859 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 860 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 861 - "Validation Architecture"
Cohesion: 0.29
...
### Community 864 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 866 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 868 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 870 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 873 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 874 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 875 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 877 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 878 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 879 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 882 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 884 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 889 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 891 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 892 - "Phase 17 — Calendar actions"
Cohesion: 0.07
Nodes (35): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents, mediaRemainingCentsInner() (+27 more)

### Community 893 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 894 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 895 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 896 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 897 - "Validation Architecture"
Cohesion: 0.33
...
### Community 898 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 901 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 902 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 909 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 910 - "Phase 15.4 Verification Report"
Cohesion: 0.33
Nodes (5): Gaps, Goal Achievement, Key Boundary Verification, Phase 15.4 Verification Report, Requirement Coverage

### Community 911 - "Phase 15 — deferred items"
Cohesion: 0.33
Nodes (5): Phase 15 — deferred items, `@pikar/audit` has no `tsconfig.json` (pre-existing since Phase 1), `replyToMessage` has no `VERB` entry (pre-existing since Phase 3.11), Two full-suite timeout flakes on the `"use node"` llm.ts import (pre-existing, load-induced), UNPAID GATE — the 15-06 specialist-body eval run was never executed (BLOCKING for activation)

### Community 912 - "Code Examples"
Cohesion: 0.33
...
### Community 913 - "Validation Architecture"
Cohesion: 0.33
...
### Community 914 - "Validation Architecture"
Cohesion: 0.33
...
### Community 915 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 916 - "Validation Architecture"
Cohesion: 0.33
...
### Community 919 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 920 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 921 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 922 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 923 - "Validation Architecture"
Cohesion: 0.33
...
### Community 924 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 925 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 926 - "Phase 15.3 — vault folders"
Cohesion: 0.40
Nodes (5): 15.3-01 — schema, 15.3-02 — read-surface survivability + cap single-source, 15.3-03 — the budget rail selector (ingest stops spending the cockpit's $5), 15.3-09 — the Google Drive rail (VALT-13), Phase 15.3 — vault folders

### Community 927 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 928 - "financialSpine.ts"
Cohesion: 0.80
Nodes (3): cfa(), ltgpCac(), round2()

### Community 929 - "error-context.md"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source

### Community 930 - "Scheduled Send"
Cohesion: 0.40
...
### Community 933 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 935 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 937 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 938 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 939 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 940 - "Standard Stack"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 941 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 942 - "10-01-PLAN.md"
Cohesion: 0.40
...
### Community 944 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 945 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 946 - "Code Examples"
Cohesion: 0.40
...
### Community 948 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 949 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 950 - "Validation Architecture"
Cohesion: 0.40
...
### Community 951 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 952 - "Sources"
Cohesion: 0.40
...
### Community 954 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 955 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 956 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 957 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 958 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 959 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 961 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 962 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 963 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 964 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 966 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 967 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 970 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 971 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 972 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 985 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 992 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read from installed source / repo files), Secondary (MEDIUM), Sources, Tertiary (LOW — flagged)

### Community 993 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
Nodes (3): Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake), From 04-01 execution, From 04-02 execution

### Community 994 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 995 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 996 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 997 - "Sources"
Cohesion: 0.50
...
### Community 1005 - "User Constraints"
Cohesion: 0.50
...
### Community 1009 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1010 - "Standard Stack"
Cohesion: 0.50
...
### Community 1011 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1012 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1014 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1015 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1016 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read directly in this repo), Secondary (MEDIUM), Sources, Tertiary (LOW / unverified)

### Community 1017 - "Deferred Items"
Cohesion: 0.50
Nodes (3): 17-02 verification, 17-04 verification, Deferred Items

### Community 1018 - "Code Examples"
Cohesion: 0.50
...
### Community 1020 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1021 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read at HEAD, 2026-08-01), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 1022 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1027 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1028 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1029 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1030 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1031 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1034 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1057 - "Code Examples"
Cohesion: 0.67
Nodes (3): Code Examples, Confidence from code, not prose, Provider endpoint containment

### Community 1075 - "goals (table)"
Cohesion: 0.11
Nodes (22): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), AskSpecialist(), DirectionBand(), fmtDuration(), fmtWhen() (+14 more)

### Community 1078 - "guardrailConfig (table)"
Cohesion: 0.08
Nodes (26): paginationBound(), controls, coverage, globalRails, LimiterWindow, mediaLedger, readWindow(), setMasterKillSwitch (+18 more)

### Community 1405 - "metering.ts"
Cohesion: 0.17
Nodes (5): enqueuedExtractions, migrationsModules, modules, workflowModules, workpoolModules

### Community 1408 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.25
...
### Community 1411 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.33
...
### Community 1412 - "The assemble contract (20-13)"
Cohesion: 0.33
...
### Community 1413 - "ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned"
Cohesion: 0.40
...
### Community 1426 - "SDD ledger — plan: docs/superpowers/plans/2026-08-09-cash-business-finance.md"
Cohesion: 0.50
Nodes (3): Pre-flight conflict scan (before Task 1), Progress, SDD ledger — plan: docs/superpowers/plans/2026-08-09-cash-business-finance.md
...
## Knowledge Gaps
- **9461 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9456 more)
...
- **Why does `api` connect `Pikar-AI` to `functions.ts`, `package.json`, `page.tsx`, `vaultFolders.test.ts`, `skills.ts`, `metering.ts`, `page.tsx`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `tenant.ts`, `page.tsx`, `calendar.test.ts`, `layout.tsx`, `index.ts`, `step`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `tenant.ts`, `officeText.test.ts`, `Dropzone.tsx`, `Phase 11: Persona Onboarding & Business Profile - Research`, `agentSteps.test.ts`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `ApprovalsErrorBoundary`, `goals (table)`, `buildTelemetry.ts`, `Phase 3.10: Cockpit Conversation Repair - Research`, `Project State`, `getActiveSkill`, `list`, `dependencies`, `officeText.ts`, `index.ts`, `finance.test.ts`, `COCKPIT_AGENT_SKILL`, `xlsText.ts`, `BlueprintDiff.tsx`, `voiceDoc.test.ts`, `index.ts`, `guardrails.test.ts`, `vaultGraph.test.ts`, `Phase 15.2 — universal format recognition`, `createdDocs.test.ts`, `http.ts`, `intake.test.ts`, `Phase 18 Plan 06: The createDocument Tool Summary`, `Phase Details - Milestone v2.0`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `metering.ts`, `skillBodies.test.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `internal` connect `package.json` to `vaultFolders.test.ts`, `tenantProfile.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `metering.ts`, `page.tsx`, `Project State`, `scan.ts`, `guardrails.ts`, `tenant.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `calendar.test.ts`, `layout.tsx`, `index.ts`, `vaultTranscribe.test.ts`, `tenant.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Dropzone.tsx`, `Validation Architecture`, `agentSteps.test.ts`, `buildTelemetry.ts`, `feedback.ts`, `log`, `tenant.ts`, `ApprovalsErrorBoundary`, `llm.ts`, `Pikar-AI`, `Project State`, `opsSignals.test.ts`, `guardrailConfig (table)`, `buildTelemetry.ts`, `cockpit.ts`, `vaultExtract.ts`, `notificationMessage`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `getActiveSkill`, `list`, `dependencies`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `Dropzone.tsx`, `xlsText.ts`, `classify.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `http.ts`, `intake.test.ts`, `vaultGraph.test.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `metering.ts`, `skillBodies.test.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `oleText()` connect `officeText.ts` to `Dropzone.tsx`, `vaultExtract.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9493 weakly-connected nodes found - possible documentation gaps or missing edges._
