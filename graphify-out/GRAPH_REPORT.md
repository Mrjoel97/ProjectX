...
## Corpus Check
- 1525 files · ~2,684,437 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14061 nodes · 16202 edges · 1408 communities (1313 shown, 95 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0fe12483`
...
## Communities (1408 total, 95 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.18
Nodes (8): notifyIfAgentTimeout(), auditControl(), MutationCtx, modules, logTierChange(), MESSAGES, NotificationKind, notificationMessage()

### Community 1 - "package.json"
Cohesion: 0.05
Nodes (21): DisconnectGoogle(), readSeen(), ReconnectBanner(), Crumb, Entry, Node, Note, WHY (+13 more)
...
Cohesion: 0.07
Nodes (30): rows(), extractDoc, Extracted, extractHosted(), ExtractPath, extractPdf(), fanOutPages(), pdfPages() (+22 more)

### Community 5 - "skills.ts"
Cohesion: 0.06
Nodes (28): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult (+20 more)
...
Cohesion: 0.05
Nodes (34): RFC-2045, RFC-2047, RFC-2822, internalAction, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies (+26 more)

### Community 11 - "scan.ts"
Cohesion: 0.05
Nodes (58): digits(), ShapePanel(), backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier (+50 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.13
Nodes (21): layoutRuns(), markdownToPdf(), wrapText(), word(), buildDocFilename(), DocFormat, DocToken, esc() (+13 more)

### Community 13 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.12
Nodes (25): seedDeck(), ArtDirection, Block, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, fail(), fieldOf() (+17 more)
...
Cohesion: 0.10
Nodes (15): aggregateModules, ALL_SLOTS, asTenant(), COMPLETE_FACTS, converse(), modules, PROFILE, rateLimiterModules (+7 more)
...
Cohesion: 0.03
Nodes (79): DriveBrowser(), assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender() (+71 more)
...
### Community 73 - "list"
Cohesion: 0.30
Nodes (10): AssemblyError, CLIP_SET, isGovernedRender(), near(), num(), parseAssemblySidecar(), codeOf(), fixture() (+2 more)
...
Cohesion: 0.13
Nodes (25): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+17 more)
...
Cohesion: 0.07
Nodes (33): ActionCtx, DatabaseWriter, QueryCtx, freshAccessToken(), bumpLanded(), classify(), classifyOne(), diffImport (+25 more)
...
Cohesion: 0.05
Nodes (29): agentBubble, card, Draft, DRAFT_VERSION, field, label, StorageId, Turn (+21 more)
...
Cohesion: 0.06
Nodes (30): cancelScheduledPlan, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, isNonAgentThreadIdError() (+22 more)

### Community 98 - "index.ts"
Cohesion: 0.12
Nodes (25): activity(), AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn (+17 more)
...
Cohesion: 0.10
Nodes (13): aggregateModules, cancelQueued(), migrationsModules, modules, profileFor(), queuedJobs(), seedProfileDoc(), SME_FACTS (+5 more)
...
Cohesion: 0.08
Nodes (25): ActivitySection(), caps, cardTitle, ConnectedHeadline(), ConnectedSolvency(), ConnectedUnitEconomics(), fallbackTier(), FigureTile() (+17 more)
...
Cohesion: 0.05
Nodes (38): deliverApprovedPlan, markPlanDone, vaultIngestPool, workflow, BlockReason, LABELS, llmSpendCorrelation(), pipelineWorkflow (+30 more)

### Community 157 - "agentSteps.test.ts"
Cohesion: 0.05
Nodes (43): { auth, signIn, signOut, store, isAuthenticated }, password, persistNextStepMemo(), httpAction, ASSET_PATH, FAL_ASSET_HOSTS, http, INLINE_ASSET (+35 more)

### Community 159 - "proactiveReview.ts"
Cohesion: 0.03
Nodes (81): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, deadLetterRecipient (+73 more)
...
Cohesion: 0.06
Nodes (33): auditCounts, backfillAuditCounts, countAudit, log, components, backfillRequestDefaults, migrations, run (+25 more)

### Community 169 - "page.tsx"
Cohesion: 0.10
Nodes (14): BLUEPRINT_TEXT, code, modules, sources, followUpIsDue(), needsAttention(), normalizeAddress(), renderFooter() (+6 more)
...
Cohesion: 0.06
Nodes (48): buildTrajectoryExport, scrub(), buildGeminiEmbedRequest(), buildOpenAIEmbedRequest(), embeddingContentHash(), embeddingV2, embedDoc, l2Normalize() (+40 more)
...
Cohesion: 0.06
Nodes (35): tenantAction, EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround, vaultGroundHydrated (+27 more)
...
Cohesion: 0.02
Nodes (46): modules, T, firstPage, modules, PlanStatus, aggregateModules, modules, modules (+38 more)
...
Cohesion: 0.10
Nodes (35): NumbersPanel(), activityFromSends(), CASH_INPUTS, CashActivity, CashFigure, CashInputs, cashInputsForTier(), CashInputSpec (+27 more)
...
### Community 265 - "fmtItemTime"
Cohesion: 0.67
Nodes (3): BriefingRow(), fmtItemTime(), PriorityRow()

### Community 266 - "documentDraft.test.ts"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)

### Community 272 - "Hot Path Rules"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)

### Community 273 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 276 - "Phase Details - Milestone v2.0"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (45): KIND_HREF, NotificationsBanner(), bubble(), ChatPane(), messageText(), IntakeControls(), StorageId, NAV (+37 more)

### Community 280 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 282 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 283 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 284 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 285 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 288 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 289 - "Architecture Research"
Cohesion: 0.09
...
### Community 297 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 299 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 301 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 302 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 305 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 306 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 307 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 308 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 309 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 310 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 311 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 312 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 313 - "Fix Order"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 314 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 317 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 318 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 319 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 320 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 321 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 322 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 323 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 324 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 325 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 326 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 327 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 328 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 329 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 330 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 333 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 334 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 335 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 336 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 337 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 338 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 339 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 340 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 341 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 342 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 343 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 344 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 345 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 346 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 347 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 348 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 349 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 350 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 351 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 354 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 355 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 356 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 357 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 358 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 359 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 360 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 362 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 363 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 364 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 365 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 366 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 367 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 368 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 369 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 370 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 371 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 372 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 373 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 375 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 376 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 377 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 378 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 379 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 381 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 382 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 383 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 385 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 386 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 387 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 388 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 389 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 390 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 392 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 393 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 394 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 395 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 396 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 398 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 399 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 400 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 401 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 402 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 403 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 405 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 406 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 407 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 408 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 409 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 410 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 412 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 413 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 414 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 415 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 416 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 417 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 419 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 420 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 421 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 422 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 424 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 425 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 426 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 427 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 429 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 430 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 432 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 433 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 434 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 435 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 437 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 438 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 440 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 441 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 442 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 443 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 444 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 446 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 447 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 448 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 449 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 450 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 451 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 452 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 453 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 454 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 455 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 456 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 457 - "Feature Research"
Cohesion: 0.12
...
### Community 458 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 460 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 461 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 462 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 467 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 468 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 469 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 471 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 472 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 473 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 474 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 475 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 477 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 482 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 487 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 490 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 492 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 493 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 494 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 495 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 496 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 497 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 498 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 508 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 509 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 510 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 512 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 513 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 514 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 515 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 517 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 518 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 522 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
...
### Community 523 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 524 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 525 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 526 - "Architecture Patterns"
Cohesion: 0.14
...
Cohesion: 0.13
Nodes (17): activity, _docToField, _fieldToDoc, inputs, inputStatesFor(), saveInput, scorecardValue(), shape (+9 more)

### Community 528 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 529 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 535 - "Goal Achievement"
Cohesion: 0.15
...
### Community 543 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 545 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 546 - "Goal Achievement"
Cohesion: 0.15
...
### Community 548 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 549 - "Goal Achievement"
Cohesion: 0.15
...
### Community 550 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 552 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 553 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 556 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 557 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 560 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 562 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 563 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 564 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 565 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 566 - "Phase 16 — the async research dispatch seam (16-06, DISP-02)"
Cohesion: 0.17
...
### Community 567 - "Key files"
Cohesion: 0.17
Nodes (12): Backend page adapters, Cash — business finance, Cash — FigureTile and the connected page (Task 6), Cash — solvency (Task 7), Cash — the Business tab, assembled (Task 9), Cash — the collection surface and `financeInputs` (Task 3), Cash — the suppression rule (Task 4), Cash — unit economics (Task 5) (+4 more)

### Community 568 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)
...
Cohesion: 0.13
Nodes (10): ErrorBoundary, CanvasPane(), capsTeal, panel, REVIEW_TAB, Tab, clamp(), readSaved() (+2 more)
...
### Community 651 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 652 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 653 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 656 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 657 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 658 - "Code Conventions"
Cohesion: 0.20
...
### Community 664 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 665 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 666 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 673 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 676 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 682 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 686 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 688 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 690 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 696 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 697 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 698 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 701 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 702 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 704 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 709 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 710 - "Validation Architecture"
Cohesion: 0.20
...
### Community 713 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 714 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 715 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 716 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 717 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 718 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 719 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 720 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 721 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 722 - "Locked Decisions"
Cohesion: 0.22
...
### Community 724 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 727 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 728 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 729 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 732 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 733 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 736 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 737 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 739 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 750 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 751 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 752 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 753 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 754 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 755 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 760 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 762 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 764 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 767 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 771 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 772 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 773 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 774 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 775 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 777 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 778 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 779 - "Invariants — what must never break"
Cohesion: 0.25
...
### Community 780 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 781 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 782 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 783 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 784 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 786 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 787 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 788 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 789 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 790 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 791 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 792 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 793 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 794 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 795 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 796 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 797 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 798 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 799 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 800 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 801 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 802 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 803 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 804 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 805 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 806 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 807 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 808 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 809 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 810 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 812 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 813 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 814 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 815 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 816 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 817 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 818 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 819 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 820 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 821 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 823 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 825 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 826 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 827 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 828 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 830 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 831 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 832 - "Phase 19 — Validation Strategy"
Cohesion: 0.25
...
### Community 838 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 839 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 840 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 841 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 842 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 843 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 844 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 845 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 846 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 847 - "failureCopy.ts"
Cohesion: 0.29
Nodes (6): COPY, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED

### Community 848 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.29
...
### Community 850 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 851 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 853 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 854 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 856 - "Validation Architecture"
Cohesion: 0.29
...
### Community 859 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 862 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 866 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 868 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 869 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 871 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 872 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 873 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 874 - "Phase 17 — Calendar actions"
Cohesion: 0.33
...
### Community 875 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 876 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 877 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 878 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 879 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 880 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 881 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 882 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 883 - "Validation Architecture"
Cohesion: 0.33
...
### Community 884 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 891 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
Cohesion: 0.04
Nodes (63): controls, coverage, globalRails, LimiterWindow, mediaLedger, patchControls(), readWindow(), setMasterKillSwitch (+55 more)

### Community 893 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 895 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 900 - "Validation Architecture"
Cohesion: 0.33
...
### Community 902 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 903 - "Validation Architecture"
Cohesion: 0.33
...
### Community 906 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 907 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 909 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 910 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 912 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 913 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 914 - "Phase 15 — Sub-agent dispatch + generalized executor"
Cohesion: 0.40
...
### Community 915 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 916 - "metering.ts"
Cohesion: 0.60
Nodes (3): accumulateUsage(), UsageDelta, ZERO_USAGE

### Community 917 - "Scheduled Send"
Cohesion: 0.40
...
### Community 919 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 920 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 921 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 924 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 925 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 933 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 935 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 936 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 941 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 942 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 943 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 944 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 945 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 946 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 949 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 950 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 951 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 953 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 954 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 957 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 958 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 959 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 971 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 972 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 974 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 975 - "Code Examples"
Cohesion: 0.50
...
### Community 977 - "User Constraints"
Cohesion: 0.50
...
### Community 983 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 986 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 988 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 992 - "User Constraints"
Cohesion: 0.50
...
### Community 994 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 998 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 999 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1001 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1002 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1007 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1009 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1013 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1014 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1015 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1016 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1017 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1020 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1036 - "Code Examples"
Cohesion: 0.67
Nodes (3): Code Examples, Confidence from code, not prose, Provider endpoint containment

### Community 1075 - "goals (table)"
Cohesion: 0.07
Nodes (36): BLOCKED, BlockedConnection, ADR-0007, ConnectionsPanel(), pill, row, NarrativePanel(), isTabId() (+28 more)
...
## Knowledge Gaps
- **9379 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9374 more)
...
- **Why does `internal` connect `tenant.ts` to `functions.ts`, `package.json`, `v1 Requirements`, `skills.ts`, `financialSpine.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `calendar.ts`, `metering.ts`, `Project State`, `scan.ts`, `skills.test.ts`, `tenantProfile.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `26-05: Connected Approvals route, owner-verified`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `agentSteps.test.ts`, `proactiveReview.ts`, `feedback.ts`, `log`, `feedback.test.ts`, `page.tsx`, `ApprovalsErrorBoundary`, `llm.ts`, `Phase 15 — Sub-agent dispatch + generalized executor`, `Project State`, `buildTelemetry.ts`, `searchVaultSpine.test.ts`, `blueprintPulse.ts`, `worm.ts`, `vaultLlm.ts`, `getActiveSkill`, `index.ts`, `index.ts`, `Hot Path Rules`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `vaultViewState.ts`, `buildTelemetry.ts`, `classify.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `Phase Details - Milestone v2.0`, `http.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `brief.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `api` connect `package.json` to `page.tsx`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `metering.ts`, `scan.ts`, `skills.test.ts`, `page.tsx`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `26-05: Connected Approvals route, owner-verified`, `Phase 11: Persona Onboarding & Business Profile - Research`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `ApprovalsErrorBoundary`, `Implementation Decisions`, `goals (table)`, `Phase 15 — Sub-agent dispatch + generalized executor`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `Phase 3.10: Cockpit Conversation Repair - Research`, `getActiveSkill`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `COCKPIT_AGENT_SKILL`, `vaultViewState.ts`, `buildTelemetry.ts`, `classify.ts`, `proactiveReview.ts`, `logger.ts`, `index.ts`, `guardrails.test.ts`, `Phase Details - Milestone v2.0`, `voiceDoc.test.ts`, `Phase 15.2 — universal format recognition`, `createdDocs.test.ts`, `http.ts`, `vaultLlm.ts`, `page.tsx`, `Phase 18 Plan 06: The createDocument Tool Summary`, `gapAction.test.ts`, `Phase Details - Milestone v2.0`, `brief.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `tenant.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `extractOfficeText()` connect `gmail.test.ts` to `v1 Requirements`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9411 weakly-connected nodes found - possible documentation gaps or missing edges._
