# Graph Report - pikar-ai  (2026-07-25)

## Corpus Check
- 916 files · ~1,200,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7795 nodes · 8178 edges · 783 communities (714 shown, 69 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43fd4991`
...
7. `base()` - 17 edges
8. `Phase Details - Milestone v2.0` - 17 edges
...
## Communities (783 total, 69 thin omitted)
...
Cohesion: 0.04
Nodes (52): Activity, attRow, badge(), box, Briefing, BriefingItem, BriefingRow(), briefingSheet (+44 more)
...
Cohesion: 0.06
Nodes (33): activateCandidate, activateSkill, activateSkillVersion(), archiveSkill, candidatesForReview, getActiveSkill, getSkillVersion, insertCandidate (+25 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.15
Nodes (11): embedDoc, openaiEmbeddingV2, rag, RagEmbeddingModel, assertGroundNeighbor, assertNoRawText, assertReady, assertSearchReturns (+3 more)
...
Cohesion: 0.14
Nodes (21): buildCockpitTools(), stripRePrefix(), applyRecipientEdit(), classify(), ContactMatch, dedupeAppend(), HeaderRecord, NameCandidates (+13 more)

### Community 10 - "Project State"
Cohesion: 0.06
Nodes (31): RFC-2045, RFC-2047, RFC-2822, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies, freshAccessToken() (+23 more)
...
Cohesion: 0.08
Nodes (28): ACTABLE_PLAN_STATUS, actOnGap, applyScorecardAnswer(), byThread, EvaluationDelta, FINANCIAL_PATTERNS, Framework, FRAMEWORK_SKILL (+20 more)

### Community 14 - "page.tsx"
Cohesion: 0.11
Nodes (12): CardList(), ErrorBoundary, capsTeal, panel, Tab, clamp(), readSaved(), SplitPane() (+4 more)
...
Cohesion: 0.12
Nodes (15): ADR-005: Live voice is browser-direct OpenAI Realtime over WebRTC, bounded by a single server wall-clock watchdog, with metering as telemetry, Alternatives rejected, Consequences, Context, Decision, Data flow, Dependencies & blast radius, How to change safely (+7 more)

### Community 30 - "vaultLlm.ts"
Cohesion: 0.09
Nodes (21): deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText, ingestFromAttachment, listVaultDocs, markExtracting (+13 more)
...
Cohesion: 0.06
Nodes (31): DEFAULT_CONFIG, getSafeTextByHash, preCall, prepare, recordSpend, saveInstruction, setKillSwitch, assertSubmitRateLimited (+23 more)
...
Cohesion: 0.08
Nodes (27): persistNextStepMemo(), contentHash(), commitProfile, extractProfile, getProfile, profileSchema, status, updateProfile (+19 more)
...
Cohesion: 0.04
Nodes (44): Milestone v2.0 - Platform -> Private Beta (Phases 10-25), Overview, Phase 03.2.1: Agent-Driven Cockpit (INSERTED), Phase 10: Vault->Agent Grounding, Phase 11: Persona Onboarding & Business Profile, Phase 12: Business Evaluation Engine, Phase 13: Proactive In-App Review, Phase 14: Flagship Voice-Doc Workflow (+36 more)

### Community 59 - "vaultGraph.ts"
Cohesion: 0.16
Nodes (15): field, label, smokeProfileFixture(), BusinessProfile, ConfirmDecision, decideConfirm(), deserializeProfile(), isPersona() (+7 more)
...
Cohesion: 0.16
Nodes (8): notifyIfAgentTimeout(), deadLetterRecipient, onPipelineComplete, modules, modules, MESSAGES, NotificationKind, notificationMessage()
...
Cohesion: 0.13
Nodes (16): agentBubble, field, label, StorageId, ActivityCard(), stepText(), traceText, bubble() (+8 more)
...
Cohesion: 0.18
Nodes (18): hangupCall, mintClientSecret, MintResponse, Captured, modules, CALLS_URL, CLIENT_SECRETS_URL, DEFAULT_REALTIME_MODEL (+10 more)
...
Cohesion: 0.13
Nodes (24): NotificationsBanner(), ReconnectBanner(), NAV, PasswordField(), TextField(), ArrowIcon(), base(), CheckCircleIcon() (+16 more)
...
Cohesion: 0.09
Nodes (19): buildTrajectoryExport, scrub(), ExtractedGraph, extractGraph, getDocText, GraphEdge, GraphNode, graphSchema (+11 more)

### Community 105 - "gapAction.test.ts"
Cohesion: 0.08
Nodes (26): deliverApprovedPlan, markPlanDone, rateLimiter, retrier, workflow, BlockReason, LABELS, pipelineWorkflow (+18 more)

### Community 106 - "11-01-PLAN.md"
Cohesion: 0.07
...
### Community 110 - "11-02-PLAN.md"
Cohesion: 0.11
Nodes (18): tenantAction, EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround, vaultGroundHydrated (+10 more)
...
Cohesion: 0.08
Nodes (26): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, listNew (+18 more)
...
### Community 117 - "financialSpine.test.ts"
Cohesion: 0.12
Nodes (11): aggregateModules, modules, profileDocText(), aggregateModules, modules, PROFILE, SENTINELS, workflowModules (+3 more)
...
Cohesion: 0.20
Nodes (9): terminalOutcome, writeTerminal, buildTelemetry(), LlmUsage, ReviewOutcome, TelemetryRow, TerminalOutcome, OPSG01_KEYS (+1 more)
...
Cohesion: 0.13
Nodes (17): extractDoc, Extracted, extractHosted(), ExtractPath, extractPdf(), PromiseCtor, slicePdfToPageCap(), WithResolvers (+9 more)
...
### Community 134 - "optimizerBreach.ts"
Cohesion: 0.29
...
Cohesion: 0.14
Nodes (17): bubble(), fmt(), LiveSession(), speakerLabel(), two(), VoicePage(), MicState, PreFlight() (+9 more)

### Community 139 - "serializeProfile"
Cohesion: 0.40
Nodes (3): box, btn, Mode

### Community 140 - "vaultSweep.ts"
Cohesion: 0.40
...
### Community 147 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)
...
### Community 151 - "evaluations.test.ts"
Cohesion: 0.08
...
### Community 152 - "COCKPIT_AGENT_SKILL"
Cohesion: 0.08
...
### Community 153 - "bfsNeighbors"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)

### Community 156 - "Hot Path Rules"
Cohesion: 0.08
...
### Community 157 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 159 - "optimizerEligibility.test.ts"
Cohesion: 0.09
...
### Community 160 - "skilloptExport.test.ts"
Cohesion: 0.09
...
### Community 163 - "Architecture Research"
Cohesion: 0.10
...
### Community 165 - "importGuard.test.ts"
Cohesion: 0.10
...
### Community 166 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.24
...
### Community 170 - "Implications for Roadmap"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (58): ADR-0006, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext(), digestInbox (+50 more)

### Community 172 - "Implementation Decisions"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 173 - "guardrails.test.ts"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (13): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+5 more)

### Community 175 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 176 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 177 - "Implementation Decisions"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 178 - "page.tsx"
Cohesion: 0.13
Nodes (9): OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), BellIcon(), BoltIcon(), BrainIcon(), ShieldIcon(), WalletIcon() (+1 more)

### Community 179 - "Convex Migration Helper"
Cohesion: 0.11
...
### Community 181 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 182 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 183 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 184 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 185 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 186 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 187 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 188 - "Convex Create Component"
Cohesion: 0.12
...
### Community 189 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 190 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 191 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 192 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
...
### Community 194 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 195 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 196 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 197 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 198 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 199 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
...
### Community 200 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 201 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 202 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
...
### Community 203 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 205 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 206 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 207 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 208 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
...
### Community 210 - "Implementation Decisions"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 211 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
...
### Community 212 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 213 - "Implementation Decisions"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 214 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 215 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)

### Community 216 - "Convex Performance Audit"
Cohesion: 0.12
...
### Community 218 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 219 - "validateSubmit.ts"
Cohesion: 0.12
...
### Community 223 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 224 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
...
### Community 225 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 226 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 227 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 228 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 229 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
...
### Community 232 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 233 - "Playbook: Audit Log & Dead-Letter Pipeline"
Cohesion: 0.11
Nodes (16): ADR-002: Insert-only audit log with redaction-safe payloads; WORM immutability lives outside Convex, Alternatives rejected, Consequences, Context, Decision, Data flow, Dependencies & blast radius, How to change safely (+8 more)
...
### Community 237 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
...
### Community 238 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 239 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 240 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
...
### Community 241 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 242 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 243 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
...
### Community 245 - "Implementation Decisions"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 246 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 247 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 248 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 249 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
...
### Community 251 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
...
### Community 253 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 254 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 255 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
...
### Community 256 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 257 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 258 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 259 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
...
### Community 260 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 261 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 262 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
...
### Community 263 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 264 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
...
### Community 265 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 266 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 267 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 268 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 269 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 270 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 271 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 272 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 273 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 274 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 275 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 276 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 277 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 278 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
...
### Community 279 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 280 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 281 - "Feature Research"
Cohesion: 0.12
...
### Community 282 - "Recommended Stack — per new capability"
Cohesion: 0.13
...
### Community 283 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 284 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
...
### Community 285 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 286 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 287 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 288 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 289 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 290 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
...
### Community 291 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 293 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 294 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 295 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
...
### Community 297 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 298 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 300 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 301 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 302 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 303 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 304 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 305 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 306 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 307 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 308 - "PostCall.tsx"
Cohesion: 0.23
Nodes (12): AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), VoiceBrief, Phase, PostCall(), primaryBtn, secondaryBtn (+4 more)

### Community 309 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
...
### Community 312 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 313 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 314 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 315 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 316 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 317 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 318 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 319 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 320 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
...
### Community 322 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 323 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 324 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 325 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
...
### Community 326 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 333 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
...
### Community 334 - "Growth OS — Hormozi Skill Suite Design Spec"
Cohesion: 0.13
...
### Community 335 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 336 - "pipeline.test.ts"
Cohesion: 0.18
...
### Community 342 - "Goal Achievement"
Cohesion: 0.15
...
### Community 343 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 344 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 345 - "Goal Achievement"
Cohesion: 0.15
...
### Community 346 - "Goal Achievement"
Cohesion: 0.15
...
### Community 347 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 348 - "Goal Achievement"
Cohesion: 0.15
...
### Community 349 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 350 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 352 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 353 - "scorecard.py"
Cohesion: 0.40
Nodes (12): cmd_get(), cmd_init(), cmd_log(), cmd_set(), cmd_show(), _dotted_get(), _dotted_set(), load() (+4 more)

### Community 354 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 355 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 356 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 357 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 358 - "Goal Achievement"
Cohesion: 0.17
...
### Community 364 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 365 - "Grand Slam Offer Canvas"
Cohesion: 0.17
...
### Community 366 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 368 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 369 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 370 - "Goal Achievement"
Cohesion: 0.18
...
### Community 372 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 373 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 374 - "Goal Achievement"
Cohesion: 0.18
...
### Community 375 - "Goal Achievement"
Cohesion: 0.18
...
### Community 376 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 378 - "Goal Achievement"
Cohesion: 0.18
...
### Community 381 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 382 - "Lead Engine — get engaged leads (Core Four + Lead Getters)"
Cohesion: 0.18
...
### Community 383 - "Money Model Designer"
Cohesion: 0.18
...
### Community 385 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 387 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 388 - "Goal Achievement"
Cohesion: 0.20
...
### Community 389 - "Goal Achievement"
Cohesion: 0.20
...
### Community 390 - "Goal Achievement"
Cohesion: 0.20
...
### Community 391 - "Goal Achievement"
Cohesion: 0.20
...
### Community 393 - "Goal Achievement"
Cohesion: 0.20
...
### Community 394 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 397 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 402 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 404 - "Goal Achievement"
Cohesion: 0.20
...
### Community 405 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 406 - "Goal Achievement"
Cohesion: 0.20
...
### Community 407 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 408 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 409 - "Parallel Build Lanes (multi-session)"
Cohesion: 0.22
Nodes (8): How each session starts, Parallel Build Lanes (multi-session), Phase 3.8 — Vault document extraction (4 lanes, Wave 0 landed 2026-07-18), Rules of the road, Sequencing note, The lanes, The three shared singletons — append-only discipline, Why this split works

### Community 410 - "Financial Spine — canonical definitions"
Cohesion: 0.20
...
### Community 411 - "Growth OS — the diagnostic router"
Cohesion: 0.20
...
### Community 412 - "Playbook 03 — Post Free Content"
Cohesion: 0.20
...
### Community 413 - "Playbook 04 — Cold Outreach"
Cohesion: 0.20
...
### Community 414 - "Playbook 05 — Paid Ads"
Cohesion: 0.20
...
### Community 415 - "The Money Model — definition, tiers, stages, rules"
Cohesion: 0.20
...
### Community 416 - "Playbook 02 — Build the Offer (the 5-Step Core Process)"
Cohesion: 0.20
...
### Community 417 - "Offer Architect — build a Grand Slam Offer"
Cohesion: 0.20
...
### Community 418 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 419 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 420 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 421 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 422 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 423 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 424 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 425 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 426 - "Locked Decisions"
Cohesion: 0.22
...
### Community 428 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 431 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 432 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 433 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 434 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 436 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 437 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
Nodes (7): byThread, generateUploadUrl, getArtifact, insertArtifact, KIND, patchArtifact, STATUS

### Community 438 - "Diagnostic Tree — diagnose and route"
Cohesion: 0.22
...
### Community 439 - "Lead Magnet Spec"
Cohesion: 0.22
...
### Community 440 - "Playbook 11 — More, Better, New (scale the channel)"
Cohesion: 0.22
...
### Community 441 - "Market Selection — "A Starving Crowd""
Cohesion: 0.22
...
### Community 442 - "The Value Equation"
Cohesion: 0.22
...
### Community 443 - "value_equation_scorer.py"
Cohesion: 0.39
...
### Community 444 - "Growth OS — a self-improvement skill suite for businesses"
Cohesion: 0.22
...
### Community 445 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 446 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 448 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 449 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 450 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 451 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 452 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 453 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 454 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 455 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 456 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 457 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 458 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 459 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 460 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 461 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 462 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 463 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 464 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 465 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 466 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 467 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 468 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 469 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 470 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 471 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 472 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 473 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 474 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 475 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 476 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 477 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 478 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 479 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 481 - "Playbook 07 — Customer Referrals"
Cohesion: 0.25
...
### Community 482 - "Playbook 09 — Employees (hire lead-getters)"
Cohesion: 0.25
...
### Community 483 - "The Four Lead Getters — get OTHER people to advertise for you"
Cohesion: 0.25
...
### Community 484 - "Lead Magnets — a complete solution to a narrow problem"
Cohesion: 0.25
...
### Community 485 - "Money-Model Canvas — {{business_name}}"
Cohesion: 0.25
...
### Community 486 - "Attraction Offers — turn strangers into customers (Stage I)"
Cohesion: 0.25
...
### Community 487 - "Upsell Offers — get customers to spend more (Stage II)"
Cohesion: 0.25
...
### Community 488 - "Playbook 03 — Enhance the Offer"
Cohesion: 0.25
...
### Community 489 - "Playbook 04 — Name the Offer"
Cohesion: 0.25
...
### Community 490 - "Pricing — the Price-to-Value Discrepancy and the Virtuous Cycle"
Cohesion: 0.25
...
### Community 491 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
Nodes (6): exports, ./api, name, private, type, version

### Community 492 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 494 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 495 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 497 - "Validation Architecture"
Cohesion: 0.29
...
### Community 498 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 500 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 501 - "One-Page Advertising Checklist"
Cohesion: 0.29
...
### Community 506 - "More, Better, New — the Core Four on steroids"
Cohesion: 0.29
...
### Community 507 - "The Rule of 100 & Open To Goal — do the reps"
Cohesion: 0.29
...
### Community 508 - "constraint_analyzer.py"
Cohesion: 0.48
Nodes (6): analyze(), main(), _norm_rate(), _parse_steps_arg(), Return per-step incoming/passed and the final output., run_funnel()

### Community 509 - "Downsell Offers — get a yes from someone about to say no (Stage II)"
Cohesion: 0.29
...
### Community 514 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 517 - "Lane ownership (Phase 3.8)"
Cohesion: 0.33
...
### Community 518 - "Advanced Component Patterns"
Cohesion: 0.29
...
### Community 519 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 520 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 521 - "devDependencies"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 522 - "03.11-02-PLAN.md"
Cohesion: 0.33
Nodes (6): devDependencies, @convex-dev/workpool, convex-test, @edge-runtime/vm, @types/node, vitest

### Community 523 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 524 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 525 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 527 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 528 - "ltgp_cac.py"
Cohesion: 0.60
Nodes (5): analyze(), cac(), ltgp(), main(), _resolve()

### Community 529 - "Playbook 01 — Pick Your Core Four Channel"
Cohesion: 0.33
Nodes (5): Artifact, Inputs, Playbook 01 — Pick Your Core Four Channel, Record it, Steps

### Community 530 - "The Core Four — the only four ways to get engaged leads"
Cohesion: 0.33
...
### Community 531 - "Continuity Offers — keep them buying (Stage III)"
Cohesion: 0.33
...
### Community 534 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 536 - "Scheduled Send"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 537 - "Validation Architecture"
Cohesion: 0.80
Nodes (3): cfa(), ltgpCac(), round2()

### Community 538 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 539 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 540 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 542 - "Validation Architecture"
Cohesion: 0.40
...
### Community 543 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 544 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 545 - "Standard Stack"
Cohesion: 0.40
...
### Community 546 - "Validation Architecture"
Cohesion: 0.40
...
### Community 547 - "10-01-PLAN.md"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 548 - "10-02-PLAN.md"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 549 - "Validation Architecture"
Cohesion: 0.40
...
### Community 550 - "Validation Architecture"
Cohesion: 0.40
...
### Community 551 - "diagnose.py"
Cohesion: 0.70
Nodes (4): diagnose(), _g(), main(), _rx()

### Community 552 - "The Four Offer Types + Sequencing"
Cohesion: 0.40
...
### Community 553 - "continuity_pricing.py"
Cohesion: 0.70
Nodes (4): forward(), full_table(), inverse(), main()

### Community 555 - "plans.test.ts"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 556 - "wormCursor.ts"
Cohesion: 0.50
Nodes (3): advanceCursor, auditSince, getCursor

### Community 557 - "tsconfig.json"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 559 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 560 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 561 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 562 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 563 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 564 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 565 - "Standard Stack"
Cohesion: 0.50
Nodes (3): exclude, extends, include
...
### Community 570 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
...
### Community 573 - "User Constraints"
Cohesion: 0.50
...
### Community 576 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
...
## Knowledge Gaps
- **5359 isolated node(s):** `graphify-mcp`, `StorageId`, `agentBubble`, `label`, `field` (+5354 more)
...
- **Why does `tenantMutation` connect `page.tsx` to `skills.ts`, `compilerOptions`, `tenant.ts`, `gapAction.test.ts`, `Phase 03.7 — Validation Strategy`, `Pikar-AI`, `Project State`, `01-08 Summary — Public web surface (PARTIAL)`, `guardrails.test.ts`, `vaultLlm.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `tenantQuery` connect `page.tsx` to `package.json`, `skills.ts`, `compilerOptions`, `gapAction.test.ts`, `Phase 03.7 — Validation Strategy`, `Pikar-AI`, `Project State`, `01-08 Summary — Public web surface (PARTIAL)`, `guardrails.test.ts`, `vaultLlm.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `contentHash()` connect `Project State` to `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `03.7-08-PLAN.md`, `emailIntent.ts`, `Project State`, `llm.ts`, `gapAction.test.ts`, `Phase 03.7 — Validation Strategy`, `guardrails.test.ts`, `vaultLlm.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
