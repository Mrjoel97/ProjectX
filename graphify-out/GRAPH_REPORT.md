...
## Corpus Check
- 1553 files · ~2,675,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14160 nodes · 16163 edges · 1436 communities (1326 shown, 110 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `43a549c6`
...
- COCKPIT_AGENT_SKILL
- MediaCanvas.tsx
- 009-tier-shapes-the-specialist-prompt-not-the-offer-set.md
...
- `activity()` --indirect_call--> `today()`  [INFERRED]
  apps/web/app/(app)/dashboard/finance/cashView.test.ts → apps/web/app/(app)/dashboard/voice/PostCall.tsx

## Import Cycles
- None detected.

## Communities (1436 total, 110 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.03
Nodes (80): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getGuardrailConfig(), getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents (+72 more)
...
Cohesion: 0.09
Nodes (15): profileText(), aggregateModules, cancelQueued(), migrationsModules, modules, profileFor(), queuedJobs(), seedProfileDoc() (+7 more)
...
Cohesion: 0.05
Nodes (41): RFC-2045, RFC-2047, RFC-2822, notifyIfAgentTimeout(), auditControl(), ActionCtx, DatabaseReader, MutationCtx (+33 more)

### Community 11 - "scan.ts"
Cohesion: 0.04
Nodes (59): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, activity (+51 more)
...
Cohesion: 0.13
Nodes (24): ArtDirection, Block, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, fail(), fieldOf(), isPaidBlock() (+16 more)
...
Cohesion: 0.07
Nodes (26): applyClassification, countTerminal(), deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText, ingestFromAttachment (+18 more)

### Community 25 - "classify.ts"
Cohesion: 0.09
Nodes (33): compareDashboardOrder(), CompleteDashboardBound, createDashboardMoney(), DASHBOARD_STATE_COPY, DashboardBound, dashboardCursorFor(), DashboardMoney, DashboardMoneyPhase (+25 more)
...
Cohesion: 0.23
Nodes (10): Attachment, EXT_MIME, isValidEmail(), MIME_ALLOWLIST, RejectionReason, resolveMimeType(), SubmitInput, base (+2 more)
...
Cohesion: 0.11
Nodes (29): AssemblyBlock, AssemblyError, AssemblyReport, CLIP_SET, isGovernedRender(), near(), num(), parseAssemblySidecar() (+21 more)
...
Cohesion: 0.05
Nodes (59): admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots(), profileSchema (+51 more)
...
Cohesion: 0.05
Nodes (39): { auth, signIn, signOut, store, isAuthenticated }, password, BusyRange, createEvent, CreateEventResult, freeBusy, FreeBusyResult, GoogleError (+31 more)
...
Cohesion: 0.05
Nodes (42): answerDecision, blockedSummary, listAwaiting, listCleared, listDecisions, listInFlight, listScheduled, numericField (+34 more)
...
Cohesion: 0.08
Nodes (30): QueryCtx, bumpLanded(), classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch() (+22 more)
...
Cohesion: 0.11
Nodes (24): DriveBrowser(), repriceUsd(), n(), chooseMediaBatch(), CLIP_SET, counted(), estimateBatchUsd(), estimateMediaUsd() (+16 more)

### Community 97 - "proactiveReview.ts"
Cohesion: 0.10
Nodes (26): BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), marker() (+18 more)
...
Cohesion: 0.18
Nodes (23): refundableCents(), CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL, estimateCostUsd(), estimateTokens(), priceRealtime() (+15 more)

### Community 106 - "classify.ts"
Cohesion: 0.06
Nodes (36): persistNextStepMemo(), contentHash(), writeProfileDoc(), isoDate(), persistFindings, researchDocumentText(), researchTitle(), BuildDigestResult (+28 more)
...
Cohesion: 0.09
Nodes (30): POST(), ADR-0011, bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, CLIP_SECONDS_SET, convexSiteOrigin() (+22 more)

### Community 127 - "intake.test.ts"
Cohesion: 0.09
Nodes (16): BLUEPRINT_TEXT, code, modules, sources, BLUEPRINT_TEXT, modules, seedChain(), seedConfirmedBlueprint() (+8 more)
...
Cohesion: 0.06
Nodes (32): SubmittableSpec, aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules (+24 more)
...
Cohesion: 0.08
Nodes (24): ATTACHMENTS, attachmentUrls, byThread, CANDIDATES, clearCandidates, getById, insertPlan, landStoryboardRefusal (+16 more)
...
Cohesion: 0.07
Nodes (24): Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions(), maybeStartCaptions(), onSubmitComplete (+16 more)
...
Cohesion: 0.09
Nodes (31): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), BlueprintPanel(), secondaryButton(), BLOCKED, BlockedConnection (+23 more)
...
### Community 215 - "009-tier-shapes-the-specialist-prompt-not-the-offer-set.md"
Cohesion: 0.06
...
### Community 217 - "Phase 15.2 — 15.2-05 (LIVE verification — THE PHASE GATE)"
Cohesion: 0.06
...
Cohesion: 0.14
Nodes (23): AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn, today() (+15 more)

### Community 228 - "fmtItemTime"
Cohesion: 0.40
Nodes (4): Folder Digest (v1), Inputs, Never invent, Output contract

### Community 229 - "ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned"
Cohesion: 0.07
...
### Community 241 - "renderReel.ts"
Cohesion: 0.05
Nodes (47): internalAction, tenantAction, EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround (+39 more)
...
### Community 243 - "cockpitThreadDegrade.test.ts"
Cohesion: 0.40
...
### Community 245 - "Phase 3.1: Cockpit Core — Research (Delivery lane)"
Cohesion: 0.06
...
### Community 256 - "NotificationsBanner.tsx"
Cohesion: 0.08
...
### Community 258 - "profileRedaction.test.ts"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)
...
### Community 263 - "cockpitThreadDegrade.test.ts"
Cohesion: 0.08
...
Cohesion: 0.03
Nodes (33): AttachmentPicker(), UploadedAttachment, DisconnectGoogle(), KIND_HREF, NotificationsBanner(), readSeen(), ReconnectBanner(), STATUS_COLOR (+25 more)
...
Cohesion: 0.03
Nodes (32): aggregateModules, modules, modules, modules, NOTE: no `@ts-expect-error` above this line, unlike its 37 siblings. tsconfig.js, modules, SCHEMA, DataModel (+24 more)

### Community 271 - "vault-redesign.spec.ts"
Cohesion: 0.09
...
### Community 273 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.09
...
### Community 280 - "VaultErrorBoundary"
Cohesion: 0.09
...
### Community 282 - "documentDraft.test.ts"
Cohesion: 0.09
...
### Community 283 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.09
...
### Community 288 - "documentDraft.test.ts"
Cohesion: 0.09
...
### Community 289 - "cockpitThreadDegrade.test.ts"
Cohesion: 0.09
...
### Community 294 - "pipeline.test.ts"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 295 - "vault-redesign.spec.ts"
Cohesion: 0.20
...
### Community 299 - "SPEND_EVENT_PAGE_LIMIT"
Cohesion: 0.10
...
### Community 308 - "createdDocs.test.ts"
Cohesion: 0.10
...
### Community 310 - "vaultSealing.test.ts"
Cohesion: 0.10
...
### Community 317 - "metering.ts"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 318 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 319 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 320 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 321 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 322 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 323 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 324 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 325 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 326 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 327 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 328 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 329 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 330 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 333 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 334 - "officeText.ts"
Cohesion: 0.12
Nodes (10): agentBubble, card, Draft, DRAFT_VERSION, field, label, StorageId, Turn (+2 more)

### Community 335 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 336 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 337 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 338 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 339 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 340 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 341 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 342 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 343 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 344 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 345 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 346 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 347 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 348 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 349 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 350 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 351 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 352 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 354 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 355 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 356 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 357 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 359 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 360 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 362 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 363 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 364 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 365 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 366 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 367 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 368 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 369 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 370 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 371 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 372 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 373 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 374 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 375 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 376 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 377 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 380 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 382 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 383 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 385 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 386 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 388 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 389 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 390 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 391 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 392 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 393 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 394 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 395 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 396 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)
...
### Community 398 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 400 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 401 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 402 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 403 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 405 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 406 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 407 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 408 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 409 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 410 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 411 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 412 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 413 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 414 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 415 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 416 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 417 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 419 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 420 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 421 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 422 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 425 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 427 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 429 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 430 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 432 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 433 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 434 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 435 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 437 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 438 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 440 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 441 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 442 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 443 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 446 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 447 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 448 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 449 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 450 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 451 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 452 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 453 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 454 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 455 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 456 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 457 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 458 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 459 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 460 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 461 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 462 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 466 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 467 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 468 - "Feature Research"
Cohesion: 0.12
...
### Community 469 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 471 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 472 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 473 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 475 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 476 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 477 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 478 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 482 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 487 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 493 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 494 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 495 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 496 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 497 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 498 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 508 - "optimizerBreach.ts"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 509 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 510 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 512 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 513 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 514 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 515 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 516 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 517 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 519 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 520 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 521 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 522 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 523 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 524 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 525 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 527 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 528 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 535 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
...
### Community 543 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 545 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 546 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 547 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 548 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 549 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 555 - "Goal Achievement"
Cohesion: 0.15
...
### Community 556 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 557 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 558 - "Goal Achievement"
Cohesion: 0.15
...
### Community 559 - "Goal Achievement"
Cohesion: 0.15
...
### Community 562 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 563 - "Goal Achievement"
Cohesion: 0.15
...
### Community 564 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 566 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 567 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 570 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 572 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 573 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 574 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 575 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 576 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 577 - "Phase 16 — the async research dispatch seam (16-06, DISP-02)"
Cohesion: 0.40
...
### Community 578 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 579 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)

### Community 580 - "vaultExtract.ts"
Cohesion: 0.20
Nodes (6): ActivitySection(), cardTitle, muted, stack, activity(), CashActivity
...
### Community 582 - "External Integrations"
Cohesion: 0.17
...
### Community 584 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 585 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 586 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 587 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 588 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 589 - "Goal Achievement"
Cohesion: 0.17
...
### Community 590 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 591 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 592 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 603 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 604 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 607 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 614 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 615 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 620 - "Repository Structure"
Cohesion: 0.18
...
### Community 621 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 624 - "Goal Achievement"
Cohesion: 0.18
...
### Community 638 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 639 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 640 - "Goal Achievement"
Cohesion: 0.18
...
### Community 641 - "Goal Achievement"
Cohesion: 0.18
...
### Community 642 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 643 - "Goal Achievement"
Cohesion: 0.18
...
### Community 644 - "Goal Achievement"
Cohesion: 0.18
...
### Community 647 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 648 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 649 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 650 - "Goal Achievement"
Cohesion: 0.18
...
### Community 652 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 655 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 656 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 667 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 668 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 669 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 672 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 673 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 676 - "Code Conventions"
Cohesion: 0.20
...
### Community 677 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 679 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 680 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 681 - "Goal Achievement"
Cohesion: 0.20
...
### Community 682 - "Goal Achievement"
Cohesion: 0.20
...
### Community 683 - "Goal Achievement"
Cohesion: 0.20
...
### Community 684 - "Goal Achievement"
Cohesion: 0.20
...
### Community 687 - "Goal Achievement"
Cohesion: 0.20
...
### Community 688 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 689 - "Goal Achievement"
Cohesion: 0.20
...
### Community 691 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 695 - "Goal Achievement"
Cohesion: 0.20
...
### Community 699 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 701 - "Goal Achievement"
Cohesion: 0.20
...
### Community 702 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 703 - "Goal Achievement"
Cohesion: 0.20
...
### Community 704 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 706 - "Goal Achievement"
Cohesion: 0.20
...
### Community 707 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 711 - "Goal Achievement"
Cohesion: 0.20
...
### Community 712 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 713 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 714 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 717 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 718 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 720 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 724 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 725 - "Validation Architecture"
Cohesion: 0.20
...
### Community 727 - "Technology Stack"
Cohesion: 0.22
...
### Community 728 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 729 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 732 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 733 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 734 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 736 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 737 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 738 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 739 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 750 - "Locked Decisions"
Cohesion: 0.22
...
### Community 752 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 755 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 756 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 758 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 759 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 760 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 761 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 762 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 763 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 767 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 768 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 769 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 770 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 771 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 772 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 774 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 778 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 779 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 780 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 782 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 786 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 787 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 788 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 789 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 790 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 792 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 794 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 795 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 796 - "calendar.ts"
Cohesion: 0.20
Nodes (4): aggregateModules, code, modules, sources

### Community 797 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 798 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 799 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 801 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 802 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 803 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 804 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 805 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 806 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 807 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 808 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 809 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 810 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 812 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 813 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 814 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 815 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 816 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 817 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 818 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 819 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 820 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 821 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 822 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 823 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 824 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 825 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 826 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 827 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 828 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 829 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 830 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 831 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 832 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 833 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 837 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 838 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 839 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 841 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 842 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 843 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 844 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 845 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 847 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 848 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 852 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 853 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 854 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 855 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 856 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 857 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 858 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 859 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 860 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 861 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.40
...
### Community 864 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 865 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 868 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 869 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 870 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 871 - "Validation Architecture"
Cohesion: 0.29
...
### Community 872 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 874 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 875 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 877 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 881 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 884 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 889 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 891 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 893 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 894 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 895 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 896 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 897 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 898 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 900 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 901 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 902 - "Validation Architecture"
Cohesion: 0.33
...
### Community 909 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 911 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 912 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 913 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 917 - "Validation Architecture"
Cohesion: 0.33
...
### Community 918 - "Validation Architecture"
Cohesion: 0.33
...
### Community 919 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 920 - "Validation Architecture"
Cohesion: 0.33
...
### Community 922 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 923 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 924 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 925 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 927 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 928 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 930 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 931 - "Scheduled Send"
Cohesion: 0.40
...
### Community 935 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 936 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 938 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 939 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 940 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 941 - "Standard Stack"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 942 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 943 - "10-01-PLAN.md"
Cohesion: 0.40
...
### Community 946 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 949 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 950 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 955 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 956 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 957 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 958 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 960 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 961 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 964 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 965 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 966 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 968 - "feedback.ts"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 969 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include
...
### Community 980 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 996 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1000 - "User Constraints"
Cohesion: 0.50
...
### Community 1004 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1005 - "Standard Stack"
Cohesion: 0.50
...
### Community 1006 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1007 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1017 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1018 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1019 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1021 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1025 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1401 - "page.tsx"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 19-CONTEXT.md)

### Community 1402 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.50
...
### Community 1407 - "Phase 19 — Validation Strategy"
Cohesion: 0.25
...
### Community 1409 - "DriveBrowser.tsx"
Cohesion: 0.33
Nodes (5): Crumb, Entry, Node, Note, WHY

### Community 1410 - "formatAbsolute"
Cohesion: 0.40
...
### Community 1414 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.40
...
### Community 1415 - "plans.test.ts"
Cohesion: 0.29
Nodes (6): COPY, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED

### Community 1416 - "The render trigger and D12(b) retention (20-16)"
Cohesion: 0.50
...
## Knowledge Gaps
- **9476 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9471 more)
...
- **Why does `api` connect `page.tsx` to `functions.ts`, `DriveBrowser.tsx`, `page.tsx`, `package.json`, `vaultFolders.test.ts`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `tenant.ts`, `page.tsx`, `cockpitThreadDegrade.test.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `officeText.test.ts`, `Dropzone.tsx`, `calendar.ts`, `agentSteps.test.ts`, `metering.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `calendar.test.ts`, `page.tsx`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `16-02-PLAN.md`, `feedback.test.ts`, `vaultExtract.ts`, `Project State`, `getActiveSkill`, `officeText.ts`, `opsSignals.test.ts`, `index.ts`, `COCKPIT_AGENT_SKILL`, `xlsText.ts`, `voiceDoc.test.ts`, `vaultExtract.ts`, `guardrails.test.ts`, `Phase 15.2 — universal format recognition`, `createdDocs.test.ts`, `http.ts`, `vaultLlm.ts`, `The render trigger and D12(b) retention (20-16)`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `Phase 18 Plan 06: The createDocument Tool Summary`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `MediaCanvas.tsx`, `intake.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `internal` connect `package.json` to `functions.ts`, `vaultFolders.test.ts`, `tenantProfile.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `metering.ts`, `page.tsx`, `Project State`, `scan.ts`, `guardrails.ts`, `tenant.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `layout.tsx`, `vaultTranscribe.test.ts`, `index.ts`, `tenant.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Dropzone.tsx`, `Validation Architecture`, `Validation Architecture`, `agentSteps.test.ts`, `buildTelemetry.ts`, `calendar.ts`, `feedback.ts`, `VaultBrowseControls.tsx`, `log`, `tenant.ts`, `llm.ts`, `calendar.test.ts`, `Project State`, `buildTelemetry.ts`, `optimizerBreach.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `16-02-PLAN.md`, `notificationMessage`, `SenderCell`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `getActiveSkill`, `index.ts`, `notificationMessage`, `index.ts`, `Key files`, `COCKPIT_AGENT_SKILL`, `xlsText.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `classify.ts`, `http.ts`, `vaultLlm.ts`, `The render trigger and D12(b) retention (20-16)`, `renderReel.ts`, `runCockpitAgent.test.ts`, `metering.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `sniffContainer()` connect `v1 Requirements` to `xlsText.ts`, `renderReel.ts`, `optimizerBreach.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9508 weakly-connected nodes found - possible documentation gaps or missing edges._
