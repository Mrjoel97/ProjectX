...
## Corpus Check
- 1527 files · ~2,688,012 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14073 nodes · 16216 edges · 1403 communities (1312 shown, 91 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bd65d51`
...
## Communities (1403 total, 91 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.12
Nodes (23): BlueprintPanel(), secondaryButton(), ConnectionsPanel(), pill, row, NarrativePanel(), isTabId(), page (+15 more)

### Community 1 - "package.json"
Cohesion: 0.04
Nodes (29): DisconnectGoogle(), Crumb, Entry, Node, Note, WHY, STATUS_COLOR, box (+21 more)
...
Cohesion: 0.04
Nodes (55): BlockReason, LABELS, pipelineWorkflow, REQUEST_STATUS, saveDraft, setStatus, toUsage(), Usage (+47 more)
...
Cohesion: 0.08
Nodes (36): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+28 more)

### Community 9 - "emailIntent.ts"
Cohesion: 0.14
Nodes (20): applyRecipientEdit(), buildRecipientView(), classify(), ContactMatch, dedupeAppend(), HeaderRecord, NameCandidates, parseAddress() (+12 more)

### Community 10 - "Project State"
Cohesion: 0.05
Nodes (41): RFC-2045, RFC-2047, RFC-2822, notifyIfAgentTimeout(), auditControl(), ActionCtx, DatabaseWriter, MutationCtx (+33 more)

### Community 11 - "scan.ts"
Cohesion: 0.04
Nodes (61): admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots(), profileSchema (+53 more)
...
Cohesion: 0.07
Nodes (50): seedMediaPlan(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal (+42 more)
...
Cohesion: 0.04
Nodes (65): controls, coverage, globalRails, LimiterWindow, mediaLedger, patchControls(), readWindow(), setMasterKillSwitch (+57 more)
...
Cohesion: 0.07
Nodes (33): numeric, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo() (+25 more)
...
Cohesion: 0.10
Nodes (28): refundableCents(), runVaultGround(), capClassifyText(), capGraphText(), capMB(), ExtractionKind, extractionKindFor(), OFFICE_MIME (+20 more)
...
Cohesion: 0.13
Nodes (16): exportAudit, s3, followUpIsDue(), needsAttention(), normalizeAddress(), renderFooter(), BreachConfig, BreachInput (+8 more)
...
Cohesion: 0.11
Nodes (9): aggregateModules, modules, rateLimiterModules, withDelivery(), withMedia(), workflowModules, workpoolModules, modules (+1 more)
...
Cohesion: 0.12
Nodes (17): BehaviorPreset, Tier, EvidenceVerdict, INCOMPLETE_MARKER, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody() (+9 more)
...
Cohesion: 0.08
Nodes (27): cancelScheduledPlan, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, listThreadMessages (+19 more)
...
Cohesion: 0.09
Nodes (23): internalAction, tenantAction, insertReviewNotification, reviewOne, runWeekly, vaultGround, vaultGroundHydrated, buildGeminiEmbedRequest() (+15 more)
...
Cohesion: 0.08
Nodes (29): ActivitySection(), caps, cardTitle, ConnectedHeadline(), ConnectedSolvency(), ConnectedUnitEconomics(), fallbackTier(), FigureTile() (+21 more)

### Community 120 - "guardrails.ts"
Cohesion: 0.18
Nodes (9): modules, diagnose(), gateOrder(), leverageRank(), Prescription, emptyScorecard, Scorecard, ValueEquation (+1 more)
...
Cohesion: 0.04
Nodes (55): DriveBrowser(), SubmittableSpec, aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules (+47 more)
...
Cohesion: 0.03
Nodes (65): persistNextStepMemo(), contentHash(), writeProfileDoc(), isoDate(), persistFindings, researchDocumentText(), researchTitle(), applyClassification (+57 more)

### Community 159 - "proactiveReview.ts"
Cohesion: 0.04
Nodes (65): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, deadLetterRecipient (+57 more)
...
Cohesion: 0.06
Nodes (29): backfillRequestDefaults, migrations, run, assertAtReview, assertBlocked, assertDeadLetter, assertDeadLetterReason, assertEvalCaseClean (+21 more)
...
Cohesion: 0.03
Nodes (74): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext(), buildHistoryBlock() (+66 more)
...
Cohesion: 0.18
Nodes (19): Err, Ok, Result, unwrap(), CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL (+11 more)
...
Cohesion: 0.03
Nodes (44): aggregateModules, modules, isNonAgentThreadIdError(), modules, agentModules, EMPTY, modules, PAGE (+36 more)
...
Cohesion: 0.09
Nodes (39): NumbersPanel(), activityFromSends(), CASH_INPUTS, CashActivity, CashFigure, CashInputs, cashInputsForTier(), CashInputSpec (+31 more)
...
### Community 263 - "matchHint"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)

### Community 265 - "SenderCell"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)
...
### Community 272 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 273 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (33): KIND_HREF, NotificationsBanner(), NAV, OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), PasswordField(), TextField() (+25 more)

### Community 280 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 282 - "Architecture Research"
Cohesion: 0.09
...
### Community 284 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 285 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 286 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 287 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 288 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 294 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 297 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 299 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 301 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 302 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (40): CategoryTabs(), discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), pillAnchor(), pillShape (+32 more)
...
### Community 305 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 310 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 311 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 312 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 313 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 314 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 315 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 316 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 317 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 318 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 320 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 321 - "officeText.ts"
Cohesion: 0.29
Nodes (17): chartLines(), docxText(), epubText(), extractOfficeText(), joinParts(), labelled(), numericSorted(), odfText() (+9 more)

### Community 322 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 323 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 324 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 325 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 326 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 327 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 328 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 329 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 330 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 333 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 334 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 335 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 336 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 337 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 338 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 339 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 340 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 341 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 342 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 343 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 344 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 345 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 347 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 348 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 349 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 350 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 351 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 352 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 354 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 355 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 356 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 357 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 358 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 359 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 360 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 362 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 363 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 364 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 365 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 366 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 367 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 370 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 372 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 373 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 375 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 376 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 377 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 379 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 444 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 446 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 447 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 448 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 449 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 450 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 451 - "Feature Research"
Cohesion: 0.12
...
### Community 452 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 454 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 455 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 456 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 457 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 458 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 459 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 460 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 461 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 462 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 467 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 468 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 469 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 471 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 472 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 473 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 474 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 475 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 477 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 482 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 487 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 492 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 493 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 494 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 495 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 496 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 497 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 498 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 499 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 508 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 510 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 512 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 520 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 521 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 523 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 524 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
Cohesion: 0.14
Nodes (16): activity, _docToField, _fieldToDoc, inputs, inputStatesFor(), saveInput, scorecardValue(), shape (+8 more)
...
### Community 531 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 532 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 533 - "Goal Achievement"
Cohesion: 0.15
...
### Community 543 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 546 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 548 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 549 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 551 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 552 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 556 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 557 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 558 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 559 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 560 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 562 - "Phase 16 — the async research dispatch seam (16-06, DISP-02)"
Cohesion: 0.17
...
### Community 563 - "Key files"
Cohesion: 0.32
Nodes (6): buildTelemetry(), LlmUsage, ReviewOutcome, TelemetryRow, TerminalOutcome, OPSG01_KEYS

### Community 564 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 565 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 567 - "External Integrations"
Cohesion: 0.17
...
### Community 570 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 571 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 572 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 573 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 574 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 575 - "Goal Achievement"
Cohesion: 0.17
...
### Community 576 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 577 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 578 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 579 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 582 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 588 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 589 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 592 - "Repository Structure"
Cohesion: 0.18
...
### Community 603 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 604 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 607 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 608 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 609 - "Goal Achievement"
Cohesion: 0.18
...
### Community 611 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 615 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 617 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 618 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 621 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 638 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 639 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 645 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 646 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 647 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 649 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 651 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 652 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 653 - "Code Conventions"
Cohesion: 0.20
...
### Community 654 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 655 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 656 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 671 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 676 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 680 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 682 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 684 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 688 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 689 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 690 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 696 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 697 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 699 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 703 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 704 - "Validation Architecture"
Cohesion: 0.20
...
### Community 706 - "Technology Stack"
Cohesion: 0.22
...
### Community 707 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 708 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 709 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 710 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 711 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 712 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 713 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 714 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 715 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 716 - "Locked Decisions"
Cohesion: 0.22
...
### Community 718 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 721 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 722 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 723 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 724 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 725 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 727 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 728 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 732 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 733 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 734 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 736 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 737 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 738 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 739 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 753 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 754 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 755 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 758 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 759 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 763 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 764 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 767 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 768 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 769 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 771 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 772 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 774 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 775 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 776 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 777 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 779 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 780 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 781 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 782 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 783 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 784 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 785 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 786 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 787 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 788 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 789 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 790 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 791 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 792 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 793 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 794 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 795 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 796 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 797 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 798 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 799 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 800 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 801 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 802 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 803 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 804 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 805 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 806 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 807 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 808 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 809 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 810 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 812 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 813 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 814 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 816 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 817 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 818 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 819 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 820 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 822 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 823 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 825 - "Phase 19 — Validation Strategy"
Cohesion: 0.25
...
### Community 828 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 829 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 830 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 831 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 832 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 833 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 837 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 838 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 839 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 840 - "failureCopy.ts"
Cohesion: 0.29
Nodes (4): llmSpendCorrelation(), aggregateModules, modules, T

### Community 841 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source

### Community 842 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 843 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 845 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 846 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 847 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 848 - "Validation Architecture"
Cohesion: 0.29
...
### Community 852 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 853 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 855 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 858 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 859 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 860 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 862 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 864 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 865 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 866 - "DriveBrowser.tsx"
Cohesion: 0.60
Nodes (3): accumulateUsage(), UsageDelta, ZERO_USAGE

### Community 868 - "Phase 17 — Calendar actions"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (39): assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender(), CLIP_SECONDS_SET (+31 more)
...
### Community 964 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 965 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 970 - "User Constraints"
Cohesion: 0.50
...
### Community 973 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
...
### Community 979 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 981 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 987 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 991 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 992 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1000 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1002 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1006 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1007 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1008 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1010 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1013 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
Cohesion: 0.11
Nodes (21): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), DirectionBand(), fmtDuration(), fmtWhen(), goalButton() (+13 more)

### Community 1078 - "guardrailConfig (table)"
Cohesion: 0.10
Nodes (20): answerDecision, blockedSummary, CASH_FIELD_BY_QUESTION, fieldValue(), listAwaiting, listCleared, listDecisions, listInFlight (+12 more)
...
## Knowledge Gaps
- **9388 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9383 more)
...
- **Why does `internal` connect `tenant.ts` to `package.json`, `formatAbsolute`, `voice.test.ts`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `tenantProfile.ts`, `metering.ts`, `Phase Details`, `Project State`, `scan.ts`, `calendar.ts`, `Phase 03.7 — Validation Strategy`, `layout.tsx`, `index.ts`, `tenant.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Validation Architecture`, `agentSteps.test.ts`, `proactiveReview.ts`, `feedback.ts`, `log`, `feedback.test.ts`, `gmailTokens (table)`, `tenant.ts`, `llm.ts`, `Project State`, `opsSignals.test.ts`, `buildTelemetry.ts`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `getActiveSkill`, `failureCopy.ts`, `Stack Research — Convex Revision`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `classify.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `http.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `brief.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `intake.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `api` connect `package.json` to `functions.ts`, `page.tsx`, `voice.test.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase Details`, `metering.ts`, `calendar.ts`, `ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate`, `page.tsx`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `26-05: Connected Approvals route, owner-verified`, `agentSteps.test.ts`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `Implementation Decisions`, `goals (table)`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `searchVaultSpine.test.ts`, `Phase 3.10: Cockpit Conversation Repair - Research`, `getActiveSkill`, `Stack Research — Convex Revision`, `index.ts`, `Hot Path Rules`, `COCKPIT_AGENT_SKILL`, `classify.ts`, `classify.ts`, `proactiveReview.ts`, `index.ts`, `scripts`, `guardrails.test.ts`, `voiceDoc.test.ts`, `createdDocs.test.ts`, `http.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `Phase Details - Milestone v2.0`, `guardrails.ts`, `brief.ts`, `runCockpitAgent.test.ts`, `tenant.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `extractOfficeText()` connect `officeText.ts` to `Phase 7: Resilience & Operations Hardening - Research`, `officeText.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9420 weakly-connected nodes found - possible documentation gaps or missing edges._
