...
## Corpus Check
- 1525 files · ~2,672,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14024 nodes · 16102 edges · 1398 communities (1309 shown, 89 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `270624be`
...
## Communities (1398 total, 89 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.08
Nodes (27): retrier, vaultIngestPool, workflow, BlockReason, LABELS, pipelineWorkflow, REQUEST_STATUS, saveDraft (+19 more)

### Community 1 - "package.json"
Cohesion: 0.02
Nodes (50): aggregateModules, modules, modules, crons, modules, SCHEMA, deadLetterRecipient, onPipelineComplete (+42 more)
...
Cohesion: 0.06
Nodes (36): DriveBrowser(), BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft (+28 more)
...
Cohesion: 0.15
Nodes (19): applyRecipientEdit(), classify(), ContactMatch, dedupeAppend(), HeaderRecord, NameCandidates, parseAddress(), parseSendTime() (+11 more)

### Community 10 - "Project State"
Cohesion: 0.06
Nodes (30): RFC-2045, RFC-2047, RFC-2822, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies, getReplyTarget (+22 more)

### Community 11 - "scan.ts"
Cohesion: 0.03
Nodes (72): finish, latestTurn, record, StepView, auditCounts, backfillAuditCounts, countAudit, log (+64 more)
...
Cohesion: 0.06
Nodes (50): InputRow(), browserTimeZone(), BudgetControl(), button, caps, card, cardTitle, ControlRow() (+42 more)
...
Cohesion: 0.05
Nodes (47): applyClassification, countTerminal(), deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText, ingestFromAttachment (+39 more)
...
Cohesion: 0.06
Nodes (36): numeric, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo() (+28 more)
...
### Community 35 - "log"
Cohesion: 0.06
Nodes (22): aggregateModules, asTenant(), budgetHarness(), digestOf(), docRow(), folderRow(), Harness, MemberSpec (+14 more)
...
Cohesion: 0.03
Nodes (79): agentBubble, card, Draft, DRAFT_VERSION, field, label, StorageId, Turn (+71 more)
...
Cohesion: 0.13
Nodes (20): BlueprintPanel(), secondaryButton(), BLOCKED, BlockedConnection, ADR-0007, ConnectionsPanel(), pill, row (+12 more)
...
Cohesion: 0.10
Nodes (29): BlueprintEntry, clip(), deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), marker(), mergeBlueprint() (+21 more)
...
Cohesion: 0.08
Nodes (33): Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions(), maybeStartCaptions(), onSubmitComplete (+25 more)
...
Cohesion: 0.11
Nodes (19): AssignedField, EveryFieldAssigned, SegmentFlowEdge, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody() (+11 more)
...
Cohesion: 0.03
Nodes (38): DisconnectGoogle(), KIND_HREF, Crumb, Entry, Node, Note, WHY, STATUS_COLOR (+30 more)
...
Cohesion: 0.09
Nodes (17): ActivitySection(), caps, cardTitle, CashTab(), muted, numbersInput, NumbersPanel(), numbersRow (+9 more)
...
Cohesion: 0.07
Nodes (28): notifyIfAgentTimeout(), auditControl(), controls, coverage, globalRails, LimiterWindow, mediaLedger, readWindow() (+20 more)
...
Cohesion: 0.21
Nodes (12): cleaned(), DocReviewConfidence, DocReviewSection, isConfidence(), isSection(), normalizeExcerpt(), ShapedDocFinding, ShapedDocGap (+4 more)
...
Cohesion: 0.07
Nodes (11): aggregateModules, modules, rateLimiterModules, T, workflowModules, workpoolModules, aggregateModules, modules (+3 more)

### Community 171 - "llm.ts"
Cohesion: 0.03
Nodes (75): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext(), buildHistoryBlock() (+67 more)
...
Cohesion: 0.08
Nodes (25): ⚠ `extractionTruncated` will now start appearing on long scans — EXPECTED, not a regression, Gates, INVARIANT — never let a non-empty string stand in for "we got content", INVARIANT — `""`, not a throw, and the two endings must not be merged, INVARIANT — the PPTX entry list, positive AND negative, Live result — 2026-07-27, `local-joel_feruzi-pikar_ai_50c69-1`, Live result — 2026-07-27, `local-joel_feruzi-pikar_ai_50c69-1`, Phase 15.2 — 15.2-06 (per-page fan-out: scanned PDFs are TRANSCRIBED, not summarised) (+17 more)
...
Cohesion: 0.10
Nodes (20): Backend page adapters, Cash — business finance, Cash — the collection surface and `financeInputs` (Task 3), Cash — the suppression rule (Task 4), Connected page gates, Data flow, Dependencies & blast radius, Focused backend gates (+12 more)
...
Cohesion: 0.13
Nodes (21): discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), pillAnchor(), pillShape, statusBadge() (+13 more)
...
### Community 251 - "Critical Pitfalls"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)
...
Cohesion: 0.04
Nodes (42): modules, activateCandidate, activateSkill, activateSkillVersion(), archiveSkill, candidatesForReview, getActiveSkill, getSkillVersion (+34 more)

### Community 256 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 262 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 263 - "Architecture Research"
Cohesion: 0.09
...
### Community 268 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.09
...
### Community 269 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.09
...
### Community 270 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.09
...
### Community 272 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 273 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 276 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 277 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (38): NotificationsBanner(), NAV, OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), PasswordField(), TextField(), ArrowIcon() (+30 more)

### Community 280 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 282 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 283 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 284 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 285 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 286 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
Cohesion: 0.09
Nodes (26): activity, _docToField, _fieldToDoc, inputs, saveInput, vCashField, activityFromSends(), CASH_INPUTS (+18 more)

### Community 288 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 294 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 301 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 302 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 304 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 305 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 306 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 307 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 308 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 309 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 310 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 311 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 313 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 314 - "officeText.ts"
Cohesion: 0.29
Nodes (17): chartLines(), docxText(), epubText(), extractOfficeText(), joinParts(), labelled(), numericSorted(), odfText() (+9 more)

### Community 315 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 317 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 318 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 319 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 320 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 321 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 322 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 323 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 324 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 325 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 326 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 327 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 328 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 329 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 330 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 333 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 334 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 335 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 336 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 337 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 338 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 339 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 341 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 342 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 343 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 344 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 345 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 346 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 347 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 348 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 349 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 350 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 351 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 352 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (6): aggregateModules, asTenant(), modules, reviewRow(), startDocSession(), VOICE_BLUEPRINT_TEXT

### Community 354 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 355 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 356 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 357 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 358 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 359 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 360 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 363 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 364 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 365 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 366 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 367 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 369 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 370 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 371 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 373 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 374 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 375 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 376 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 377 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 378 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 380 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 381 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 382 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 383 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 384 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 385 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 386 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 387 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 388 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 389 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 390 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 391 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 392 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 393 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 394 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 395 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 396 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 399 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 400 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 401 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 402 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 405 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 407 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 408 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 409 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 410 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 411 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 412 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 413 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 414 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 415 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 416 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 417 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 418 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 419 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 420 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 421 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 422 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 424 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 425 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 426 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 427 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 429 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 430 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 432 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 433 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 434 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 435 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 437 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 438 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 440 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 441 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 442 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 443 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 444 - "Feature Research"
Cohesion: 0.12
...
### Community 446 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 448 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 449 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 450 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 451 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 452 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 453 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 454 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 455 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 456 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 457 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 458 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 459 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 460 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 461 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 462 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 467 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 468 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 469 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 471 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 472 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 473 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 474 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 476 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 477 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 482 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 487 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 492 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 493 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 494 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 496 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 497 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 523 - "Goal Achievement"
Cohesion: 0.15
...
### Community 524 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 525 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
Cohesion: 0.05
Nodes (26): aggregateModules, code, modules, profileText(), sources, aggregateModules, FACT_NUMBERS, modules (+18 more)

### Community 532 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 535 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 543 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 546 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 547 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 550 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 551 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 557 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 558 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 611 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 612 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 613 - "Goal Achievement"
Cohesion: 0.18
...
### Community 614 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 618 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 620 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 640 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 641 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 642 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 645 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 646 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 647 - "VaultBrowseControls.tsx"
Cohesion: 0.33
...
### Community 648 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 649 - "Code Conventions"
Cohesion: 0.20
...
### Community 650 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 651 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 652 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 658 - "Goal Achievement"
Cohesion: 0.20
...
### Community 664 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 667 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 672 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 675 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 677 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 680 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 683 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 684 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 686 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 689 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 690 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 691 - "DriveBrowser.tsx"
Cohesion: 0.20
...
### Community 695 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 699 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 700 - "Validation Architecture"
Cohesion: 0.20
...
### Community 703 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 704 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 705 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 706 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 707 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 708 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 709 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 710 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 711 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 712 - "Locked Decisions"
Cohesion: 0.22
...
### Community 714 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 717 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 718 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 719 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 720 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 721 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 722 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 723 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 724 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 726 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 727 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 728 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 729 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 732 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 733 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 734 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 739 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 751 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 753 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 754 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 759 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 760 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 761 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 762 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 763 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 767 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 768 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 769 - "Invariants — what must never break"
Cohesion: 0.25
...
### Community 771 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 772 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 773 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 774 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 776 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 777 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 778 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 779 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 780 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 781 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 782 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 783 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 784 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 785 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 786 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 787 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 788 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 789 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 790 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 791 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 792 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 793 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 794 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 795 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 796 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 797 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 798 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 799 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 800 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 801 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 802 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 803 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 804 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 805 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 806 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 807 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 808 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 809 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 810 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 813 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 814 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 815 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 821 - "Phase 19 — Validation Strategy"
Cohesion: 0.25
...
### Community 825 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 826 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 827 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 828 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 829 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 830 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 831 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 832 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 833 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 837 - "xlsText.ts"
Cohesion: 0.38
Nodes (5): rows(), SALES, workbook(), xlsBytes(), xlsText()

### Community 838 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 839 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 841 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 842 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 844 - "Validation Architecture"
Cohesion: 0.29
...
### Community 845 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 847 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 848 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 851 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 854 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 855 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 856 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 858 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 859 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 860 - "contacts.ts"
Cohesion: 0.12
Nodes (17): modules, BLUEPRINT_TEXT, modules, seedChain(), seedConfirmedBlueprint(), seedDoc(), seedEdge(), exportAudit (+9 more)

### Community 861 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 862 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table
...
### Community 864 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 865 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 866 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 868 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 869 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 870 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 871 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 872 - "Validation Architecture"
Cohesion: 0.33
...
### Community 873 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 875 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 876 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 877 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 881 - "Validation Architecture"
Cohesion: 0.33
...
### Community 883 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 884 - "Validation Architecture"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (46): components, DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents (+38 more)

### Community 893 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 895 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 896 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 897 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 898 - "Validation Architecture"
Cohesion: 0.33
...
### Community 900 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 901 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 902 - "Phase 15.3 — vault folders"
Cohesion: 0.40
...
### Community 903 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 904 - "Scheduled Send"
Cohesion: 0.40
...
### Community 907 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 908 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 910 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 911 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 912 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 921 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 922 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 927 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 928 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 929 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 930 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 931 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 932 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 936 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 937 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 938 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 940 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 941 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 944 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 945 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 946 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 950 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 951 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 952 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 953 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include
...
### Community 955 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
...
### Community 959 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 964 - "User Constraints"
Cohesion: 0.50
...
### Community 967 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
...
### Community 970 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 973 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 974 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 975 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 979 - "User Constraints"
Cohesion: 0.50
...
### Community 981 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 985 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 986 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 996 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1000 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1001 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1003 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1005 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1008 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1015 - "Standard Stack"
Cohesion: 0.67
Nodes (3): Core — all already installed; this phase adds NO dependency, Explicitly NOT used, Standard Stack

### Community 1021 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
### Community 1024 - "Code Examples"
Cohesion: 0.67
Nodes (3): Code Examples, Confidence from code, not prose, Provider endpoint containment

### Community 1067 - "stepText"
Cohesion: 0.27
Nodes (9): ActivityCard(), stepText(), traceText, bubble(), ChatPane(), messageText(), IntakeControls(), StorageId (+1 more)
...
## Knowledge Gaps
- **9367 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9362 more)
...
- **Why does `api` connect `buildTelemetry.ts` to `functions.ts`, `package.json`, `page.tsx`, `metering.ts`, `page.tsx`, `page.tsx`, `calendar.test.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `officeText.test.ts`, `Dropzone.tsx`, `26-05: Connected Approvals route, owner-verified`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `ApprovalsErrorBoundary`, `optimizerBreach.ts`, `stepText`, `Implementation Decisions`, `goals (table)`, `buildTelemetry.ts`, `notificationMessage`, `blueprintPulse.ts`, `Phase 3.10: Cockpit Conversation Repair - Research`, `getActiveSkill`, `index.ts`, `COCKPIT_AGENT_SKILL`, `contacts.ts`, `BlueprintDiff.tsx`, `classify.ts`, `voiceDoc.test.ts`, `index.ts`, `guardrails.test.ts`, `Phase 15.2 — universal format recognition`, `Sources`, `createdDocs.test.ts`, `http.ts`, `Phase Details - Milestone v2.0`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `skillBodies.test.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `internal` connect `package.json` to `functions.ts`, `briefings.ts`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `tenantProfile.ts`, `metering.ts`, `page.tsx`, `Project State`, `scan.ts`, `calendar.test.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `officeText.test.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Dropzone.tsx`, `26-05: Connected Approvals route, owner-verified`, `Validation Architecture`, `feedback.ts`, `log`, `ApprovalsErrorBoundary`, `llm.ts`, `optimizerBreach.ts`, `goals (table)`, `Project State`, `opsSignals.test.ts`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `vaultGround.test.ts`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `getActiveSkill`, `index.ts`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `contacts.ts`, `Dropzone.tsx`, `BlueprintDiff.tsx`, `classify.ts`, `buildTelemetry.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `classify.ts`, `http.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `skillBodies.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `rtfText()` connect `officeText.ts` to `Dropzone.tsx`, `vaultGround.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9399 weakly-connected nodes found - possible documentation gaps or missing edges._
