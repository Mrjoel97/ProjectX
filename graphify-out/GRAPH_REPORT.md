...
## Corpus Check
- 2372 files · ~4,937,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23259 nodes · 29502 edges · 2058 communities (1917 shown, 141 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 145 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23351ffc`
...
## Communities (2058 total, 141 thin omitted)
...
Cohesion: 0.03
Nodes (89): persistNextStepMemo(), retrier, contentHash(), Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult (+81 more)

### Community 2 - "page.tsx"
Cohesion: 0.05
Nodes (70): accepted(), availableItems(), businessFinance, BusinessFinanceResult, byCurrency(), CashView, composeBusinessFinance(), degraded() (+62 more)
...
Cohesion: 0.07
Nodes (47): RFC-7009, calls, cascadeStub(), connect(), HUBSPOT_DEAL_PROPERTIES_SORTED, modules, rawSources, Recorded (+39 more)

### Community 5 - "skills.ts"
Cohesion: 0.05
Nodes (55): beginConnect, checkGrantedFeatures(), classifyGrantSubject(), disconnect, disconnectForTenant, DisconnectOutcome, environmentArg, FeatureVerdict (+47 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.05
Nodes (53): ExistingMatch, FIELD_LABELS, FILLABLE, ImportCounts, ImportPanel(), ImportResult, mapSafely(), REFUSAL_COPY (+45 more)

### Community 7 - "Playbook: Email Chat Cockpit"
Cohesion: 0.05
Nodes (63): viewFor(), admissionValidator, asRecord(), availableProviders, connectableProviderGates(), connectPermitted, connectStartAllowed(), eligibilityFor() (+55 more)
...
Cohesion: 0.03
Nodes (56): RFC-2045, RFC-2047, DeliveryResult, send, internalAction, base64Url(), buildMime(), DeliveryRequest (+48 more)

### Community 11 - "scan.ts"
Cohesion: 0.05
Nodes (52): dueCopy(), ghostButton, listsInvoices(), OpenInvoiceList(), OpenInvoiceRow, openInvoiceRows(), OpenInvoices, reminderOpener() (+44 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.03
Nodes (72): ADR-0003, activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan, ActivationResult (+64 more)
...
Cohesion: 0.02
Nodes (155): finish, latestTurn, record, refuse, StepView, auditCounts, backfillAuditCounts, countAudit (+147 more)
...
Cohesion: 0.04
Nodes (57): CashTab(), InputRow(), FinanceTabId, FinanceTabs(), isTabId(), visibleTabs(), browserTimeZone(), BudgetControl() (+49 more)

### Community 21 - "cockpit-resolve.spec.ts"
Cohesion: 0.04
Nodes (59): modules, loadEffectiveSkill(), loadSkill(), readTenantPublishState(), aggregateModules, AsIdentity, modules, PublishOverrides (+51 more)
...
Cohesion: 0.19
Nodes (21): checkEvidenceRef(), checkLiveEvidenceArtifact(), DECIDERS, DECISIONS, deferAbsenceChecks(), eligibility(), EVIDENCE_TYPES, fileIdentity() (+13 more)
...
Cohesion: 0.05
Nodes (46): cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, ensureThreadAndPlan(), executePlan, ExternalActionType, ExternalArgs (+38 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (72): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, __cockpitTurnPrompt, CRM_DUE_REFUSAL (+64 more)
...
Cohesion: 0.06
Nodes (27): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), Exec, execs() (+19 more)
...
Cohesion: 0.06
Nodes (69): deltaLine(), EvaluationCard(), CashFigure, day(), Err, Ok, Result, unwrap() (+61 more)
...
Cohesion: 0.08
Nodes (39): KIND_HREF, NotificationsBanner(), NAV, Shell(), TABBAR_HREFS, PasswordField(), TextField(), ArrowIcon() (+31 more)
...
Cohesion: 0.06
Nodes (43): QueryCtx, logTenantActivation(), bumpLanded(), classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry (+35 more)
...
Cohesion: 0.08
Nodes (47): assertKnownArgs(), assertPinWasLoaded(), assertRanModel(), codeOwnedPackSuite(), costSrcPath, DUMP, EnvironmentAbort, EVAL_MODEL (+39 more)
...
Cohesion: 0.10
Nodes (24): NarrativePanel(), isProfileTabId(), isTabId(), page, PROFILE_TABS, ProfileSurface(), ProfileTabId, resolveProfileTabs() (+16 more)
...
Cohesion: 0.11
Nodes (27): BillingPanelView(), BillingState, body, card, checkoutNotice(), days(), heldAmountCopy(), heldBalancesFigure() (+19 more)
...
Cohesion: 0.11
Nodes (18): DisconnectGoogle(), DisconnectMicrosoft(), LINK, connectButton, ConnectionsPanel(), ConnectorRowCard(), ConnectorRows(), disconnectButton (+10 more)
...
Cohesion: 0.09
Nodes (20): callTimeoutMsFor(), MEDIA_REFUSAL_REPLY, runSpecialistTurn(), USER_FACING_MEDIA_REPLY, agentModules, aggregateModules, crmStep(), EDIT_SCRIPT (+12 more)
...
Cohesion: 0.06
Nodes (37): here, page, preview, previewSource, spec, listPackCandidates, listPackPriorVersions, listPacks (+29 more)
...
Cohesion: 0.08
Nodes (41): bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, cardColorsOf(), convexSiteOrigin(), deckStillNeedsJob(), handleRenderRequest() (+33 more)
...
Cohesion: 0.03
Nodes (75): MON_09_00_UTC, MON_10_30_UTC, MON_23_00_UTC, TUE_01_00_UTC, Activity, attRow, badge(), box (+67 more)
...
Cohesion: 0.03
Nodes (67): ConnectMicrosoftPage(), ADR-0018, aggregateModules, coreSources, Harness, modules, PARTIAL_REASONS, rawSources (+59 more)
...
Cohesion: 0.12
Nodes (24): citationCoverage(), claimRatio(), completionOutcomes(), followUpRecovery(), missingSourceSurprise(), PACK_DERIVED_METRIC_SOURCES, PackEvent, PackMetricEvent (+16 more)
...
Cohesion: 0.06
Nodes (33): ADR-025: An explicit, human-initiated promotion admits agent-authored artifacts to the retrieval corpus — and the attribution is preserved rather than the trust withheld, Consequences, Context, Decision, ADR-006: Vault chunks are trusted-as-own — they enter the agent loop directly, not through the toolless-ingestion invariant, Alternatives rejected, Consequences, Context (+25 more)

### Community 147 - "DriveBrowser.tsx"
Cohesion: 0.06
Nodes (30): applyClassification, countTerminal(), deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText, ingestFromAttachment (+22 more)
...
Cohesion: 0.04
Nodes (59): AGENDA_COPY, AgendaCard(), agendaHasNothingToRank(), agendaRow, AgendaView, BUCKET_WORD, card, ConnectedAgenda() (+51 more)
...
Cohesion: 0.15
Nodes (17): BillingMovement, cashBalanceTransaction(), fundsAvailable(), invoicePaid(), invoicePaymentMethods(), moved(), movement(), NOTHING (+9 more)
...
Cohesion: 0.06
Nodes (29): Business blueprint (Phase 17.1) — `packages/core/src/blueprint.ts`, Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work (+21 more)
...
Cohesion: 0.03
Nodes (85): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+77 more)
...
Cohesion: 0.04
Nodes (31): BLUEPRINT_TEXT, code, modules, sources, cappedPipelineReader, modules, REAL_NOW, seedHealthyTenant() (+23 more)
...
Cohesion: 0.14
Nodes (24): BriefingCard(), AGENT_WRITABLE_FIGURES, buildCockpitTools(), buildSaveAsDocumentTool(), otherKindRefusal(), stripRePrefix(), BriefingItem, BriefingView (+16 more)

### Community 188 - "skills.test.ts"
Cohesion: 0.10
Nodes (22): AskSpecialist(), ActivityCard(), stepText(), traceText, bubble(), ChatPane(), messageText(), pinLabel() (+14 more)
...
Cohesion: 0.11
Nodes (35): refundableCents(), toUsage(), CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL, estimateCostUsd(), estimateTokens() (+27 more)
...
Cohesion: 0.15
Nodes (13): onboardingCompletedAt(), toMetricEvent(), costForRun(), forTenant, latencyForRun(), ledgerCorrelationIds(), PackCostRollup, packIdArg (+5 more)
...
Cohesion: 0.12
Nodes (16): billingPeriodKey(), billingStatus, checkoutParams(), Door, doorReturns, hostedSession(), hostedUrl(), invoices (+8 more)
...
Cohesion: 0.06
Nodes (33): Agent Evaluation, Connected Product Surfaces — Pulled Before Private Beta, Connector-Backed Revenue Pack, Curated Pack Pilot, Discoverability, Email Cockpit, Executive Agent & Planning, Expansion (+25 more)
...
Cohesion: 0.10
Nodes (44): AUTHORITY, cashOnHand, entityArg, environmentArg, gatedRead(), homeCurrency(), QbReadEvidence, queryPath() (+36 more)
...
Cohesion: 0.11
Nodes (24): InlineMarkdown(), MarkdownDocument(), tableCells(), layoutRuns(), markdownToPdf(), wrapText(), renderAndStorePack(), buildDocFilename() (+16 more)
...
Cohesion: 0.05
Nodes (35): burned(), gate(), location(), mint(), mintRaw(), modules, resultOf(), ROUTED (+27 more)
...
Cohesion: 0.19
Nodes (11): modules, RevenueSeed, seedRequest(), seedRevenueDerivedFacts(), seedRevenueEvent(), seedRevenueSignalFixture(), seedTelemetry(), seedTelemetryFixture() (+3 more)
...
Cohesion: 0.04
Nodes (47): evalSignals, revenueSignals, BlockReason, LABELS, llmSpendCorrelation(), pipelineWorkflow, REQUEST_STATUS, saveDraft (+39 more)

### Community 285 - "ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned"
Cohesion: 0.01
Nodes (86): aggregateModules, GAP, modules, sync(), ADR-0033, modules, T, aggregateModules (+78 more)
...
Cohesion: 0.11
Nodes (16): ADR-017: Direct Wan visuals and OpenAI audio supersede fal, Consequences, Context, Decision, ADR-019: The scene timeline supersedes the uniform block deck, Consequences, Context, Decision (+8 more)
...
Cohesion: 0.08
Nodes (18): aggregateModules, modules, rateLimiterModules, ADR-0035, workflowModules, workpoolModules, parseAgentSmoke(), parseSmoke() (+10 more)

### Community 290 - "approvalsView.test.ts"
Cohesion: 0.05
Nodes (53): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), AttachmentLinks, AwaitingCardBody(), AwaitingItem, AwaitingPage (+45 more)
...
Cohesion: 0.10
Nodes (24): DOC_IN_PROGRESS, docContext, docReviewSchema, docScopedPassages(), forMatch(), modelDocReview(), NO_REVIEW, pickableDocs (+16 more)
...
Cohesion: 0.06
Nodes (16): hooks, PENDING, render(), AdminView(), PendingRow, AdminPage(), STATUS_COLOR, box (+8 more)
...
Cohesion: 0.12
Nodes (15): AccessTokenResult, CRM_DATASET, CRM_ENVIRONMENTS, CRM_UNAVAILABLE_REASON, CrmUnavailableCause, dealText(), isoDay(), readCrmKnowledge (+7 more)
...
Cohesion: 0.11
Nodes (18): attachBtn, chip, chipTitle, DocIdArg, DocPicker(), hintText, iconBtn, leadingIcon (+10 more)

### Community 403 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.12
Nodes (17): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, REVENUE_TOOLS, SPECIALIST_TOOLS, specialistMemoBody() (+9 more)
...
Cohesion: 0.10
Nodes (11): pinRunState, agentModules, aggregateModules, auditRows(), modules, pinRunEvents(), rateLimiterModules, seam (+3 more)
...
Cohesion: 0.18
Nodes (13): billingConfigured(), encodeForm(), requireApiVersion(), requireSecret(), send(), stripeDelete(), StripeFailure, stripeGet() (+5 more)
...
Cohesion: 0.10
Nodes (24): Recommendation(), health, HomeHealth, HomeSummary, summary, UNAVAILABLE, DashboardPartialReason, evidence() (+16 more)
...
Cohesion: 0.07
Nodes (59): ArtDirection, Block, BLOCK_REFUSAL_WHY, cellsOf(), CLAIM_QUANTIFIED, CLIP_SECONDS, CLIP_SECONDS_SET, fail() (+51 more)
...
Cohesion: 0.12
Nodes (13): ARTIFACT, DecisionDoc, docOf(), here, liveArtifactDir, liveRefs, MatrixRow, repoRoot (+5 more)
...
Cohesion: 0.13
Nodes (12): escapeGmailQuery(), pickPlainText(), aggregateModules, LEGACY, MailStub, mockGoogle(), mockMailbox(), modules (+4 more)
...
Cohesion: 0.03
Nodes (96): modules, sources, ADR-0017, ADR-0022, ADR-0035, attachToThread, decodeUtf8(), dictateToThread (+88 more)
...
Cohesion: 0.27
Nodes (10): buildAgentContext(), buildHistoryBlock(), buildTurnPrompt(), fmtSendInstant(), ACTION_TYPES, ActionType, actionTypeOf(), Arm (+2 more)
...
Cohesion: 0.17
Nodes (12): Phase 27: Curated Knowledge-Work Pack Pilot, Phase 28.1: Stripe Billing, Invoicing and Tax for Pikar's own merchant account (INSERTED), Phase 28.2: Unpark ONE connector + invoice reminders (INSERTED 2026-09-06), Phase 28: Connector-Backed Revenue Pack, Phase 29: Unified Knowledge and Routines, Phase 30: Optional Vertical Workflow Packs, Phase 35: Outcome language and the idea-stage artifact (INSERTED 2026-09-06), Phase 36: SMOKE sentinels out of band (INSERTED 2026-09-06) (+4 more)
...
Cohesion: 0.33
Nodes (8): SPECIALISTS, grantsFor(), isRevenueToolGrant(), NO_GRANTS, table, ADR-0007, ToolGrants, ADR-0007
...
Cohesion: 0.06
Nodes (39): CategoryTabs(), discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), MoveDocId, MoveFolderId (+31 more)
...
Cohesion: 0.10
Nodes (23): ApprovalsView(), APPROVAL_COMPLIANCE_TABS, ApprovalComplianceSurface(), ApprovalComplianceTab, ApprovalComplianceTabs(), isApprovalComplianceTab(), pageStyle, tabStyle() (+15 more)
...
### Community 2131 - "billingCoverage (table)"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (46): connect(), CREDENTIAL, keyB64(), modules, rawSources, seedConnection(), accessTokenFor(), APP (+38 more)

### Community 2144 - "contacts (table)"
Cohesion: 0.03
Nodes (110): readLiveForTenant(), applyCrmOperations(), assertConsent, base64urlDecode(), base64urlEncode(), ConsentRecord, ConsentSource, contactByEmail() (+102 more)

### Community 2154 - "graphEdges (table)"
Cohesion: 0.05
Nodes (49): runVaultGround(), vaultGround, vaultGroundHydrated, rag, assertGroundNeighbor, assertNoRawText, assertReady, assertSearchReturns (+41 more)

### Community 2156 - "guardrailConfig (table)"
Cohesion: 0.02
Nodes (83): ADR-0011, controls, coverage, globalRails, LimiterWindow, mediaLedger, patchControls(), readWindow() (+75 more)

### Community 2159 - "mediaJobs (table)"
Cohesion: 0.04
Nodes (78): ADR-0028, ADR-0029, ADR-0030, getGuardrailConfig(), reserveFolderInner(), assetUrls, batchToSubmit, buildSubmitBody() (+70 more)

### Community 2166 - "providerGates (table)"
Cohesion: 0.02
Nodes (113): googleCalendarToken(), acquireRefreshLease, commitRefresh, connectionArgs, ConnectionStatusView, connectorStatuses, environmentArg, failureClassArg (+105 more)

### Community 2174 - "tenantProfiles (table)"
Cohesion: 0.03
Nodes (99): firstPage, modules, PlanStatus, activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal (+91 more)
...
## Knowledge Gaps
- **14759 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+14754 more)
...
- **Why does `internal` connect `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned` to `package.json`, `v1 Requirements`, `skills.ts`, `Playbook: Email Chat Cockpit`, `emailIntent.ts`, `Project State`, `skillBodies.test.ts`, `guardrails.ts`, `Phase 03.7 — Validation Strategy`, `page.tsx`, `knowledgeExternalSources.ts`, `layout.tsx`, `index.ts`, `vaultLlm.ts`, `agentSteps.test.ts`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `classify.ts`, `bfsNeighbors`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Project State`, `spend.ts`, `feedback.ts`, `gmail.test.ts`, `page.tsx`, `log`, `pinnedWorkflows.test.ts`, `provUsage`, `feedback.test.ts`, `User Constraints (from CONTEXT.md)`, `AdminView.tsx`, `optimizerBreach.ts`, `intake.test.ts`, `calendarComplete.ts`, `Parallel Build Lanes (multi-session)`, `vaultSealing.test.ts`, `graph.test.ts`, `officeText.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `vaultSweep.test.ts`, `feedback.test.ts`, `selfCheck`, `Phase 25.1 Plan 04: Approvals Feedback Summary`, `intake.test.ts`, `SkillAuthoringPanel.tsx`, `knowledgeExternalSources.test.ts`, `cockpit-attachment.spec.ts`, `package.json`, `agentSteps (table)`, `vaultDigest.ts`, `billingCustomers (table)`, `vaultViewState.ts`, `connectorOAuthStates (table)`, `vaultDrive.test.ts`, `contacts (table)`, `index.ts`, `012-media-route-and-the-reel.md`, `graphEdges (table)`, `http.ts`, `guardrailConfig (table)`, `Phase 28.1 Plan 09: The Tenant-Facing Billing Surface — Summary`, `vaultLlm.ts`, `mediaJobs (table)`, `Playbook: Audit Log & Dead-Letter Pipeline`, `providerGates (table)`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `blueprint.test.ts`, `spendLedger.ts`, `Phase Details`, `vaultTranscribe.test.ts`, `tenantProfiles (table)`, `intake.test.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `api` connect `dashboardSchema.test.ts` to `functions.ts`, `package.json`, `v1 Requirements`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `Playbook: Email Chat Cockpit`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `scan.ts`, `page.tsx`, `layout.tsx`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `guardrails.test.ts`, `Validation Architecture`, `vaultLlm.ts`, `buildCockpitTools`, `Phase 31: Marketing Surface and Funnel v0 — Validation Strategy`, `log`, `cockpit-schedule.spec.ts`, `optimizerBreach.ts`, `buildTelemetry.ts`, `cockpit.ts`, `Locked Decisions`, `Phase 13 Plan 02: The Weekly Proactive Review Cron Summary`, `vaultLlm.ts`, `betaInvites (table)`, `failureCopy.ts`, `intake.spec.ts`, `classify.ts`, `connectorOAuthStates (table)`, `proactiveReview.ts`, `http.ts`, `guardrailConfig (table)`, `vaultLlm.ts`, `page.tsx`, `providerGates (table)`, `tenantProfiles (table)`, `intake.test.ts`, `metering.ts`, `skillBodies.test.ts`, `skills.test.ts`, `DriveBrowser.tsx`, `vault.spec.ts`, `evaluations.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `feedback.ts`, `feedback.test.ts`, `intake.test.ts`, `Parallel Build Lanes (multi-session)`, `officeText.ts`, `skills.test.ts`, `vaultSweep.test.ts`, `feedback.test.ts`, `index.ts`, `SkillAuthoringPanel.tsx`, `PinnedWorkflowButton.tsx`, `knowledgeExternalSources.test.ts`, `vaultDigest.ts`, `Lane ownership (Phase 3.8)`, `vault-redesign.spec.ts`, `Playbook: Audit Log & Dead-Letter Pipeline`, `vaultDrive.test.ts`, `DriveBrowser.tsx`, `vaultTranscribe.test.ts`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `gmailStatus`, `Phase 25 — the owner gates`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `page.tsx`, `gmail.test.ts`, `approvalsView.test.ts`, `AdminView.tsx`, `graph.test.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `pipeline-uat.spec.ts`, `cockpit-attachment.spec.ts`, `package.json`, `ReportsView.tsx`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase 28.1 Plan 09: The Tenant-Facing Billing Surface — Summary`, `Critical Pitfalls`, `Implementation Decisions`, `page.tsx`, `User Constraints (from CONTEXT.md)`, `pinnedWorkflows.test.ts`, `home.ts`, `selfCheck`, `Phase 33.1 PRD — Media provider migration to OpenRouter`, `PinnedWorkflowButton.test.ts`, `Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `rtfText()` connect `Proactive weekly review (BEVL-03, 13-02)` to `AdminView.tsx`, `graphEdges (table)`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _14794 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `package.json` be split into smaller, more focused modules?**
  _Cohesion score 0.027183146449201494 - nodes in this community are weakly interconnected._
