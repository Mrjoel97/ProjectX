# Graph Report - pikar-ai  (2026-08-26)

## Corpus Check
- 2077 files · ~4,065,730 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19643 nodes · 23285 edges · 1862 communities (1709 shown, 153 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e6d043c5`
...
- `Recommendation()` --calls--> `recommendNextMove()`  [EXTRACTED]
  apps/web/app/(app)/dashboard/CommandCenter.tsx → packages/core/src/home.ts
...
## Communities (1862 total, 153 thin omitted)
...
Cohesion: 0.07
Nodes (43): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+35 more)
...
Cohesion: 0.11
Nodes (20): Container, ExtractRail, indexOfBytes(), isPrintable(), looksTextual(), MARKUP_MIME, OLE2_PREFIX, OLE2_STREAMS (+12 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.03
Nodes (86): numeric, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), buildMemo(), byThread (+78 more)
...
Cohesion: 0.03
Nodes (76): RFC-2045, RFC-2047, googleCalendarToken(), ActionCtx, DatabaseWriter, QueryCtx, base64Url(), buildMime() (+68 more)
...
Cohesion: 0.09
Nodes (37): salvageNote(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), deckTokenCounts(), dispatchAndLand(), DispatchArgs (+29 more)

### Community 14 - "page.tsx"
Cohesion: 0.07
Nodes (27): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+19 more)
...
Cohesion: 0.05
Nodes (43): BUCKET_WORD, card, CommandCenter(), ConnectedBriefing(), ConnectedStats(), CONSTRAINT_COPY, ConstraintCard(), CTA_DESTINATION (+35 more)
...
Cohesion: 0.06
Nodes (49): browserTimeZone(), BudgetControl(), button, caps, card, cardTitle, ControlRow(), ControlsResult (+41 more)

### Community 21 - "cockpit-resolve.spec.ts"
Cohesion: 0.10
Nodes (21): DOC_IN_PROGRESS, docContext, docReviewSchema, docScopedPassages(), forMatch(), modelDocReview(), NO_REVIEW, pickableDocs (+13 more)
...
Cohesion: 0.08
Nodes (35): ActivitySection(), caps, cardTitle, ConnectedActivity(), ConnectedHeadline(), ConnectedNumbers(), ConnectedSolvency(), ConnectedUnitEconomics() (+27 more)
...
Cohesion: 0.08
Nodes (32): activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal, financeSpineFor, inputs, inputsFor (+24 more)
...
Cohesion: 0.04
Nodes (79): attachToThread, decodeUtf8(), dictateToThread, extractVisual(), runIntake(), RunIntakeArgs, transcribeAudio(), fogIntegration() (+71 more)
...
Cohesion: 0.02
Nodes (97): ADR-0011, aggregateModules, modules, rateLimiterModules, T, DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult (+89 more)

### Community 31 - "buildCockpitTools"
Cohesion: 0.10
Nodes (15): ErrorBoundary, CanvasPane(), capsTeal, panel, readStoredWorkspace(), REVIEW_TAB, StoredWorkspace, Tab (+7 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (98): ADR-0016, applyGmailCapability(), CAPABILITY_RULES, CockpitCapability, CockpitCapabilityRoute, GMAIL_TOOL_NAMES, isPinnedCockpitEvaluation(), routeCockpitIntent() (+90 more)
...
Cohesion: 0.10
Nodes (26): BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), mergeBlueprint() (+18 more)

### Community 55 - "buildTelemetry.ts"
Cohesion: 0.08
Nodes (38): KIND_HREF, NotificationsBanner(), NAV, age(), AllTenantDeadLetters(), OptimizerPanel(), REVIEW_OUTCOMES, shortRef() (+30 more)

### Community 56 - "formatAbsolute"
Cohesion: 0.04
Nodes (40): backfillRequestDefaults, migrations, run, captionStalled(), inFlight(), lastRenderActivity(), notifyStall(), renderStalled() (+32 more)
...
Cohesion: 0.02
Nodes (108): activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan, ActivationResult, ActivationTarget (+100 more)
...
Cohesion: 0.06
Nodes (25): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+17 more)
...
Cohesion: 0.11
Nodes (22): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), DirectionBand(), fmtDuration(), fmtWhen(), goalButton() (+14 more)
...
### Community 73 - "list"
Cohesion: 0.08
Nodes (38): solvencyForTenant(), burn(), activityFromSends(), CashInputs, CashInputSpec, CashInputState, CashMetricKey, CashMetricSet (+30 more)
...
Cohesion: 0.11
Nodes (23): health, HomeHealth, HomeSummary, summary, UNAVAILABLE, DashboardPartialReason, evidence(), HOME_PRIORITY_COPY (+15 more)
...
Cohesion: 0.08
Nodes (24): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+16 more)
...
Cohesion: 0.13
Nodes (26): onboardingCompletedAt(), toMetricEvent(), costForRun(), forTenant, ledgerCorrelationIds(), PackCostRollup, packIdArg, PackLatencyRollup (+18 more)
...
Cohesion: 0.07
Nodes (42): backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier, FACT_KEYS, forTenant (+34 more)
...
Cohesion: 0.07
Nodes (25): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult (+17 more)

### Community 121 - "spendLedger.ts"
Cohesion: 0.04
Nodes (62): flushTelemetry(), Fog, IntegrationContext, IntegrationInput, traced(), newArtifactIds(), outcomeFor(), packArgs (+54 more)
...
Cohesion: 0.04
Nodes (45): aggregateModules, asA(), asB(), ASSET, BRIEF, deck(), JOB_41(), land() (+37 more)
...
Cohesion: 0.03
Nodes (64): applyCrmOperations(), assertConsent, base64urlDecode(), base64urlEncode(), ConsentRecord, ConsentSource, contactByEmail(), ContactOrigin (+56 more)
...
Cohesion: 0.14
Nodes (19): confirmedDelete(), dangerButtonStyle, fieldStyle, PreviewActionDescriptor, previewActionDescriptors(), PreviewActionId, PreviewControlHandlers, PreviewControls() (+11 more)
...
Cohesion: 0.20
Nodes (16): AssemblyScene, ascii(), assTime(), buildCaptionLines(), CaptionLine, concatWavTakes(), escapeAss(), groupIntoLines() (+8 more)

### Community 156 - "Phase 11: Persona Onboarding & Business Profile - Research"
Cohesion: 0.03
Nodes (69): cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, ensureThreadAndPlan(), executePlan, ExternalActionType, ExternalArgs (+61 more)
...
Cohesion: 0.04
Nodes (64): scene(), patchControls(), getGuardrailConfig(), assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit (+56 more)
...
Cohesion: 0.14
Nodes (16): bubble(), ChatPane(), messageText(), pinLabel(), PinState, IntakeControls(), StorageId, chat (+8 more)
...
Cohesion: 0.08
Nodes (34): aggregateModules, evaluateWithGap(), modules, profileDocText(), seedDoc(), seedDocReview(), workflowModules, workpoolModules (+26 more)

### Community 182 - "officeText.ts"
Cohesion: 0.05
Nodes (38): auditCounts, backfillAuditCounts, countAudit, log, recentByType, DeliveryResult, send, components (+30 more)
...
Cohesion: 0.11
Nodes (9): convexDir, DocSeed, modules, workflowModules, workpoolModules, DataModel, Doc, Id (+1 more)

### Community 191 - "feedback.test.ts"
Cohesion: 0.17
Nodes (17): ConnectionsPanel(), NarrativePanel(), isTabId(), page, ProfilePage(), TabId, TABS, digits() (+9 more)
...
Cohesion: 0.13
Nodes (21): BusyRange, createEvent, EVENT_URL(), freeBusy, FreeBusyResult, googleDelete(), GoogleError, GoogleEventBody (+13 more)

### Community 209 - "vaultDigest.ts"
Cohesion: 0.03
Nodes (64): ConnectMicrosoftPage(), ADR-0018, deadLetterRecipient, onPipelineComplete, httpAction, aggregateModules, modules, T (+56 more)
...
Cohesion: 0.12
Nodes (22): docLabel(), fmtSize(), COPY, failureCopy, GENERIC, INGEST, MISSING, PARSE_FAILED (+14 more)
...
Cohesion: 0.22
Nodes (8): Crumb, DriveBrowser(), Entry, Node, Note, WHY, n(), counted()
...
Cohesion: 0.13
Nodes (12): CashTab(), FinanceTabId, FinanceTabs(), isTabId(), visibleTabs(), FinanceView(), OperatorTab(), msg() (+4 more)
...
Cohesion: 0.16
Nodes (16): ASSEMBLY_VISUALS, AssemblyError, AssemblyReport, AssemblyVisual, isGovernedRender(), near(), num(), parseAssemblySidecar() (+8 more)
...
Cohesion: 0.12
Nodes (21): BLUEPRINT_FIELDS, CASH_INPUTS, CashInputField, FieldProvenance, FigureActor, FigureConfidence, FigureOrigin, BY_KEY (+13 more)
...
Cohesion: 0.10
Nodes (20): 15.3-01 — schema, 15.3-02 — read-surface survivability + cap single-source, 15.3-03 — the budget rail selector (ingest stops spending the cockpit's $5), 15.3-04 — folder orchestration (VALT-05, VALT-06, VALT-08), 15.3-05 — sealing (VALT-07), 15.3-09 — the Google Drive rail (VALT-13), 1. `vaultIngestPool` — and why the shared `WorkflowManager` was left alone, 2. The watchdog measures WORK time, not queue time (+12 more)
...
Cohesion: 0.09
Nodes (15): cappedPipelineReader, modules, REAL_NOW, seedHealthyTenant(), shapelessReader, T, throwingReader, BLUEPRINT_TEXT (+7 more)
...
Cohesion: 0.11
Nodes (24): InlineMarkdown(), MarkdownDocument(), tableCells(), layoutRuns(), markdownToPdf(), saveMarkdownDocument(), wrapText(), buildDocFilename() (+16 more)
...
Cohesion: 0.05
Nodes (28): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+20 more)
...
Cohesion: 0.05
Nodes (55): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), ApprovalsView(), AttachmentLinks, AwaitingCardBody(), AwaitingItem (+47 more)
...
Cohesion: 0.14
Nodes (17): DASHBOARD_STATE_COPY, DashboardBound, compareSnapshots(), Completeness, completenessOver(), coverageLabel, EvaluationFramework, EvaluationSnapshot (+9 more)

### Community 311 - "planTenantActivation"
Cohesion: 0.02
Nodes (110): answerDecision, blockedSummary, CASH_FIELD_BY_QUESTION, fieldValue(), listAwaiting, listCleared, listDecisions, listInFlight (+102 more)
...
Cohesion: 0.07
Nodes (38): aggregateModules, harness(), modules, ownerHarness(), Seed, sourceFiles(), tenantHarness(), WINDOW (+30 more)
...
Cohesion: 0.10
Nodes (19): activeButton, AuditPage, Business, button, caps, card, grid2, hintStyle (+11 more)
...
Cohesion: 0.09
Nodes (23): CategoryTabs(), discussPillStyle(), DocGrid(), folderChip(), MoveDocId, MoveFolderId, pillAnchor(), pillShape (+15 more)
...
Cohesion: 0.09
Nodes (16): tenantAction, generateBoardPack, GenerateBoardPackResult, renderAndStorePack(), aggregateModules, here, modules, PACK_MODULES (+8 more)
...
### Community 359 - "Phase 22 / 22.1 — Evidence Reconciliation"
Cohesion: 0.08
...
### Community 371 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 373 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 374 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 376 - "Implementation Decisions"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (117): finish, latestTurn, record, refuse, StepView, byThread, insert, LatestBriefing (+109 more)
...
### Community 381 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 384 - "Phase 21 Plan 04: The Owner Boundary Summary"
Cohesion: 0.09
...
### Community 387 - "Phase 21 Research: User-Authored Skills & Routines"
Cohesion: 0.09
...
### Community 389 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 390 - "Architecture Research"
Cohesion: 0.09
...
### Community 392 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 393 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 394 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 395 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 398 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 402 - "Phase 19 Plan 10: Close the phase honestly Summary"
Cohesion: 0.10
...
### Community 403 - "Phase 19 Plan 13: Consent Record Gap Closure Summary"
Cohesion: 0.10
...
### Community 405 - "Phase 21 Plan 03: Exact Tenant Candidate Evaluation Summary"
Cohesion: 0.10
...
### Community 406 - "Verified defect inventory (the work list)"
Cohesion: 0.10
...
### Community 410 - "26-20 Task 2 — Command Center v2 and Phase 26 owner UAT (BLOCKING, open)"
Cohesion: 0.10
...
### Community 411 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 412 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 413 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 416 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 417 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 418 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 420 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 421 - "Phase 25.1 Plan 05: Memo Rendering & Research Sources Summary"
Cohesion: 0.10
...
### Community 425 - "Pikar Consistency Audit"
Cohesion: 0.11
...
### Community 427 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 430 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 431 - "specialists.ts"
Cohesion: 0.13
Nodes (17): BehaviorPreset, sanitizeAgentName(), EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody(), SPECIALISTS (+9 more)

### Community 432 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 433 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 434 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 435 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 437 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 438 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 440 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 441 - "17-08 SUMMARY — governed calendar management: management, minus Microsoft delete"
Cohesion: 0.11
...
### Community 442 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 443 - "Phase 19 Plan 09: Teach the Body, Owe the Fixture Summary"
Cohesion: 0.11
...
### Community 444 - "Phase 21 Plan 05: Routine v0 — Pinned Prompts Summary"
Cohesion: 0.11
...
### Community 446 - "Phase 25.1 Plan 04: Approvals Feedback Summary"
Cohesion: 0.11
...
### Community 448 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 449 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 450 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 451 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 452 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 453 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 454 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 455 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 456 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 457 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 458 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 459 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 460 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 461 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 462 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 466 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 467 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 468 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 469 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 470 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 471 - "Phase 19.1 Plan 06: The CSV Import Panel Summary"
Cohesion: 0.11
...
### Community 472 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 473 - "Phase 33 Plan 09: media-director v3 — the specialist learns to write what the parsers read"
Cohesion: 0.11
...
### Community 474 - "Phase 33 Plan 13: The proposal stage gets a failure card, and the two parser edits get disclosed Summary"
Cohesion: 0.11
...
### Community 475 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (53): ArtDirection, Block, BLOCK_REFUSAL_WHY, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, DeckContract, fail() (+45 more)

### Community 477 - "Phase 23 — agent-authored skills: the DATA PLANE only (23-01, SKILL-02)"
Cohesion: 0.12
...
### Community 478 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 480 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 481 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 482 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 484 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 485 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 486 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 487 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 488 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 490 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 492 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 493 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 494 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 496 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 497 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 498 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 499 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 508 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 509 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 510 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 512 - "Playbook: Skill Registry (versioned LLM prompts)"
Cohesion: 0.12
...
### Community 515 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 516 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 517 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 518 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 520 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 521 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 522 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 523 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 524 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 525 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 526 - "Phase 17 Plan 09: Managed-event discovery and safe staging Summary"
Cohesion: 0.12
...
### Community 527 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.12
...
### Community 528 - "Phase 19.1 Plan 05: pipelineTiles Reports Its Scan Bound Summary"
Cohesion: 0.12
...
### Community 529 - "Phase 20.2: Scene Timeline Reels — Code and Offline Evidence Summary"
Cohesion: 0.12
...
### Community 530 - "Phase 21 Plan 02: Tenant Candidate Write/Read and Effective Loading Summary"
Cohesion: 0.12
...
### Community 532 - "reportsView.test.ts"
Cohesion: 0.14
Nodes (13): BusinessSection(), GovernanceSection(), OwnerSection(), PERIODS, Section(), BASE_OPS, Biz, full (+5 more)

### Community 533 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)
...
### Community 535 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)
...
### Community 543 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 546 - "finance-update-fails-only-in-full-sequence.md"
Cohesion: 0.12
...
### Community 547 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 548 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 549 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 550 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 551 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 553 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 558 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 559 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 560 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 562 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 565 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 566 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 567 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 568 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 570 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 572 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 573 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 574 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 575 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 576 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 577 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 578 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 579 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 580 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 581 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 582 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 583 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 584 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 585 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 586 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 587 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 588 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 589 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 590 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 592 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 603 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 604 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)
...
### Community 606 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 607 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 608 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 609 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 610 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 613 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 614 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 615 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 617 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 618 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 619 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 620 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 621 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 623 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 624 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 638 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 639 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 640 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 641 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 642 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 643 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 644 - "Phase 19 Plan 03: The CAN-SPAM postal address Summary"
Cohesion: 0.12
...
### Community 645 - "Phase 25.1 Plan 01: renderReel Honest Terminals Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 646 - "Phase 25.1 Plan 02: Stuck-Work Watchdog Summary"
Cohesion: 0.12
...
### Community 647 - "Phase 25.1 Plan 03: Media Vault Persistence Summary"
Cohesion: 0.12
...
### Community 648 - "Phase 33 Plan 02: Plan-Row State + Governed Mutations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 649 - "Phase 33 Plan 03: Persist Terminal + Money Gates Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 650 - "Phase 33 Plan 04: Failure/Retry Backend Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 651 - "Phase 33 Plan 08: Grounded citations and clear failure on the canvas Summary"
Cohesion: 0.12
...
### Community 652 - "Feature Research"
Cohesion: 0.12
...
### Community 653 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 655 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 657 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 658 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 664 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 665 - "calendarEvents.ts"
Cohesion: 0.12
...
### Community 666 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 667 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 668 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 669 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 670 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 671 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 672 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 675 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 680 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 681 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 682 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 683 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 684 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 686 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 687 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 688 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 689 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 690 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 691 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 695 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 696 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 697 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 698 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 699 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 700 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 701 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 702 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 703 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 704 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 705 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 706 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 707 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 708 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 714 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 715 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 716 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 717 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 718 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 719 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 720 - "Phase 17 Calendar Actions — agent-operated live UAT runbook"
Cohesion: 0.13
...
### Community 721 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 722 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 723 - "Phase 19.1 Plan 03: fill-empty-only as a Flag on the ONE Writer Summary"
Cohesion: 0.13
...
### Community 724 - "Phase 19.1 Plan 04: matchExisting and importContacts Summary"
Cohesion: 0.13
...
### Community 725 - "Phase 22: Owner Authorization Primitive Verification Report"
Cohesion: 0.13
...
### Community 726 - "23-03 SUMMARY — the model can now draft a skill, and still cannot activate one"
Cohesion: 0.13
...
### Community 727 - "Phase 25 Plan 05: Microsoft Delivery Arm Summary"
Cohesion: 0.13
...
### Community 728 - "26-17 — Reports, connected end to end, and the nav that only lit after the owner said so"
Cohesion: 0.13
...
### Community 729 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 732 - "Phase 33 Plan 01: Storyboard Parse Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 733 - "Project State"
Cohesion: 0.13
...
### Community 739 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 750 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 751 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 752 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 753 - "Phase 19.1 Plan 02: The Two Union Widenings Summary"
Cohesion: 0.14
...
### Community 755 - "Phase 19.1: Bulk Contact Import (CSV) — Research"
Cohesion: 0.14
...
### Community 758 - "Phase 19 Plan 08: Contacts-first resolution and the CRM staging tool Summary"
Cohesion: 0.14
...
### Community 759 - "Phase 20 Plan 20: Finance Fingerprint Reconciliation Summary"
Cohesion: 0.14
...
### Community 760 - "Phase 21 Plan 01: Contracts and Schema Foundation Summary"
Cohesion: 0.14
...
### Community 761 - "Phase 22.1 Plan 04: Tenant Data Export Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 762 - "Phase 25 Plan 03: Isolation Gate Summary"
Cohesion: 0.14
...
### Community 763 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 764 - "26-10-PLAN.md"
Cohesion: 0.14
...
### Community 767 - "Phase 27 Plan 02: Native Pack Contracts Summary"
Cohesion: 0.14
...
### Community 768 - "Roadmap: Pikar-AI"
Cohesion: 0.14
...
### Community 769 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 774 - "Goal Achievement"
Cohesion: 0.15
...
### Community 778 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
Cohesion: 0.16
Nodes (14): AttachmentPicker(), UploadedAttachment, pickedFolderFromFiles(), VaultBody(), REJECTION_COPY, Attachment, EXT_MIME, MIME_ALLOWLIST (+6 more)

### Community 780 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 781 - "Goal Achievement"
Cohesion: 0.15
...
### Community 782 - "Goal Achievement"
Cohesion: 0.15
...
### Community 783 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 784 - "Goal Achievement"
Cohesion: 0.15
...
### Community 785 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 787 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 788 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 790 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.15
...
### Community 791 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 792 - "Phase 19.1 Plan 01: The Pure CSV Import Brain Summary"
Cohesion: 0.15
...
### Community 793 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 796 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 797 - "Phase 23 Plan 05: Owner/Eval Agent Activation Summary"
Cohesion: 0.15
...
### Community 798 - "Phase 25 Plan 02: Beta Admission UI Summary"
Cohesion: 0.15
...
### Community 799 - "Phase 25 Plan 04: First-Send Projection Summary"
Cohesion: 0.15
...
### Community 801 - "Phase 25: Private Beta Productionization - Research"
Cohesion: 0.15
...
### Community 802 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 803 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 804 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 805 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 806 - "Phase 33 Plan 06: Reel-first canvas Summary"
Cohesion: 0.15
...
### Community 807 - "Phase 33 Plan 07: Guided intake and variations on the canvas Summary"
Cohesion: 0.15
...
### Community 810 - "Phase 19.1: Bulk Contact Import (CSV) Verification Report"
Cohesion: 0.17
...
### Community 812 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 813 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 816 - "External Integrations"
Cohesion: 0.17
...
### Community 818 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 819 - "The Goal Engine (Chief-of-Staff loop) — design capture"
Cohesion: 0.17
...
### Community 820 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 821 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 823 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 824 - "Goal Achievement"
Cohesion: 0.17
...
### Community 825 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 826 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 827 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 829 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 830 - "17.1-10 live-gate audit"
Cohesion: 0.17
...
### Community 831 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 832 - "Phase 19 Plan 02: The person store Summary"
Cohesion: 0.17
...
### Community 833 - "Phase 19 Plan 04: The public unsubscribe route Summary"
Cohesion: 0.17
...
### Community 837 - "Phase 19 Plan 05: The trust boundary Summary"
Cohesion: 0.17
...
### Community 839 - "Phase 19 Plan 06: crm_write, the fifth action type Summary"
Cohesion: 0.17
...
### Community 840 - "Phase 19 Plan 07: The connected Pipeline route Summary"
Cohesion: 0.17
...
### Community 842 - "Phase 19: Contacts, CRM & Follow-ups — Verification Report"
Cohesion: 0.17
...
### Community 843 - "Phase 20.1 Plan 01: Drive Read Substrate Summary"
Cohesion: 0.17
...
### Community 846 - "Phase 20.2 — Validation Strategy"
Cohesion: 0.17
...
### Community 848 - "Phase 20 — Validation Strategy"
Cohesion: 0.17
...
### Community 850 - "23-04 SUMMARY — the gate that judges what the agent wrote, and cannot be read by it"
Cohesion: 0.17
...
### Community 852 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 853 - "Goal Achievement"
Cohesion: 0.17
...
### Community 854 - "26-15 — the audit viewer is safe by filtering, and the mockup said otherwise"
Cohesion: 0.17
...
### Community 855 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 856 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 857 - "Phase 33 Plan 10: closing the phase live — and the two defects that only production could show"
Cohesion: 0.17
...
### Community 864 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)

### Community 865 - "calendarComplete.ts"
Cohesion: 0.20
...
### Community 869 - "Repository Structure"
Cohesion: 0.18
...
### Community 870 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 871 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 874 - "Goal Achievement"
Cohesion: 0.18
...
### Community 875 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 876 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 877 - "Goal Achievement"
Cohesion: 0.18
...
### Community 878 - "Goal Achievement"
Cohesion: 0.18
...
### Community 879 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 881 - "Goal Achievement"
Cohesion: 0.18
...
### Community 883 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 884 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 889 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 890 - "Goal Achievement"
Cohesion: 0.18
...
### Community 891 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 894 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 895 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 896 - "Phase 19.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 897 - "Phase 19 — Validation Strategy"
Cohesion: 0.18
...
### Community 898 - "Phase 20.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 905 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 908 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 913 - "Phase 21 — Validation Strategy"
Cohesion: 0.18
...
### Community 914 - "23-01 SUMMARY — the agent-authoring data vocabulary, and nothing else"
Cohesion: 0.18
...
### Community 915 - "Phase 23 — Validation Strategy"
Cohesion: 0.18
...
### Community 916 - "Phase 24 — Validation Strategy"
Cohesion: 0.18
...
### Community 917 - "26-10 — Connected Finance route: executed browser gate, owner UAT, closure"
Cohesion: 0.18
...
### Community 918 - "26-13 — the connected Content library, approved and live"
Cohesion: 0.18
...
### Community 919 - "27-07 — Bind the packs onto the real agent seam, and measure real runs"
Cohesion: 0.18
...
### Community 920 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 921 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 922 - "Phases 14–25 — gap ledger (re-derived 2026-08-17)"
Cohesion: 0.18
...
### Community 923 - "ADR-002: Insert-only audit log with redaction-safe payloads; WORM immutability lives outside Convex"
Cohesion: 0.20
...
### Community 924 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 925 - "Code Conventions"
Cohesion: 0.20
...
### Community 926 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 927 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 928 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 929 - "Goal Achievement"
Cohesion: 0.20
...
### Community 930 - "Goal Achievement"
Cohesion: 0.20
...
### Community 932 - "AwaitingCardBody"
Cohesion: 0.20
...
### Community 933 - "Goal Achievement"
Cohesion: 0.20
...
### Community 935 - "Goal Achievement"
Cohesion: 0.20
...
### Community 936 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 937 - "Goal Achievement"
Cohesion: 0.20
...
### Community 938 - "Goal Achievement"
Cohesion: 0.20
...
### Community 939 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 940 - "Goal Achievement"
Cohesion: 0.20
...
### Community 946 - "Goal Achievement"
Cohesion: 0.20
...
### Community 947 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 948 - "Goal Achievement"
Cohesion: 0.20
...
### Community 949 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 951 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 953 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 955 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 956 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 957 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 960 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 961 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 963 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 964 - "Phase 19.1 Plan 07: The Browser Proof Summary"
Cohesion: 0.20
...
### Community 965 - "Deferred items — Phase 19"
Cohesion: 0.20
...
### Community 970 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 971 - "Phase 25 Plan 01: Beta Admission Trust Boundary Summary"
Cohesion: 0.20
...
### Community 972 - "Phase 25 — the owner gates"
Cohesion: 0.20
...
### Community 973 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 975 - "26-14 — truthful report metrics, and the audit that found the plan's own first draft lying"
Cohesion: 0.20
...
### Community 976 - "Validation Architecture"
Cohesion: 0.20
...
### Community 977 - "Phase 31: Marketing Surface and Funnel v0 — Validation Strategy"
Cohesion: 0.20
...
### Community 978 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 979 - "2026-07-26-voice-doc-picker-design.md"
Cohesion: 0.22
...
### Community 982 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 983 - "Service architecture, post-beta — design note"
Cohesion: 0.22
...
### Community 984 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 985 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 986 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 987 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 988 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 989 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 990 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 991 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 992 - "Locked Decisions"
Cohesion: 0.22
...
### Community 994 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 998 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 999 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 1000 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 1001 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 1003 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 1006 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 1007 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 1008 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 1009 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 1010 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 1011 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 1015 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 1016 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1017 - "Phase 17 — Gap-Closure Validation Strategy"
Cohesion: 0.22
...
### Community 1018 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 1020 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 1021 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 1026 - "21-07 COMPLETE — the frozen candidate carries a passing held-out gate"
Cohesion: 0.22
...
### Community 1027 - "Phase 21: User-Authored Skills & Routines Verification Report"
Cohesion: 0.22
...
### Community 1029 - "Phase 22.1 Plan 05: Tenant Deletion Summary"
Cohesion: 0.22
...
### Community 1030 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 1031 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 1032 - "Deferred items — phase 25.1"
Cohesion: 0.22
...
### Community 1033 - "1. The invite gate — `callbacks.createOrUpdateUser` (BETA-01) — **HIGH confidence, source-verified**"
Cohesion: 0.22
...
### Community 1034 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1035 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1036 - "Plan 26-20: Command Center v2, owner-approved"
Cohesion: 0.22
...
### Community 1037 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 1038 - "Phase 27 Plan 01: Upstream Pin and Provenance Summary"
Cohesion: 0.22
...
### Community 1039 - "Phase 27 Plan 03: Pack Measurement Plane Summary"
Cohesion: 0.22
...
### Community 1040 - "27-08 — Final provenance, six DEV candidates, and an eval runner that can go red"
Cohesion: 0.22
...
### Community 1041 - "Phase 27 Decision Memo — Curated Knowledge-Work Pack Pilot"
Cohesion: 0.22
...
### Community 1043 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 1044 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 1045 - "Plan 33-05: Auto-assembled reel — vault save + regenerate ordering"
Cohesion: 0.22
...
### Community 1046 - "Common Pitfalls"
Cohesion: 0.22
...
### Community 1048 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 1049 - "optimizerBreach.ts"
Cohesion: 0.29
Nodes (6): BreachConfig, BreachInput, BreachReason, BreachResult, classifyBreach(), cfg

### Community 1050 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 1051 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1052 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 1055 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1056 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 1057 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 1058 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 1059 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 1060 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1061 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1062 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1063 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1064 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 1065 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1066 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 1067 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 1068 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 1069 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1070 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 1072 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 1073 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1074 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1075 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 1076 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 1078 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1079 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1080 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 1081 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 1082 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 1083 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1084 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 1085 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 1086 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 1087 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1088 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 1089 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.25
...
### Community 1090 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1092 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1095 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1096 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1097 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1098 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 1099 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 1101 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 1104 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 1105 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 1106 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 1107 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 1108 - "Phase 22.1 Plan 03: CI Gate Summary"
Cohesion: 0.25
...
### Community 1109 - "Phase 22.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1110 - "Phase 22.1 — Goal Verification"
Cohesion: 0.25
...
### Community 1111 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 1118 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 1119 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 1120 - "Phase 23 prerequisite gate — run 2026-08-18, before the first edit"
Cohesion: 0.25
...
### Community 1121 - "23-02 SUMMARY — the inert writer, built before anything can reach it"
Cohesion: 0.25
...
### Community 1122 - "25.1-07 — Live UAT checkpoint"
Cohesion: 0.25
...
### Community 1125 - "Phase 25.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1126 - "Phase 25 — Validation Strategy"
Cohesion: 0.25
...
### Community 1127 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 1128 - "26-11 — artifact provenance and the explicit trust promotion"
Cohesion: 0.25
...
### Community 1129 - "26-12 — the Content shelf: one bounded read plane over artifacts that already exist"
Cohesion: 0.25
...
### Community 1130 - "26-13.1 — the image lane, and the comment that hid it"
Cohesion: 0.25
...
### Community 1131 - "26-16 — the board pack: one transaction is the snapshot, and promotion is not a new authorship"
Cohesion: 0.25
...
### Community 1132 - "27-09 — The discovery surface, the owner primitive, and the deadlock they had to break"
Cohesion: 0.25
...
### Community 1133 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 1162 - "Phase 33: Media Creation UX Overhaul - Research"
Cohesion: 0.25
...
### Community 1163 - "Phase 33 — Validation Strategy"
Cohesion: 0.25
...
### Community 1167 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 1168 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1169 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 1170 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 1171 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1173 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1174 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1175 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 1176 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1178 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 1181 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1182 - "Phase 16: Research Sub-Agent & Web Research Verification Report"
Cohesion: 0.29
...
### Community 1183 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 1185 - "Deviations from Plan"
Cohesion: 0.29
...
### Community 1186 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 1188 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 1189 - "Phase 21 — live session 2026-08-18: what was executed, and what CANNOT be"
Cohesion: 0.29
...
### Community 1190 - "25-01 — security audit of the BETA-01 admission boundary"
Cohesion: 0.29
...
### Community 1191 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 1193 - "26-13 Task 2 — Content artifact UAT (BLOCKING, open)"
Cohesion: 0.29
...
### Community 1194 - "Plan 26-19: the deterministic Command Center backend"
Cohesion: 0.29
...
### Community 1195 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 1196 - "buildBoardPackMarkdown"
Cohesion: 0.67
Nodes (6): OperationsSection(), buildBoardPackMarkdown(), countCell(), coverageWord(), floorCell(), fmtDate()

### Community 1197 - "5. Synthesis"
Cohesion: 0.33
...
### Community 1198 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 1199 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 1200 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes
...
### Community 1202 - "calendar-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1203 - "first-login-second-attempt-auth-redirect.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1204 - "gmail-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1205 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1206 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1207 - "phase21-local-google-login-failure.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1208 - "production-frontend-rollback-after-media-release.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1209 - "convex-local-backend-preparing-functions.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1210 - "production-client-provided-address-not-absolute-url.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1211 - "allowlist.ts"
Cohesion: 0.40
Nodes (3): sources, NOTE: `internalQuery`/`internalMutation`/`internalAction` are NOT banned by, RAW_BUILDER_ALLOWLIST

### Community 1212 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 1213 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 1214 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 1215 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 1217 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 1219 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 1220 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 1221 - "Phase 14: Flagship Voice-Doc Workflow Verification Report"
Cohesion: 0.33
...
### Community 1225 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1226 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1229 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 1230 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1235 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 1236 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 1237 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 1240 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 1241 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1242 - "21-08 — the free half of the live gate: executed, except the half that cannot be"
Cohesion: 0.33
...
### Community 1243 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 1244 - "Plan 26-18: Sales Pipeline navigation activation"
Cohesion: 0.33
Nodes (5): Change, External gate consumed, Plan 26-18: Sales Pipeline navigation activation, Rollback, Verification

### Community 1245 - "Phase 27 Plan 04: Business Pulse and Campaign Plan Summary"
Cohesion: 0.33
...
### Community 1246 - "Phase 27 Plan 06: Process/SOP Builder and Brand Review Summary"
Cohesion: 0.33
...
### Community 1247 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 1249 - "Phases 14–25 milestone audit — 2026-08-20"
Cohesion: 0.33
...
### Community 1252 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1253 - "Scheduled Send"
Cohesion: 0.40
...
### Community 1255 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 1256 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 1257 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 1261 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 1262 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 1263 - "Standard Stack"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 1264 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1265 - "10-01-PLAN.md"
Cohesion: 0.40
...
### Community 1276 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1278 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 1279 - "Validation Architecture"
Cohesion: 0.40
...
### Community 1280 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1281 - "Sources"
Cohesion: 0.40
...
### Community 1283 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 1285 - "Union Blast Radius — the executor's walk"
Cohesion: 0.40
...
### Community 1287 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1288 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 1289 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 1290 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 1291 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 1292 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 1294 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1295 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 1296 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 1297 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 1299 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 1300 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 1303 - "3. The BETA-05 isolation suite — schema-derived enumeration — **HIGH confidence, API-verified**"
Cohesion: 0.40
...
### Community 1304 - "4. Microsoft Graph — the mapping (DLVR-02)"
Cohesion: 0.40
...
### Community 1307 - "Production Secret Inventory (research Q5)"
Cohesion: 0.40
...
### Community 1309 - "Phase 27 Plan 05: Complaint Response and Sales Call Prep Summary"
Cohesion: 0.40
...
### Community 1310 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 1311 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 1313 - "Phase 33 — deferred items"
Cohesion: 0.40
...
### Community 1317 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1318 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1319 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1320 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1321 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1322 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1323 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1324 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1325 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1326 - "Standard Stack"
Cohesion: 0.50
...
### Community 1328 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 1329 - "deletableTables"
Cohesion: 0.50
Nodes (3): deletableTables(), schemaSource, schemaTables

### Community 1330 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 1335 - "User Constraints"
Cohesion: 0.50
...
### Community 1341 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1342 - "Sources"
Cohesion: 0.50
...
### Community 1350 - "User Constraints"
Cohesion: 0.50
...
### Community 1352 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 1356 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1357 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1359 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1360 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1361 - "Sources"
Cohesion: 0.50
...
### Community 1367 - "The Existing Substrate — as it actually is today"
Cohesion: 0.50
...
### Community 1370 - "Re-Verification Summary"
Cohesion: 0.50
...
### Community 1371 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1373 - "User Constraints (from 19-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1375 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1376 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1377 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1378 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1379 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1384 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1388 - "Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07"
Cohesion: 0.50
...
### Community 1389 - "4. Precedence — typing wins (D5)"
Cohesion: 0.67
...
Cohesion: 0.01
Nodes (95): hooks, PENDING, render(), AdminView(), PendingRow, AdminPage(), DisconnectGoogle(), DisconnectMicrosoft() (+87 more)

## Knowledge Gaps
- **12874 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+12869 more)
...
- **Why does `api` connect `attachments (table)` to `functions.ts`, `page.tsx`, `v1 Requirements`, `briefings.ts`, `metering.ts`, `emailIntent.ts`, `notificationTemplates.ts`, `validateSubmit.ts`, `skills.test.ts`, `layout.tsx`, `replyDrafter.ts`, `index.ts`, `skills.test.ts`, `tenant.ts`, `buildCockpitTools`, `guardrails.test.ts`, `Dropzone.tsx`, `classify.ts`, `gapAction.test.ts`, `Phase 25 — the owner gates`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Validation Architecture`, `vaultLlm.ts`, `buildCockpitTools`, `vaultGround.test.ts`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `approvalsView.test.ts`, `log`, `agentSteps.test.ts`, `FinanceTabs.tsx`, `packCustomerComplaint.ts`, `page.tsx`, `AdminView.tsx`, `Phase 15 — Sub-agent dispatch + generalized executor`, `buildTelemetry.ts`, `extractKind.ts`, `cockpit.ts`, `pipeline-uat.spec.ts`, `guardrails.test.ts`, `vaultSweep.test.ts`, `feedback.test.ts`, `selfCheck`, `layout.tsx`, `index.ts`, `BusinessBlueprint`, `SkillAuthoringPanel.tsx`, `executiveAgentClassifier.ts`, `Project State`, `isolation.test.ts`, `officeText.test.ts`, `gmail.test.ts`, `index.ts`, `vaultDigest.ts`, `media.ts`, `Key files`, `Plan 33-05: Auto-assembled reel — vault save + regenerate ordering`, `ReportsView.tsx`, `classify.ts`, `page.tsx`, `proposals.test.ts`, `vaultTranscribe.test.ts`, `classify.ts`, `finance.test.ts`, `createdDocs.test.ts`, `vaultLlm.ts`, `worm.ts`, `goals.test.ts`, `Phase Details - Milestone v2.0`, `assembly.ts`, `runCockpitAgent.test.ts`, `DriveBrowser.tsx`, `evaluations.test.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `internal` connect `attachments (table)` to `package.json`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `Project State`, `notificationTemplates.ts`, `skills.test.ts`, `Phase 03.7 — Validation Strategy`, `page.tsx`, `layout.tsx`, `cockpit-resolve.spec.ts`, `evaluations.test.ts`, `classify.ts`, `gapAction.test.ts`, `replyDrafter.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Validation Architecture`, `agentSteps.test.ts`, `vaultLlm.ts`, `vaultGround.test.ts`, `feedback.ts`, `FinanceTabs.tsx`, `log`, `Phase 15 — Sub-agent dispatch + generalized executor`, `packCustomerComplaint.ts`, `vaultTranscribe.test.ts`, `vaultSealing.test.ts`, `vaultDrive.ts`, `Phase 15 — Sub-agent dispatch + generalized executor`, `officeText.ts`, `planTenantActivation`, `formatAbsolute`, `extractKind.ts`, `cockpit.ts`, `guardrails.test.ts`, `selfCheck`, `assembly.ts`, `Project State`, `intake.test.ts`, `vaultDigest.ts`, `media.ts`, `classify.ts`, `calendarComplete.ts`, `finance.test.ts`, `runCockpitAgent.test.ts`, `vaultLlm.ts`, `page.tsx`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `spendLedger.ts`, `assembly.ts`, `worm.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `dependencies` connect `How to verify` to `spendLedger.ts`, `package.json`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _12906 weakly-connected nodes found - possible documentation gaps or missing edges._
