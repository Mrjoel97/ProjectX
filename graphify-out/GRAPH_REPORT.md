...
## Corpus Check
- 1525 files · ~2,684,770 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5499 nodes · 8960 edges · 397 communities (368 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19e3ec3e`
...
4. `log` - 30 edges
5. `base()` - 29 edges
6. `tenantQuery` - 28 edges
7. `internalQuery` - 28 edges
8. `contentHash()` - 26 edges
...
Cohesion: 0.13
Nodes (22): BlueprintPanel(), secondaryButton(), ConnectionsPanel(), pill, row, NarrativePanel(), isTabId(), page (+14 more)

### Community 1 - "package.json"
Cohesion: 0.06
Nodes (18): DisconnectGoogle(), Crumb, Entry, Node, Note, WHY, STATUS_COLOR, modules (+10 more)
...
Cohesion: 0.06
Nodes (33): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), BLUEPRINT_FIELD_SET, BlueprintDraft, BlueprintPulseResult, BlueprintStateResult (+25 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.04
Nodes (61): deliverApprovedPlan, markPlanDone, send, prepare, workflow, draft, Route, BlockReason (+53 more)
...
Cohesion: 0.11
Nodes (23): BlueprintReport(), EMPTY_BLUEPRINT, formatConfirmedAt(), SegmentLedger(), AskSpecialist(), blueprintPulse, buildBlueprintDraft, BLUEPRINT_FIELDS (+15 more)
...
Cohesion: 0.06
Nodes (32): RFC-2045, RFC-2047, RFC-2822, ActionCtx, internalAction, base64Url(), buildMime(), FetchBodiesResult (+24 more)

### Community 11 - "scan.ts"
Cohesion: 0.07
Nodes (45): digits(), ShapePanel(), tenantProfiles (table), backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage (+37 more)
...
Cohesion: 0.07
Nodes (32): numeric, finish, latestTurn, record, StepView, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal (+24 more)
...
Cohesion: 0.14
Nodes (16): categoryFor(), isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource, ExtractionKind, extractionKindFor(), OFFICE_MIME (+8 more)
...
Cohesion: 0.09
Nodes (21): DOCUMENT_DRAFTER_SKILL, EMAIL_DRAFTER_SKILL, EvalEvidence, EXECUTIVE_AGENT_CLASSIFIER_SKILL, EXECUTIVE_ROUTER_SKILL, INBOX_DIGEST_SKILL, LEAD_ENGINE_SKILL, LoadedSkill (+13 more)
...
Cohesion: 0.15
Nodes (14): crons, flagExpiringTokens, runWeekly, exportCursors (table), runSweep, exportAudit, s3, advanceCursor (+6 more)
...
Cohesion: 0.23
Nodes (14): ascii(), assTime(), buildCaptionLines(), CaptionLine, concatWavTakes(), escapeAss(), groupIntoLines(), parseWav() (+6 more)
...
Cohesion: 0.13
Nodes (21): BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), marker() (+13 more)
...
Cohesion: 0.07
Nodes (35): DriveBrowser(), submitCaptions, Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, maybeBurnCaptions(), maybeStartCaptions() (+27 more)
...
### Community 73 - "list"
Cohesion: 0.22
Nodes (13): AssemblyBlock, AssemblyError, AssemblyReport, CLIP_SET, isGovernedRender(), near(), num(), parseAssemblySidecar() (+5 more)
...
Cohesion: 0.11
Nodes (26): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+18 more)

### Community 77 - "notificationMessage"
Cohesion: 0.11
Nodes (12): admits(), ConverseResult, mergeSlots(), profileSchema, __seedOnboardedTenant, status, TurnOutput, turnSchema (+4 more)
...
Cohesion: 0.14
Nodes (17): sanitizeAgentName(), EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, resolveSpecialist(), SPECIALIST_TOOLS, specialistMemoBody(), SPECIALISTS (+9 more)
...
Cohesion: 0.09
Nodes (24): cockpitAgent, ExternalActionType, ExternalArgs, FanoutArgs, listThreadMessages, moveScheduledPlan, proposeEmailPlan, reschedulePlan (+16 more)
...
Cohesion: 0.15
Nodes (11): Err, Result, unwrap(), DETECTORS, Match, PiiEntity, PiiScanError, PiiScanResult (+3 more)
...
Cohesion: 0.15
Nodes (18): decodeUtf8(), extractVisual(), runIntake(), RunIntakeArgs, transcribeAudio(), ingestFromAttachment, ATTACHMENT_EXTRACTOR_SKILL, asciiAt() (+10 more)
...
Cohesion: 0.09
Nodes (15): aggregateModules, cancelQueued(), migrationsModules, modules, profileFor(), queuedJobs(), seedProfileDoc(), SME_FACTS (+7 more)
...
Cohesion: 0.12
Nodes (8): activateSkill, archiveSkill, getSkillVersion, recordEvalEvidence, seedSkills, ADR-0007, MEDIA_DIRECTOR_SKILL, bodies
...
Cohesion: 0.08
Nodes (22): ActivitySection(), caps, cardTitle, ConnectedHeadline(), ConnectedSolvency(), ConnectedUnitEconomics(), fallbackTier(), FigureTile() (+14 more)
...
Cohesion: 0.13
Nodes (12): batchToRender, burnCaptions, captionsToBurn, markRendering, recordCaptionBurn, recordRender, RenderInputs, renderReel (+4 more)
...
Cohesion: 0.12
Nodes (17): paginationBound(), controls, coverage, globalRails, LimiterWindow, mediaLedger, readWindow(), setMasterKillSwitch (+9 more)
...
Cohesion: 0.15
Nodes (10): OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), BellIcon(), WalletIcon(), evalSignals, getOptimizerStatus, setOptimizerEnabled (+2 more)
...
Cohesion: 0.17
Nodes (6): convexSiteOrigin(), SandboxOptions, deps(), plausibleMp4(), Recorder, SIDECAR_OK
...
Cohesion: 0.10
Nodes (21): persistNextStepMemo(), contentHash(), writeProfileDoc(), isoDate(), persistFindings, researchDocumentText(), researchTitle(), vaultDocuments (table) (+13 more)

### Community 159 - "proactiveReview.ts"
Cohesion: 0.05
Nodes (39): listNew, markResolved, addItem, listItems, myFeedback, submitFeedback, undoFeedback, action (+31 more)
...
Cohesion: 0.14
Nodes (12): followUpIsDue(), needsAttention(), normalizeAddress(), renderFooter(), LogFields, LogLevel, BreachConfig, BreachInput (+4 more)
...
Cohesion: 0.04
Nodes (63): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext(), buildHistoryBlock() (+55 more)
...
Cohesion: 0.29
Nodes (4): OperatorTab(), msg(), createLogger(), Logger
...
Cohesion: 0.06
Nodes (34): spineForTenant, tenantAction, graphEdges (table), graphNodes (table), getDoc, markReady, ownedDocsMeta, sealedDocIds (+26 more)

### Community 210 - "Phase 7: Resilience & Operations Hardening - Research"
Cohesion: 0.08
Nodes (25): preCall, recordSpend, applyClassification, countTerminal(), getDocForExtraction, ingestExtractedText, insertCreatedDoc, markExtracting (+17 more)
...
Cohesion: 0.06
Nodes (33): Approvals — owner-APPROVED (Plan 26-05, Task 2 closed 2026-08-08), Approvals read contract, Approvals type scale — inline styles must quote the mockup, not invent, Backend page adapters, Cash — business finance, Cash — FigureTile and the connected page (Task 6), Cash — solvency (Task 7), Cash — the Business tab, assembled (Task 9) (+25 more)
...
Cohesion: 0.06
Nodes (18): aggregateModules, modules, modules, T, modules, modules, components, internal (+10 more)

### Community 255 - "formatAbsolute"
Cohesion: 0.09
Nodes (21): ATTACHMENTS, attachmentUrls, byThread, CANDIDATES, clearCandidates, insertPlan, LIVE_JOB_STATUS, LIVE_RENDER_STATUS (+13 more)
...
Cohesion: 0.10
Nodes (36): activityFromSends(), CASH_INPUTS, CashActivity, CashFigure, CashInputs, cashInputsForTier(), CashInputSpec, CashMetricKey (+28 more)
...
Cohesion: 0.12
Nodes (16): BusyRange, createEvent, freeBusy, FreeBusyResult, GoogleError, GoogleFreeBusy, RFC-3339, getById (+8 more)
...
Cohesion: 0.06
Nodes (40): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), ApprovalsView(), AwaitingCard(), AwaitingItem, AwaitingPage (+32 more)
...
Cohesion: 0.20
Nodes (9): notifyIfAgentTimeout(), auditControl(), DatabaseWriter, MutationCtx, QueryCtx, logTierChange(), MESSAGES, NotificationKind (+1 more)

### Community 527 - "calendar.test.ts"
Cohesion: 0.12
Nodes (18): activity, _docToField, _fieldToDoc, inputs, inputStatesFor(), saveInput, scorecardValue(), shape (+10 more)
...
Cohesion: 0.10
Nodes (15): CardList(), ErrorBoundary, CanvasPane(), capsTeal, panel, REVIEW_TAB, Tab, clamp() (+7 more)
...
### Community 1052 - "audit (table)"
Cohesion: 0.07
Nodes (31): auditCounts, backfillAuditCounts, countAudit, log, byThread, insert, ADR-0004, CreateEventResult (+23 more)

### Community 1055 - "contacts (table)"
Cohesion: 0.07
Nodes (21): DataModel, Doc, Id, TableNames, aggregateModules, modules, contacts (table), followUps (table) (+13 more)

### Community 1063 - "gmailTokens (table)"
Cohesion: 0.08
Nodes (24): { auth, signIn, signOut, store, isAuthenticated }, password, httpAction, buildAuthorizeUrl(), deleteTokens, getForDelivery, getTokens, hmacHex() (+16 more)

### Community 1067 - "stepText"
Cohesion: 0.20
Nodes (13): ActivityCard(), stepText(), bubble(), ChatPane(), messageText(), IntakeControls(), StorageId, ChevronDownIcon() (+5 more)

### Community 1070 - "mediaJobs (table)"
Cohesion: 0.07
...
## Knowledge Gaps
- **2567 isolated node(s):** `stack`, `muted`, `cardTitle`, `caps`, `numbersRow` (+2562 more)
...
- **Why does `api` connect `package.json` to `functions.ts`, `page.tsx`, `skills.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase Details`, `metering.ts`, `scan.ts`, `skills.test.ts`, `page.tsx`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `Dropzone.tsx`, `evaluations.test.ts`, `DriveBrowser.tsx`, `26-05: Connected Approvals route, owner-verified`, `Phase 11: Persona Onboarding & Business Profile - Research`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `contacts (table)`, `approvalsView.test.ts`, `audit.test.ts`, `routing.ts`, `log`, `ApprovalsErrorBoundary`, `stepText`, `Parallel Build Lanes (multi-session)`, `Implementation Decisions`, `goals (table)`, `Phase 15 — Sub-agent dispatch + generalized executor`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `Phase 3.10: Cockpit Conversation Repair - Research`, `getActiveSkill`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `COCKPIT_AGENT_SKILL`, `vaultViewState.ts`, `Phase 22 Research: Owner Authorization Primitive (`requireOwner`)`, `classify.ts`, `Lane ownership (Phase 3.8)`, `guardrails.ts`, `buildTelemetry.ts`, `classify.ts`, `proactiveReview.ts`, `logger.ts`, `index.ts`, `scripts`, `officeText.test.ts`, `guardrails.test.ts`, `Phase Details - Milestone v2.0`, `Phase 15.2 — universal format recognition`, `voiceDoc.test.ts`, `createdDocs.test.ts`, `http.ts`, `runCockpitAgent.test.ts`, `vaultLlm.ts`, `gapAction.test.ts`, `Critical Pitfalls`, `brief.ts`, `Implementation Decisions`, `page.tsx`, `Phase 17 — Calendar actions`, `tenant.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `internal` connect `tenant.ts` to `package.json`, `briefings.ts`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `v1 Requirements`, `calendar.ts`, `metering.ts`, `Project State`, `scan.ts`, `skills.test.ts`, `Phase 17 — Calendar actions`, `tenantProfile.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `DriveBrowser.tsx`, `guardrails.test.ts`, `evaluations.test.ts`, `Validation Architecture`, `audit (table)`, `agentSteps.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `feedback.ts`, `contacts (table)`, `log`, `feedback.test.ts`, `gmailTokens (table)`, `ApprovalsErrorBoundary`, `llm.ts`, `mediaJobs (table)`, `Phase 15 — Sub-agent dispatch + generalized executor`, `opsSignals.test.ts`, `buildTelemetry.ts`, `Project State`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `getActiveSkill`, `index.ts`, `notificationMessage`, `opsSignals.test.ts`, `index.ts`, `Hot Path Rules`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `vaultViewState.ts`, `Phase 22 Research: Owner Authorization Primitive (`requireOwner`)`, `buildTelemetry.ts`, `classify.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `index.ts`, `guardrails.test.ts`, `Phase Details - Milestone v2.0`, `http.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `Critical Pitfalls`, `brief.ts`, `runCockpitAgent.test.ts`, `intake.test.ts`, `formatAbsolute`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ApprovalsErrorBoundary` connect `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary` to `approvalsView.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `stack`, `muted`, `cardTitle` to the rest of the system?**
