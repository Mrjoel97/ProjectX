# Graph Report - Pikar-Ai  (2026-08-08)

## Corpus Check
- 1502 files · ~2,560,466 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13610 nodes · 15435 edges · 1374 communities (1284 shown, 90 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12b7b685`
...
4. `base()` - 29 edges
5. `internalQuery` - 28 edges
6. `contentHash()` - 26 edges
7. `tenantQuery` - 25 edges
8. `buildCockpitTools()` - 25 edges
9. `Phase Details - Milestone v2.0` - 24 edges
10. `Pending Pages + Knowledge Vault: Pre-Implementation Integration Map` - 24 edges
...
- `Dropzone()` --calls--> `capMB()`  [EXTRACTED]
  apps/web/app/(app)/dashboard/vault/Dropzone.tsx → packages/vault/src/constants.ts

## Import Cycles
- None detected.

## Communities (1374 total, 90 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.04
Nodes (33): DisconnectGoogle(), Crumb, DriveBrowser(), Entry, Node, Note, WHY, STATUS_COLOR (+25 more)

### Community 1 - "package.json"
Cohesion: 0.07
Nodes (36): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents, mediaRemainingCentsInner() (+28 more)
...
Cohesion: 0.08
Nodes (34): Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions(), maybeStartCaptions(), onSubmitComplete (+26 more)
...
Cohesion: 0.05
Nodes (40): RFC-2045, RFC-2047, RFC-2822, notifyIfAgentTimeout(), ActionCtx, DatabaseReader, MutationCtx, base64Url() (+32 more)

### Community 11 - "scan.ts"
Cohesion: 0.05
Nodes (43): getGuardrailConfig(), assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender() (+35 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.13
Nodes (23): buildCockpitTools(), layoutRuns(), markdownToPdf(), stripRePrefix(), wrapText(), word(), buildDocFilename(), DocFormat (+15 more)

### Community 13 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.07
Nodes (47): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, governedDispatch() (+39 more)
...
Cohesion: 0.14
Nodes (16): buildAuthorizeUrl(), deleteTokens, disconnectGoogle, flagExpiringTokens, getForDelivery, getTokens, gmailConnectUrl, gmailStatus (+8 more)

### Community 21 - "cockpit-resolve.spec.ts"
Cohesion: 0.08
Nodes (38): Tab, VAULT_TABS, base(), DownloadIcon(), FileDocIcon(), FileTextIcon(), FolderIcon(), GridIcon() (+30 more)
...
Cohesion: 0.21
Nodes (13): AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn, today() (+5 more)
...
Cohesion: 0.07
Nodes (32): ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo(), byThread (+24 more)
...
Cohesion: 0.08
Nodes (35): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, readLayout(), VaultDoc (+27 more)
...
Cohesion: 0.07
Nodes (24): modules, modules, COCKPIT_AGENT_SKILL, CONTENT_DRAFTER_SKILL, DOCUMENT_DRAFTER_SKILL, EMAIL_DRAFTER_SKILL, EvalEvidence, EXECUTIVE_AGENT_CLASSIFIER_SKILL (+16 more)
...
Cohesion: 0.06
Nodes (49): digits(), ShapePanel(), backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier (+41 more)
...
Cohesion: 0.06
Nodes (43): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult, candidatesSchema, confirmBlueprint (+35 more)
...
Cohesion: 0.05
Nodes (41): persistNextStepMemo(), httpAction, ASSET_PATH, FAL_ASSET_HOSTS, http, INLINE_ASSET, contentHash(), writeProfileDoc() (+33 more)
...
Cohesion: 0.08
Nodes (12): agentModules, aggregateModules, modules, rateLimiterModules, T, workflowModules, workpoolModules, enqueuedExtractions (+4 more)

### Community 77 - "notificationMessage"
Cohesion: 0.13
Nodes (17): DocPicker(), MicState, PreFlight(), primaryBtn, secondaryBtn, ActivityCard(), stepText(), traceText (+9 more)
...
Cohesion: 0.08
Nodes (26): deliverApprovedPlan, markPlanDone, retrier, vaultIngestPool, workflow, BlockReason, LABELS, pipelineWorkflow (+18 more)

### Community 96 - "classify.ts"
Cohesion: 0.05
Nodes (49): answerDecision, blockedSummary, listAwaiting, listCleared, listDecisions, listInFlight, listScheduled, numericField (+41 more)
...
Cohesion: 0.11
Nodes (18): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+10 more)
...
Cohesion: 0.08
Nodes (26): cancelScheduledPlan, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, listThreadMessages (+18 more)

### Community 106 - "classify.ts"
Cohesion: 0.06
Nodes (40): CategoryTabs(), discussPillStyle(), DocGrid(), docLabel(), folderChip(), pillAnchor(), pillShape, statusBadge() (+32 more)
...
Cohesion: 0.08
Nodes (17): admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots(), profileSchema (+9 more)
...
Cohesion: 0.08
Nodes (37): batchToRender, burnCaptions, captionsToBurn, markRendering, recordCaptionBurn, recordRender, RenderInputs, renderReel (+29 more)

### Community 120 - "guardrails.ts"
Cohesion: 0.11
Nodes (26): NAV, PasswordField(), TextField(), ArrowIcon(), base(), BoltIcon(), BrainIcon(), CheckCircleIcon() (+18 more)
...
Cohesion: 0.08
Nodes (41): buildTrajectoryExport, scrub(), transcribeDoc, Err, Ok, Result, unwrap(), CHEAP_MODEL (+33 more)
...
Cohesion: 0.06
Nodes (33): SubmittableSpec, aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules (+25 more)
...
Cohesion: 0.12
Nodes (16): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody(), SpecialistRoute (+8 more)
...
Cohesion: 0.06
Nodes (27): DispatchResult, aggregateModules, BASE, __dirname, DISPATCH_STEP_TOOLS, MEDIA_BODY, mediaArgs(), modules (+19 more)
...
### Community 169 - "calendar.test.ts"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (66): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, callTimeoutMsFor(), __cockpitTurnPrompt (+58 more)
...
Cohesion: 0.17
Nodes (11): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+3 more)
...
Cohesion: 0.08
Nodes (25): A failed render dead-letters, and does not retry, Dependencies & blast radius, How to change this safely, Invariants — what must never break, Landing: `none_reported`, exact spend, and a window that does not move, Playbook: Media Canvas (finished reels and standalone images), Playbook ownership for Phase 20, Rate observation (dated, vendor-direct) (+17 more)
...
### Community 191 - "vaultSmoke.ts"
Cohesion: 0.08
Nodes (19): activateCandidate, activateSkill, activateSkillVersion(), archiveSkill, candidatesForReview, getActiveSkill, getSkillVersion, insertCandidate (+11 more)
...
Cohesion: 0.08
Nodes (27): internalAction, tenantAction, insertReviewNotification, reviewOne, runWeekly, runVaultGround(), vaultGround, vaultGroundHydrated (+19 more)

### Community 198 - "Project State"
Cohesion: 0.13
Nodes (16): BLOCKED, BlockedConnection, ADR-0007, ConnectionsPanel(), pill, row, NarrativePanel(), isTabId() (+8 more)
...
Cohesion: 0.15
Nodes (12): ADR-009: Tier shapes the specialist PROMPT, not the offer set, Alternatives rejected, Consequences, Context, Decision, Deferred — and the supersession path, ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits, Alternatives rejected (+4 more)

### Community 203 - "DocPicker.tsx"
Cohesion: 0.33
...
### Community 206 - "Convex Quickstart"
Cohesion: 0.05
...
Cohesion: 0.17
Nodes (11): 15.3-03 — the third window, the clamped refund, and the rail selector, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Phase 15.3 — the folder-ingest rail, Playbook: Guardrails (the spend rails, the kill switches, the redaction choke point) (+3 more)
...
Cohesion: 0.03
Nodes (90): finish, latestTurn, record, StepView, { auth, signIn, signOut, store, isAuthenticated }, password, byThread, insert (+82 more)

### Community 216 - "vault-redesign.spec.ts"
Cohesion: 0.06
...
### Community 223 - "Critical Pitfalls"
Cohesion: 0.06
...
Cohesion: 0.17
Nodes (12): Backend page adapters, Data flow, Dependencies & blast radius, Frontend and connected browser evidence, How to change safely, Key files, Known gaps & deferred work, Operational notes (+4 more)
...
### Community 243 - "VaultBrowseControls.tsx"
Cohesion: 0.20
...
Cohesion: 0.03
Nodes (39): aggregateModules, modules, aggregateModules, CalendarEventFields, convexSources, EventField, freeBusyArgs, modules (+31 more)

### Community 248 - "Implementation Decisions"
Cohesion: 0.07
...
### Community 251 - "5. Cross-cutting prerequisites"
Cohesion: 0.07
...
Cohesion: 0.11
Nodes (20): EDGE, expand, NODE, upsertGraph, isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource (+12 more)
...
### Community 254 - "Stack Research — Convex Revision"
Cohesion: 0.07
...
### Community 255 - "Phase 15.4: Vault Redesign and Scoped Browse Correctness - Research"
Cohesion: 0.08
...
### Community 256 - "Convex Quickstart"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)
...
### Community 258 - "Hot Path Rules"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)

### Community 259 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 261 - "Phase Details - Milestone v2.0"
Cohesion: 0.08
...
### Community 262 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 263 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 264 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 265 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 266 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 267 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 269 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 270 - "Architecture Research"
Cohesion: 0.09
...
### Community 272 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 273 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 275 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 276 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 278 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 279 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 280 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 281 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 282 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 283 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 284 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 285 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 287 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 288 - "Fix Order"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 289 - "Implementation Decisions"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (18): fmtSize(), Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME, StorageId (+10 more)
...
### Community 295 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 297 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 299 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 300 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 301 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 302 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 303 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 304 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 305 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 306 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 307 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 308 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 309 - "officeText.ts"
Cohesion: 0.29
Nodes (17): chartLines(), docxText(), epubText(), extractOfficeText(), joinParts(), labelled(), numericSorted(), odfText() (+9 more)

### Community 310 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 311 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 312 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 313 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 314 - "validateSubmit.ts"
Cohesion: 0.11
...
### Community 315 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 317 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 318 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 319 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 320 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 321 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 322 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 323 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 324 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 325 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 326 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 327 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 328 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 329 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 330 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 333 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 334 - "vaultDrive.test.ts"
Cohesion: 0.20
Nodes (5): aggregateModules, modules, rateLimiterModules, workflowModules, workpoolModules

### Community 335 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)
...
### Community 337 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 338 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 339 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 340 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 341 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 342 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 343 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 344 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 345 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 346 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 347 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 348 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 349 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 350 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 351 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 352 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 354 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 355 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 356 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 357 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 359 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 362 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 363 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 364 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 365 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 366 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 367 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 369 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 370 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 371 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 372 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 373 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 374 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 376 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 377 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 378 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 379 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 380 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 381 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 382 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 383 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 384 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 385 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 386 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 387 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 388 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 389 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 390 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 391 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 392 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 394 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 395 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 396 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 398 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 400 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 402 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 403 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 405 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 406 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 407 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 408 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 409 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 410 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 411 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 412 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 413 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 414 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 415 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 416 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 417 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 418 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 419 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 420 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 421 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 422 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 424 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 425 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 426 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 427 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 429 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 430 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 432 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 433 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 434 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 435 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 437 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 438 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 440 - "Feature Research"
Cohesion: 0.12
...
### Community 441 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 443 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 446 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 447 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 448 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 449 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 450 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 451 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 452 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 453 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 454 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 455 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 456 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 457 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 458 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 459 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 460 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 461 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 462 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 467 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 468 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 469 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 471 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 473 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 475 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 477 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 479 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 480 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 482 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 487 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 491 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 493 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 494 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 495 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 496 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 510 - "officeText.test.ts"
Cohesion: 0.15
...
### Community 512 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
...
### Community 513 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 514 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 515 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 517 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 518 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 524 - "Goal Achievement"
Cohesion: 0.15
...
### Community 525 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 526 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 527 - "Goal Achievement"
Cohesion: 0.15
...
### Community 528 - "Goal Achievement"
Cohesion: 0.15
...
### Community 529 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 530 - "Goal Achievement"
Cohesion: 0.15
...
### Community 531 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 543 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 545 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 547 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 549 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 550 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 551 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.33
Nodes (4): Brand, CONTRACTS_PACKAGE_NAME, TENANT_FIELD, TenantId

### Community 552 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 553 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 555 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 556 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 557 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)

### Community 558 - "vaultExtract.ts"
Cohesion: 0.21
...
### Community 560 - "External Integrations"
Cohesion: 0.17
...
### Community 563 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 564 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 565 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 566 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 567 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 568 - "Goal Achievement"
Cohesion: 0.17
...
### Community 570 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 571 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 572 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 573 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 582 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 583 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 586 - "Repository Structure"
Cohesion: 0.18
...
### Community 587 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 588 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 590 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 591 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 592 - "Goal Achievement"
Cohesion: 0.18
...
### Community 603 - "Goal Achievement"
Cohesion: 0.18
...
### Community 604 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 609 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 610 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 611 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 613 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 617 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 618 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 639 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 640 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 641 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 643 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 644 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 645 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 648 - "Code Conventions"
Cohesion: 0.20
...
### Community 649 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 650 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 651 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 652 - "Goal Achievement"
Cohesion: 0.20
...
### Community 654 - "Goal Achievement"
Cohesion: 0.20
...
### Community 655 - "Goal Achievement"
Cohesion: 0.20
...
### Community 656 - "Goal Achievement"
Cohesion: 0.20
...
### Community 657 - "Goal Achievement"
Cohesion: 0.20
...
### Community 658 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 666 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 671 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 674 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 676 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 677 - "Goal Achievement"
Cohesion: 0.20
...
### Community 679 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 682 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 683 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 684 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 688 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 689 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 691 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 698 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 699 - "Validation Architecture"
Cohesion: 0.20
...
### Community 701 - "Technology Stack"
Cohesion: 0.22
...
### Community 702 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 703 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 704 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 705 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 706 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 707 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 710 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 711 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 712 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 713 - "Locked Decisions"
Cohesion: 0.22
...
### Community 715 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 718 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 719 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 720 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 721 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 722 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 723 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 724 - "opsSignals.test.ts"
Cohesion: 0.32
Nodes (5): modules, seedRequest(), seedTelemetry(), seedTelemetryFixture(), T

### Community 725 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 728 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 729 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 732 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 733 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 734 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 736 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 737 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 751 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 753 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 755 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 760 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 761 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 762 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 764 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 767 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 768 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 769 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 770 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 771 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 772 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 774 - "The assemble contract (20-13)"
Cohesion: 0.25
...
### Community 775 - "Phase 15 — Sub-agent dispatch + generalized executor"
Cohesion: 0.29
...
### Community 776 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 777 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 778 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 779 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 780 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 781 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 782 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 783 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 784 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 785 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 786 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 787 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 788 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 789 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 790 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 791 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 792 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 793 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 794 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 795 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 796 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 797 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 798 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 799 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 800 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 801 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 802 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 803 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 804 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 805 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 806 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 807 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 808 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 809 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 812 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 813 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 814 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 816 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 817 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 819 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 820 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 823 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 824 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 825 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 826 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 827 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 828 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 829 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 830 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 837 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 839 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 840 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 841 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 842 - "Validation Architecture"
Cohesion: 0.29
...
### Community 843 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 845 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 846 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 848 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 853 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 855 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 856 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 857 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.40
...
### Community 858 - "ADR-011: Media generation goes to fal.ai on Wan 2.5 — a per-second USD price is the binding criterion, not model prestige"
Cohesion: 0.33
...
### Community 859 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 860 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 861 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes
...
### Community 864 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 865 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 866 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 868 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 869 - "Validation Architecture"
Cohesion: 0.33
...
### Community 870 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 872 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 873 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 874 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 878 - "error-context.md"
Cohesion: 0.40
...
### Community 880 - "Validation Architecture"
Cohesion: 0.33
...
### Community 881 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 882 - "Validation Architecture"
Cohesion: 0.33
...
### Community 889 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 891 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 892 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 893 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 895 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 896 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 897 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 898 - "Phase 15 — Sub-agent dispatch + generalized executor"
Cohesion: 0.40
...
### Community 909 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 910 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 912 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 913 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 914 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 919 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 922 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 924 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 929 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 930 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 931 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 932 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 935 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 936 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 939 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 940 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 941 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 942 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 943 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 944 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 945 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 946 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 947 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 948 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 949 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 950 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 951 - "Standard Stack"
Cohesion: 0.50
...
### Community 953 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 954 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 959 - "User Constraints"
Cohesion: 0.50
...
### Community 965 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 966 - "Sources"
Cohesion: 0.50
...
### Community 974 - "User Constraints"
Cohesion: 0.50
...
### Community 976 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 978 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 980 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 981 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 991 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 992 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 993 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 995 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 998 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 999 - "Invariants — what must never break"
Cohesion: 0.40
Nodes (5): Approvals — owner-APPROVED (Plan 26-05, Task 2 closed 2026-08-08), Approvals read contract, Approvals type scale — inline styles must quote the mockup, not invent, Finance ledger contract, Invariants — what must never break

### Community 1002 - "Standard Stack"
Cohesion: 0.67
Nodes (3): Alternatives Considered, Core (all existing), Standard Stack

### Community 1003 - "Sources"
Cohesion: 0.67
Nodes (3): Primary (HIGH confidence — direct source reads, 2026-07-15, repo @ adc7dd0), Secondary / Tertiary, Sources

### Community 1006 - "Standard Stack"
Cohesion: 0.67
Nodes (3): Core — all already installed; this phase adds NO dependency, Explicitly NOT used, Standard Stack

### Community 1012 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
### Community 1371 - "How to verify"
Cohesion: 0.40
Nodes (5): Connected page gates, Focused backend gates, How to verify, Phase close, Pure contracts and operational ownership

### Community 1372 - "metering.ts"
Cohesion: 0.60
Nodes (3): accumulateUsage(), UsageDelta, ZERO_USAGE

## Knowledge Gaps
- **9144 isolated node(s):** `Overview`, `Phase 26: Connected product pages`, `Phase 27: Curated Knowledge-Work Pack Pilot`, `Phase 28: Connector-Backed Revenue Pack`, `Phase 29: Unified Knowledge and Routines` (+9139 more)
...
- **Why does `api` connect `functions.ts` to `package.json`, `page.tsx`, `vaultFolders.test.ts`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `LiveSession.tsx`, `layout.tsx`, `index.ts`, `cockpit-resolve.spec.ts`, `Dropzone.tsx`, `evaluations.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `feedback.test.ts`, `ApprovalsErrorBoundary`, `optimizerBreach.ts`, `Pikar-AI`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `notificationMessage`, `Project State`, `DocPicker.tsx`, `index.ts`, `notificationMessage`, `vaultDrive.test.ts`, `index.ts`, `opsSignals.test.ts`, `COCKPIT_AGENT_SKILL`, `Dropzone.tsx`, `buildTelemetry.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `vaultExtract.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `classify.ts`, `createdDocs.test.ts`, `http.ts`, `The render trigger and D12(b) retention (20-16)`, `server.d.ts`, `intake.test.ts`, `guardrails.ts`, `runCockpitAgent.test.ts`, `MediaCanvas.tsx`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `internal` connect `intake.test.ts` to `functions.ts`, `package.json`, `v1 Requirements`, `vaultFolders.test.ts`, `blueprint.ts`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Project State`, `scan.ts`, `Phase 03.7 — Validation Strategy`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `constants.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `feedback.ts`, `log`, `tenant.ts`, `ApprovalsErrorBoundary`, `optimizerBreach.ts`, `llm.ts`, `vaultExtract.ts`, `Parallel Build Lanes (multi-session)`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `Project State`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `notificationMessage`, `layout.tsx`, `searchVaultSpine.test.ts`, `Phase 3.10: Cockpit Conversation Repair - Research`, `vaultLlm.ts`, `index.ts`, `vaultDrive.test.ts`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `009-tier-shapes-the-specialist-prompt-not-the-offer-set.md`, `Dropzone.tsx`, `buildTelemetry.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `Project State`, `gapAction.test.ts`, `http.ts`, `The render trigger and D12(b) retention (20-16)`, `vaultLlm.ts`, `page.tsx`, `Phase Details - Milestone v2.0`, `runCockpitAgent.test.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `oleText()` connect `officeText.ts` to `retention.ts`, `vaultExtract.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **What connects `Overview`, `Phase 26: Connected product pages`, `Phase 27: Curated Knowledge-Work Pack Pilot` to the rest of the system?**
  _9176 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `functions.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03501006036217304 - nodes in this community are weakly interconnected._
