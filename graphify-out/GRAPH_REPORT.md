...
## Corpus Check
- 2009 files · ~3,916,664 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18980 nodes · 22370 edges · 1860 communities (1710 shown, 150 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `85daa4b7`
...
1. `api` - 123 edges
2. `internal` - 117 edges
3. `internalMutation` - 48 edges
4. `contentHash()` - 46 edges
5. `tenantQuery` - 41 edges
...
- `SegmentLedger()` --indirect_call--> `segment()`  [INFERRED]
  apps/web/app/(app)/dashboard/profile/BlueprintPanel.tsx → packages/core/src/blueprintSegments.test.ts
...
## Communities (1860 total, 150 thin omitted)
...
Cohesion: 0.09
Nodes (20): DisconnectMicrosoft(), LINK, ConnectMicrosoftPage(), ADR-0018, aggregateModules, modules, T, ADR-0018 (+12 more)
...
Cohesion: 0.05
Nodes (59): ReelCanvas(), face(), fscene(), imageCanvas, sceneCard(), scenesWithFailure(), source, adjustmentNotes() (+51 more)
...
Cohesion: 0.04
Nodes (61): persistNextStepMemo(), auditControl(), MutationCtx, contentHash(), rearmAfterFix(), storeAndLand(), Actual, actualValidator (+53 more)
...
Cohesion: 0.07
Nodes (26): RFC-2045, RFC-2047, base64Url(), buildMime(), DeliveryRequest, FetchBodiesResult, fetchInboxBodies, getReplyTarget (+18 more)

### Community 11 - "scan.ts"
Cohesion: 0.09
Nodes (38): salvageNote(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), deckTokenCounts(), dispatchAndLand(), DispatchArgs (+30 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.09
Nodes (30): activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal, financeSpineFor, inputs, inputsFor (+22 more)

### Community 13 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.13
Nodes (16): flushTelemetry(), Fog, fogIntegration(), IntegrationContext, IntegrationInput, traced(), extractDoc, Extracted (+8 more)
...
Cohesion: 0.05
Nodes (50): browserTimeZone(), BudgetControl(), button, caps, card, cardTitle, ControlRow(), ControlsResult (+42 more)
...
Cohesion: 0.03
Nodes (92): modules, modules, activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan (+84 more)

### Community 25 - "classify.ts"
Cohesion: 0.05
Nodes (51): tenantAction, EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround, vaultGroundHydrated (+43 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (75): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, callTimeoutMsFor(), __cockpitTurnPrompt (+67 more)
...
Cohesion: 0.05
Nodes (53): buildTrajectoryExport, scrub(), BuildDigestResult, buildFolderDigest, digestMembersPage, digestPrompt(), FolderDigestState, folderForDigest (+45 more)
...
Cohesion: 0.09
Nodes (30): seedHealthyTenant(), BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField() (+22 more)
...
Cohesion: 0.02
Nodes (46): aggregateModules, modules, isNonAgentThreadIdError(), BLUEPRINT_TEXT, code, modules, sources, modules (+38 more)
...
Cohesion: 0.10
Nodes (26): AGENT_EXPECT_KEYS, argv, assertKnownArgs(), CANDIDATE_STATUSES, casesDir, evaluateExpect(), EVIDENCE_STATES, EXPECT_KEYS (+18 more)

### Community 61 - "guardrails.test.ts"
Cohesion: 0.06
Nodes (31): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+23 more)
...
Cohesion: 0.05
Nodes (44): ADR-0011, DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents (+36 more)
...
Cohesion: 0.12
Nodes (20): CASH_INPUTS, CashInputField, FieldProvenance, FigureActor, FigureConfidence, FigureOrigin, BY_KEY, classifyProposal() (+12 more)
...
Cohesion: 0.11
Nodes (13): ErrorBoundary, CanvasPane(), capsTeal, panel, readStoredWorkspace(), REVIEW_TAB, StoredWorkspace, Tab (+5 more)
...
Cohesion: 0.11
Nodes (28): activity(), AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn (+20 more)

### Community 106 - "classify.ts"
Cohesion: 0.05
Nodes (27): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+19 more)
...
Cohesion: 0.04
Nodes (71): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+63 more)
...
Cohesion: 0.11
Nodes (26): paginationBound(), pageBounded(), runCron(), capped(), resolve(), activeSkills, auditPage, readAuditPage() (+18 more)
...
Cohesion: 0.03
Nodes (70): Activity, ActivityCard(), attRow, badge(), box, Briefing, BriefingItem, BriefingRow() (+62 more)
...
Cohesion: 0.12
Nodes (17): readSeen(), ReconnectBanner(), reconnectLines(), ADR-0018, exportAudit, s3, MESSAGES, NotificationKind (+9 more)
...
Cohesion: 0.06
Nodes (34): backfillRequestDefaults, migrations, run, captionStalled(), inFlight(), lastRenderActivity(), notifyStall(), renderStalled() (+26 more)

### Community 152 - "evaluations.test.ts"
Cohesion: 0.09
Nodes (32): docForMint, hangupCall, mintClientSecret, MintResponse, calls, Captured, modules, ADR-0006 (+24 more)
...
Cohesion: 0.09
Nodes (36): burn(), activityFromSends(), CashFigure, CashInputs, CashInputSpec, CashInputState, CashMetricSet, CashOrigin (+28 more)

### Community 155 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.21
Nodes (15): AssemblyReport, AssemblyScene, ascii(), assTime(), buildCaptionLines(), CaptionLine, concatWavTakes(), escapeAss() (+7 more)
...
Cohesion: 0.13
Nodes (16): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody(), SPECIALISTS (+8 more)
...
Cohesion: 0.03
Nodes (87): scene(), cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs (+79 more)
...
Cohesion: 0.11
Nodes (21): landPack, snapshot, earliestAt(), readOperations(), DASHBOARD_STATE_COPY, DashboardBound, BoardPackInput, compareSnapshots() (+13 more)
...
Cohesion: 0.22
Nodes (10): pickedFolderFromFiles(), VaultBody(), Attachment, EXT_MIME, MIME_ALLOWLIST, resolveMimeType(), SubmitInput, base (+2 more)
...
Cohesion: 0.08
Nodes (31): aggregateModules, evaluateWithGap(), modules, profileDocText(), seedDoc(), seedDocReview(), workflowModules, workpoolModules (+23 more)
...
Cohesion: 0.03
Nodes (54): aggregateModules, coreSources, Harness, modules, PARTIAL_REASONS, rawSources, signed(), httpAction (+46 more)
...
Cohesion: 0.06
Nodes (40): numeric, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo() (+32 more)
...
Cohesion: 0.06
Nodes (30): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx, exports, ./api (+22 more)
...
Cohesion: 0.09
Nodes (27): buildOnboardingFolderIntake(), extension(), isOnboardingTextFile(), isPrivateOrGenerated(), MIME_BY_EXTENSION, onboardingFolderDisplayPath(), OnboardingFolderFile, onboardingFolderMimeType() (+19 more)
...
Cohesion: 0.10
Nodes (16): BusyRange, createEvent, deploymentUrlHash(), freeBusy, graphConcurrencyProbe, GraphEvent, GraphTokenResult, inspectEvent (+8 more)
...
Cohesion: 0.10
Nodes (23): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), AskSpecialist(), DirectionBand(), fmtDuration(), fmtWhen() (+15 more)
...
Cohesion: 0.15
Nodes (5): aggregateModules, asTenant(), modules, startDocSession(), VOICE_BLUEPRINT_TEXT
...
Cohesion: 0.13
Nodes (14): AvailabilityRange, availabilityWindow(), eventIdFor(), GOOGLE_SCOPES, RFC-3339, button, connectPage, data (+6 more)
...
Cohesion: 0.22
Nodes (9): aggregateModules, harness(), modules, ownerHarness(), Seed, sourceFiles(), tenantHarness(), WINDOW (+1 more)
...
Cohesion: 0.06
Nodes (46): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+38 more)
...
Cohesion: 0.06
Nodes (32): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult (+24 more)
...
Cohesion: 0.24
Nodes (9): googleCalendarToken(), ActionCtx, freshAccessToken(), prepareGovernedMessage(), GraphSendResult, send, ADR-0018, freshGraphToken() (+1 more)
...
Cohesion: 0.03
Nodes (38): hooks, PENDING, render(), AdminView(), PendingRow, AdminPage(), AttachmentPicker(), UploadedAttachment (+30 more)
...
### Community 343 - "Stack Research — Convex Revision"
Cohesion: 0.40
...
### Community 344 - "httpAuth.test.ts"
Cohesion: 0.40
...
Cohesion: 0.33
Nodes (5): DatabaseReader, DatabaseWriter, QueryCtx, logTenantActivation(), byTenant()

### Community 347 - "ReportsView.tsx"
Cohesion: 0.07
Nodes (39): activeButton, AuditPage, Business, BusinessSection(), button, caps, card, GovernanceSection() (+31 more)
...
Cohesion: 0.09
Nodes (27): CategoryTabs(), discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), MoveDocId, MoveFolderId (+19 more)

### Community 351 - "Phase 23 Research: Agent-Authored Skills"
Cohesion: 0.07
Nodes (30): deliverApprovedPlan, markPlanDone, retrier, vaultIngestPool, workflow, BlockReason, LABELS, pipelineWorkflow (+22 more)
...
### Community 356 - "groundedSources.test.ts"
Cohesion: 0.70
...
### Community 373 - "Phase Details - Milestone v2.0"
Cohesion: 0.08
...
### Community 375 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 377 - "Phase 17 Plan 05: `calendar_manage` Substrate Summary"
Cohesion: 0.09
...
### Community 378 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 379 - "Phase 25: Private Beta Productionization - Context"
Cohesion: 0.09
...
### Community 380 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 382 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 384 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 385 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 386 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 387 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 388 - "Phase 21 Plan 04: The Owner Boundary Summary"
Cohesion: 0.09
...
### Community 389 - "Phase 21 Research: User-Authored Skills & Routines"
Cohesion: 0.09
...
### Community 390 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 391 - "Architecture Research"
Cohesion: 0.09
...
### Community 393 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 394 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 395 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 396 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 399 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 400 - "buildAgentContext"
Cohesion: 0.05
Nodes (35): internalQuery, ConfigPatch, DEFAULT_OPTIMIZER_CONFIG, getOptimizerConfig, getOptimizerStatus, OptimizerConfigView, setOptimizerConfig, setOptimizerEnabled (+27 more)

### Community 401 - "Phase 19 Plan 10: Close the phase honestly Summary"
Cohesion: 0.10
...
### Community 402 - "Phase 19 Plan 13: Consent Record Gap Closure Summary"
Cohesion: 0.10
...
### Community 403 - "Phase 21 Plan 03: Exact Tenant Candidate Evaluation Summary"
Cohesion: 0.10
...
### Community 405 - "Verified defect inventory (the work list)"
Cohesion: 0.10
...
### Community 414 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 416 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 417 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 419 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 420 - "Phase 25.1 Plan 05: Memo Rendering & Research Sources Summary"
Cohesion: 0.10
...
### Community 424 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 443 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 444 - "officeText.ts"
Cohesion: 0.29
...
### Community 446 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 448 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 449 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 450 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 451 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 452 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 453 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 454 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 455 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 456 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 457 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 458 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 459 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 460 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 461 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 462 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 466 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 467 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 468 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 469 - "Phase 19.1 Plan 06: The CSV Import Panel Summary"
Cohesion: 0.11
...
### Community 471 - "Phase 33 Plan 09: media-director v3 — the specialist learns to write what the parsers read"
Cohesion: 0.11
...
### Community 472 - "Phase 33 Plan 13: The proposal stage gets a failure card, and the two parser edits get disclosed Summary"
Cohesion: 0.11
...
### Community 473 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 474 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 475 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (52): ArtDirection, BLOCK_REFUSAL_WHY, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, DeckContract, fail(), fieldOf() (+44 more)

### Community 477 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 478 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 479 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 480 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 481 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 482 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 514 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 516 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 517 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 518 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 520 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 521 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 522 - "Phase 17 Plan 09: Managed-event discovery and safe staging Summary"
Cohesion: 0.12
...
### Community 523 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.12
...
### Community 524 - "Phase 19.1 Plan 05: pipelineTiles Reports Its Scan Bound Summary"
Cohesion: 0.12
...
### Community 525 - "Phase 20.2: Scene Timeline Reels — Code and Offline Evidence Summary"
Cohesion: 0.12
...
### Community 526 - "Phase 21 Plan 02: Tenant Candidate Write/Read and Effective Loading Summary"
Cohesion: 0.12
...
### Community 527 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 528 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 529 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 530 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 532 - "finance-update-fails-only-in-full-sequence.md"
Cohesion: 0.12
...
### Community 533 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 535 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 543 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 545 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 546 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 547 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 548 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 549 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 550 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 551 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 553 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 558 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 559 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 560 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 562 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 565 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 566 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 568 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 570 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 572 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 573 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 575 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 577 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 578 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 579 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 580 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 581 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 582 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 583 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 584 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 585 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 586 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 587 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 588 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 589 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 590 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 592 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 603 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 604 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 606 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 607 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 608 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 609 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 610 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 613 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 614 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 615 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 617 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 618 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 619 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 620 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 621 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 623 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 624 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 638 - "vaultDrive.test.ts"
Cohesion: 0.40
...
### Community 640 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 641 - "Phase 19 Plan 03: The CAN-SPAM postal address Summary"
Cohesion: 0.12
...
### Community 642 - "Phase 25.1 Plan 01: renderReel Honest Terminals Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 643 - "Phase 25.1 Plan 02: Stuck-Work Watchdog Summary"
Cohesion: 0.12
...
### Community 644 - "Phase 25.1 Plan 03: Media Vault Persistence Summary"
Cohesion: 0.12
...
### Community 645 - "Phase 33 Plan 02: Plan-Row State + Governed Mutations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 646 - "Phase 33 Plan 03: Persist Terminal + Money Gates Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 647 - "Phase 33 Plan 04: Failure/Retry Backend Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 648 - "Phase 33 Plan 08: Grounded citations and clear failure on the canvas Summary"
Cohesion: 0.12
...
### Community 649 - "Feature Research"
Cohesion: 0.12
...
### Community 650 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 652 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 653 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 654 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 655 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 657 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 658 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)
...
### Community 664 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 665 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 666 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 667 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 668 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 669 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 670 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 671 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 672 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 675 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 680 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 681 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 682 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 683 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 684 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 686 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 687 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 688 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 689 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 690 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 691 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 695 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 696 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 697 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 698 - "VaultBrowseControls.tsx"
Cohesion: 0.11
Nodes (18): auditCounts, backfillAuditCounts, countAudit, log, recentByType, components, buildGeminiEmbedRequest(), buildOpenAIEmbedRequest() (+10 more)

### Community 699 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 700 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 701 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 702 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 703 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 704 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 705 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 706 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 707 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 708 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 714 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 715 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 716 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 717 - "Phase 17 Calendar Actions — agent-operated live UAT runbook"
Cohesion: 0.13
...
### Community 718 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 719 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 720 - "Phase 19.1 Plan 03: fill-empty-only as a Flag on the ONE Writer Summary"
Cohesion: 0.13
...
### Community 721 - "Phase 19.1 Plan 04: matchExisting and importContacts Summary"
Cohesion: 0.13
...
### Community 722 - "Phase 22: Owner Authorization Primitive Verification Report"
Cohesion: 0.13
...
### Community 723 - "23-03 SUMMARY — the model can now draft a skill, and still cannot activate one"
Cohesion: 0.13
...
### Community 724 - "Phase 25 Plan 05: Microsoft Delivery Arm Summary"
Cohesion: 0.13
...
### Community 725 - "26-17 — Reports, connected end to end, and the nav that only lit after the owner said so"
Cohesion: 0.13
...
### Community 726 - "Phase 33 Plan 01: Storyboard Parse Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 727 - "Project State"
Cohesion: 0.13
...
### Community 729 - "savedPrompts.test.ts"
Cohesion: 0.16
...
### Community 736 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 739 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 750 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 751 - "Phase 19.1 Plan 02: The Two Union Widenings Summary"
Cohesion: 0.14
...
### Community 752 - "Phase 19.1: Bulk Contact Import (CSV) — Research"
Cohesion: 0.14
...
### Community 755 - "Phase 19 Plan 08: Contacts-first resolution and the CRM staging tool Summary"
Cohesion: 0.14
...
### Community 758 - "Phase 20 Plan 20: Finance Fingerprint Reconciliation Summary"
Cohesion: 0.14
...
### Community 759 - "Phase 21 Plan 01: Contracts and Schema Foundation Summary"
Cohesion: 0.14
...
### Community 760 - "Phase 22.1 Plan 04: Tenant Data Export Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 761 - "Phase 25 Plan 03: Isolation Gate Summary"
Cohesion: 0.14
...
### Community 762 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 763 - "26-10-PLAN.md"
Cohesion: 0.14
...
### Community 764 - "Roadmap: Pikar-AI"
Cohesion: 0.14
...
### Community 767 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 768 - "Playbook: Connected dashboard pages"
Cohesion: 0.15
...
### Community 773 - "Goal Achievement"
Cohesion: 0.15
...
### Community 774 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 775 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 778 - "Goal Achievement"
Cohesion: 0.15
...
### Community 779 - "Goal Achievement"
Cohesion: 0.15
...
### Community 780 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 782 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 784 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 785 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 787 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.15
...
### Community 788 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 789 - "Phase 19.1 Plan 01: The Pure CSV Import Brain Summary"
Cohesion: 0.15
...
### Community 790 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 793 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 794 - "Phase 23 Plan 05: Owner/Eval Agent Activation Summary"
Cohesion: 0.15
...
### Community 795 - "Phase 25 Plan 02: Beta Admission UI Summary"
Cohesion: 0.15
...
### Community 797 - "Phase 25 Plan 04: First-Send Projection Summary"
Cohesion: 0.15
...
### Community 798 - "Phase 25: Private Beta Productionization - Research"
Cohesion: 0.15
...
### Community 799 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 801 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 802 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 803 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 804 - "Phase 33 Plan 06: Reel-first canvas Summary"
Cohesion: 0.15
...
### Community 805 - "Phase 33 Plan 07: Guided intake and variations on the canvas Summary"
Cohesion: 0.15
...
### Community 806 - "approvalsView.test.ts"
Cohesion: 0.18
...
### Community 815 - "External Integrations"
Cohesion: 0.17
...
### Community 817 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 818 - "The Goal Engine (Chief-of-Staff loop) — design capture"
Cohesion: 0.17
...
### Community 819 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 820 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 821 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 822 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 823 - "Goal Achievement"
Cohesion: 0.17
...
### Community 824 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 825 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 826 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 827 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 829 - "17.1-10 live-gate audit"
Cohesion: 0.17
...
### Community 830 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 831 - "Phase 19 Plan 02: The person store Summary"
Cohesion: 0.17
...
### Community 832 - "Phase 19 Plan 04: The public unsubscribe route Summary"
Cohesion: 0.17
...
### Community 833 - "Phase 19 Plan 05: The trust boundary Summary"
Cohesion: 0.17
...
### Community 837 - "Phase 19 Plan 06: crm_write, the fifth action type Summary"
Cohesion: 0.17
...
### Community 839 - "Phase 19 Plan 07: The connected Pipeline route Summary"
Cohesion: 0.17
...
### Community 840 - "Phase 19: Contacts, CRM & Follow-ups — Verification Report"
Cohesion: 0.17
...
### Community 842 - "cockpitAccess.test.ts"
Cohesion: 0.50
...
### Community 852 - "planTenantActivation"
Cohesion: 0.17
...
### Community 860 - "ADR-002: Insert-only audit log with redaction-safe payloads; WORM immutability lives outside Convex"
Cohesion: 0.18
...
### Community 864 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 865 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)

### Community 866 - "calendarComplete.ts"
Cohesion: 0.20
...
### Community 874 - "Repository Structure"
Cohesion: 0.18
...
### Community 875 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 876 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 878 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 879 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 882 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 884 - "Goal Achievement"
Cohesion: 0.18
...
### Community 890 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 891 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 892 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 893 - "Goal Achievement"
Cohesion: 0.18
...
### Community 894 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 897 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 898 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 900 - "Phase 19.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 901 - "Phase 19 — Validation Strategy"
Cohesion: 0.18
...
### Community 902 - "Phase 20.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 914 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 915 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 916 - "Phase 21 — Validation Strategy"
Cohesion: 0.18
...
### Community 917 - "23-01 SUMMARY — the agent-authoring data vocabulary, and nothing else"
Cohesion: 0.18
...
### Community 918 - "Phase 23 — Validation Strategy"
Cohesion: 0.18
...
### Community 919 - "Phase 24 — Validation Strategy"
Cohesion: 0.18
...
### Community 920 - "26-10 — Connected Finance route: executed browser gate, owner UAT, closure"
Cohesion: 0.18
...
### Community 921 - "26-13 — the connected Content library, approved and live"
Cohesion: 0.18
...
### Community 922 - "Implementation Decisions"
Cohesion: 0.18
Nodes (10): Candidate and exposure gate, Claude's Discretion, Deferred Ideas, Implementation Decisions, Native adaptation, Outcome measurement, Phase 27: Curated Knowledge-Work Pack Pilot - Context, Phase Boundary (+2 more)
...
### Community 924 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 925 - "Phases 14–25 — gap ledger (re-derived 2026-08-17)"
Cohesion: 0.18
...
### Community 926 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 927 - "Code Conventions"
Cohesion: 0.20
...
### Community 929 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 930 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 931 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 932 - "Goal Achievement"
Cohesion: 0.20
...
### Community 936 - "Goal Achievement"
Cohesion: 0.20
...
### Community 939 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 941 - "Goal Achievement"
Cohesion: 0.20
...
### Community 942 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 943 - "Goal Achievement"
Cohesion: 0.20
...
### Community 947 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 950 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 951 - "Goal Achievement"
Cohesion: 0.20
...
### Community 952 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 954 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 956 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 958 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 959 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 960 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 963 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 964 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 966 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 968 - "Phase 19.1 Plan 07: The Browser Proof Summary"
Cohesion: 0.20
...
### Community 969 - "Deferred items — Phase 19"
Cohesion: 0.20
...
### Community 974 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 975 - "Phase 25 Plan 01: Beta Admission Trust Boundary Summary"
Cohesion: 0.20
...
### Community 976 - "Phase 25 — the owner gates"
Cohesion: 0.20
...
### Community 979 - "26-14 — truthful report metrics, and the audit that found the plan's own first draft lying"
Cohesion: 0.20
...
### Community 980 - "Validation Architecture"
Cohesion: 0.20
...
### Community 981 - "Phase 31: Marketing Surface and Funnel v0 — Validation Strategy"
Cohesion: 0.20
...
### Community 982 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 983 - "AwaitingCardBody"
Cohesion: 0.39
...
### Community 984 - "Invariants — what must never break"
Cohesion: 0.22
...
### Community 985 - "2026-07-26-voice-doc-picker-design.md"
Cohesion: 0.22
...
### Community 986 - "finance.test.ts"
Cohesion: 0.22
Nodes (4): aggregateModules, modules, rateLimiterModules, T

### Community 987 - "Technology Stack"
Cohesion: 0.22
...
### Community 988 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 989 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 990 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 991 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 992 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 993 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 994 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 995 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 997 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 998 - "Locked Decisions"
Cohesion: 0.22
...
### Community 1000 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 1002 - "Common Pitfalls"
Cohesion: 0.22
...
### Community 1003 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 1004 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 1005 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 1006 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 1008 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 1009 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1011 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 1012 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 1013 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 1014 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 1015 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 1016 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 1020 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 1021 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1022 - "Phase 17 — Gap-Closure Validation Strategy"
Cohesion: 0.22
...
### Community 1023 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 1025 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 1026 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 1032 - "21-07 COMPLETE — the frozen candidate carries a passing held-out gate"
Cohesion: 0.22
...
### Community 1033 - "Phase 21: User-Authored Skills & Routines Verification Report"
Cohesion: 0.22
...
### Community 1034 - "Phase 22.1 Plan 05: Tenant Deletion Summary"
Cohesion: 0.22
...
### Community 1035 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 1036 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 1037 - "Deferred items — phase 25.1"
Cohesion: 0.22
...
### Community 1038 - "1. The invite gate — `callbacks.createOrUpdateUser` (BETA-01) — **HIGH confidence, source-verified**"
Cohesion: 0.22
...
### Community 1039 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1040 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1041 - "Plan 26-20: Command Center v2, owner-approved"
Cohesion: 0.22
...
### Community 1042 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 1044 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 1045 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 1046 - "Plan 33-05: Auto-assembled reel — vault save + regenerate ordering"
Cohesion: 0.22
...
### Community 1048 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 1049 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 1050 - "tenantExport.test.ts"
Cohesion: 0.29
Nodes (6): exportTenantData, modules, seedOverBudgetEarlyTable(), seedTwoTenants(), TenantDataExport, TenantExportCursor

### Community 1051 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 1052 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1053 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 1056 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1057 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1058 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 1059 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 1060 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 1062 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 1063 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1064 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1065 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1066 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1067 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 1068 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1069 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 1070 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 1071 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 1072 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1073 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 1075 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 1076 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1077 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1078 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 1079 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 1080 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1081 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1082 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 1083 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 1084 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 1085 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1086 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 1087 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 1088 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 1089 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1090 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 1091 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.25
...
### Community 1092 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1095 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1098 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1099 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1100 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1101 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 1102 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 1104 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 1107 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 1108 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 1109 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 1110 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 1111 - "Phase 22.1 Plan 03: CI Gate Summary"
Cohesion: 0.25
...
### Community 1118 - "Phase 22.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1119 - "Phase 22.1 — Goal Verification"
Cohesion: 0.25
...
### Community 1120 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 1121 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 1122 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 1125 - "Phase 23 prerequisite gate — run 2026-08-18, before the first edit"
Cohesion: 0.25
...
### Community 1126 - "23-02 SUMMARY — the inert writer, built before anything can reach it"
Cohesion: 0.25
...
### Community 1127 - "25.1-07 — Live UAT checkpoint"
Cohesion: 0.25
...
### Community 1128 - "Phase 25.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1129 - "Phase 25 — Validation Strategy"
Cohesion: 0.25
...
### Community 1130 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 1131 - "26-11 — artifact provenance and the explicit trust promotion"
Cohesion: 0.25
...
### Community 1132 - "26-12 — the Content shelf: one bounded read plane over artifacts that already exist"
Cohesion: 0.25
...
### Community 1133 - "26-13.1 — the image lane, and the comment that hid it"
Cohesion: 0.25
...
### Community 1162 - "26-16 — the board pack: one transaction is the snapshot, and promotion is not a new authorship"
Cohesion: 0.25
...
### Community 1163 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 1164 - "Phase 33: Media Creation UX Overhaul - Research"
Cohesion: 0.25
...
### Community 1165 - "Phase 33 — Validation Strategy"
Cohesion: 0.25
...
### Community 1166 - "DriveBrowser.tsx"
Cohesion: 0.29
Nodes (6): Crumb, DriveBrowser(), Entry, Node, Note, WHY

### Community 1167 - "isFallbackEligible"
Cohesion: 0.02
Nodes (134): finish, latestTurn, record, refuse, StepView, { auth, signIn, signOut, store, isAuthenticated }, google, microsoft (+126 more)

### Community 1168 - "17.1-09-SUMMARY.md"
Cohesion: 0.29
Nodes (3): Dependency graph, Metrics, Tech tracking

### Community 1169 - "business-evaluation-no-grounded-findings.md"
Cohesion: 0.29
Nodes (6): Consequence, now discharged, Eliminated during investigation, Fix, Root cause, Verification, Why it escaped

### Community 1170 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 1171 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 1172 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1173 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 1174 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 1176 - "Validation Architecture"
Cohesion: 0.29
...
### Community 1177 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1178 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1179 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 1180 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1182 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 1185 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1186 - "Phase 16: Research Sub-Agent & Web Research Verification Report"
Cohesion: 0.29
...
### Community 1187 - "ADR-011: Media generation goes to fal.ai on Wan 2.5 — a per-second USD price is the binding criterion, not model prestige"
Cohesion: 0.33
...
### Community 1188 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 1190 - "Deviations from Plan"
Cohesion: 0.29
...
### Community 1191 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 1195 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 1196 - "Phase 21 — live session 2026-08-18: what was executed, and what CANNOT be"
Cohesion: 0.29
...
### Community 1197 - "25-01 — security audit of the BETA-01 admission boundary"
Cohesion: 0.29
...
### Community 1198 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 1200 - "26-13 Task 2 — Content artifact UAT (BLOCKING, open)"
Cohesion: 0.29
...
### Community 1201 - "Plan 26-19: the deterministic Command Center backend"
Cohesion: 0.29
...
### Community 1202 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 1204 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 1205 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 1206 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 1207 - "calendar-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1208 - "first-login-second-attempt-auth-redirect.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1209 - "gmail-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1210 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1211 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1212 - "phase21-local-google-login-failure.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1213 - "production-frontend-rollback-after-media-release.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1214 - "convex-local-backend-preparing-functions.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1215 - "production-client-provided-address-not-absolute-url.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1216 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 1217 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 1218 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 1219 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 1220 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1221 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 1224 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 1225 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 1226 - "Phase 14: Flagship Voice-Doc Workflow Verification Report"
Cohesion: 0.33
...
### Community 1231 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1232 - "deletableTables"
Cohesion: 0.50
Nodes (3): deletableTables(), schemaSource, schemaTables

### Community 1233 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 1234 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1240 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.33
...
### Community 1241 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 1242 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 1243 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 1244 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 1245 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1246 - "21-08 — the free half of the live gate: executed, except the half that cannot be"
Cohesion: 0.33
...
### Community 1247 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 1251 - "Phases 14–25 milestone audit — 2026-08-20"
Cohesion: 0.33
...
### Community 1254 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1255 - "Scheduled Send"
Cohesion: 0.40
...
### Community 1258 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 1259 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 1262 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 1263 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 1274 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 1277 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 1286 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1287 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 1288 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 1289 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 1290 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 1291 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 1294 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 1295 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 1296 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 1298 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 1299 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
Cohesion: 0.21
Nodes (10): exportTenantData, ClassifiedTenantTable, DeletableTenantTable, exportableTables, summarizeTenantCredential(), TenantCredentialSummary, TenantDataExportPage, TenantExportHeader (+2 more)
...
### Community 1308 - "Production Secret Inventory (research Q5)"
Cohesion: 0.40
...
### Community 1328 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 1333 - "User Constraints"
Cohesion: 0.50
...
### Community 1343 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 1344 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1346 - "15.1-05-PLAN.md"
Cohesion: 0.50
...
### Community 1348 - "User Constraints"
Cohesion: 0.50
...
### Community 1352 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1354 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1355 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1357 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1358 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1362 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1364 - "Three OPEN Items"
Cohesion: 0.50
...
### Community 1365 - "The Existing Substrate — as it actually is today"
Cohesion: 0.50
...
### Community 1368 - "Re-Verification Summary"
Cohesion: 0.50
...
### Community 1369 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1371 - "User Constraints (from 19-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1373 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1374 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1375 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1377 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1382 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1386 - "Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07"
Cohesion: 0.50
...
### Community 1388 - "withheldNote"
Cohesion: 0.67
Nodes (3): InFlightRow(), PlanCards(), withheldNote()

### Community 1389 - "HealthCard"
Cohesion: 0.67
Nodes (3): ConstraintCard(), HealthCard(), healthOf()

### Community 1390 - "4. Precedence — typing wins (D5)"
Cohesion: 0.67
...
### Community 1403 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
### Community 1406 - "Code Examples"
Cohesion: 0.67
Nodes (3): Code Examples, Confidence from code, not prose, Provider endpoint containment

## Knowledge Gaps
- **12490 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+12485 more)
...
- **Why does `api` connect `Phase 15.2 — universal format recognition` to `functions.ts`, `page.tsx`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `guardrails.ts`, `layout.tsx`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `guardrails.test.ts`, `Dropzone.tsx`, `log`, `buildTelemetry.ts`, `formatAbsolute`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `guardrails.test.ts`, `vaultLlm.ts`, `index.ts`, `Key files`, `classify.ts`, `index.ts`, `gapAction.test.ts`, `classify.ts`, `Phase Details - Milestone v2.0`, `intake.test.ts`, `skill-authoring.spec.ts`, `briefings.ts`, `metering.ts`, `DriveBrowser.tsx`, `isFallbackEligible`, `skills.test.ts`, `evaluations.test.ts`, `feedback.ts`, `Phase 15 — Sub-agent dispatch + generalized executor`, `extractKind.ts`, `skills.test.ts`, `feedback.test.ts`, `assembly.ts`, `index.ts`, `SkillAuthoringPanel.tsx`, `isolation.test.ts`, `officeText.test.ts`, `crmCard.test.ts`, `vaultDigest.ts`, `savedPrompts.test.ts`, `proposals.test.ts`, `vaultTranscribe.test.ts`, `scripts`, `contacts.test.ts`, `createdDocs.test.ts`, `assembly.ts`, `DriveBrowser.tsx`, `vaultTranscribe.test.ts`, `replyDrafter.ts`, `content.test.ts`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `page.tsx`, `vaultGround.test.ts`, `approvalsView.test.ts`, `cockpitAccess.test.ts`, `AdminView.tsx`, `Phase 17 — Calendar actions`, `opsSignals.test.ts`, `pipeline-uat.spec.ts`, `skills.test.ts`, `How to verify`, `media.ts`, `CommandCenter.tsx`, `ReportsView.tsx`, `page.tsx`, `Phase 23 Research: Agent-Authored Skills`, `home.ts`, `blueprint.test.ts`, `reportPack.test.ts`, `FinanceTabs.tsx`, `selfCheck`, `reportsBusiness.test.ts`, `finance.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `internal` connect `formatAbsolute` to `Phase 3.11: Inbox Reply - Research`, `package.json`, `page.tsx`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `Project State`, `scan.ts`, `guardrails.ts`, `Phase 03.7 — Validation Strategy`, `page.tsx`, `isFallbackEligible`, `buildAgentContext`, `layout.tsx`, `skills.test.ts`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `reportPack.test.ts`, `routing.ts`, `Dropzone.tsx`, `classify.ts`, `evaluations.test.ts`, `replyDrafter.ts`, `Validation Architecture`, `FinanceTabs.tsx`, `feedback.ts`, `log`, `routing.ts`, `Phase 17 — Calendar actions`, `optimizerBreach.ts`, `Proactive weekly review (BEVL-03, 13-02)`, `vaultSealing.test.ts`, `session.ts`, `worm.ts`, `Phase 15 — Sub-agent dispatch + generalized executor`, `vaultDrive.ts`, `extractKind.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `VaultBrowseControls.tsx`, `skills.test.ts`, `guardrails.test.ts`, `server.d.ts`, `selfCheck`, `vaultSweep.test.ts`, `assembly.ts`, `skills.test.ts`, `layout.tsx`, `How to verify`, `vaultLlm.ts`, `Phase 15.2 — universal format recognition`, `crmCard.test.ts`, `vaultDigest.ts`, `media.ts`, `approvalsView.test.ts`, `classify.ts`, `Phase 23 Research: Agent-Authored Skills`, `vaultTranscribe.test.ts`, `calendarComplete.ts`, `scripts`, `gmail.test.ts`, `agentSteps.test.ts`, `contacts.test.ts`, `classify.ts`, `page.tsx`, `goals.test.ts`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `assembly.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `text()` connect `intake.test.ts` to `index.ts`, `attemptCase`, `contacts.test.ts`, `gapAction.test.ts`, `classify.ts`, `opsSignals.test.ts`, `VaultBrowseControls.tsx`, `provUsage`, `proposals.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _12522 weakly-connected nodes found - possible documentation gaps or missing edges._
