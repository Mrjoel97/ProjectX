...
## Corpus Check
- 1490 files · ~2,546,711 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13541 nodes · 15350 edges · 1365 communities (1272 shown, 93 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6782dbea`
...
4. `base()` - 29 edges
5. `internalQuery` - 27 edges
6. `contentHash()` - 26 edges
7. `tenantQuery` - 25 edges
8. `buildCockpitTools()` - 24 edges
...
- `ShapePanel()` --calls--> `missingSlots()`  [EXTRACTED]
  apps/web/app/(app)/dashboard/profile/ShapePanel.tsx → packages/core/src/businessProfile.ts

## Import Cycles
- None detected.

## Communities (1365 total, 93 thin omitted)
...
Cohesion: 0.05
Nodes (42): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents, mediaRemainingCentsInner() (+34 more)
...
Cohesion: 0.07
Nodes (35): reserveProviderLinesInner(), Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions(), maybeStartCaptions() (+27 more)
...
Cohesion: 0.06
Nodes (30): RFC-2045, RFC-2047, RFC-2822, ActionCtx, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies (+22 more)
...
Cohesion: 0.06
Nodes (38): notifyIfAgentTimeout(), ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo() (+30 more)
...
Cohesion: 0.08
Nodes (34): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, readLayout(), VaultDoc (+26 more)
...
Cohesion: 0.04
Nodes (60): admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots(), profileSchema (+52 more)
...
Cohesion: 0.05
Nodes (44): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult, candidatesSchema, confirmBlueprint (+36 more)
...
Cohesion: 0.04
Nodes (59): deliverApprovedPlan, markPlanDone, vaultIngestPool, workflow, BlockReason, LABELS, pipelineWorkflow, REQUEST_STATUS (+51 more)
...
Cohesion: 0.13
Nodes (21): compareDashboardOrder(), CompleteDashboardBound, createDashboardMoney(), DASHBOARD_STATE_COPY, DashboardBound, dashboardCursorFor(), DashboardMoney, DashboardMoneyPhase (+13 more)
...
Cohesion: 0.08
Nodes (36): docLabel(), COPY, failureCopy, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED (+28 more)
...
Cohesion: 0.06
Nodes (32): aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules, RENDER_SIDECAR (+24 more)
...
Cohesion: 0.05
Nodes (42): { auth, signIn, signOut, store, isAuthenticated }, password, persistNextStepMemo(), httpAction, ASSET_PATH, FAL_ASSET_HOSTS, http, INLINE_ASSET (+34 more)
...
Cohesion: 0.10
Nodes (17): answerDecision, blockedSummary, listAwaiting, listCleared, listDecisions, listInFlight, listScheduled, numericField (+9 more)
...
Cohesion: 0.14
Nodes (14): Dependencies & blast radius, How to change this safely, Invariants — what must never break, Playbook: Media Canvas (finished reels and standalone images), Playbook ownership for Phase 20, Rate observation (dated, vendor-direct), Reconciliation, Standalone image path (ADR-014) (+6 more)
...
Cohesion: 0.06
Nodes (34): CategoryTabs(), discussPillStyle(), DocGrid(), folderChip(), pillAnchor(), pillShape, statusBadge(), StatusChip() (+26 more)
...
Cohesion: 0.04
Nodes (58): finish, latestTurn, record, StepView, byThread, insert, ADR-0004, deadLetterRecipient (+50 more)

### Community 216 - "vault-redesign.spec.ts"
Cohesion: 0.07
Nodes (48): seedMediaPlan(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal (+40 more)

### Community 217 - "Phase 10: Vault→Agent Grounding - Research"
Cohesion: 0.29
...
### Community 218 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.07
Nodes (39): batchToRender, burnCaptions, captionsToBurn, markRendering, recordCaptionBurn, recordRender, RenderInputs, renderReel (+31 more)

### Community 219 - "Phase 3.11: Inbox Reply - Research"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (21): Approvals — owner-APPROVED (Plan 26-05, Task 2 closed 2026-08-08), Approvals read contract, Approvals type scale — inline styles must quote the mockup, not invent, Backend page adapters, Connected page gates, Data flow, Dependencies & blast radius, Focused backend gates (+13 more)
...
### Community 232 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 238 - "Implementation Decisions"
Cohesion: 0.19
...
### Community 241 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 243 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 245 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
Cohesion: 0.03
Nodes (42): DisconnectGoogle(), modules, T, aggregateModules, modules, modules, T, modules (+34 more)
...
### Community 249 - "VaultBrowseControls.tsx"
Cohesion: 0.09
...
### Community 250 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 251 - "Architecture Research"
Cohesion: 0.09
...
### Community 254 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 255 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 256 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 258 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 259 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 261 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 262 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 264 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 265 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 266 - "metering.ts"
Cohesion: 0.60
Nodes (3): accumulateUsage(), UsageDelta, ZERO_USAGE

### Community 267 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 275 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 276 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 278 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 279 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 280 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 281 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 282 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 283 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 284 - "27-05-PLAN.md"
Cohesion: 0.08
Nodes (38): buildTrajectoryExport, scrub(), transcribeDoc, Result, CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL (+30 more)

### Community 285 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 287 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 289 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)
...
### Community 297 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 299 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 300 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 301 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 302 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 303 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 304 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 305 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 306 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 307 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 308 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 309 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 310 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 311 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 312 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 313 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (27): AttachmentPicker(), UploadedAttachment, STATUS_COLOR, box, btn, Mode, REJECTION_COPY, Auth (+19 more)

### Community 315 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 317 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 318 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 319 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 320 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 321 - "dashboardSchema.test.ts"
Cohesion: 0.11
Nodes (10): modules, SCHEMA, DataModel, Doc, Id, TableNames, Brand, CONTRACTS_PACKAGE_NAME (+2 more)
...
### Community 323 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 324 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 325 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 326 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 327 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 328 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 329 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 330 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 333 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 334 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 335 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 336 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 337 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 338 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 339 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 340 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 341 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 342 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 343 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 344 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 346 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 348 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 349 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 351 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 352 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 354 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 355 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 356 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 357 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 358 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 359 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 360 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)
...
### Community 362 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)

### Community 363 - "compilerOptions"
Cohesion: 0.12
...
### Community 364 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 365 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 366 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 367 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 368 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 369 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 370 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 371 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 372 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 373 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 374 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 375 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 376 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 377 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 378 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 379 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 380 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 382 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 383 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 384 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 385 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 387 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 388 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 389 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 390 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 391 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 392 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 393 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 394 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 395 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 396 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 398 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 399 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 400 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 401 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 402 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 403 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 405 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 406 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 407 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 408 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 409 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 410 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 411 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 412 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 413 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 414 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 415 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 416 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 417 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 418 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 419 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 421 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 422 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 424 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 425 - "Feature Research"
Cohesion: 0.12
...
### Community 426 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 429 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 430 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 431 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 432 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 433 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 434 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 435 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 437 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 438 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 440 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 441 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 442 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 443 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 446 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 447 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 448 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 449 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 450 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 451 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 452 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 453 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 454 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 455 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 456 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 458 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 459 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 460 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 461 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 462 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 467 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 468 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 469 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 471 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 472 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 473 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 475 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 477 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 478 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 480 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 481 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 488 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 490 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 491 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 493 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 494 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 495 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 508 - "Goal Achievement"
Cohesion: 0.15
...
### Community 509 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 510 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 512 - "Goal Achievement"
Cohesion: 0.15
...
### Community 513 - "Goal Achievement"
Cohesion: 0.15
...
### Community 514 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 516 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 518 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 519 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 521 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 524 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 525 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 526 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 527 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 528 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 529 - "Phase 16 — the async research dispatch seam (16-06, DISP-02)"
Cohesion: 0.17
...
### Community 530 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 531 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)
...
### Community 543 - "External Integrations"
Cohesion: 0.17
...
### Community 546 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 547 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 548 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 549 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 550 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 553 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 555 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 556 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 557 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 567 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 568 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 572 - "Repository Structure"
Cohesion: 0.18
...
### Community 573 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 574 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 576 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 577 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 578 - "Goal Achievement"
Cohesion: 0.18
...
### Community 580 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 581 - "Goal Achievement"
Cohesion: 0.18
...
### Community 584 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 585 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 586 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 588 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 591 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 592 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 609 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 610 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 611 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 612 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 613 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 615 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 617 - "proactiveReview.test.ts"
Cohesion: 0.20
Nodes (4): aggregateModules, code, modules, sources

### Community 618 - "logger.ts"
Cohesion: 0.16
...
### Community 620 - "logger.ts"
Cohesion: 0.24
Nodes (5): msg(), createLogger(), LogFields, Logger, LogLevel

### Community 621 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 623 - "Code Conventions"
Cohesion: 0.20
...
### Community 624 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 638 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 639 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (3): enqueuedExtractions, migrationsModules, modules
...
### Community 645 - "Goal Achievement"
Cohesion: 0.20
...
### Community 650 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 655 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 658 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 665 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 667 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 670 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 671 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 672 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 675 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 676 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 679 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 683 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 684 - "Validation Architecture"
Cohesion: 0.20
...
### Community 687 - "Technology Stack"
Cohesion: 0.22
...
### Community 688 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 689 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 690 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 691 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 695 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 696 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 697 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 698 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 699 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 700 - "Locked Decisions"
Cohesion: 0.22
...
### Community 702 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 705 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 706 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 707 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 710 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 711 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 712 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 713 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 714 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 716 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 717 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 718 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 719 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 720 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 721 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 722 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 727 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 729 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 733 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 739 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 750 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 751 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 753 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 754 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 756 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This
...
### Community 759 - "vaultGround.test.ts"
Cohesion: 0.36
Nodes (6): BLUEPRINT_TEXT, modules, seedChain(), seedConfirmedBlueprint(), seedDoc(), seedEdge()

### Community 760 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 761 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 762 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 764 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 767 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 768 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 769 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 770 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 771 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 772 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 773 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 775 - "The budget rail (20-04)"
Cohesion: 0.33
...
### Community 776 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 777 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 778 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 779 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 780 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 781 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 782 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 783 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 784 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 785 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 786 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 787 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 788 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 789 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 790 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 791 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 792 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 793 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 794 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 795 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 796 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 797 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 798 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 799 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 800 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 801 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 802 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 804 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 805 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 806 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 807 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 808 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 810 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 812 - "Phase 17 — Validation Strategy"
Cohesion: 0.25
...
### Community 816 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 817 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 818 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 819 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 820 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 821 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 822 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 823 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 824 - "The externalAction arm (20-07) — TWO occupants, one Approve gate"
Cohesion: 0.29
...
### Community 825 - "xlsText.ts"
Cohesion: 0.38
Nodes (5): rows(), SALES, workbook(), xlsBytes(), xlsText()

### Community 826 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 827 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 829 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 830 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 831 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 832 - "Validation Architecture"
Cohesion: 0.29
...
### Community 833 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 838 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 839 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 841 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 844 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 845 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 847 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 848 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 850 - "ADR-009: Tier shapes the specialist PROMPT, not the offer set"
Cohesion: 0.33
...
### Community 851 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 852 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 853 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes
...
### Community 855 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 856 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 857 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 858 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 859 - "Validation Architecture"
Cohesion: 0.33
...
### Community 860 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 862 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 864 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 865 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 873 - "Validation Architecture"
Cohesion: 0.33
...
### Community 875 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 876 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 877 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 879 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 881 - "financialSpine.ts"
Cohesion: 0.80
Nodes (3): cfa(), ltgpCac(), round2()

### Community 882 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 884 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 889 - "ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned"
Cohesion: 0.40
...
### Community 890 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.40
...
### Community 891 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 892 - "Scheduled Send"
Cohesion: 0.40
...
### Community 894 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 895 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 896 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 900 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 901 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 923 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 924 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 925 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 927 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 928 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 931 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 932 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 933 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 940 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 941 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include
...
### Community 946 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 947 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 952 - "User Constraints"
Cohesion: 0.50
...
### Community 955 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
...
### Community 963 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 973 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 974 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 984 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 985 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 986 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 988 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 991 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1004 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
## Knowledge Gaps
- **9101 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9096 more)
...
- **Why does `internal` connect `intake.test.ts` to `package.json`, `Goal Achievement`, `v1 Requirements`, `vaultFolders.test.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Project State`, `scan.ts`, `layout.tsx`, `index.ts`, `buildCockpitTools`, `constants.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Validation Architecture`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `actionType.ts`, `27-05-PLAN.md`, `feedback.ts`, `log`, `Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary`, `calendar.test.ts`, `llm.ts`, `Project State`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `vaultGround.test.ts`, `vaultSmoke.ts`, `notificationMessage`, `layout.tsx`, `searchVaultSpine.test.ts`, `index.ts`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `009-tier-shapes-the-specialist-prompt-not-the-offer-set.md`, `vault-redesign.spec.ts`, `ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits`, `Dropzone.tsx`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `Project State`, `proactiveReview.test.ts`, `logger.ts`, `http.ts`, `Implementation Decisions`, `vaultSealing.test.ts`, `createdDocs.test.ts`, `vaultGround.test.ts`, `runCockpitAgent.test.ts`, `worm.test.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `api` connect `validateSubmit.ts` to `package.json`, `page.tsx`, `Goal Achievement`, `vaultFolders.test.ts`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `LiveSession.tsx`, `layout.tsx`, `index.ts`, `cockpit-resolve.spec.ts`, `evaluations.test.ts`, `classify.ts`, `vaultLlm.ts`, `buildCockpitTools`, `actionType.ts`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `feedback.test.ts`, `Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary`, `calendar.test.ts`, `opsSignals.test.ts`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `vaultSmoke.ts`, `page.tsx`, `Phase 3.10: Cockpit Conversation Repair - Research`, `Project State`, `index.ts`, `index.ts`, `opsSignals.test.ts`, `COCKPIT_AGENT_SKILL`, `MediaCanvas.tsx`, `Dropzone.tsx`, `proactiveReview.ts`, `voiceDoc.test.ts`, `vaultExtract.ts`, `guardrails.test.ts`, `proactiveReview.test.ts`, `createdDocs.test.ts`, `http.ts`, `vaultGround.test.ts`, `vaultSealing.test.ts`, `Phase 18 Plan 06: The createDocument Tool Summary`, `createdDocs.test.ts`, `intake.test.ts`, `guardrails.ts`, `runCockpitAgent.test.ts`, `worm.test.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `internalMutation` connect `009-tier-shapes-the-specialist-prompt-not-the-offer-set.md` to `package.json`, `v1 Requirements`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `scan.ts`, `skills.test.ts`, `buildCockpitTools`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Validation Architecture`, `actionType.ts`, `tenant.ts`, `vaultSmoke.ts`, `notificationMessage`, `layout.tsx`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits`, `intake.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9133 weakly-connected nodes found - possible documentation gaps or missing edges._
