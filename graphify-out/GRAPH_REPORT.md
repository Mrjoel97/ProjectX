...
## Corpus Check
- 1526 files · ~2,687,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14069 nodes · 16216 edges · 1400 communities (1310 shown, 90 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac28d4ae`
...
## Communities (1400 total, 90 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.16
Nodes (18): ConnectionsPanel(), pill, row, NarrativePanel(), isTabId(), page, ProfilePage(), TabId (+10 more)

### Community 1 - "package.json"
Cohesion: 0.03
Nodes (43): DisconnectGoogle(), modules, T, firstPage, modules, PlanStatus, aggregateModules, modules (+35 more)
...
Cohesion: 0.04
Nodes (56): tenantAction, rows(), EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround (+48 more)
...
Cohesion: 0.03
Nodes (67): workflow, BlockReason, LABELS, llmSpendCorrelation(), pipelineWorkflow, REQUEST_STATUS, saveDraft, setStatus (+59 more)
...
Cohesion: 0.11
Nodes (22): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), BlueprintPanel(), BlueprintReport(), EMPTY_BLUEPRINT, formatConfirmedAt() (+14 more)
...
Cohesion: 0.04
Nodes (49): RFC-2045, RFC-2047, RFC-2822, ActionCtx, internalAction, base64Url(), buildMime(), FetchBodiesResult (+41 more)

### Community 11 - "scan.ts"
Cohesion: 0.04
Nodes (63): admits(), commitProfile, converse, ConverseResult, extractProfile, getProfile, mergeSlots(), profileSchema (+55 more)
...
Cohesion: 0.07
Nodes (46): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+38 more)
...
Cohesion: 0.05
Nodes (57): CategoryTabs(), Tab, VAULT_TABS, discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip() (+49 more)
...
Cohesion: 0.05
Nodes (51): numeric, notifyIfAgentTimeout(), ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer() (+43 more)
...
Cohesion: 0.05
Nodes (30): AttachmentPicker(), UploadedAttachment, Crumb, Entry, Node, Note, WHY, STATUS_COLOR (+22 more)
...
Cohesion: 0.11
Nodes (29): AssemblyBlock, AssemblyReport, CLIP_SET, isGovernedRender(), near(), num(), parseAssemblySidecar(), codeOf() (+21 more)
...
Cohesion: 0.12
Nodes (22): BLUEPRINT_FIELDS, BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField() (+14 more)
...
Cohesion: 0.12
Nodes (18): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, resolveSpecialist(), SPECIALIST_TOOLS, specialistMemoBody() (+10 more)
...
Cohesion: 0.07
Nodes (29): cancelScheduledPlan, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, isNonAgentThreadIdError() (+21 more)
...
Cohesion: 0.05
Nodes (40): activateCandidate, activateSkill, activateSkillVersion(), archiveSkill, candidatesForReview, getActiveSkill, getSkillVersion, insertCandidate (+32 more)
...
Cohesion: 0.08
Nodes (30): ActivitySection(), caps, cardTitle, ConnectedHeadline(), ConnectedSolvency(), ConnectedUnitEconomics(), fallbackTier(), FigureTile() (+22 more)
...
Cohesion: 0.07
Nodes (15): retrier, vaultIngestPool, asTenant(), enqueued, modules, newFolder(), rateLimiterModules, upload() (+7 more)
...
Cohesion: 0.07
Nodes (34): POST(), ADR-0011, SH, SH, AssemblyError, bearerMatches(), buildSandboxOptions(), burnCaptions() (+26 more)
...
Cohesion: 0.03
Nodes (84): finish, latestTurn, record, StepView, { auth, signIn, signOut, store, isAuthenticated }, password, byThread, insert (+76 more)
...
Cohesion: 0.11
Nodes (17): auditCounts, backfillAuditCounts, countAudit, log, components, buildGeminiEmbedRequest(), buildOpenAIEmbedRequest(), embeddingContentHash() (+9 more)

### Community 170 - "ApprovalsErrorBoundary"
Cohesion: 0.19
Nodes (10): NumbersPanel(), CASH_INPUTS, cashInputsForTier(), here, NOW, sol(), state(), SURFACES (+2 more)
...
Cohesion: 0.07
Nodes (44): buildTrajectoryExport, scrub(), extractDoc, Extracted, extractHosted(), ExtractPath, extractPdf(), fanOutPages() (+36 more)
...
Cohesion: 0.12
Nodes (23): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+15 more)
...
Cohesion: 0.09
Nodes (10): modules, SCHEMA, aggregateModules, modules, rateLimiterModules, T, DataModel, Doc (+2 more)
...
Cohesion: 0.13
Nodes (28): activityFromSends(), CashFigure, CashInputs, CashInputSpec, CashMetricKey, CashMetricSet, CashOrigin, CashSolvency (+20 more)
...
### Community 304 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 309 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 310 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 311 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 312 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 313 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 314 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 315 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 316 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 317 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.11
...
### Community 319 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 320 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 321 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 322 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 323 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 324 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 325 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 326 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 327 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 328 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 329 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 330 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
...
### Community 333 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 334 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 378 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
...
### Community 379 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 380 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 381 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 382 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 384 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 385 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 386 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 387 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 388 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 389 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 390 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 391 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 392 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 393 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 394 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 395 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 396 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 398 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 399 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 400 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 401 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 403 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 405 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 406 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 407 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 409 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 411 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 412 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 413 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 414 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 415 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 416 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 417 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 418 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 419 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 420 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 421 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 422 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)
...
### Community 424 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 425 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 426 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 427 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 429 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 430 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 431 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 432 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 433 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 434 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 435 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 437 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 438 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 440 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 441 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 442 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 443 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 444 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 446 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 447 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 448 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 449 - "Feature Research"
Cohesion: 0.12
...
### Community 450 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 452 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 453 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 454 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 455 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 456 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 457 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 458 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 459 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 460 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 461 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 462 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 466 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 467 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 468 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 469 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 470 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 471 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 472 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 473 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 474 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 475 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 476 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 477 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 478 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 480 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 481 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 482 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 483 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 485 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 486 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 487 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 488 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 490 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 491 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 492 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 493 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 494 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 495 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 496 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 497 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 498 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 508 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 509 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 516 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 517 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 518 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 519 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 520 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 521 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
Cohesion: 0.15
Nodes (14): activity, _docToField, _fieldToDoc, inputs, inputStatesFor(), saveInput, scorecardValue(), shape (+6 more)
...
### Community 529 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 530 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 533 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 543 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 546 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 547 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 549 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 550 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 553 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 555 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 556 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 557 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 558 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 559 - "Phase 16 — the async research dispatch seam (16-06, DISP-02)"
Cohesion: 0.17
...
### Community 560 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)
...
### Community 565 - "External Integrations"
Cohesion: 0.17
...
### Community 567 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 568 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 570 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 571 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 572 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 573 - "Goal Achievement"
Cohesion: 0.17
...
### Community 574 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 575 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 576 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 577 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 586 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 587 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 590 - "Repository Structure"
Cohesion: 0.18
...
### Community 591 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 592 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 604 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 606 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 609 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 610 - "Goal Achievement"
Cohesion: 0.18
...
### Community 613 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 614 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 615 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 617 - "Goal Achievement"
Cohesion: 0.18
...
### Community 618 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 623 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 624 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 643 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 644 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 645 - "Phase 20 — Validation Strategy"
Cohesion: 0.18
...
### Community 649 - "Roadmap: Pikar-AI"
Cohesion: 0.18
...
### Community 650 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 651 - "Code Conventions"
Cohesion: 0.20
...
### Community 652 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 653 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 654 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 666 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 669 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 677 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 680 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 682 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 686 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 687 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 688 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 691 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 695 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 697 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 701 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 702 - "Validation Architecture"
Cohesion: 0.20
...
### Community 706 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 707 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 708 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 709 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 710 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 711 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 712 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 713 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 714 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 715 - "Locked Decisions"
Cohesion: 0.22
...
### Community 717 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 720 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 721 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 722 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 723 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 724 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 725 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 726 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 727 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 729 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 732 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 733 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 734 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 736 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 737 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 738 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 752 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 753 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 754 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 756 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 758 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 762 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 763 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 764 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 767 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 768 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 770 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 771 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 773 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 774 - "vaultGround.test.ts"
Cohesion: 0.36
...
### Community 843 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 844 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 846 - "Validation Architecture"
Cohesion: 0.29
...
### Community 850 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 853 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 856 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 857 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 858 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 860 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 861 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 862 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 868 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 869 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 870 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 871 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 872 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 873 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 874 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 875 - "Validation Architecture"
Cohesion: 0.33
...
### Community 876 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 878 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 879 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 880 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 889 - "Validation Architecture"
Cohesion: 0.33
...
### Community 891 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (44): assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender(), CLIP_SECONDS_SET (+36 more)
...
### Community 897 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 898 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 900 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 901 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 903 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 904 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 1023 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
Cohesion: 0.11
Nodes (19): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), AskSpecialist(), DirectionBand(), fmtDuration(), fmtWhen() (+11 more)
...
## Knowledge Gaps
- **9384 isolated node(s):** `graphify-mcp`, `KIND_HREF`, `AwaitingPage`, `AwaitingItem`, `ScheduledPage` (+9379 more)
...
- **Why does `internal` connect `package.json` to `voice.test.ts`, `v1 Requirements`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `vaultGround.test.ts`, `metering.ts`, `Phase Details`, `Project State`, `scan.ts`, `tenantProfile.ts`, `Phase 03.7 — Validation Strategy`, `calendar.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `agentSteps.test.ts`, `proactiveReview.ts`, `feedback.ts`, `vaultLlm.ts`, `log`, `feedback.test.ts`, `gmailTokens (table)`, `tenant.ts`, `page.tsx`, `llm.ts`, `Pikar-AI`, `Project State`, `buildTelemetry.ts`, `feedback.test.ts`, `cockpitBlueprint.test.ts`, `searchVaultSpine.test.ts`, `blueprintPulse.ts`, `getActiveSkill`, `index.ts`, `Key files`, `COCKPIT_AGENT_SKILL`, `classify.ts`, `proactiveReview.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `http.ts`, `intake.test.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `brief.ts`, `runCockpitAgent.test.ts`, `Phase 17 — Calendar actions`, `formatAbsolute`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `api` connect `vaultLlm.ts` to `functions.ts`, `package.json`, `page.tsx`, `voice.test.ts`, `vaultGround.test.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase Details`, `metering.ts`, `calendar.ts`, `ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate`, `page.tsx`, `layout.tsx`, `index.ts`, `DriveBrowser.tsx`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `assembleScript.ts`, `financialSpine.ts`, `evaluations.test.ts`, `tenant.ts`, `26-05: Connected Approvals route, owner-verified`, `Phase 11: Persona Onboarding & Business Profile - Research`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `goals (table)`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `feedback.test.ts`, `Phase 3.10: Cockpit Conversation Repair - Research`, `getActiveSkill`, `index.ts`, `Hot Path Rules`, `COCKPIT_AGENT_SKILL`, `classify.ts`, `Dropzone.tsx`, `classify.ts`, `proactiveReview.ts`, `index.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `gapAction.test.ts`, `createdDocs.test.ts`, `http.ts`, `runCockpitAgent.test.ts`, `vaultLlm.ts`, `page.tsx`, `gapAction.test.ts`, `Phase Details - Milestone v2.0`, `brief.ts`, `page.tsx`, `tenant.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `scanText()` connect `blueprintPulse.ts` to `skills.ts`, `tenantProfile.ts`, `page.tsx`, `http.ts`, `llm.ts`, `tenant.ts`, `tokenExpiry.ts`, `guardrails.test.ts`, `agentSteps.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _9416 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `package.json` be split into smaller, more focused modules?**
  _Cohesion score 0.028994845360824743 - nodes in this community are weakly interconnected._
