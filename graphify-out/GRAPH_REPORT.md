# Graph Report - pikar-ai  (2026-08-18)

## Corpus Check
- 1912 files · ~3,683,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17870 nodes · 20870 edges · 1774 communities (1625 shown, 149 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5323c635`
...
1. `api` - 114 edges
2. `internal` - 110 edges
3. `internalMutation` - 45 edges
4. `contentHash()` - 44 edges
5. `tenantQuery` - 36 edges
...
## Communities (1774 total, 149 thin omitted)
...
Cohesion: 0.05
Nodes (40): assertSubmitRateLimited, boom, briefingCountForThread, briefingSynopsisPresent, createdDocCountForThread, drainDailySpend, driveReadCountForThread, evaluationCountForThread (+32 more)
...
Cohesion: 0.10
Nodes (31): scene(), ASSEMBLY_VISUALS, AssemblyError, AssemblyReport, AssemblyScene, AssemblyVisual, isGovernedRender(), near() (+23 more)
...
Cohesion: 0.05
Nodes (41): RFC-2045, RFC-2047, ActionCtx, base64Url(), buildMime(), DeliveryRequest, FetchBodiesResult, fetchInboxBodies (+33 more)

### Community 11 - "scan.ts"
Cohesion: 0.04
Nodes (51): numeric, answerDecision, blockedSummary, CASH_FIELD_BY_QUESTION, fieldValue(), listAwaiting, listCleared, listDecisions (+43 more)
...
Cohesion: 0.18
Nodes (15): confirmedDelete(), dangerButtonStyle, fieldStyle, PreviewActionDescriptor, previewActionDescriptors(), PreviewActionId, PreviewControlHandlers, PreviewControls() (+7 more)
...
Cohesion: 0.05
Nodes (42): manageProbeEnv(), auditControl(), MutationCtx, contentHash(), storeAndLand(), deploymentUrlHash(), aggregateModules, always() (+34 more)
...
Cohesion: 0.06
Nodes (33): modules, modules, COCKPIT_AGENT_SKILL, composeUserSkillBody(), CONTENT_DRAFTER_SKILL, DOCUMENT_DRAFTER_SKILL, EMAIL_DRAFTER_SKILL, EvalEvidence (+25 more)
...
Cohesion: 0.13
Nodes (16): Container, ExtractRail, indexOfBytes(), isPrintable(), looksTextual(), MARKUP_MIME, OLE2_PREFIX, OLE2_STREAMS (+8 more)
...
Cohesion: 0.07
Nodes (41): KIND_HREF, NotificationsBanner(), NAV, OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), UserCandidatesPanel(), PasswordField() (+33 more)

### Community 56 - "formatAbsolute"
Cohesion: 0.04
Nodes (42): AttachmentPicker(), UploadedAttachment, DisconnectGoogle(), DisconnectMicrosoft(), LINK, ConnectMicrosoftPage(), ADR-0018, ConnectionsPanel() (+34 more)
...
Cohesion: 0.07
Nodes (30): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+22 more)
...
Cohesion: 0.11
Nodes (27): DriveBrowser(), repriceUsd(), n(), VisualKind, chooseMediaBatch(), counted(), estimateBatchUsd(), estimateMediaUsd() (+19 more)
...
Cohesion: 0.15
Nodes (16): modules, sources, ADR-0022, ENV_MANIFEST, EnvSpec, EnvTier, FEATURE_ENV, isDurableOrigin() (+8 more)
...
Cohesion: 0.13
Nodes (16): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody(), SpecialistSpec (+8 more)
...
Cohesion: 0.09
Nodes (27): currentProfileDoc(), currentTierRow(), acceptProposal, AcceptResult, discardProposal, listPending, ProposalRefusal, CASH_INPUTS (+19 more)
...
Cohesion: 0.08
Nodes (21): AskSpecialist(), AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), CardList(), ErrorBoundary, BriefRow(), CanvasPane() (+13 more)
...
Cohesion: 0.07
Nodes (29): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+21 more)
...
Cohesion: 0.03
Nodes (53): FinanceApplyRefusal, cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs (+45 more)

### Community 106 - "classify.ts"
Cohesion: 0.07
Nodes (20): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+12 more)
...
Cohesion: 0.04
Nodes (64): admits(), commitProfile, converse, ConverseResult, extractProfile, firstSendOffer, getProfile, mergeSlots() (+56 more)
...
Cohesion: 0.06
Nodes (36): briefingSheet, capsTeal, snippetSheet, traceText, typeBadge, VaultDocButton(), ArtDirection, Block (+28 more)
...
Cohesion: 0.06
Nodes (26): activateCandidate, activateSkill, activateTenantCandidate, ActivationPlan, ActivationResult, ActivationTarget, archiveSkill, candidatesForReview (+18 more)
...
Cohesion: 0.07
Nodes (37): POST(), SH, SH, bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, convexSiteOrigin() (+29 more)

### Community 127 - "intake.test.ts"
Cohesion: 0.04
Nodes (45): SubmittableSpec, aggregateModules, ASSET, BRIEF, deck(), JOB_41(), land(), mediaCode (+37 more)
...
Cohesion: 0.03
Nodes (70): MON_09_00_UTC, MON_10_30_UTC, MON_23_00_UTC, TUE_01_00_UTC, Activity, attRow, badge(), box (+62 more)
...
Cohesion: 0.04
Nodes (72): BusyRange, createEvent, CreateEventResult, EVENT_URL(), freeBusy, FreeBusyResult, googleDelete(), GoogleError (+64 more)
...
Cohesion: 0.03
Nodes (55): httpAction, aggregateModules, modules, T, ADR-0018, RFC-2822, ASSET_PATH, esc() (+47 more)
...
Cohesion: 0.14
Nodes (25): docForMint, hangupCall, mintClientSecret, MintResponse, ADR-0006, DOCUMENT_ANALYST_SKILL, SEARCH_DOCUMENT_TOOL, accumulateUsage() (+17 more)
...
Cohesion: 0.09
Nodes (36): burn(), activityFromSends(), CashActivity, CashInputs, CashInputSpec, CashInputState, CashMetricSet, CashOrigin (+28 more)

### Community 155 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.15
Nodes (25): Ok, Result, unwrap(), CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL, estimateCostUsd() (+17 more)

### Community 156 - "Phase 11: Persona Onboarding & Business Profile - Research"
Cohesion: 0.13
Nodes (18): DocId, DocStrip(), bubble(), fmt(), LiveSession(), speakerLabel(), two(), VoicePage() (+10 more)
...
Cohesion: 0.04
Nodes (60): assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender(), confirmClaim (+52 more)
...
Cohesion: 0.04
Nodes (49): modules, crons, deliverApprovedPlan, markPlanDone, DeliveryResult, send, internal, internalAction (+41 more)
...
Cohesion: 0.13
Nodes (18): cleaned(), composeDocMemo(), DOC_REVIEW_SECTIONS, DocReviewConfidence, DocReviewSection, isConfidence(), isSection(), normalizeExcerpt() (+10 more)
...
Cohesion: 0.04
Nodes (44): 0. Ordering — do M4 FIRST, and why, 10. Evidence summary template — fill this in and hand it to `/gsd:verify-work 17`, 11. Unresolved — flagging rather than guessing, 1.1 Confirm the working tree is the code you think it is, 1.2 Rebuild the production bundle, 1.3 ✅ THE TIMESTAMP GATE — do this before trusting any UI symptom, 1.4 Start the backend and the web app (two terminals, leave both running), 1.5 ✅ THE FIXTURE GATE — clear the offline calendar fixture (+36 more)
...
Cohesion: 0.04
Nodes (33): aggregateModules, CalendarEventFields, convexSources, EventField, freeBusyArgs, modules, PlanStatus, ADR-0023 (+25 more)
...
Cohesion: 0.05
Nodes (40): auditCounts, backfillAuditCounts, countAudit, log, recentByType, components, backfillRequestDefaults, migrations (+32 more)

### Community 191 - "feedback.test.ts"
Cohesion: 0.11
Nodes (24): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), NarrativePanel(), isTabId(), page, ProfilePage() (+16 more)
...
Cohesion: 0.07
Nodes (42): ReelCanvas(), adjustmentNotes(), BriefChip, BriefChipField, briefChips(), BriefOption, buysPicture(), CAPTION_DETAIL (+34 more)
...
Cohesion: 0.21
Nodes (12): here, page, panel, panelSource, adaptationBytes(), card, dim, SkillAuthoringPanel() (+4 more)

### Community 198 - "Project State"
Cohesion: 0.10
Nodes (11): BLUEPRINT_TEXT, code, modules, sources, aggregateModules, BLUEPRINT_TEXT, modules, newTest() (+3 more)
...
Cohesion: 0.09
Nodes (28): activity, applyFinanceClaims(), _docToField, _fieldToDoc, financeSpineFor, inputs, inputsFor, inputStatesFor() (+20 more)
...
Cohesion: 0.18
Nodes (11): Data flow, Dependencies & blast radius, How to change safely, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes, Playbook: Authorization (tenancy + ownership) (+3 more)
...
Cohesion: 0.03
Nodes (37): modules, T, aggregateModules, modules, modules, modules, SCHEMA, DataModel (+29 more)
...
Cohesion: 0.33
Nodes (5): ADR-022: The beta domain posture — durable, not custom, and already in force, Alternatives considered, Consequences, Context, Decision
...
Cohesion: 0.10
Nodes (28): { auth, signIn, signOut, store, isAuthenticated }, google, microsoft, password, ADR-0018, mutation, query, AdmitArgs (+20 more)
...
Cohesion: 0.05
Nodes (52): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+44 more)
...
Cohesion: 0.10
Nodes (28): InlineMarkdown(), MarkdownDocument(), tableCells(), AGENT_WRITABLE_FIGURES, buildCockpitTools(), fmtSendInstant(), layoutRuns(), markdownToPdf() (+20 more)
...
Cohesion: 0.07
Nodes (21): AwaitingItem, AwaitingPage, button, caps, card, cardTitle, ClearedItem, DecisionItem (+13 more)
...
Cohesion: 0.25
Nodes (7): How to verify, Invariants, Key files, Known gaps & deferred work, Operational notes, Playbook: Production Beta Readiness (25-10), Purpose
...
Cohesion: 0.22
Nodes (3): aggregateModules, modules, T
...
Cohesion: 0.04
Nodes (60): persistNextStepMemo(), isoDate(), persistFindings, researchDocumentText(), researchTitle(), applyClassification, countTerminal(), deleteVaultDoc (+52 more)
...
Cohesion: 0.09
Nodes (22): ActivityCard(), stepText(), bubble(), ChatPane(), COCKPIT_STARTERS, messageText(), pinLabel(), PinState (+14 more)
...
### Community 324 - "setup"
Cohesion: 0.10
Nodes (7): loadEffectiveSkill(), loadSkill(), aggregateModules, modules, SkillStatus, EvalEvidenceTenantTarget, USER_SKILL_ADAPTATION_SECTION
...
### Community 343 - "optimizerBreach.ts"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)

### Community 344 - "httpAuth.test.ts"
Cohesion: 0.50
Nodes (4): How to verify, Live owner/non-owner checklist (deployment smoke test), Operator commands (21-04), The presentation rule (why the whole section is conditional)
...
### Community 348 - "Phase 23 Research: Agent-Authored Skills"
Cohesion: 0.08
...
### Community 349 - "Phase Details - Milestone v2.0"
Cohesion: 0.08
...
Cohesion: 0.12
Nodes (15): CategoryTabs(), VaultFolder, pickedFolderFromFiles(), FolderBreadcrumb(), VaultBody(), VaultErrorBoundary, StartPhase, deriveVaultViewState() (+7 more)

### Community 351 - "Hot Path Rules"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)
...
### Community 353 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 355 - "Phase 17 Plan 05: `calendar_manage` Substrate Summary"
Cohesion: 0.09
...
### Community 356 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 359 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 362 - "attachmentExtractor.ts"
Cohesion: 0.09
...
### Community 363 - "businessProfile.ts"
Cohesion: 0.09
...
### Community 364 - "contentDrafter.ts"
Cohesion: 0.09
...
### Community 366 - "documentDrafter.ts"
Cohesion: 0.09
...
### Community 367 - "emailDrafter.ts"
Cohesion: 0.09
Nodes (21): 1. [Rule 3 — Blocking] The harness CLI and the browser addressed DIFFERENT deployments, 1. The closed consent gate does not look closed (BRAND / accessibility), 2. [Rule 1 — the plan's own verify command cannot pass], 2. The preview says `1 rejected`, the result screen says `0 rejected` — USER-VISIBLE, 3. [Rule 3] The running stack was stale and had to be restarted, 3. The consent-chip comparison could not be performed, 4. [Beyond the plan] A second screenshot, 5. [Deviation from the plan's instruction, deliberate] `status: complete` was withheld until the gate closed (+13 more)
...
### Community 370 - "executiveRouter.ts"
Cohesion: 0.09
...
### Community 371 - "graphExtractor.ts"
Cohesion: 0.09
...
### Community 377 - "mediaCanvas.test.ts"
Cohesion: 0.12
Nodes (15): face(), fscene(), imageCanvas, sceneCard(), scenesWithFailure(), source, Brief, briefRefusalText() (+7 more)

### Community 378 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 379 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 380 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 381 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 382 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 384 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 385 - "Phase 19 Plan 10: Close the phase honestly Summary"
Cohesion: 0.10
...
### Community 386 - "Phase 19 Plan 13: Consent Record Gap Closure Summary"
Cohesion: 0.10
...
### Community 387 - "Phase 21 Plan 03: Exact Tenant Candidate Evaluation Summary"
Cohesion: 0.10
...
### Community 388 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 389 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 390 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 391 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 392 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 393 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 395 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 398 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 400 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 401 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 402 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 403 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 405 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 406 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 410 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 411 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 412 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 414 - "Phase 19 Plan 09: Teach the Body, Owe the Fixture Summary"
Cohesion: 0.11
...
### Community 416 - "Phase 21 Plan 05: Routine v0 — Pinned Prompts Summary"
Cohesion: 0.11
...
### Community 417 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 418 - "mediaComplete.ts"
Cohesion: 0.14
Nodes (16): rearmAfterFix(), Actual, actualValidator, afterCaptionLanding(), evaluateRenderTrigger(), EXACT_SPEND_KINDS, landResult, maybeBurnCaptions() (+8 more)

### Community 419 - "officeText.ts"
Cohesion: 0.29
Nodes (17): chartLines(), docxText(), epubText(), extractOfficeText(), joinParts(), labelled(), numericSorted(), odfText() (+9 more)

### Community 420 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 421 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 422 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 424 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 425 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 426 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 427 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)
...
### Community 429 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 430 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 431 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 432 - "Phase 15.2 Plan 08: False-Ready Family and PPTX Fan-Out Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Issues Encountered, Live Verification, Next Phase Readiness, Performance (+9 more)

### Community 433 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 434 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 435 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 437 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 438 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 440 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 441 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 442 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 443 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 444 - "Phase 19.1 Plan 06: The CSV Import Panel Summary"
Cohesion: 0.11
...
### Community 446 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 448 - "Phase 33 Plan 09: media-director v3 — the specialist learns to write what the parsers read"
Cohesion: 0.11
...
### Community 449 - "Phase 33 Plan 13: The proposal stage gets a failure card, and the two parser edits get disclosed Summary"
Cohesion: 0.11
...
### Community 450 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 451 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 452 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 453 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 454 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 455 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 456 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 457 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 458 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 459 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 460 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 461 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 462 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 466 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 467 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 468 - "page.tsx"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 469 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 470 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 471 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 472 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 473 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
Cohesion: 0.07
Nodes (50): ArtDirection, Block, BLOCK_REFUSAL_WHY, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, DeckContract, fail() (+42 more)

### Community 477 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 478 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 479 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 480 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 482 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 484 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 485 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 486 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 487 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 488 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 490 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 492 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.12
...
### Community 493 - "Phase 19.1 Plan 05: pipelineTiles Reports Its Scan Bound Summary"
Cohesion: 0.12
...
### Community 494 - "Phase 20.2: Scene Timeline Reels — Code and Offline Evidence Summary"
Cohesion: 0.12
...
### Community 496 - "Phase 21 Plan 02: Tenant Candidate Write/Read and Effective Loading Summary"
Cohesion: 0.12
...
### Community 497 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 498 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 499 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)
...
### Community 508 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
Cohesion: 0.12
Nodes (16): scripts, codegen, dev, eval:golden, probe:gemini, probe:gemini:grounded, seed, smoke:dlq (+8 more)
...
### Community 512 - "finance-update-fails-only-in-full-sequence.md"
Cohesion: 0.12
...
### Community 514 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 515 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 516 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 517 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 518 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 519 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 520 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 521 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 522 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 523 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 524 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 525 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 526 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 527 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 528 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 529 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 530 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 532 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 533 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 535 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 543 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 546 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 548 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 549 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 550 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 551 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 553 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 558 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 559 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 560 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 562 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (38): DatabaseReader, DatabaseWriter, QueryCtx, logTenantActivation(), byTenant(), bumpLanded(), classify(), classifyOne() (+30 more)
...
### Community 565 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 566 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 567 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 568 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 570 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 572 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 573 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 574 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 575 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 576 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 577 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 578 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 579 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 580 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 581 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 582 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 583 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 584 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 585 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 586 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 588 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 589 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 590 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 592 - "Phase 19 Plan 03: The CAN-SPAM postal address Summary"
Cohesion: 0.12
...
### Community 603 - "Phase 33 Plan 02: Plan-Row State + Governed Mutations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 604 - "Phase 33 Plan 03: Persist Terminal + Money Gates Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 606 - "Phase 33 Plan 04: Failure/Retry Backend Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 607 - "Phase 33 Plan 08: Grounded citations and clear failure on the canvas Summary"
Cohesion: 0.12
...
### Community 608 - "Feature Research"
Cohesion: 0.12
...
### Community 609 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 613 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 614 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 615 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 617 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 618 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 619 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 620 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 621 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 623 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 624 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 640 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 641 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 642 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 643 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 644 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 645 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 646 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 647 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 648 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 649 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 650 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 651 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 652 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 653 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 654 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 655 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 657 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 658 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 664 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 665 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 666 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 667 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 668 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 669 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 670 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 671 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 672 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 675 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 680 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 681 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 682 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 683 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 684 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 686 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 687 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 688 - "Phase 19.1 Plan 03: fill-empty-only as a Flag on the ONE Writer Summary"
Cohesion: 0.13
...
### Community 689 - "Phase 19.1 Plan 04: matchExisting and importContacts Summary"
Cohesion: 0.13
...
### Community 690 - "Phase 22: Owner Authorization Primitive Verification Report"
Cohesion: 0.13
...
### Community 691 - "Phase 33 Plan 01: Storyboard Parse Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
Cohesion: 0.09
Nodes (23): tenantAction, runVaultGround(), vaultGround, vaultGroundHydrated, buildGeminiEmbedRequest(), buildOpenAIEmbedRequest(), embeddingContentHash(), embeddingV2 (+15 more)

### Community 699 - "officeText.test.ts"
Cohesion: 0.15
Nodes (5): MONTHS, pts(), NOTE: extractOfficeText takes ONE argument. No MIME type is supplied anywhere in, rels(), ser()

### Community 700 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
Nodes (13): Card + Activity-Step UI (research priority #8), Don't Hand-Roll, evaluateBusiness Tool Shape (research priority #2), Gap→Action Wiring (research priority #5), Grounding (research priority #3), Growth OS source (to PORT, not run), Metadata, Open Questions (+5 more)

### Community 701 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 702 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 703 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 704 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 705 - "Phase 19.1 Plan 02: The Two Union Widenings Summary"
Cohesion: 0.14
...
### Community 706 - "Phase 19.1: Bulk Contact Import (CSV) — Research"
Cohesion: 0.14
...
### Community 708 - "Phase 19 Plan 08: Contacts-first resolution and the CRM staging tool Summary"
Cohesion: 0.14
...
### Community 714 - "Phase 20 Plan 20: Finance Fingerprint Reconciliation Summary"
Cohesion: 0.14
...
### Community 715 - "Phase 21 Plan 01: Contracts and Schema Foundation Summary"
Cohesion: 0.14
...
### Community 716 - "Phase 22.1 Plan 04: Tenant Data Export Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 717 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 718 - "previewState.ts"
Cohesion: 0.22
...
### Community 719 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 720 - "vaultExtract.ts"
Cohesion: 0.19
Nodes (10): extractDoc, Extracted, extractHosted(), ExtractPath, extractPdf(), fanOutPages(), pdfPages(), PromiseCtor (+2 more)

### Community 721 - "voiceToken.test.ts"
Cohesion: 0.15
Nodes (5): calls, Captured, modules, DIGEST_FENCE_CLOSE, DIGEST_FENCE_OPEN

### Community 722 - "package.json"
Cohesion: 0.15
...
### Community 726 - "Goal Achievement"
Cohesion: 0.15
...
### Community 727 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 728 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 729 - "Goal Achievement"
Cohesion: 0.15
...
### Community 732 - "Goal Achievement"
Cohesion: 0.15
...
### Community 733 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 734 - "Goal Achievement"
Cohesion: 0.15
...
### Community 736 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 739 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 750 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 752 - "17.1-10 live-gate audit"
Cohesion: 0.15
...
### Community 753 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 754 - "Phase 19.1 Plan 01: The Pure CSV Import Brain Summary"
Cohesion: 0.15
...
### Community 755 - "Phase 19.1: Bulk Contact Import (CSV) Verification Report"
Cohesion: 0.15
...
### Community 758 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 761 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 762 - "Phase 25: Private Beta Productionization - Research"
Cohesion: 0.15
...
### Community 763 - "vaultTranscribe.test.ts"
Cohesion: 0.17
Nodes (6): aggregateModules, modules, rateLimiterModules, T, workflowModules, workpoolModules

### Community 764 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 767 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 768 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 769 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 770 - "Phase 33 Plan 06: Reel-first canvas Summary"
Cohesion: 0.15
...
### Community 771 - "Phase 33 Plan 07: Guided intake and variations on the canvas Summary"
Cohesion: 0.15
...
### Community 772 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 773 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)

### Community 774 - "vaultSweep.test.ts"
Cohesion: 0.17
Nodes (5): enqueuedExtractions, migrationsModules, modules, workflowModules, workpoolModules

### Community 775 - "compilerOptions"
Cohesion: 0.17
...
### Community 778 - "External Integrations"
Cohesion: 0.17
...
### Community 780 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 781 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 782 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 783 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 784 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 785 - "Goal Achievement"
Cohesion: 0.17
...
### Community 786 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 787 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 788 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 789 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 791 - "Phase 19.1 — Validation Strategy"
Cohesion: 0.17
...
### Community 792 - "Phase 19 Plan 02: The person store Summary"
Cohesion: 0.17
...
### Community 793 - "Phase 19 Plan 04: The public unsubscribe route Summary"
Cohesion: 0.17
...
### Community 794 - "Phase 19 Plan 05: The trust boundary Summary"
Cohesion: 0.17
...
### Community 795 - "Phase 19 Plan 06: crm_write, the fifth action type Summary"
Cohesion: 0.17
...
### Community 796 - "Phase 19 Plan 07: The connected Pipeline route Summary"
Cohesion: 0.17
...
### Community 797 - "Phase 19: Contacts, CRM & Follow-ups — Verification Report"
Cohesion: 0.17
...
### Community 798 - "Phase 20.1 Plan 01: Drive Read Substrate Summary"
Cohesion: 0.17
...
### Community 799 - "Phase 20.2 — Validation Strategy"
Cohesion: 0.17
...
### Community 802 - "Phase 20 — Validation Strategy"
Cohesion: 0.17
...
### Community 803 - "Phase 24 Plan 01: ISO 9001 Evidence Map Foundation Summary"
Cohesion: 0.17
...
### Community 804 - "Microsoft disconnect: what it does, what it cannot do, and the choice"
Cohesion: 0.17
Nodes (11): Microsoft disconnect: what it does, what it cannot do, and the choice, Owner decision, Posture A — accept the honest local disconnect for the beta, Posture B — stop this lane and commission a security/consent review, Proposed copy — `apps/web/app/(app)/_components/DisconnectMicrosoft.tsx`, Re-verification, 2026-08-17 — two claims confirmed verbatim, one URL WRONG, Recommendation, The choice (+3 more)

### Community 805 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 806 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 807 - "Phase 33 Plan 10: closing the phase live — and the two defects that only production could show"
Cohesion: 0.17
...
### Community 810 - "approvalsView.test.ts"
Cohesion: 0.20
Nodes (10): ApprovalKindBadge(), ApprovalsStateNotice(), compactSubject(), emailApprovalActionLabel(), EmailApprovalDetails(), emailBusinessAction(), recipientName(), rawSource (+2 more)
...
### Community 815 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 816 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 819 - "Repository Structure"
Cohesion: 0.18
...
### Community 820 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 821 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 822 - "Goal Achievement"
Cohesion: 0.18
...
### Community 823 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 824 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 825 - "Goal Achievement"
Cohesion: 0.18
...
### Community 826 - "Goal Achievement"
Cohesion: 0.18
...
### Community 827 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 829 - "Goal Achievement"
Cohesion: 0.18
...
### Community 832 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 833 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 837 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 839 - "Goal Achievement"
Cohesion: 0.18
...
### Community 840 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 843 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 844 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 846 - "Phase 19 — Validation Strategy"
Cohesion: 0.18
...
### Community 847 - "Phase 20.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 854 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 855 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 856 - "Phase 21 — Validation Strategy"
Cohesion: 0.18
...
### Community 857 - "Phase 23 — Validation Strategy"
Cohesion: 0.18
...
### Community 858 - "Phase 24 — Validation Strategy"
Cohesion: 0.18
...
### Community 859 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 864 - "Phases 14–25 — gap ledger (re-derived 2026-08-17)"
Cohesion: 0.18
...
### Community 865 - "formatAbsoluteInstant"
Cohesion: 0.31
Nodes (10): actionLabel(), AwaitingCard(), browserTimeZone(), ClearedRow(), formatAbsoluteInstant(), InFlightRow(), parseScheduleInput(), ScheduleComposer() (+2 more)

### Community 866 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 868 - "Code Conventions"
Cohesion: 0.20
...
### Community 869 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 870 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 871 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 875 - "Goal Achievement"
Cohesion: 0.20
...
### Community 876 - "Goal Achievement"
Cohesion: 0.20
...
### Community 879 - "Goal Achievement"
Cohesion: 0.20
...
### Community 880 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 882 - "Goal Achievement"
Cohesion: 0.20
...
### Community 883 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 892 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 895 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 896 - "Goal Achievement"
Cohesion: 0.20
...
### Community 897 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 900 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 902 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 904 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 905 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 906 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 913 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 914 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 916 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 917 - "Deferred items — Phase 19"
Cohesion: 0.20
...
### Community 921 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 922 - "Phase 25 Plan 01: Beta Admission Trust Boundary Summary"
Cohesion: 0.20
...
### Community 923 - "Phase 25 — the owner gates"
Cohesion: 0.20
...
### Community 924 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 926 - "Validation Architecture"
Cohesion: 0.20
...
### Community 927 - "Phase 31: Marketing Surface and Funnel v0 — Validation Strategy"
Cohesion: 0.20
...
### Community 929 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 932 - "Technology Stack"
Cohesion: 0.22
...
### Community 933 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 935 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 936 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 937 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 938 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 939 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 940 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 941 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 942 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 943 - "Locked Decisions"
Cohesion: 0.22
...
### Community 945 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 948 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 949 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 950 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 951 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 952 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.22
...
### Community 954 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 955 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 957 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 958 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 959 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 960 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 961 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 962 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 966 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 967 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 968 - "Phase 17 — Gap-Closure Validation Strategy"
Cohesion: 0.22
...
### Community 969 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 971 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 972 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 977 - "21-07 COMPLETE — the frozen candidate carries a passing held-out gate"
Cohesion: 0.22
...
### Community 978 - "Phase 22.1 Plan 05: Tenant Deletion Summary"
Cohesion: 0.22
...
### Community 979 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 980 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 981 - "1. The invite gate — `callbacks.createOrUpdateUser` (BETA-01) — **HIGH confidence, source-verified**"
Cohesion: 0.22
...
### Community 982 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 983 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 984 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 986 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 987 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 988 - "Plan 33-05: Auto-assembled reel — vault save + regenerate ordering"
Cohesion: 0.22
...
### Community 991 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 992 - "vaultGround.test.ts"
Cohesion: 0.36
Nodes (6): BLUEPRINT_TEXT, modules, seedChain(), seedConfirmedBlueprint(), seedDoc(), seedEdge()

### Community 993 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 994 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 995 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 998 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 999 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1000 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 1001 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 1002 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 1003 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 1004 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1005 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1006 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1007 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1008 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 1009 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1010 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 1011 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 1012 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 1013 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1014 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 1015 - "Architecture Patterns"
Cohesion: 0.25
...
### Community 1016 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 1017 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1018 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1019 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 1020 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 1021 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1022 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1023 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 1024 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 1025 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 1027 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1029 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 1030 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 1031 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 1032 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1033 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 1034 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1036 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1038 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1039 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1040 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1041 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 1042 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 1044 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 1047 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 1048 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 1049 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 1050 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 1051 - "Phase 22.1 Plan 03: CI Gate Summary"
Cohesion: 0.25
...
### Community 1052 - "Phase 22.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1053 - "Phase 22.1 — Goal Verification"
Cohesion: 0.25
...
### Community 1055 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 1056 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 1057 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 1058 - "Phase 25 — Validation Strategy"
Cohesion: 0.25
...
### Community 1059 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 1060 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 1062 - "Phase 33: Media Creation UX Overhaul - Research"
Cohesion: 0.25
...
### Community 1063 - "Phase 33 — Validation Strategy"
Cohesion: 0.25
...
### Community 1064 - "Roadmap: Pikar-AI"
Cohesion: 0.25
Nodes (7): EXTERNAL BLOCKER (non-code, unscheduled): the legal entity, Milestone v2.0 - Platform -> Private Beta (Phases 10-25), Overview, Phase 26: Connected product pages, Phases, Progress, Roadmap: Pikar-AI

### Community 1065 - "business-evaluation-no-grounded-findings.md"
Cohesion: 0.29
Nodes (6): Consequence, now discharged, Eliminated during investigation, Fix, Root cause, Verification, Why it escaped

### Community 1066 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 1067 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 1068 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1069 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 1070 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 1071 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1072 - "Validation Architecture"
Cohesion: 0.29
...
### Community 1073 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1075 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 1078 - "Phase 14: Flagship Voice-Doc Workflow Verification Report"
Cohesion: 0.29
...
### Community 1079 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 1080 - "Phase 15.2: Universal Vault Extraction Verification Report"
Cohesion: 0.29
Nodes (6): Current Focused Checks, Goal Achievement, Phase 15.2: Universal Vault Extraction Verification Report, Preserved Observations, Three-Source Requirement Cross-Check, Verdict

### Community 1081 - "Code Examples"
Cohesion: 0.29
...
### Community 1083 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1084 - "Phase 16: Research Sub-Agent & Web Research Verification Report"
Cohesion: 0.29
...
### Community 1085 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 1087 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 1089 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 1090 - "Phase 21 — live session 2026-08-18: what was executed, and what CANNOT be"
Cohesion: 0.29
...
### Community 1091 - "error-context.md"
Cohesion: 0.33
Nodes (5): Error details, Instructions, Page snapshot, Test info, Test source

### Community 1092 - "25-01 — security audit of the BETA-01 admission boundary"
Cohesion: 0.29
...
### Community 1094 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 1098 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 1099 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 1100 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 1102 - "devDependencies"
Cohesion: 0.33
Nodes (6): devDependencies, convex-test, @edge-runtime/vm, @types/node, vitest, xlsx

### Community 1103 - "xlsText.ts"
Cohesion: 0.47
Nodes (4): SALES, workbook(), xlsBytes(), xlsText()

### Community 1104 - "calendar-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1105 - "first-login-second-attempt-auth-redirect.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1106 - "gmail-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1107 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1108 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1109 - "phase21-local-google-login-failure.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1110 - "production-frontend-rollback-after-media-release.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1111 - "convex-local-backend-preparing-functions.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1118 - "production-client-provided-address-not-absolute-url.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1119 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 1120 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 1121 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 1122 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 1123 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1124 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 1126 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 1127 - "14-09 — SC4 proven statically, then verified by voice"
Cohesion: 0.33
...
### Community 1128 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 1132 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1133 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1162 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 1163 - "Validation Architecture"
Cohesion: 0.33
...
Cohesion: 0.03
Nodes (86): finish, latestTurn, record, refuse, StepView, byThread, insert, ADR-0004 (+78 more)

### Community 1168 - "20-12 — SUMMARY"
Cohesion: 0.33
...
### Community 1169 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 1170 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 1171 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 1172 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 1173 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1174 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 1178 - "Phases 14–25 milestone gap audit"
Cohesion: 0.33
Nodes (5): Dependency-safe closure order, External-only evidence, Outcome, Phase matrix, Phases 14–25 milestone gap audit

### Community 1179 - "Phase 15.2 — universal format recognition"
Cohesion: 0.40
...
### Community 1180 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1181 - "Scheduled Send"
Cohesion: 0.40
...
### Community 1183 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 1184 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 1185 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 1187 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1188 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 1189 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 1194 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps
...
### Community 1199 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 1204 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 1206 - "Union Blast Radius — the executor's walk"
Cohesion: 0.40
...
### Community 1207 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1208 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 1209 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 1210 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 1211 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 1212 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 1214 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1215 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 1216 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 1217 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 1219 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 1220 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 1224 - "3. The BETA-05 isolation suite — schema-derived enumeration — **HIGH confidence, API-verified**"
Cohesion: 0.40
...
### Community 1225 - "4. Microsoft Graph — the mapping (DLVR-02)"
Cohesion: 0.40
...
### Community 1227 - "Production Secret Inventory (research Q5)"
Cohesion: 0.40
...
### Community 1229 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 1230 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 1232 - "Phase 33 — deferred items"
Cohesion: 0.40
...
### Community 1233 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
### Community 1234 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1235 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1236 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1237 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1238 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1239 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1240 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1241 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1242 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1243 - "Standard Stack"
Cohesion: 0.50
...
### Community 1245 - "Deferred items — Phase 03.10"
Cohesion: 0.50
...
### Community 1246 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 1251 - "User Constraints"
Cohesion: 0.50
...
### Community 1253 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read from installed source / repo files), Secondary (MEDIUM), Sources, Tertiary (LOW — flagged)

### Community 1254 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
Nodes (3): Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake), From 04-01 execution, From 04-02 execution

### Community 1255 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1256 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 1257 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1258 - "Sources"
Cohesion: 0.50
...
### Community 1271 - "User Constraints"
Cohesion: 0.50
...
### Community 1275 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1276 - "Standard Stack"
Cohesion: 0.50
...
### Community 1277 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1278 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1280 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1281 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1285 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1286 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read at HEAD, 2026-08-01), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 1287 - "The Existing Substrate — as it actually is today"
Cohesion: 0.50
...
### Community 1290 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1292 - "User Constraints (from 19-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1294 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1295 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1296 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1298 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1299 - "User Constraints (from `25-CONTEXT.md`)"
Cohesion: 0.50
...
### Community 1303 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1309 - "Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07"
Cohesion: 0.50
...
### Community 1310 - "ageLabel"
Cohesion: 0.67
Nodes (3): ageLabel(), ConnectedApprovals(), PlanMeta()

### Community 1314 - "Standard Stack"
Cohesion: 0.67
...
### Community 1324 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
## Knowledge Gaps
- **11828 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+11823 more)
...
- **Why does `api` connect `formatAbsolute` to `FinanceTabs.tsx`, `briefings.ts`, `vaultSweep.test.ts`, `metering.ts`, `Phase Details`, `emailIntent.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase 03.7 — Validation Strategy`, `vaultTranscribe.test.ts`, `layout.tsx`, `skills.test.ts`, `tenant.ts`, `buildCockpitTools`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `guardrails.test.ts`, `Dropzone.tsx`, `replyDrafter.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `agentSteps.test.ts`, `vaultLlm.ts`, `spend.ts`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `FinanceTabs.tsx`, `approvalsView.test.ts`, `finance.test.ts`, `log`, `vaultDrive.test.ts`, `AdminView.tsx`, `Proactive weekly review (BEVL-03, 13-02)`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `graph.test.ts`, `buildTelemetry.ts`, `extractKind.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `pipeline-uat.spec.ts`, `skills.test.ts`, `guardrails.test.ts`, `feedback.test.ts`, `routing.ts`, `selfCheck`, `server.d.ts`, `setup`, `SkillAuthoringPanel.tsx`, `vaultLlm.ts`, `vault-redesign.spec.ts`, `officeText.test.ts`, `isolation.test.ts`, `index.ts`, `crmCard.test.ts`, `media.ts`, `voiceToken.test.ts`, `Key files`, `createdDocs.test.ts`, `approvalsView.test.ts`, `vaultSealing.test.ts`, `microsoftAuth.test.ts`, `classify.ts`, `page.tsx`, `ReconnectBanner.tsx`, `vaultTranscribe.test.ts`, `index.ts`, `vaultGround.test.ts`, `createdDocs.test.ts`, `gapAction.test.ts`, `http.ts`, `classify.ts`, `intake.test.ts`, `Phase 18 Plan 06: The createDocument Tool Summary`, `Phase Details - Milestone v2.0`, `vaultDrive.test.ts`, `assembly.ts`, `DriveBrowser.tsx`, `skill-authoring.spec.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `internal` connect `Phase 3.1: Cockpit Core — Research (Delivery lane)` to `functions.ts`, `package.json`, `v1 Requirements`, `vaultSweep.test.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `Project State`, `skillBodies.test.ts`, `scan.ts`, `Phase 03.7 — Validation Strategy`, `page.tsx`, `isFallbackEligible`, `layout.tsx`, `skills.test.ts`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `Dropzone.tsx`, `evaluations.test.ts`, `replyDrafter.ts`, `FinanceTabs.tsx`, `feedback.ts`, `mediaComplete.ts`, `log`, `vaultDrive.test.ts`, `session.ts`, `vaultDrive.ts`, `graph.test.ts`, `formatAbsolute`, `research.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `skills.test.ts`, `guardrails.test.ts`, `extractKind.ts`, `selfCheck`, `VaultBrowseControls.tsx`, `vaultSweep.test.ts`, `setup`, `Project State`, `list`, `cockpitDriveTools.test.ts`, `crmCard.test.ts`, `vaultExtract.ts`, `media.ts`, `voiceToken.test.ts`, `createdDocs.test.ts`, `approvalsView.test.ts`, `vaultSealing.test.ts`, `microsoftAuth.test.ts`, `classify.ts`, `blueprint.test.ts`, `vaultTranscribe.test.ts`, `vaultGround.test.ts`, `agentSteps.test.ts`, `gapAction.test.ts`, `classify.ts`, `http.ts`, `page.tsx`, `Phase Details - Milestone v2.0`, `vaultDrive.test.ts`, `assembly.ts`, `vaultTranscribe.test.ts`, `intake.test.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `n()` connect `layout.tsx` to `selfCheck`, `index.ts`, `log`, `v1 Requirements`, `officeText.ts`, `vaultTranscribe.test.ts`, `26-05: Connected Approvals route, owner-verified`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _11860 weakly-connected nodes found - possible documentation gaps or missing edges._
