# Graph Report - Pikar-Ai  (2026-08-04)

## Corpus Check
- 1344 files · ~2,391,121 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4798 nodes · 6856 edges · 395 communities (362 shown, 33 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d01085f`
...
1. `base()` - 29 edges
2. `log` - 26 edges
3. `buildCockpitTools()` - 23 edges
4. `Phase Details` - 22 edges
5. `Phase Details - Milestone v2.0` - 22 edges
6. `Playbook: Media Canvas (finished reel)` - 22 edges
7. `contentHash()` - 21 edges
8. `Playbook: Email Chat Cockpit` - 20 edges
9. `tenantQuery` - 19 edges
10. `Voice-doc sessions (Phase 14, DOCV-01)` - 19 edges
...
Cohesion: 0.11
Nodes (27): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+19 more)

### Community 1 - "package.json"
Cohesion: 0.14
Nodes (19): discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), pillAnchor(), pillShape, statusBadge() (+11 more)

### Community 2 - "page.tsx"
Cohesion: 0.04
Nodes (49): Activity, ActivityCard(), attRow, badge(), box, Briefing, BriefingItem, BriefingRow() (+41 more)

### Community 3 - "biome.json"
Cohesion: 0.12
Nodes (16): Data flow (one agent turn), Dependencies & blast radius, How to change safely, How to verify, Interpretation, Invariants — what must never break, Key files, Known gaps & deferred work (+8 more)
...
Cohesion: 0.06
Nodes (33): preCall, recordSpend, applyClassification, getDocForExtraction, ingestExtractedText, insertCreatedDoc, markExtracting, markFailed (+25 more)

### Community 6 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.08
Nodes (23): DisconnectGoogle(), { auth, signIn, signOut, store, isAuthenticated }, password, buildAuthorizeUrl(), deleteTokens, disconnectGoogle, getForDelivery, getTokens (+15 more)
...
Cohesion: 0.06
Nodes (30): RFC-2045, RFC-2047, RFC-2822, base64Url(), buildMime(), FetchBodiesResult, fetchInboxBodies, freshAccessToken() (+22 more)

### Community 11 - "scan.ts"
Cohesion: 0.07
Nodes (27): getGuardrailConfig(), batchToSubmit, buildSubmitBody(), captionsToSubmit, claimLine, clearRender(), CLIP_SECONDS_SET, EstimateLine (+19 more)
...
Cohesion: 0.10
Nodes (23): ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), applyScorecardAnswer(), buildMemo(), coerceScorecardValue() (+15 more)
...
Cohesion: 0.11
Nodes (10): ADR-0004, RFC-5322, aggregateModules, modules, modules, modules, modules, RFC-3339 (+2 more)

### Community 20 - "buildCockpitTools"
Cohesion: 0.10
Nodes (22): cancelScheduledPlan, cockpitAgent, executePlan, ExternalActionType, ExternalArgs, FanoutArgs, listThreadMessages, proposeEmailPlan (+14 more)

### Community 21 - "cockpit-resolve.spec.ts"
Cohesion: 0.06
Nodes (45): Tab, VAULT_TABS, base(), DownloadIcon(), FileDocIcon(), FileTextIcon(), FolderIcon(), GridIcon() (+37 more)
...
Cohesion: 0.10
Nodes (18): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+10 more)

### Community 24 - "Dropzone.tsx"
Cohesion: 0.07
Nodes (23): BLUEPRINT_FIELD_SET, BlueprintDraft, BlueprintStateResult, BuildBlueprintDraftResult, candidatesSchema, ConfirmBlueprintResult, deriveCandidates, DeriveCandidatesResult (+15 more)

### Community 25 - "classify.ts"
Cohesion: 0.12
Nodes (13): ownerMutation, ownerQuery, ConfigPatch, DEFAULT_OPTIMIZER_CONFIG, getOptimizerConfig, setOptimizerConfig, optimizerEligibility, BreachConfig (+5 more)
...
Cohesion: 0.07
Nodes (36): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, readLayout(), VaultDoc (+28 more)
...
### Community 35 - "log"
Cohesion: 0.18
Nodes (18): aggregateModules, asTenant(), budgetHarness(), build(), digestOf(), docRow(), folderRow(), Harness (+10 more)
...
Cohesion: 0.07
Nodes (41): backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier, FACT_KEYS, forTenant (+33 more)
...
Cohesion: 0.06
Nodes (32): assertSubmitRateLimited, boom, briefingCountForThread, briefingSynopsisPresent, createdDocCountForThread, drainDailySpend, evaluationCountForThread, failingPipeline (+24 more)
...
Cohesion: 0.11
Nodes (11): aggregateModules, BASE_ARGS, modules, rateLimiterModules, REPLY_STEP, RETRIEVED, SOURCES, T (+3 more)
...
Cohesion: 0.18
Nodes (11): NAV, base(), ChevronDownIcon(), ChevronLeftIcon(), FileIcon(), GlobeIcon(), GridIcon(), PieIcon() (+3 more)
...
Cohesion: 0.12
Nodes (16): buildTrajectoryExport, scrub(), getDoc, embedDoc, openaiEmbeddingV2, rag, RagEmbeddingModel, DETECTORS (+8 more)
...
Cohesion: 0.13
Nodes (24): AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), Phase, PostCall(), primaryBtn, secondaryBtn, today() (+16 more)

### Community 77 - "notificationMessage"
Cohesion: 0.09
Nodes (26): deliverApprovedPlan, markPlanDone, send, prepare, retrier, vaultIngestPool, workflow, draft (+18 more)
...
Cohesion: 0.09
Nodes (24): classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch(), DriveFile, DriveImportResult (+16 more)
...
Cohesion: 0.17
Nodes (6): aggregateModules, modules, rateLimiterModules, REQ, workflowModules, workpoolModules

### Community 96 - "classify.ts"
Cohesion: 0.16
Nodes (11): submitCaptions, Actual, actualValidator, afterCaptionLanding(), EXACT_SPEND_KINDS, maybeBurnCaptions(), maybeStartCaptions(), onSubmitComplete (+3 more)
...
Cohesion: 0.26
Nodes (11): persistNextStepMemo(), contentHash(), writeProfileDoc(), isoDate(), persistFindings, researchDocumentText(), researchTitle(), startIngest() (+3 more)
...
Cohesion: 0.29
Nodes (8): s3, advanceCursor, auditSince, getCursor, retainUntilDate(), serializeAuditNdjson(), sortKeys(), wormObjectKey()

### Community 106 - "classify.ts"
Cohesion: 0.12
Nodes (11): BLUEPRINT_TEXT, code, modules, sources, terminalOutcome, BLUEPRINT_TEXT, modules, seedChain() (+3 more)

### Community 107 - "http.ts"
Cohesion: 0.16
Nodes (17): decodeUtf8(), extractVisual(), runIntake(), RunIntakeArgs, transcribeAudio(), tenantAction, ingestFromAttachment, asciiAt() (+9 more)
...
Cohesion: 0.15
Nodes (8): KIND_HREF, NotificationsBanner(), readSeen(), ReconnectBanner(), STATUS_COLOR, list, markRead, list
...
### Community 119 - "vaultGround.test.ts"
Cohesion: 0.12
Nodes (13): markReady, EDGE, expand, NODE, upsertGraph, assertGroundNeighbor, assertNoRawText, assertReady (+5 more)
...
Cohesion: 0.09
Nodes (22): Phase 10: Vault->Agent Grounding, Phase 11: Persona Onboarding & Business Profile, Phase 12: Business Evaluation Engine, Phase 13: Proactive In-App Review, Phase 14: Flagship Voice-Doc Workflow, Phase 15.1: Fact-Derived Tier & Conversational Onboarding (INSERTED), Phase 15.2: Vault Universal Format Recognition & Extraction Fan-Out (INSERTED), Phase 15.3: Vault Folders - Folder Ingest, Synthesis and Drill-In (INSERTED) (+14 more)
...
### Community 134 - "deadLetter.ts"
Cohesion: 0.10
Nodes (26): VaultFolder, Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME, StorageId (+18 more)
...
Cohesion: 0.06
Nodes (29): aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules, RENDER_SIDECAR (+21 more)

### Community 137 - "fmtItemTime"
Cohesion: 0.17
Nodes (13): DocId, DocStrip(), bubble(), fmt(), LiveSession(), speakerLabel(), two(), VoicePage() (+5 more)
...
Cohesion: 0.43
Nodes (7): asTenant(), ground(), Harness, modules, seedDoc(), seedEdge(), seedFolder()

### Community 145 - "vaultLlm.ts"
Cohesion: 0.12
Nodes (19): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents, mediaRemainingCentsInner() (+11 more)
...
Cohesion: 0.24
Nodes (12): AssemblyBlock, AssemblyError, AssemblyReport, CLIP_SET, isGovernedRender(), near(), num(), parseAssemblySidecar() (+4 more)
...
Cohesion: 0.05
Nodes (40): A second stager, and a memo that stops lying (16-06, DISP-02), "Act on this" now RUNS the specialist (15-04, DISP-01), Blueprint standing context and the provenance ceiling, Data flow, Dependencies & blast radius, How to change it safely, How to change safely, How to verify (+32 more)

### Community 151 - "page.tsx"
Cohesion: 0.10
Nodes (19): ATTACHMENTS, attachmentUrls, byThread, CANDIDATES, clearCandidates, LIVE_JOB_STATUS, LIVE_RENDER_STATUS, patchPlan (+11 more)
...
Cohesion: 0.13
Nodes (15): BehaviorPreset, Tier, EvidenceVerdict, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS, specialistMemoBody(), SPECIALISTS (+7 more)

### Community 155 - "functions.ts"
Cohesion: 0.20
...
Cohesion: 0.16
Nodes (10): auditCounts, backfillAuditCounts, countAudit, log, bootstrapOwner, viewer, AuditHash, AuditPayload (+2 more)

### Community 160 - "feedback.ts"
Cohesion: 0.07
Nodes (24): aggregateModules, BASE, DISPATCH_STEP_TOOLS, MEDIA_BODY, mediaArgs(), modules, orderedLineage(), provUsage() (+16 more)
...
Cohesion: 0.15
Nodes (10): bumpFolder(), cancelFolder, createFolder, folderEstimate, FolderEstimateLine, FolderView, listFolders, reserveFolder (+2 more)
...
### Community 166 - "Phase 10: Vault→Agent Grounding - Research"
Cohesion: 0.06
Nodes (23): agentBubble, card, Draft, DRAFT_VERSION, field, label, StorageId, Turn (+15 more)
...
Cohesion: 0.04
Nodes (64): ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext(), buildHistoryBlock(), buildTurnPrompt() (+56 more)

### Community 172 - "proactiveReview.ts"
Cohesion: 0.33
...
### Community 175 - "skillBodies.test.ts"
Cohesion: 0.18
Nodes (9): crons, lastForThread, runEvaluation, flagExpiringTokens, insertReviewNotification, reviewOne, runWeekly, runSweep (+1 more)
...
Cohesion: 0.15
Nodes (13): Dependencies & blast radius, How to change this safely, Invariants — what must never break, Playbook: Media Canvas (finished reel), Playbook ownership for Phase 20, Rate observation (dated, vendor-direct), Reconciliation, Storage retention (D12b) (+5 more)
...
Cohesion: 0.11
Nodes (19): cleaned(), DOC_GAP_PLAYBOOK, DOC_GAP_ROUTE, DocReviewConfidence, DocReviewSection, isConfidence(), isSection(), normalizeExcerpt() (+11 more)
...
### Community 194 - "Phase 3.5: Deferred Send (INSERTED) - Research"
Cohesion: 0.29
...
### Community 196 - "blueprint.ts"
Cohesion: 0.18
Nodes (14): isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource, ExtractionKind, extractionKindFor(), OFFICE_MIME, SchedulingRail (+6 more)
...
Cohesion: 0.09
Nodes (31): BlueprintPanel(), secondaryButton(), BLOCKED, BlockedConnection, ADR-0007, ConnectionsPanel(), pill, row (+23 more)

### Community 199 - "stepText"
Cohesion: 0.64
Nodes (7): collectSources(), collectToolCalls(), formatReport(), LADDER, main(), probeOne(), selfCheck()

### Community 200 - "Phase 6: Live Voice Sessions - Research"
Cohesion: 0.20
Nodes (5): aggregateModules, modules, rateLimiterModules, workflowModules, workpoolModules

### Community 201 - "Phase 3.1: Cockpit Core — Research (Delivery lane)"
Cohesion: 0.17
Nodes (6): aggregateModules, modules, rateLimiterModules, T, workflowModules, workpoolModules

### Community 202 - "Lane ownership (Phase 3.8)"
Cohesion: 0.33
...
### Community 209 - "classify.ts"
Cohesion: 0.07
Nodes (45): modules, activateSkill, activateSkillVersion(), archiveSkill, getSkillVersion, recordEvalEvidence, seedSkills, ADR-0007 (+37 more)
...
Cohesion: 0.08
Nodes (27): byThread, insert, ADR-0004, listNew, markResolved, addItem, listItems, myFeedback (+19 more)

### Community 216 - "notifications.test.ts"
Cohesion: 0.27
Nodes (8): aggregateModules, evaluateWithGap(), modules, profileDocText(), seedDoc(), seedDocReview(), workflowModules, workpoolModules

### Community 217 - "intakeDb.ts"
Cohesion: 0.31
...
Cohesion: 0.21
Nodes (15): ascii(), assTime(), buildCaptionLines(), CaptionLine, concatWavTakes(), escapeAss(), groupIntoLines(), parseWav() (+7 more)

### Community 219 - "financialSpine.ts"
Cohesion: 0.33
Nodes (5): Milestone v2.0 - Platform -> Private Beta (Phases 10-25), Overview, Phases, Progress, Roadmap: Pikar-AI

### Community 223 - "plans.test.ts"
Cohesion: 0.17
Nodes (9): OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), BellIcon(), WalletIcon(), getOptimizerStatus, setOptimizerEnabled, activateCandidate (+1 more)

### Community 224 - "notifications.test.ts"
Cohesion: 0.17
...
### Community 229 - "Phase 15.2 — 15.2-05 (LIVE verification — THE PHASE GATE)"
Cohesion: 0.29
...
### Community 247 - "agentSteps.ts"
Cohesion: 0.23
Nodes (12): refundableCents(), centsFor(), clampRefundCents(), estimateFile(), estimateFolderCents(), EstimateInput, FileEstimate, FolderEstimate (+4 more)

### Community 248 - "voice-doc.spec.ts"
Cohesion: 0.25
Nodes (7): COPY, failureCopy, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED

### Community 251 - "deadLetters.test.ts"
Cohesion: 0.14
...
### Community 261 - "rawText.ts"
Cohesion: 0.08
Nodes (35): chartLines(), docxText(), epubText(), extractOfficeText(), joinParts(), labelled(), numericSorted(), odfText() (+27 more)

### Community 262 - "MediaCanvas.tsx"
Cohesion: 0.07
Nodes (32): briefingSheet, capsTeal, snippetSheet, traceText, typeBadge, ArtDirection, Block, BlockTile() (+24 more)

### Community 263 - "The render trigger and D12(b) retention (20-16)"
Cohesion: 0.50
...
### Community 285 - "proactiveReview.ts"
Cohesion: 0.15
Nodes (10): getActiveSkill, BuildDigestResult, buildFolderDigest, digestMembersPage, digestPrompt(), folderForDigest, isoDate(), MemberMeta (+2 more)

### Community 286 - "xlsText.test.ts"
Cohesion: 0.50
...
### Community 736 - "The voiceover stage (20-14)"
Cohesion: 0.29
...
### Community 772 - "error-context.md"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source

### Community 773 - "error-context.md"
Cohesion: 0.40
Nodes (4): Error details, Instructions, Test info, Test source
...
### Community 793 - "session.ts"
Cohesion: 0.11
Nodes (19): DocRef, FnCallItem, ServerEvent, SessionId, Turn, VoiceStatus, draftVoiceBrief, abortSession (+11 more)

### Community 808 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.33
...
## Knowledge Gaps
- **2302 isolated node(s):** `The suite`, `How they connect`, `The loop (owned by growth-os)`, `Using it`, `Structure of each skill` (+2297 more)
...
- **Why does `log` connect `VaultStats.tsx` to `functions.ts`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `Project State`, `Phase 03.7 — Validation Strategy`, `buildCockpitTools`, `Dropzone.tsx`, `session.ts`, `proactiveReview.ts`, `Phase 10: Vault→Agent Grounding - Research`, `llm.ts`, `Pikar-AI`, `Project State`, `tokenExpiry.ts`, `16-06-PLAN.md`, `list`, `notificationMessage`, `classify.ts`, `index.ts`, `http.ts`, `deadLetters.test.ts`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `contentHash()` connect `index.ts` to `feedback.ts`, `16-06-PLAN.md`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `Phase 10: Vault→Agent Grounding - Research`, `metering.ts`, `Project State`, `llm.ts`, `guardrails.ts`, `Phase 03.7 — Validation Strategy`, `scan.ts`, `notificationMessage`, `vaultLlm.ts`, `vaultGround.test.ts`, `guardrails.test.ts`, `session.ts`, `deadLetters.test.ts`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `page` connect `buildCockpitTools` to `Project State`?**
...
- **What connects `The suite`, `How they connect`, `The loop (owned by growth-os)` to the rest of the system?**
