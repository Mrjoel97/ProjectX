...
## Corpus Check
- 2386 files · ~4,959,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 23342 nodes · 29618 edges · 2077 communities (1928 shown, 149 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 149 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2cefd42`
...
- Architecture Patterns
- workflowPackQuickStarts.test.ts
- approvals.spec.ts
...
- `validateFixture()` --indirect_call--> `count()`  [INFERRED]
  packages/backend/scripts/run-eval-golden.mjs → apps/web/app/(app)/dashboard/vault/SheetGrid.tsx
- `activityFromSends()` --indirect_call--> `count()`  [INFERRED]
  packages/core/src/cash.ts → apps/web/app/(app)/dashboard/vault/SheetGrid.tsx

## Import Cycles
- None detected.

## Communities (2077 total, 149 thin omitted)
...
Cohesion: 0.03
Nodes (80): persistNextStepMemo(), retrier, contentHash(), rearmAfterFix(), Actual, actualValidator, afterCaptionLanding(), evaluateRenderTrigger() (+72 more)

### Community 2 - "page.tsx"
Cohesion: 0.06
Nodes (44): attentionForTenant, attentionList, AttentionView, contactPulse, BusinessFinanceResult, degraded(), FinanceSourceReads, emitConnectorReadEvent() (+36 more)
...
Cohesion: 0.06
Nodes (65): RFC-7009, ParsedPage, datasetArg, environmentArg, hasCreatedAt(), hubspotRead, HubSpotReadEvidence, HubSpotReadResult (+57 more)

### Community 5 - "skills.ts"
Cohesion: 0.05
Nodes (67): requireCredentialKey(), classifyRevokeOutcome(), postTokenForm(), ActionCtx, DatabaseWriter, ensureHubSpotAccessToken(), freshGraphToken(), beginConnect (+59 more)
...
Cohesion: 0.04
Nodes (71): connections, ConnectorView, disconnectProvider, environmentArg, providerArg, startConnect, viewFor(), Attempt (+63 more)

### Community 8 - "ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages"
Cohesion: 0.03
Nodes (95): briefingSheet, capsTeal, snippetSheet, typeBadge, VaultDocButton(), ArtDirection, Block, BriefPatch (+87 more)
...
Cohesion: 0.04
Nodes (42): RFC-2045, RFC-2047, DeliveryResult, send, internalAction, base64Url(), buildMime(), DeliveryRequest (+34 more)

### Community 11 - "scan.ts"
Cohesion: 0.05
Nodes (56): buildInvoiceReminderTool(), ConnectorEnvironment, EVAL_NOW, evalInvoiceProjection(), evalRecipientSuppressed, evalSuppressedRef, invoiceRefArg, InvoiceReminderStageArgs (+48 more)

### Community 12 - "guardrails.ts"
Cohesion: 0.02
Nodes (134): ADR-0003, modules, QueryCtx, activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate (+126 more)
...
Cohesion: 0.02
Nodes (107): finish, latestTurn, record, refuse, StepView, auditCounts, backfillAuditCounts, countAudit (+99 more)
...
Cohesion: 0.03
Nodes (66): applyCrmOperations(), assertConsent, base64urlDecode(), base64urlEncode(), ConsentRecord, ConsentSource, contactByEmail(), ContactOrigin (+58 more)
...
Cohesion: 0.08
Nodes (44): inputStatesFor(), scorecardValue(), solvencyForTenant(), unitEconomicsForTenant(), burn(), activityFromSends(), CashInputs, CashInputSpec (+36 more)
...
Cohesion: 0.04
Nodes (45): backfillRequestDefaults, migrations, run, enumerateWeeklyReview, insertReviewNotification, reviewOne, runWeekly, ADR-0033 (+37 more)
...
Cohesion: 0.08
Nodes (25): A single still image, After a pick completes, Assessing the business, Cancel and start over, Creating images and video, Decision principles, Documents, attachments and decks, Executive Agent — Business Cockpit (v3) (+17 more)

### Community 28 - "Validation Architecture"
Cohesion: 0.05
Nodes (41): cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, ensureThreadAndPlan(), executePlan, ExternalActionType, ExternalArgs (+33 more)
...
Cohesion: 0.07
Nodes (24): ErrorBoundary, CanvasPane(), capsTeal, panel, readStoredWorkspace(), REVIEW_TAB, StoredWorkspace, Tab (+16 more)
...
### Community 35 - "log"
Cohesion: 0.02
Nodes (133): InlineMarkdown(), MarkdownDocument(), tableCells(), ADR-0016, applyGmailCapability(), CAPABILITY_RULES, CockpitCapability, CockpitCapabilityRoute (+125 more)
...
Cohesion: 0.05
Nodes (35): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), Exec, execs() (+27 more)
...
Cohesion: 0.04
Nodes (112): currenciesOf(), accepted(), availableItems(), businessFinance, byCurrency(), CashView, composeBusinessFinance(), environmentArg (+104 more)

### Community 54 - "opsSignals.test.ts"
Cohesion: 0.05
Nodes (42): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+34 more)
...
Cohesion: 0.07
Nodes (36): bumpLanded(), classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch(), DriveFile (+28 more)

### Community 58 - "cockpit.ts"
Cohesion: 0.04
Nodes (75): card, changeIdLine(), changeSummary(), mount(), control, CustomizerView(), CustomizerViewProps, dim (+67 more)
...
Cohesion: 0.05
Nodes (55): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+47 more)
...
Cohesion: 0.10
Nodes (23): AdditionRow, BlueprintDiff(), ContradictionRow, secondaryButton(), NarrativePanel(), isProfileTabId(), isTabId(), page (+15 more)
...
Cohesion: 0.10
Nodes (28): BillingPanelView(), BillingState, body, card, checkoutNotice(), days(), heldAmountCopy(), heldBalancesFigure() (+20 more)
...
Cohesion: 0.12
Nodes (19): reason(), cleaned(), composeDocMemo(), DOC_REVIEW_SECTIONS, DocReviewConfidence, DocReviewSection, isConfidence(), isSection() (+11 more)

### Community 97 - "proactiveReview.ts"
Cohesion: 0.12
Nodes (16): DisconnectGoogle(), connectButton, ConnectionsPanel(), ConnectorRowCard(), ConnectorRows(), disconnectButton, rowStyle, ADR-0018 (+8 more)
...
Cohesion: 0.05
Nodes (62): here, page, preview, previewSource, spec, flushTelemetry(), Fog, IntegrationContext (+54 more)
...
Cohesion: 0.03
Nodes (57): Activity, attRow, box, Briefing, BriefingItem, BriefingRow(), btn, CAL_PROVIDER_LABEL (+49 more)
...
Cohesion: 0.04
Nodes (43): DisconnectMicrosoft(), LINK, ConnectMicrosoftPage(), ADR-0018, aggregateModules, modules, T, ADR-0018 (+35 more)

### Community 140 - "skills.test.ts"
Cohesion: 0.11
Nodes (22): aggregateModules, harness(), modules, ownerHarness(), Seed, tenantHarness(), WINDOW, ACTORS (+14 more)

### Community 145 - "skills.test.ts"
Cohesion: 0.03
Nodes (83): onboardingCompletedAt(), evalSignals, revenueSignals, emitObservedRecoveryEvents(), recordRevenueEvent(), RevenueRecoveryObservation, revenueSubjectRef(), RevenueTelemetryArgs (+75 more)
...
Cohesion: 0.05
Nodes (35): applyClassification, countTerminal(), CREATED_FORM, deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText (+27 more)
...
Cohesion: 0.03
Nodes (82): AGENDA_COPY, AgendaCard(), agendaHasNothingToRank(), agendaRow, AgendaView, BUCKET_WORD, card, ConnectedAgenda() (+74 more)
...
Cohesion: 0.07
Nodes (33): BILLING_EVENT_PAGE_LIMIT, billingCoverageFor(), BillingMovementArgs, BillingPhase, ensureBillingCoverage(), ListBillingEventsArgs, listBillingEventsFor(), PHASES (+25 more)
...
Cohesion: 0.04
Nodes (65): digits(), POSTAL_REFUSAL, ShapePanel(), backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage (+57 more)
...
Cohesion: 0.02
Nodes (92): BLUEPRINT_TEXT, code, modules, sources, cappedPipelineReader, modules, REAL_NOW, seedHealthyTenant() (+84 more)
...
Cohesion: 0.07
Nodes (33): RecommendationCard(), AskSpecialist(), ActivityCard(), stepText(), traceText, bubble(), ChatPane(), COCKPIT_STARTERS (+25 more)
...
Cohesion: 0.09
Nodes (17): tenantAction, generateBoardPack, GenerateBoardPackResult, renderAndStorePack(), aggregateModules, here, modules, PACK_MODULES (+9 more)
...
Cohesion: 0.06
Nodes (34): Agent Evaluation, Connected Product Surfaces — Pulled Before Private Beta, Connector-Backed Revenue Pack, Curated Pack Pilot, Discoverability, Document canvas (minted 2026-09-06 — Phase 40, Track C step 11 / G5), Email Cockpit, Executive Agent & Planning (+26 more)
...
Cohesion: 0.11
Nodes (25): BlueprintEntry, BlueprintField, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField() (+17 more)
...
Cohesion: 0.11
Nodes (25): DocGrid(), docLabel(), fmtSize(), COPY, failureCopy, GENERIC, INGEST, MISSING (+17 more)

### Community 248 - "vaultDrive.test.ts"
Cohesion: 0.02
Nodes (87): burned(), gate(), location(), mint(), mintRaw(), modules, resultOf(), ROUTED (+79 more)
...
Cohesion: 0.14
Nodes (14): AvailabilityRange, availabilityWindow(), eventIdFor(), GOOGLE_SCOPES, hasScope(), toRfc3339(), RFC-3339, button (+6 more)

### Community 251 - "Phase Details"
Cohesion: 0.06
Nodes (29): fenceSafe(), GateStop, KNOWLEDGE_PLAN_JSON_SCHEMA, KNOWLEDGE_SYNTHESIS_JSON_SCHEMA, KnowledgePlanResult, knowledgePlanSchema, KnowledgeSynthesisResult, knowledgeSynthesisSchema (+21 more)
...
Cohesion: 0.01
Nodes (97): aggregateModules, GAP, modules, sync(), ADR-0033, modules, T, aggregateModules (+89 more)
...
Cohesion: 0.09
Nodes (25): AUTHORITY_COPY, body, card, Claim(), CONFIDENCE_COPY, dim, FRESHNESS_COPY, KnowledgeSearchPanel() (+17 more)
...
Cohesion: 0.12
Nodes (18): DOC_IN_PROGRESS, docContext, docReviewSchema, docScopedPassages(), forMatch(), modelDocReview(), NO_REVIEW, pickableDocs (+10 more)
...
### Community 332 - "cockpit-personalize.spec.ts"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (25): briefsPath, codeOwnedMediaModel(), costSrcPath, dispatchSrcPath, ensureTenant(), EnvironmentAbort, fmt(), here (+17 more)
...
Cohesion: 0.05
Nodes (52): activeButton, AuditPage, Business, BusinessSection(), button, caps, card, GovernanceSection() (+44 more)
...
Cohesion: 0.12
Nodes (16): AccessTokenResult, CRM_DATASET, CRM_ENVIRONMENTS, CRM_UNAVAILABLE_REASON, CrmUnavailableCause, dealText(), isoDay(), readCrmKnowledge (+8 more)
...
Cohesion: 0.15
Nodes (15): dueCopy(), ghostButton, listsInvoices(), OpenInvoiceList(), OpenInvoiceRow, openInvoiceRows(), OpenInvoices, reminderOpener() (+7 more)
...
Cohesion: 0.11
Nodes (15): BillingPeriodId, Charge, ChargeKind, chargeValidator, INVOICE_LINE_LABELS, invoiceIdempotencyKey(), periodForPost, PostedCharge (+7 more)
...
### Community 508 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.12
...
### Community 543 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 553 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
...
### Community 562 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)
...
### Community 606 - "verify-knowledge-work-provenance.mjs"
Cohesion: 0.17
...
### Community 617 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 623 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 624 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
...
### Community 645 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 670 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (16): actionLine(), blockerLine(), control, noticeLine(), PackListing, PackRow(), Pin, PinAction (+8 more)
...
### Community 714 - "knowledgeExternalSources.test.ts"
Cohesion: 0.15
...
### Community 732 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 733 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 734 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
...
### Community 736 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
...
### Community 737 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
...
### Community 738 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
...
### Community 739 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
...
### Community 750 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
...
### Community 755 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
...
### Community 756 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
...
### Community 758 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
...
### Community 759 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
...
### Community 760 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
...
### Community 761 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
...
### Community 762 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
...
### Community 769 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
...
Cohesion: 0.03
Nodes (90): modules, sources, ADR-0017, ADR-0022, ADR-0035, attachToThread, decodeUtf8(), dictateToThread (+82 more)
...
Cohesion: 0.15
Nodes (13): Phase 27: Curated Knowledge-Work Pack Pilot, Phase 28.1: Stripe Billing, Invoicing and Tax for Pikar's own merchant account (INSERTED), Phase 28.2: Unpark ONE connector + invoice reminders (INSERTED 2026-09-06), Phase 28: Connector-Backed Revenue Pack, Phase 29: Unified Knowledge and Routines, Phase 30: Optional Vertical Workflow Packs, Phase 35: Outcome language and the idea-stage artifact (INSERTED 2026-09-06), Phase 36: SMOKE sentinels out of band (INSERTED 2026-09-06) (+5 more)
...
Cohesion: 0.09
Nodes (23): CategoryTabs(), VaultDoc, VaultFolder, Crumb, DriveBrowser(), Entry, Node, Note (+15 more)
...
Cohesion: 0.17
Nodes (11): 1.1 Generation (backend) — three siblings, one renderer, two formats, 1.2 Display (web) — the PDF is one click away, the sheet is a `<pre>`, 1.3 Ingest (vault) — the original is kept, the text is the only projection, 1.4 Decisions, requirements, hooks, 1. What exists today, plane by plane, 2. Corrections to the record (verified against source), 3. Design — the lazy version of each step, 4. Blast radius — what goes red, what the hooks demand (+3 more)
...
Cohesion: 0.20
Nodes (9): 1. Step 11 is three phases, not one, 2. G4 — what research is today (measured), 3. G5 — Document Canvas (measured), 4. G6 + G10 — durable runs, fan-out, batches (measured), 5. Proposed split, 6. Owner decisions, G4 design (the lazy version that fixes the felt ceiling), Track C step 11 — research engine (G4), Document Canvas (G5), durable runs + batches (G6, G10) — RESEARCH (+1 more)
...
Cohesion: 0.22
Nodes (9): Lineage, and how a republished template is detected, Phase 29 — pack customization: the THIRD authoring channel (29-05, ROUT-01), Running a pack candidate before it is activated, The five refusals, in order, THE GOVERNANCE DECISION, and why the obvious change was NOT made, THE PACK GATE HAS NO TENANT LANE — and the tenant lane FAILS CLOSED, The pin door IS open, and this is what governs it, What a tenant can and cannot express (+1 more)
...
### Community 1069 - "2026-07-26-voice-doc-picker-design.md"
Cohesion: 0.22
...
Cohesion: 0.11
Nodes (15): discussPillStyle(), folderChip(), MoveDocId, MoveFolderId, pillAnchor(), pillShape, statusBadge(), StatusChip() (+7 more)
...
### Community 1241 - "17.1-09-SUMMARY.md"
Cohesion: 0.29
...
### Community 1349 - "Phase 15 — Sub-agent dispatch + generalized executor"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1350 - "3. Architecture"
Cohesion: 0.40
...
Cohesion: 0.50
Nodes (3): 39-01 — The research specialist reads the pages it cites, Not in scope, Tasks

### Community 1511 - "Deferred items — Phase 06 Live Voice Sessions"
Cohesion: 0.50
Nodes (3): 40-01 — Sheet grids: structured rows at ingest, rendered in the vault preview, Not in scope, Tasks

### Community 1512 - "Phase 7 — Deferred / Out-of-Scope Items"
Cohesion: 0.50
Nodes (3): 40-02 — A real `.xlsx` on both planes, taught by the body, Not in scope, Tasks

### Community 1513 - "Phase 8 — Deferred / Out-of-Scope Items"
Cohesion: 0.50
Nodes (3): 40-03 — The PDF shows up where the work is, and the Office decision is written down, Not in scope, Tasks
...
Cohesion: 0.14
Nodes (22): AgendaAsk, AgendaItem, AgendaView, current, dismiss, syncFromReview, ADR-0033, markAgendaProposed() (+14 more)
...
Cohesion: 0.04
Nodes (58): billingPeriodKey(), billingStatus, Door, doorReturns, hostedSession(), hostedUrl(), invoices, portalLink (+50 more)

### Community 2142 - "connectorOAuthStates (table)"
Cohesion: 0.03
Nodes (75): acquireRefreshLease, commitRefresh, connectionArgs, ConnectionStatusView, connectorStatuses, environmentArg, failureClassArg, get (+67 more)

### Community 2144 - "contacts (table)"
Cohesion: 0.03
Nodes (95): readLiveForTenant(), pageBounded(), artifactById, card(), KINDS_BY_LANE, Lane, LANE_BY_KIND, laneArg (+87 more)

### Community 2154 - "graphEdges (table)"
Cohesion: 0.04
Nodes (75): runVaultGround(), vaultGround, vaultGroundHydrated, classifyDoc, classifySchema, DocIdentity, _docToDocType, ExtractedGraph (+67 more)

### Community 2156 - "guardrailConfig (table)"
Cohesion: 0.03
Nodes (65): ADR-0011, patchControls(), aggregateModules, modules, rateLimiterModules, T, DEFAULT_CONFIG, DEPLOYMENT_BUDGET_CENTS (+57 more)

### Community 2159 - "mediaJobs (table)"
Cohesion: 0.04
Nodes (74): ADR-0028, ADR-0029, ADR-0030, assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit (+66 more)

### Community 2174 - "tenantProfiles (table)"
Cohesion: 0.04
Nodes (73): numeric, firstPage, modules, PlanStatus, activity, applyFinanceClaims(), _docToField, _fieldToDoc (+65 more)

## Knowledge Gaps
- **14804 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+14799 more)
...
- **Why does `internal` connect `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned` to `package.json`, `v1 Requirements`, `skills.ts`, `Playbook: Email Chat Cockpit`, `emailIntent.ts`, `Project State`, `skillBodies.test.ts`, `guardrails.ts`, `Phase 03.7 — Validation Strategy`, `page.tsx`, `knowledgeExternalSources.ts`, `layout.tsx`, `skills.test.ts`, `index.ts`, `agentSteps.test.ts`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `evaluations.test.ts`, `classify.ts`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Project State`, `spend.ts`, `feedback.ts`, `gmail.test.ts`, `page.tsx`, `log`, `pinnedWorkflows.test.ts`, `feedback.test.ts`, `AdminView.tsx`, `optimizerBreach.ts`, `intake.test.ts`, `calendarComplete.ts`, `Parallel Build Lanes (multi-session)`, `vaultSealing.test.ts`, `officeText.ts`, `opsSignals.test.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `vaultSweep.test.ts`, `feedback.test.ts`, `selfCheck`, `tenant.ts`, `intake.test.ts`, `SkillAuthoringPanel.tsx`, `Phase 25.1 Plan 05: Memo Rendering & Research Sources Summary`, `Phase 28 Plan 17: Hard Phase 19/25/27 Readiness Gate Summary`, `dashboardSchema.test.ts`, `knowledgeExternalSources.test.ts`, `cockpit-attachment.spec.ts`, `package.json`, `vaultDigest.ts`, `billingCustomers (table)`, `15.3-04 — folder orchestration (VALT-05, VALT-06, VALT-08)`, `connectorOAuthStates (table)`, `cockpit-split.spec.ts`, `vaultDrive.test.ts`, `contacts (table)`, `012-media-route-and-the-reel.md`, `tenant.ts`, `http.ts`, `guardrailConfig (table)`, `Phase 28.1 Plan 09: The Tenant-Facing Billing Surface — Summary`, `vaultLlm.ts`, `mediaJobs (table)`, `graphEdges (table)`, `Playbook: Audit Log & Dead-Letter Pipeline`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `blueprint.test.ts`, `spendLedger.ts`, `Phase Details`, `vaultTranscribe.test.ts`, `tenantProfiles (table)`, `intake.test.ts`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `api` connect `dashboardSchema.test.ts` to `functions.ts`, `package.json`, `v1 Requirements`, `skills.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `Playbook: Email Chat Cockpit`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `guardrails.ts`, `page.tsx`, `layout.tsx`, `tenant.ts`, `buildCockpitTools`, `cockpit-resolve.spec.ts`, `Validation Architecture`, `Validation Architecture`, `vaultLlm.ts`, `buildCockpitTools`, `29-08 ROUND 3 — the happy arm is reached by a run, not by a fixture`, `log`, `cockpit-schedule.spec.ts`, `optimizerBreach.ts`, `buildTelemetry.ts`, `cockpit.ts`, `Locked Decisions`, `Phase 13 Plan 02: The Weekly Proactive Review Cron Summary`, `vaultLlm.ts`, `betaInvites (table)`, `failureCopy.ts`, `intake.spec.ts`, `classify.ts`, `connectorOAuthStates (table)`, `proactiveReview.ts`, `http.ts`, `guardrailConfig (table)`, `vaultLlm.ts`, `page.tsx`, `tenantProfiles (table)`, `intake.test.ts`, `metering.ts`, `skillBodies.test.ts`, `skills.test.ts`, `skills.test.ts`, `DriveBrowser.tsx`, `vault.spec.ts`, `evaluations.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `feedback.ts`, `feedback.test.ts`, `intake.test.ts`, `Parallel Build Lanes (multi-session)`, `officeText.ts`, `skills.test.ts`, `vaultSweep.test.ts`, `feedback.test.ts`, `index.ts`, `SkillAuthoringPanel.tsx`, `PinnedWorkflowButton.tsx`, `knowledgeExternalSources.test.ts`, `vaultDigest.ts`, `Lane ownership (Phase 3.8)`, `vault-redesign.spec.ts`, `Playbook: Audit Log & Dead-Letter Pipeline`, `profileRedaction.test.ts`, `vaultDrive.test.ts`, `DriveBrowser.tsx`, `vaultTranscribe.test.ts`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `gmailStatus`, `Phase 25 — the owner gates`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `page.tsx`, `gmail.test.ts`, `approvalsView.test.ts`, `AdminView.tsx`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `pipeline-uat.spec.ts`, `tenant.ts`, `cockpit-attachment.spec.ts`, `package.json`, `ReportsView.tsx`, `Phase 25: Private Beta Productionization - Research`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Phase 28.1 Plan 09: The Tenant-Facing Billing Surface — Summary`, `mediaIntent.ts`, `Implementation Decisions`, `Architecture Research`, `pinnedWorkflows.test.ts`, `selfCheck`, `Implementation Decisions`, `Phase 28 Plan 17: Hard Phase 19/25/27 Readiness Gate Summary`, `PinnedWorkflowButton.test.ts`, `Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `extractOfficeText()` connect `Proactive weekly review (BEVL-03, 13-02)` to `AdminView.tsx`?**
