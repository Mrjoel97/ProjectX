# Graph Report - pikar-lane-34  (2026-08-30)

## Corpus Check
- 2007 files · ~4,029,868 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19086 nodes · 22867 edges · 1821 communities (1705 shown, 116 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44345733`
...
4. `contentHash()` - 47 edges
5. `tenantQuery` - 44 edges
6. `buildCockpitTools()` - 37 edges
7. `Playbook: Media Canvas (finished reels and standalone images)` - 37 edges
8. `internalQuery` - 34 edges
9. `base()` - 29 edges
...
## Communities (1821 total, 116 thin omitted)
...
Cohesion: 0.04
Nodes (47): assertSubmitRateLimited, boom, briefingCountForThread, briefingSynopsisPresent, CalendarLifecycleFacts, CalendarLifecycleReadback, createdDocCountForThread, drainDailySpend (+39 more)
...
Cohesion: 0.04
Nodes (93): briefingSheet, capsTeal, snippetSheet, traceText, typeBadge, VaultDocButton(), ArtDirection, Block (+85 more)

### Community 5 - "skills.ts"
Cohesion: 0.05
Nodes (53): runVaultGround(), vaultGround, vaultGroundHydrated, rag, isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource (+45 more)
...
Cohesion: 0.43
Nodes (6): main(), MUSIC_EXTS, MUSIC_SRC, readMusicLibrary(), step(), n()
...
Cohesion: 0.05
Nodes (40): RFC-2045, RFC-2047, googleCalendarToken(), ActionCtx, base64Url(), buildMime(), DeliveryRequest, FetchBodiesResult (+32 more)

### Community 11 - "scan.ts"
Cohesion: 0.04
Nodes (52): activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan, ActivationResult, ActivationTarget (+44 more)
...
Cohesion: 0.09
Nodes (18): BUCKET_WORD, card, CommandCenter(), CONSTRAINT_COPY, CTA_DESTINATION, floorCount(), heading, HEALTH_COPY (+10 more)
...
Cohesion: 0.13
Nodes (20): fmtSize(), DIRECTORY_INPUT_ATTRIBUTES, Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME (+12 more)
...
Cohesion: 0.11
Nodes (20): DOC_IN_PROGRESS, docContext, docReviewSchema, docScopedPassages(), forMatch(), modelDocReview(), NO_REVIEW, pickableDocs (+12 more)
...
Cohesion: 0.07
Nodes (36): ActivitySection(), caps, cardTitle, ConnectedActivity(), ConnectedHeadline(), ConnectedNumbers(), ConnectedSolvency(), ConnectedUnitEconomics() (+28 more)

### Community 24 - "Dropzone.tsx"
Cohesion: 0.03
Nodes (94): BusyRange, createEvent, CreateEventResult, EVENT_URL(), freeBusy, FreeBusyResult, googleDelete(), GoogleError (+86 more)

### Community 25 - "classify.ts"
Cohesion: 0.07
Nodes (38): repriceUsd(), logPlaneJson(), aggregateModules, deadLetters(), modules, rateLimiterModules, rawModules, T (+30 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (90): ADR-0016, ACCENT, AGENT_WRITABLE_FIGURES, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext() (+82 more)
...
Cohesion: 0.14
Nodes (20): InlineMarkdown(), MarkdownDocument(), tableCells(), renderAndStorePack(), buildDocFilename(), DocFormat, DocToken, esc() (+12 more)
...
Cohesion: 0.07
Nodes (45): PinState, IntakeControls(), StorageId, NAV, age(), AllTenantDeadLetters(), OptimizerPanel(), REVIEW_OUTCOMES (+37 more)

### Community 56 - "formatAbsolute"
Cohesion: 0.08
Nodes (25): backfillRequestDefaults, migrations, run, agentAuthoringStateForThread, assertAtReview, assertBlocked, assertDeadLetter, assertDeadLetterReason (+17 more)
...
Cohesion: 0.06
Nodes (42): modules, AGENT_AUTHORABLE_SKILLS, AGENT_EVAL_SUITE, AgentAuthorableSkill, AgentSkillSource, CONTENT_DRAFTER_SKILL, DOCUMENT_DRAFTER_SKILL, EMAIL_DRAFTER_SKILL (+34 more)
...
Cohesion: 0.06
Nodes (27): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+19 more)
...
Cohesion: 0.03
Nodes (75): ADR-0011, controls, coverage, globalRails, LimiterWindow, mediaLedger, patchControls(), readWindow() (+67 more)
...
Cohesion: 0.03
Nodes (39): finish, latestTurn, record, refuse, StepView, aggregateModules, modules, isNonAgentThreadIdError() (+31 more)
...
### Community 73 - "list"
Cohesion: 0.09
Nodes (35): burn(), activityFromSends(), CashInputs, CashInputSpec, CashInputState, CashMetricSet, CashOrigin, CashSolvency (+27 more)
...
Cohesion: 0.09
Nodes (22): auditCounts, backfillAuditCounts, countAudit, log, recentByType, components, buildGeminiEmbedRequest(), buildOpenAIEmbedRequest() (+14 more)
...
Cohesion: 0.18
Nodes (16): Recommendation(), evidence(), HOME_PRIORITY_COPY, HOME_PRIORITY_ORDER, HOME_SIGNAL_LABEL, HOME_UNCERTAIN_COPY, HomeRecommendation, HomeSignal (+8 more)
...
Cohesion: 0.06
Nodes (31): Data flow, Dependencies & blast radius, Discovery and staging order (17-09), How to change safely, How to verify, How to verify, Invariants, Invariants — what must never break (+23 more)
...
Cohesion: 0.04
Nodes (62): manageProbeEnv(), ensureThreadAndPlan(), persistNextStepMemo(), auditControl(), MutationCtx, contentHash(), storeAndLand(), Actual (+54 more)
...
Cohesion: 0.08
Nodes (42): salvageNote(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), deckTokenCounts(), dispatchAndLand(), DispatchArgs (+34 more)
...
Cohesion: 0.08
Nodes (13): loadEffectiveSkill(), loadSkill(), readTenantPublishState(), aggregateModules, modules, SkillStatus, composeUserSkillBody(), hasPassingEvidence() (+5 more)

### Community 121 - "spendLedger.ts"
Cohesion: 0.05
Nodes (60): here, page, preview, previewSource, spec, flushTelemetry(), Fog, IntegrationContext (+52 more)
...
Cohesion: 0.12
Nodes (12): aggregateModules, CalendarEventFields, convexSources, EventField, freeBusyArgs, modules, PlanStatus, seedCalendarGrant() (+4 more)
...
Cohesion: 0.12
Nodes (31): bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, cardColorsOf(), deckStillNeedsJob(), handleRenderRequest(), hasFtypMagic() (+23 more)

### Community 127 - "intake.test.ts"
Cohesion: 0.04
Nodes (47): SubmittableSpec, aggregateModules, asA(), asB(), ASSET, BRIEF, deck(), JOB_41() (+39 more)
...
Cohesion: 0.09
Nodes (33): buildTrajectoryExport, scrub(), transcribeDoc, Err, Ok, Result, unwrap(), CHEAP_MODEL (+25 more)
...
Cohesion: 0.03
Nodes (54): Activity, attRow, badge(), box, Briefing, BriefingItem, BriefingRow(), btn (+46 more)
...
Cohesion: 0.03
Nodes (36): AttachmentPicker(), UploadedAttachment, DisconnectGoogle(), DisconnectMicrosoft(), LINK, KIND_HREF, NotificationsBanner(), ConnectMicrosoftPage() (+28 more)
...
Cohesion: 0.10
Nodes (29): VaultDoc, confirmedDelete(), dangerButtonStyle, fieldStyle, PreviewActionDescriptor, previewActionDescriptors(), PreviewActionId, PreviewControlHandlers (+21 more)
...
Cohesion: 0.12
Nodes (16): A second stager, and a memo that stops lying (16-06, DISP-02), "Act on this" now RUNS the specialist (15-04, DISP-01), Blueprint standing context and the provenance ceiling, Data flow, Dependencies & blast radius, How to change safely, How to verify, How to verify (+8 more)
...
Cohesion: 0.07
Nodes (29): mockGoogle(), docForMint, hangupCall, mintClientSecret, MintResponse, calls, Captured, modules (+21 more)
...
Cohesion: 0.05
Nodes (49): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+41 more)

### Community 155 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.17
Nodes (18): scene(), AssemblyReport, AssemblyScene, ascii(), assTime(), buildCaptionLines(), CaptionLine, concatWavTakes() (+10 more)
...
Cohesion: 0.10
Nodes (18): answerDecision, blockedSummary, CASH_FIELD_BY_QUESTION, fieldValue(), listAwaiting, listCleared, listDecisions, listInFlight (+10 more)
...
Cohesion: 0.04
Nodes (62): assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender(), confirmClaim (+54 more)
...
Cohesion: 0.04
Nodes (32): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+24 more)
...
Cohesion: 0.13
Nodes (21): activity(), Phase, PostCall(), primaryBtn, secondaryBtn, today(), two(), BRIEF_HEADERS (+13 more)
...
Cohesion: 0.07
Nodes (28): 15.3-01 — schema, 15.3-02 — read-surface survivability + cap single-source, 15.3-03 — the budget rail selector (ingest stops spending the cockpit's $5), 15.3-05 — sealing (VALT-07), 15.3-08 — document identity (VALT-12), 15.3-09 — the Google Drive rail (VALT-13), A model string never reaches the database, Accepted limitation — structural, not content (+20 more)

### Community 190 - "vaultSweep.test.ts"
Cohesion: 0.11
Nodes (23): ConnectionsPanel(), pill, row, ADR-0018, NarrativePanel(), isTabId(), page, ProfilePage() (+15 more)
...
Cohesion: 0.20
Nodes (11): pickedFolderFromFiles(), VaultBody(), Attachment, EXT_MIME, MIME_ALLOWLIST, RejectionReason, resolveMimeType(), SubmitInput (+3 more)

### Community 201 - "isolation.test.ts"
Cohesion: 0.14
Nodes (11): EXEMPT_AUTH, LooseCall, NON_TENANT_LEADING, OWNER_ARGS, OWNER_SURFACE, PUBLIC_SURFACE, PUBLIC_UNAUTHENTICATED, PublicFn (+3 more)
...
Cohesion: 0.13
Nodes (17): discussPillStyle(), DocGrid(), docLabel(), folderChip(), MoveDocId, MoveFolderId, pillAnchor(), pillShape (+9 more)
...
Cohesion: 0.02
Nodes (84): aggregateModules, coreSources, Harness, modules, PARTIAL_REASONS, rawSources, signed(), httpAction (+76 more)
...
Cohesion: 0.26
Nodes (12): aggregateModules, always(), callWith(), create(), FAT_EVENT, freeBusyArgs, harness(), json() (+4 more)
...
Cohesion: 0.13
Nodes (19): DocId, DocStrip(), bubble(), fmt(), LiveSession(), speakerLabel(), two(), VoicePage() (+11 more)
...
Cohesion: 0.09
Nodes (22): Environment — the deployment was DOWN and had to be recovered first, ⚠ `extractionTruncated` will now start appearing on long scans — EXPECTED, not a regression, INVARIANT — never let a non-empty string stand in for "we got content", INVARIANT — `""`, not a throw, and the two endings must not be merged, INVARIANT — the PPTX entry list, positive AND negative, ⚠ KNOWN GAP — PPTX extracts TITLES ONLY, and scaffolding-only output reports `ready`, Live result — 2026-07-27, `local-joel_feruzi-pikar_ai_50c69-1`, Live result — 2026-07-27, `local-joel_feruzi-pikar_ai_50c69-1` (+14 more)
...
Cohesion: 0.04
Nodes (75): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+67 more)
...
Cohesion: 0.22
Nodes (12): derivedConstantFor(), KNOWN_FLAGS, lf(), loadDerived(), main(), manifestPath, noticesPath, repoRoot (+4 more)
...
Cohesion: 0.10
Nodes (18): CategoryTabs(), VaultFolder, Crumb, DriveBrowser(), Entry, Node, Note, WHY (+10 more)
...
Cohesion: 0.05
Nodes (33): ageLabel(), ApprovalsView(), AttachmentLinks, AwaitingItem, AwaitingPage, AwaitingSection(), button, caps (+25 more)
...
Cohesion: 0.06
Nodes (44): firstPage, modules, PlanStatus, activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal (+36 more)
...
Cohesion: 0.14
Nodes (22): pageBounded(), activeSkills, auditPage, readAuditPage(), wormExport, REGISTRY_SKILL_NAMES, compareDashboardOrder(), CompleteDashboardBound (+14 more)
...
Cohesion: 0.05
Nodes (58): backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier, FACT_KEYS, forTenant (+50 more)
...
### Community 328 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.08
...
### Community 330 - "dashboardSchema.test.ts"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)
...
### Community 338 - "Phase 16 — the GROUNDED probe (`probe:gemini --grounded`), 2026-08-07"
Cohesion: 0.08
...
### Community 341 - "ADR-019: The scene timeline supersedes the uniform block deck"
Cohesion: 0.08
...
### Community 342 - "Hot Path Rules"
Cohesion: 0.08
Nodes (23): 1. Push Filters To Storage, 2. Minimize Data Sources, 3. Minimize Row Size, 4. Isolate Frequently-Updated Fields, 5. Match Consistency To Read Patterns, Aggregates, Backfills, Check for redundant indexes (+15 more)

### Community 343 - "reportsBusiness.ts"
Cohesion: 0.12
Nodes (22): readLiveForTenant(), runCron(), landPack, snapshot, business, capped(), earliestAt(), isFilled() (+14 more)
...
### Community 346 - "Critical Pitfalls"
Cohesion: 0.08
...
### Community 348 - "Parallel Build Lanes (multi-session)"
Cohesion: 0.40
...
### Community 351 - "Phase 17 Plan 05: `calendar_manage` Substrate Summary"
Cohesion: 0.09
...
### Community 357 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.40
...
### Community 358 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 359 - "commandCenter.test.ts"
Cohesion: 0.09
...
### Community 362 - "Phase 25: Private Beta Productionization - Context"
Cohesion: 0.09
...
### Community 363 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 366 - "plans.test.ts"
Cohesion: 0.03
Nodes (70): cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs (+62 more)

### Community 367 - "approvalsView.test.ts"
Cohesion: 0.14
Nodes (21): actionLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), AwaitingCardBody(), browserTimeZone(), ClearedRow(), emailApprovalActionLabel(), formatAbsoluteInstant() (+13 more)

### Community 368 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 369 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 370 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.09
...
### Community 371 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 373 - "Implementation Decisions"
Cohesion: 0.09
...
### Community 374 - "Implementation Decisions"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (118): byThread, insert, LatestBriefing, latestForTenant, ADR-0004, byThread, insert, ADR-0004 (+110 more)
...
### Community 381 - "Phase 21 Research: User-Authored Skills & Routines"
Cohesion: 0.09
...
### Community 383 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 384 - "Architecture Research"
Cohesion: 0.09
...
### Community 387 - "Fix Order"
Cohesion: 0.10
Nodes (20): 1. Use point-in-time reads when live updates are not valuable, 2. Batch related data into fewer queries, 3. Use skip to avoid unnecessary subscriptions, 4. Isolate frequently-updated fields into separate documents, 5. Use the aggregate component for counts and sums, 6. Narrow query read sets, 7. Remove `Date.now()` from queries, 8. Consider pagination strategy (+12 more)

### Community 389 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 390 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 391 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 392 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 393 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 394 - "Phase 19 Plan 10: Close the phase honestly Summary"
Cohesion: 0.10
...
### Community 395 - "Phase 19 Plan 13: Consent Record Gap Closure Summary"
Cohesion: 0.10
...
### Community 398 - "Phase 21 Plan 03: Exact Tenant Candidate Evaluation Summary"
Cohesion: 0.10
...
### Community 399 - "Verified defect inventory (the work list)"
Cohesion: 0.10
...
### Community 402 - "26-20 Task 2 — Command Center v2 and Phase 26 owner UAT (BLOCKING, open)"
Cohesion: 0.10
...
### Community 403 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 405 - "ContentErrorBoundary"
Cohesion: 0.12
...
### Community 406 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 407 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 408 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 409 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 410 - "burnCapsScript.ts"
Cohesion: 0.10
...
### Community 413 - "Implementation Decisions"
Cohesion: 0.10
...
### Community 416 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 417 - "Phase 25.1 Plan 05: Memo Rendering & Research Sources Summary"
Cohesion: 0.10
...
### Community 418 - "Phase 33.1 PRD — Media provider migration to OpenRouter"
Cohesion: 0.10
...
### Community 419 - "Fix Order"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 420 - "Pikar Consistency Audit"
Cohesion: 0.11
...
### Community 421 - "deletableTables"
Cohesion: 0.50
Nodes (3): deletableTables(), schemaSource, schemaTables

### Community 422 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 426 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 427 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 429 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 430 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 431 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 432 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 433 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 434 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 435 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 437 - "17-08 SUMMARY — governed calendar management: management, minus Microsoft delete"
Cohesion: 0.11
...
### Community 438 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 440 - "Phase 19 Plan 09: Teach the Body, Owe the Fixture Summary"
Cohesion: 0.11
...
### Community 441 - "Phase 21 Plan 05: Routine v0 — Pinned Prompts Summary"
Cohesion: 0.11
...
### Community 442 - "Phase 25.1 Plan 04: Approvals Feedback Summary"
Cohesion: 0.11
...
### Community 443 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 444 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)
...
### Community 446 - "render.test.ts"
Cohesion: 0.12
Nodes (12): setup(), convexSiteOrigin(), isTransientRenderCode(), SandboxOptions, body(), deps(), plausibleMp4(), Recorder (+4 more)
...
### Community 448 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 449 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 450 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 451 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 452 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 453 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 454 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)

### Community 455 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 456 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 457 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 458 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 459 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 460 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 461 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 462 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 466 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 467 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 468 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 469 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 470 - "Phase 19.1 Plan 06: The CSV Import Panel Summary"
Cohesion: 0.11
...
### Community 472 - "Phase 33 Plan 09: media-director v3 — the specialist learns to write what the parsers read"
Cohesion: 0.11
...
### Community 473 - "Phase 33 Plan 13: The proposal stage gets a failure card, and the two parser edits get disclosed Summary"
Cohesion: 0.11
...
### Community 474 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 475 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 476 - "15.3-04 — folder orchestration (VALT-05, VALT-06, VALT-08)"
Cohesion: 0.07
Nodes (54): ArtDirection, Block, BLOCK_REFUSAL_WHY, cellsOf(), CLAIM_QUANTIFIED, CLIP_SECONDS, CLIP_SECONDS_SET, DeckContract (+46 more)

### Community 477 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 478 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 479 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 480 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 481 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 482 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 483 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 484 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 485 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 486 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 487 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 488 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 490 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 492 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 493 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 494 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 496 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 497 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 498 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 499 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 508 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 509 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 510 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 512 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 513 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 514 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 515 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 516 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 517 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)

### Community 518 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 519 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 520 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 521 - "Phase 17 Plan 09: Managed-event discovery and safe staging Summary"
Cohesion: 0.12
...
### Community 522 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.12
...
### Community 523 - "Phase 19.1 Plan 05: pipelineTiles Reports Its Scan Bound Summary"
Cohesion: 0.12
...
### Community 524 - "Phase 20.2: Scene Timeline Reels — Code and Offline Evidence Summary"
Cohesion: 0.12
...
### Community 525 - "Phase 21 Plan 02: Tenant Candidate Write/Read and Effective Loading Summary"
Cohesion: 0.12
...
### Community 527 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 528 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 529 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 531 - "finance-update-fails-only-in-full-sequence.md"
Cohesion: 0.12
...
### Community 532 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 533 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 535 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 543 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 545 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 546 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 547 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 548 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 549 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 550 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 551 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 553 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 555 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 556 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 557 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 558 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 559 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 562 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 563 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 565 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 566 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 567 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 568 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 570 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 571 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 572 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 573 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 574 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 575 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 576 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 577 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 578 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 579 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 580 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 581 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 582 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 583 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 584 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 585 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 586 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 587 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 588 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 589 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 590 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 592 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 603 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 604 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 606 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 607 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 608 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 609 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 610 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 611 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 612 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 613 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 614 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 615 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 617 - "Phase 19 Plan 03: The CAN-SPAM postal address Summary"
Cohesion: 0.12
...
### Community 618 - "Phase 25.1 Plan 01: renderReel Honest Terminals Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 619 - "Phase 25.1 Plan 02: Stuck-Work Watchdog Summary"
Cohesion: 0.12
...
### Community 620 - "Phase 25.1 Plan 03: Media Vault Persistence Summary"
Cohesion: 0.12
...
### Community 621 - "Phase 33 Plan 02: Plan-Row State + Governed Mutations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 623 - "Phase 33 Plan 03: Persist Terminal + Money Gates Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 624 - "Phase 33 Plan 04: Failure/Retry Backend Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 638 - "Phase 33 Plan 08: Grounded citations and clear failure on the canvas Summary"
Cohesion: 0.12
...
### Community 639 - "Feature Research"
Cohesion: 0.12
...
### Community 640 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 643 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 644 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 645 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 646 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 647 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 648 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 649 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 650 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 651 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 652 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 653 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 654 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 655 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 656 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 657 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 658 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 664 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 665 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 666 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 667 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 668 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 669 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 670 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 671 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 672 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 675 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 680 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 681 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 682 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 683 - "Phase 5 Plan 05: Vault Read Plane (GraphRAG grounding + browse/search) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 684 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 686 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 687 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 688 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 689 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 690 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 691 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 695 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 696 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 697 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 698 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 699 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 700 - "Phase 17 Calendar Actions — agent-operated live UAT runbook"
Cohesion: 0.13
...
### Community 701 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 702 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 703 - "Phase 19.1 Plan 03: fill-empty-only as a Flag on the ONE Writer Summary"
Cohesion: 0.13
...
### Community 704 - "Phase 19.1 Plan 04: matchExisting and importContacts Summary"
Cohesion: 0.13
...
### Community 705 - "Phase 22: Owner Authorization Primitive Verification Report"
Cohesion: 0.13
...
### Community 706 - "23-03 SUMMARY — the model can now draft a skill, and still cannot activate one"
Cohesion: 0.13
...
### Community 707 - "Phase 25 Plan 05: Microsoft Delivery Arm Summary"
Cohesion: 0.13
...
### Community 708 - "26-17 — Reports, connected end to end, and the nav that only lit after the owner said so"
Cohesion: 0.13
...
### Community 709 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 710 - "Phase 33 Plan 01: Storyboard Parse Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 711 - "Project State"
Cohesion: 0.13
...
### Community 714 - "Phase 12: Business Evaluation Engine - Research"
Cohesion: 0.14
...
### Community 715 - "Phase 15.4 Plan 02: Connected Nord Edge Vault Browse Summary"
Cohesion: 0.14
...
### Community 716 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 717 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 718 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 719 - "Phase 19.1 Plan 02: The Two Union Widenings Summary"
Cohesion: 0.14
...
### Community 720 - "Phase 19.1: Bulk Contact Import (CSV) — Research"
Cohesion: 0.14
...
### Community 722 - "Phase 19 Plan 08: Contacts-first resolution and the CRM staging tool Summary"
Cohesion: 0.14
...
### Community 723 - "Phase 20 Plan 20: Finance Fingerprint Reconciliation Summary"
Cohesion: 0.14
...
### Community 724 - "Phase 21 Plan 01: Contracts and Schema Foundation Summary"
Cohesion: 0.14
...
### Community 725 - "Phase 22.1 Plan 04: Tenant Data Export Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 726 - "Phase 25 Plan 03: Isolation Gate Summary"
Cohesion: 0.14
...
### Community 727 - "Phase 26 Plan 04: Approvals Read Model Summary"
Cohesion: 0.14
Nodes (13): Accomplishments, Auto-fixed Issues, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance (+5 more)

### Community 728 - "26-10-PLAN.md"
Cohesion: 0.14
...
### Community 729 - "Phase 27 Plan 02: Native Pack Contracts Summary"
Cohesion: 0.14
...
### Community 732 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 736 - "assembly.ts"
Cohesion: 0.28
Nodes (11): ASSEMBLY_VISUALS, AssemblyError, AssemblyVisual, isGovernedRender(), near(), num(), parseAssemblySidecar(), codeOf() (+3 more)

### Community 737 - "package.json"
Cohesion: 0.15
Nodes (12): dependencies, @pikar/core, devDependencies, vitest, exports, name, private, scripts (+4 more)

### Community 738 - "package.json"
Cohesion: 0.15
Nodes (12): dependencies, @pikar/core, devDependencies, vitest, exports, name, private, scripts (+4 more)

### Community 739 - "Goal Achievement"
Cohesion: 0.15
...
### Community 750 - "Phase 3.8 Plan 02: Lane 1 — PDF + Image Extraction Summary"
Cohesion: 0.15
...
### Community 751 - "Plan 03.9-02 — Summary"
Cohesion: 0.15
...
### Community 752 - "Goal Achievement"
Cohesion: 0.15
...
### Community 753 - "Goal Achievement"
Cohesion: 0.15
...
### Community 755 - "Phase 6: Live Voice Sessions — Close Summary"
Cohesion: 0.15
...
### Community 756 - "Goal Achievement"
Cohesion: 0.15
...
### Community 758 - "Phase 14 Plan 02: Pure Voice-Doc Domain Summary"
Cohesion: 0.15
...
### Community 760 - "Phase 15.2 Plan 02: Universal Format Coverage (Pure Layer) Summary"
Cohesion: 0.15
...
### Community 761 - "Phase 15.4 Plan 01: Folder-Scoped Vault Search Summary"
Cohesion: 0.15
...
### Community 763 - "Phase 17.1 Plan 09: Profile Blueprint Confirmation Surface Summary"
Cohesion: 0.15
...
### Community 764 - "Phase 17.1 — Validation Strategy"
Cohesion: 0.15
...
### Community 767 - "Phase 19.1 Plan 01: The Pure CSV Import Brain Summary"
Cohesion: 0.15
...
### Community 768 - "Phase 19 Plan 01: Contacts substrate Summary"
Cohesion: 0.15
...
### Community 771 - "10. Pitfalls, ranked by how likely this phase is to go wrong"
Cohesion: 0.15
...
### Community 772 - "Phase 23 Plan 05: Owner/Eval Agent Activation Summary"
Cohesion: 0.15
...
### Community 773 - "Phase 25 Plan 02: Beta Admission UI Summary"
Cohesion: 0.15
...
### Community 774 - "Phase 25: Private Beta Productionization - Research"
Cohesion: 0.15
...
### Community 776 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 777 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 778 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 779 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 780 - "Phase 33 Plan 06: Reel-first canvas Summary"
Cohesion: 0.15
...
### Community 781 - "Phase 33 Plan 07: Guided intake and variations on the canvas Summary"
Cohesion: 0.15
...
### Community 782 - "Phase 19.1: Bulk Contact Import (CSV) Verification Report"
Cohesion: 0.17
...
### Community 783 - "Migration Patterns Reference"
Cohesion: 0.17
Nodes (11): Adding a Required Field, Changing a Field Type, Cleaning Up Orphaned Documents, Deleting a Field, Dual Read, Dual Write (Preferred), Migration Patterns Reference, Small Table Shortcut (+3 more)

### Community 784 - "Convex Auth"
Cohesion: 0.17
Nodes (11): Checklist, Concrete Steps, Convex Auth, Expected Files and Decisions, Gotchas, Human Handoff, Production, Validation (+3 more)

### Community 785 - "vaultSweep.test.ts"
Cohesion: 0.17
...
### Community 787 - "External Integrations"
Cohesion: 0.17
...
### Community 789 - "Design — Agent-Driven Cockpit (capability #1)"
Cohesion: 0.17
...
### Community 790 - "The Goal Engine (Chief-of-Staff loop) — design capture"
Cohesion: 0.17
...
### Community 791 - "Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary"
Cohesion: 0.17
...
### Community 792 - "Implementation Decisions (LOCKED)"
Cohesion: 0.17
...
### Community 793 - "Phase 03.2 Plan 05: Resolution Card UI Summary"
Cohesion: 0.17
...
### Community 794 - "Plan 03.9-03 — Summary"
Cohesion: 0.17
...
### Community 795 - "Goal Achievement"
Cohesion: 0.17
...
### Community 796 - "Phase 14 Plan 01: Wave-0 Freeze Commit Summary"
Cohesion: 0.17
...
### Community 797 - "Phase 15.2 Plan 03: Permissive Scheduling + In-Action Rail Dispatch Summary"
Cohesion: 0.17
...
### Community 798 - "15.3-05 — sealing (VALT-07)"
Cohesion: 0.17
...
### Community 800 - "16-09 — the research eval gate"
Cohesion: 0.17
...
### Community 801 - "17.1-10 live-gate audit"
Cohesion: 0.17
...
### Community 802 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 803 - "reportsGovernance.test.ts"
Cohesion: 0.20
Nodes (10): aggregateModules, harness(), modules, ownerHarness(), Seed, sourceFiles(), tenantHarness(), WINDOW (+2 more)

### Community 804 - "Phase 19 Plan 02: The person store Summary"
Cohesion: 0.17
...
### Community 805 - "Phase 19 Plan 04: The public unsubscribe route Summary"
Cohesion: 0.17
...
### Community 806 - "Phase 19 Plan 05: The trust boundary Summary"
Cohesion: 0.17
...
### Community 807 - "Phase 19 Plan 06: crm_write, the fifth action type Summary"
Cohesion: 0.17
...
### Community 808 - "Phase 19 Plan 07: The connected Pipeline route Summary"
Cohesion: 0.17
...
### Community 810 - "Phase 19: Contacts, CRM & Follow-ups — Verification Report"
Cohesion: 0.17
...
### Community 812 - "Phase 20.1 Plan 01: Drive Read Substrate Summary"
Cohesion: 0.17
...
### Community 813 - "Phase 20.2 — Validation Strategy"
Cohesion: 0.17
...
### Community 816 - "Phase 20 — Validation Strategy"
Cohesion: 0.17
...
### Community 817 - "23-04 SUMMARY — the gate that judges what the agent wrote, and cannot be read by it"
Cohesion: 0.17
...
### Community 818 - "Phase 24 Plan 01: ISO 9001 Evidence Map Foundation Summary"
Cohesion: 0.17
...
### Community 819 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 820 - "Goal Achievement"
Cohesion: 0.17
...
### Community 821 - "26-15 — the audit viewer is safe by filtering, and the mockup said otherwise"
Cohesion: 0.17
...
### Community 822 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 823 - "Implementation Decisions"
Cohesion: 0.17
...
### Community 824 - "Phase 33 Plan 10: closing the phase live — and the two defects that only production could show"
Cohesion: 0.17
...
### Community 826 - "route.ts"
Cohesion: 0.18
Nodes (4): POST(), SH, SH, SandboxLike

### Community 827 - "crmCard.test.ts"
Cohesion: 0.20
...
### Community 832 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 833 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)
...
### Community 839 - "Repository Structure"
Cohesion: 0.18
...
### Community 840 - "Inbox Briefing (Phase 3.7)"
Cohesion: 0.18
...
### Community 842 - "Architecture Patterns"
Cohesion: 0.18
...
### Community 843 - "Goal Achievement"
Cohesion: 0.18
...
### Community 846 - "Phase 3.8 Plan 05: Lane 4 — Video Transcription Summary"
Cohesion: 0.18
...
### Community 847 - "Plan 03.9-04 — Summary"
Cohesion: 0.18
...
### Community 848 - "Goal Achievement"
Cohesion: 0.18
...
### Community 851 - "Implementation Decisions (LOCKED by owner 2026-07-21)"
Cohesion: 0.18
...
### Community 854 - "Goal Achievement"
Cohesion: 0.18
...
### Community 856 - "Phase 14: Flagship Voice-Doc Workflow — Research"
Cohesion: 0.18
...
### Community 857 - "2. Ingest orchestration at folder scale"
Cohesion: 0.18
...
### Community 858 - "Phase 15.4 Plan 04: Connected Vault Verification Summary"
Cohesion: 0.18
...
### Community 859 - "home.ts"
Cohesion: 0.18
Nodes (8): health, HomeHealth, HomeSummary, summary, UNAVAILABLE, DashboardPartialReason, HomeHealthState, HomePriorityCode
...
### Community 861 - "Phase 16: Research Sub-Agent & Web Research — Research"
Cohesion: 0.18
...
### Community 865 - "Phase 18 Plan 02: Schema & Trace Registration Surfaces Summary"
Cohesion: 0.18
...
### Community 866 - "Phase 18 Plan 05: Threading skillName and format Summary"
Cohesion: 0.18
...
### Community 868 - "Phase 19.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 869 - "Phase 19 — Validation Strategy"
Cohesion: 0.18
...
### Community 870 - "Phase 20.1 — Validation Strategy"
Cohesion: 0.18
...
### Community 876 - "Phase 20: Media Canvas — Research"
Cohesion: 0.18
...
### Community 877 - "6. Q4 — WHAT THE RE-SCOPE BREAKS IN THE TWELVE PLANS"
Cohesion: 0.18
...
### Community 878 - "Phase 21 — Validation Strategy"
Cohesion: 0.18
...
### Community 879 - "23-01 SUMMARY — the agent-authoring data vocabulary, and nothing else"
Cohesion: 0.18
...
### Community 880 - "Phase 23 — Validation Strategy"
Cohesion: 0.18
...
### Community 881 - "Phase 24 — Validation Strategy"
Cohesion: 0.18
...
### Community 882 - "26-10 — Connected Finance route: executed browser gate, owner UAT, closure"
Cohesion: 0.18
...
### Community 883 - "26-13 — the connected Content library, approved and live"
Cohesion: 0.18
...
### Community 884 - "27-07 — Bind the packs onto the real agent seam, and measure real runs"
Cohesion: 0.18
...
### Community 889 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 890 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 891 - "Phases 14–25 — gap ledger (re-derived 2026-08-17)"
Cohesion: 0.18
...
### Community 892 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 893 - "Code Conventions"
Cohesion: 0.20
...
### Community 894 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 895 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 896 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 897 - "Goal Achievement"
Cohesion: 0.20
...
### Community 898 - "Goal Achievement"
Cohesion: 0.20
...
### Community 900 - "Goal Achievement"
Cohesion: 0.20
...
### Community 901 - "Goal Achievement"
Cohesion: 0.20
...
### Community 902 - "Goal Achievement"
Cohesion: 0.20
...
### Community 904 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 905 - "Goal Achievement"
Cohesion: 0.20
...
### Community 909 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 910 - "Goal Achievement"
Cohesion: 0.20
...
### Community 914 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 917 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 918 - "Goal Achievement"
Cohesion: 0.20
...
### Community 919 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 920 - "Goal Achievement"
Cohesion: 0.20
...
### Community 921 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 924 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 925 - "Goal Achievement"
Cohesion: 0.20
...
### Community 926 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 927 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 928 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 931 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 932 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 935 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 936 - "Phase 19.1 Plan 07: The Browser Proof Summary"
Cohesion: 0.20
...
### Community 937 - "Deferred items — Phase 19"
Cohesion: 0.20
...
### Community 941 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 942 - "Phase 25 Plan 01: Beta Admission Trust Boundary Summary"
Cohesion: 0.20
...
### Community 943 - "Phase 25 — the owner gates"
Cohesion: 0.20
...
### Community 944 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 946 - "26-14 — truthful report metrics, and the audit that found the plan's own first draft lying"
Cohesion: 0.20
...
### Community 947 - "Validation Architecture"
Cohesion: 0.20
...
### Community 948 - "Phase 31: Marketing Surface and Funnel v0 — Validation Strategy"
Cohesion: 0.20
...
### Community 949 - "Phase 33.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 950 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 951 - "2026-07-26-voice-doc-picker-design.md"
Cohesion: 0.22
...
### Community 952 - "finance.test.ts"
Cohesion: 0.22
Nodes (4): aggregateModules, modules, rateLimiterModules, T

### Community 953 - "Technology Stack"
Cohesion: 0.22
...
### Community 954 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 955 - "Service architecture, post-beta — design note"
Cohesion: 0.22
...
### Community 956 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 957 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 958 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 959 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 960 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 961 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 962 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 963 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 964 - "Locked Decisions"
Cohesion: 0.22
...
### Community 966 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 970 - "reportsGovernance.test.ts"
Cohesion: 0.12
Nodes (18): AskSpecialist(), AbnormalBriefBanner(), markVoiceBriefSeen(), readSeen(), ActivityCard(), stepText(), bubble(), ChatPane() (+10 more)

### Community 971 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 972 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 973 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 974 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 975 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 976 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 977 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 979 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 980 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 981 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 982 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 983 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 984 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 988 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 989 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 990 - "Phase 17 — Gap-Closure Validation Strategy"
Cohesion: 0.22
...
### Community 991 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 993 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 994 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 999 - "21-07 COMPLETE — the frozen candidate carries a passing held-out gate"
Cohesion: 0.22
...
### Community 1000 - "Phase 21: User-Authored Skills & Routines Verification Report"
Cohesion: 0.22
...
### Community 1001 - "Phase 22.1 Plan 05: Tenant Deletion Summary"
Cohesion: 0.22
...
### Community 1002 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 1003 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 1004 - "Deferred items — phase 25.1"
Cohesion: 0.22
...
### Community 1005 - "Phase 25 Plan 04: First-Send Projection Summary"
Cohesion: 0.22
Nodes (9): Accomplishments, Decisions Made, Files Created/Modified, Next Phase Readiness, Performance, Phase 25 Plan 04: First-Send Projection Summary, Requirements and Live Gates, Task Commits (+1 more)

### Community 1006 - "1. The invite gate — `callbacks.createOrUpdateUser` (BETA-01) — **HIGH confidence, source-verified**"
Cohesion: 0.22
...
### Community 1007 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1008 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1009 - "Plan 26-20: Command Center v2, owner-approved"
Cohesion: 0.22
...
### Community 1010 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 1011 - "Phase 27 Plan 01: Upstream Pin and Provenance Summary"
Cohesion: 0.22
...
### Community 1012 - "Phase 27 Plan 03: Pack Measurement Plane Summary"
Cohesion: 0.22
...
### Community 1013 - "27-08 — Final provenance, six DEV candidates, and an eval runner that can go red"
Cohesion: 0.22
...
### Community 1014 - "Phase 27 Decision Memo — Curated Knowledge-Work Pack Pilot"
Cohesion: 0.22
...
### Community 1016 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 1017 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 1018 - "Plan 33-05: Auto-assembled reel — vault save + regenerate ordering"
Cohesion: 0.22
...
### Community 1020 - "Roadmap: Pikar-AI"
Cohesion: 0.22
...
### Community 1021 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 1022 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 1024 - "vaultGround.test.ts"
Cohesion: 0.36
Nodes (6): BLUEPRINT_TEXT, modules, seedChain(), seedConfirmedBlueprint(), seedDoc(), seedEdge()

### Community 1026 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 1027 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1028 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 1030 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1031 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1032 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 1033 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 1034 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 1035 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 1038 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1039 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1041 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1042 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1043 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 1044 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1045 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 1046 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 1047 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 1048 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1049 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 1051 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 1052 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1053 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1054 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 1055 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 1056 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1057 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1058 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 1059 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 1060 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 1061 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1062 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 1063 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 1064 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 1065 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1066 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 1067 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.25
...
### Community 1068 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1070 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1072 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1073 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1074 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1075 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 1076 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 1078 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 1081 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 1082 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 1083 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 1084 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 1085 - "Phase 22.1 Plan 03: CI Gate Summary"
Cohesion: 0.25
...
### Community 1086 - "Phase 22.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1087 - "Phase 22.1 — Goal Verification"
Cohesion: 0.25
...
### Community 1088 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 1089 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 1090 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 1091 - "Phase 23 prerequisite gate — run 2026-08-18, before the first edit"
Cohesion: 0.25
...
### Community 1092 - "23-02 SUMMARY — the inert writer, built before anything can reach it"
Cohesion: 0.25
...
### Community 1093 - "25.1-07 — Live UAT checkpoint"
Cohesion: 0.25
...
### Community 1094 - "Phase 25.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1095 - "Phase 25 — Validation Strategy"
Cohesion: 0.25
...
### Community 1096 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 1097 - "26-11 — artifact provenance and the explicit trust promotion"
Cohesion: 0.25
...
### Community 1098 - "26-12 — the Content shelf: one bounded read plane over artifacts that already exist"
Cohesion: 0.25
...
### Community 1099 - "26-13.1 — the image lane, and the comment that hid it"
Cohesion: 0.25
...
### Community 1100 - "26-16 — the board pack: one transaction is the snapshot, and promotion is not a new authorship"
Cohesion: 0.25
...
### Community 1101 - "27-09 — The discovery surface, the owner primitive, and the deadlock they had to break"
Cohesion: 0.25
...
### Community 1102 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 1103 - "Phase 33: Media Creation UX Overhaul - Research"
Cohesion: 0.25
...
### Community 1104 - "Phase 33 — Validation Strategy"
Cohesion: 0.25
...
### Community 1105 - "Key files"
Cohesion: 0.29
Nodes (7): Business blueprint (Phase 17.1) — `packages/core/src/blueprint.ts`, Key files, The conversational turn (plan 15.1-06, design §6) — `convex/onboarding.ts` `converse`, The `saveFacts` contract (plan 15.1-02) — `convex/tenantProfile.ts`, The two surfaces (plan 15.1-07) — `apps/web/.../onboarding/page.tsx` + `.../profile/page.tsx`, Tier control plane — `tenantProfiles` (Phase 15.1, design §4.1), Tier derivation (Phase 15.1, design §5) — same file, `businessProfile.ts`

### Community 1106 - "17.1-09-SUMMARY.md"
Cohesion: 0.29
Nodes (3): Dependency graph, Metrics, Tech tracking

### Community 1107 - "business-evaluation-no-grounded-findings.md"
Cohesion: 0.29
Nodes (6): Consequence, now discharged, Eliminated during investigation, Fix, Root cause, Verification, Why it escaped

### Community 1108 - "ISO 9001:2015 as an Embedded QMS Layer"
Cohesion: 0.29
...
### Community 1109 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 1111 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 1112 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 1113 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1114 - "Validation Architecture"
Cohesion: 0.29
...
### Community 1115 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1116 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1117 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 1118 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1120 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 1124 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1125 - "Phase 16: Research Sub-Agent & Web Research Verification Report"
Cohesion: 0.29
...
### Community 1126 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 1128 - "Deviations from Plan"
Cohesion: 0.29
...
### Community 1129 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 1131 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 1132 - "Phase 21 — live session 2026-08-18: what was executed, and what CANNOT be"
Cohesion: 0.29
...
### Community 1133 - "25-01 — security audit of the BETA-01 admission boundary"
Cohesion: 0.29
...
### Community 1134 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 1136 - "26-13 Task 2 — Content artifact UAT (BLOCKING, open)"
Cohesion: 0.29
...
### Community 1137 - "Plan 26-19: the deterministic Command Center backend"
Cohesion: 0.29
...
### Community 1138 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 1140 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 1141 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means

### Community 1142 - "Local Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Layout, Local Convex Components, When to Choose This, Workflow Notes

### Community 1143 - "worm.test.ts"
Cohesion: 0.33
Nodes (3): modules, { s3Send }, sources

### Community 1144 - "calendar-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1145 - "first-login-second-attempt-auth-redirect.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1146 - "gmail-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1147 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1148 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1149 - "phase21-local-google-login-failure.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1150 - "production-frontend-rollback-after-media-release.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1151 - "convex-local-backend-preparing-functions.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms
...
### Community 1154 - "production-client-provided-address-not-absolute-url.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1155 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 1156 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 1157 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 1158 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 1159 - "devDependencies"
Cohesion: 0.20
Nodes (6): aggregateModules, BLUEPRINT_TEXT, modules, newTest(), setup(), T

### Community 1160 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1161 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 1163 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 1164 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 1165 - "Phase 14: Flagship Voice-Doc Workflow Verification Report"
Cohesion: 0.33
...
### Community 1169 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1170 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1171 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 1172 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1177 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 1178 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 1179 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 1180 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 1181 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1182 - "21-08 — the free half of the live gate: executed, except the half that cannot be"
Cohesion: 0.33
...
### Community 1183 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 1184 - "Plan 26-18: Sales Pipeline navigation activation"
Cohesion: 0.33
Nodes (5): Change, External gate consumed, Plan 26-18: Sales Pipeline navigation activation, Rollback, Verification

### Community 1185 - "Phase 27 Plan 04: Business Pulse and Campaign Plan Summary"
Cohesion: 0.33
...
### Community 1186 - "Phase 27 Plan 06: Process/SOP Builder and Brand Review Summary"
Cohesion: 0.33
...
### Community 1187 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 1189 - "Phases 14–25 milestone audit — 2026-08-20"
Cohesion: 0.33
...
### Community 1190 - "mailboxOptions"
Cohesion: 0.50
Nodes (4): mailboxOptions(), MailboxPicker(), opts(), ADR-0018

### Community 1191 - "3. Architecture"
Cohesion: 0.40
...
### Community 1193 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1194 - "Scheduled Send"
Cohesion: 0.40
...
### Community 1197 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 1198 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 1200 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1201 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 1202 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 1205 - "Standard Stack"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 1206 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1207 - "10-01-PLAN.md"
Cohesion: 0.40
...
### Community 1209 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1210 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1211 - "Code Examples"
Cohesion: 0.40
...
### Community 1212 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1213 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1214 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 1215 - "Validation Architecture"
Cohesion: 0.40
...
### Community 1219 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 1221 - "Union Blast Radius — the executor's walk"
Cohesion: 0.40
...
### Community 1222 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1223 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 1224 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 1225 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 1226 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 1227 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 1229 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1230 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 1231 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 1232 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 1234 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 1235 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 1240 - "3. The BETA-05 isolation suite — schema-derived enumeration — **HIGH confidence, API-verified**"
Cohesion: 0.40
...
### Community 1241 - "4. Microsoft Graph — the mapping (DLVR-02)"
Cohesion: 0.40
...
### Community 1243 - "Production Secret Inventory (research Q5)"
Cohesion: 0.40
...
### Community 1244 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1245 - "Phase 27 Plan 05: Complaint Response and Sales Call Prep Summary"
Cohesion: 0.40
...
### Community 1246 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 1247 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 1248 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1249 - "Phase 33 — deferred items"
Cohesion: 0.40
...
### Community 1250 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
Nodes (5): Phase 27: Curated Knowledge-Work Pack Pilot, Phase 28: Connector-Backed Revenue Pack, Phase 29: Unified Knowledge and Routines, Phase 30: Optional Vertical Workflow Packs, Post-Beta Knowledge-Work Expansion (Phases 27-30)

### Community 1252 - "previewIndex"
Cohesion: 0.50
Nodes (3): OutputCard(), previewIndex(), llm

### Community 1253 - "Proactive weekly review (BEVL-03, 13-02)"
Cohesion: 0.50
Nodes (4): How to change it safely, How to verify, Invariants, Proactive weekly review (BEVL-03, 13-02)

### Community 1254 - "Sharing the `evaluations` table with voice-doc (Phase 14, DOCV-01)"
Cohesion: 0.50
...
### Community 1256 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1257 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1258 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1259 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1260 - "ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned"
Cohesion: 0.10
Nodes (17): ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned, Alternatives rejected, Consequences, Context, Decision, ADR-009: Tier shapes the specialist PROMPT, not the offer set, Alternatives rejected, Consequences (+9 more)

### Community 1261 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1262 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1263 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1264 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1266 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
...
### Community 1272 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 1278 - "User Constraints"
Cohesion: 0.50
...
### Community 1280 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read from installed source / repo files), Secondary (MEDIUM), Sources, Tertiary (LOW — flagged)

### Community 1281 - "Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake)"
Cohesion: 0.50
Nodes (3): Deferred / Out-of-Scope Items — Phase 4 (Attachment & Voice-Dictation Intake), From 04-01 execution, From 04-02 execution

### Community 1282 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1283 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence)

### Community 1284 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1285 - "Sources"
Cohesion: 0.50
...
### Community 1294 - "User Constraints"
Cohesion: 0.50
...
### Community 1298 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1299 - "Standard Stack"
Cohesion: 0.50
...
### Community 1300 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1301 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1303 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all in-repo), Standard Stack, Supporting

### Community 1304 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1306 - "Sources"
Cohesion: 0.50
...
### Community 1312 - "The Existing Substrate — as it actually is today"
Cohesion: 0.50
...
### Community 1313 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1314 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence — flagged)

### Community 1315 - "Re-Verification Summary"
Cohesion: 0.50
...
### Community 1316 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1320 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1321 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1322 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1323 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1324 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1325 - "Deviations from Plan"
Cohesion: 0.50
Nodes (4): Deviations from Plan, Only the backend projection landed, The plan's thin-profile vocabulary was stale, The planned browser path is absent

### Community 1326 - "User Constraints (from `25-CONTEXT.md`)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from `25-CONTEXT.md`)

### Community 1327 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence), Secondary (MEDIUM confidence), Sources, Tertiary (LOW confidence — flagged for live validation)

### Community 1328 - "Credential and OAuth Architecture"
Cohesion: 0.50
Nodes (4): Credential and OAuth Architecture, Encrypted envelope, One-time OAuth state, Refresh and revoke

### Community 1329 - "Dependency Gates"
Cohesion: 0.50
...
### Community 1330 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1331 - "Phase 33.1 — deferred items"
Cohesion: 0.50
Nodes (3): 1. `packages/backend/convex/dispatch.test.ts` is lint-RED before this phase touched it, 2. `packages/backend/convex/media.test.ts` — the caption BURN test is FLAKY, not a standing red, Phase 33.1 — deferred items

### Community 1332 - "Standard Stack"
Cohesion: 0.50
Nodes (4): Alternatives Considered, Core (all existing, reuse), Provider stack (locked, ADR-017), Standard Stack

### Community 1333 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1334 - "Sources"
Cohesion: 0.50
Nodes (4): Primary (HIGH confidence — read from repo), Secondary (MEDIUM-HIGH confidence), Sources, Tertiary (LOW confidence)

### Community 1335 - "Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07"
Cohesion: 0.50
...
### Community 1336 - "HealthCard"
Cohesion: 0.67
Nodes (3): ConstraintCard(), HealthCard(), healthOf()

### Community 1337 - "4. Precedence — typing wins (D5)"
Cohesion: 0.67
Nodes (3): 4.0 The rule is a pure function, not a prompt, 4.1 Both entry routes are permanent, 4. Precedence — typing wins (D5)

### Community 1340 - "Standard Stack"
Cohesion: 0.67
...
### Community 1344 - "Standard Stack"
Cohesion: 0.67
Nodes (3): Core — all already installed; this phase adds NO dependency, Explicitly NOT used, Standard Stack

### Community 1350 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
### Community 1814 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.29
Nodes (7): Phase 16 — 16-05 (the hosted search capability), Phase 17 — 17-02 (Calendar adapter + terminal), Phase 17 — 17-03 (Calendar tool staging), Phase 17 — 17-04 (Approve-only external action enforcement), Phase 17 — Calendar actions, Phase 17 — the CALENDAR card (ACTN-02, availability content plane), Phase 17 — Wave 0 (freeze)

### Community 1815 - "server.d.ts"
Cohesion: 0.33
...
### Community 1820 - "The created-artifact surface — what the agent may say about it (2026-08-14)"
Cohesion: 0.25
...
### Community 1825 - "ADR-017: Direct Wan visuals and OpenAI audio supersede fal"
Cohesion: 0.40
Nodes (4): ADR-017: Direct Wan visuals and OpenAI audio supersede fal, Consequences, Context, Decision

## Knowledge Gaps
- **12421 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+12416 more)
...
- **Why does `api` connect `skillBodies.test.ts` to `functions.ts`, `vaultGround.test.ts`, `page.tsx`, `vaultSealing.test.ts`, `v1 Requirements`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `emailIntent.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `guardrails.test.ts`, `buildCockpitTools`, `log`, `opsSignals.test.ts`, `buildTelemetry.ts`, `guardrails.test.ts`, `layout.tsx`, `vaultLlm.ts`, `index.ts`, `Key files`, `classify.ts`, `vaultLlm.ts`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `runCockpitAgent.test.ts`, `intake.test.ts`, `metering.ts`, `skills.test.ts`, `DriveBrowser.tsx`, `evaluations.test.ts`, `feedback.test.ts`, `Parallel Build Lanes (multi-session)`, `fmtItemTime`, `extractKind.ts`, `vaultSweep.test.ts`, `index.ts`, `SkillAuthoringPanel.tsx`, `Project State`, `isolation.test.ts`, `gmail.test.ts`, `vaultDigest.ts`, `approvalsView.test.ts`, `proposals.test.ts`, `contacts.test.ts`, `goals.test.ts`, `assembly.ts`, `DriveBrowser.tsx`, `buildCockpitTools`, `gmailStatus`, `vaultTranscribe.test.ts`, `reviewThreshold.ts`, `vaultSweep.test.ts`, `replyDrafter.ts`, `provUsage`, `page.tsx`, `vaultGround.test.ts`, `approvalsView.test.ts`, `reportsGovernance.test.ts`, `AdminView.tsx`, `burnCapsScript.ts`, `pipeline-uat.spec.ts`, `BusinessBlueprint`, `How to verify`, `ingestEstimate.ts`, `dashboardSchema.test.ts`, `actionType.ts`, `media.ts`, `ReportsView.tsx`, `home.ts`, `DriveBrowser.tsx`, `plans.test.ts`, `worm.ts`, `searchVaultSpine.test.ts`, `FinanceTabs.tsx`, `packCustomerComplaint.ts`, `finance.test.ts`, `selfCheck`, `reportsGovernance.test.ts`, `createdDocs.test.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `internal` connect `plans.test.ts` to `vaultGround.test.ts`, `package.json`, `page.tsx`, `vaultSealing.test.ts`, `briefings.ts`, `skills.ts`, `devDependencies`, `Playbook: Email Chat Cockpit`, `emailIntent.ts`, `Project State`, `skillBodies.test.ts`, `skills.test.ts`, `gmailStatus`, `scan.ts`, `layout.tsx`, `vaultTranscribe.test.ts`, `vaultSweep.test.ts`, `cockpit-resolve.spec.ts`, `Dropzone.tsx`, `classify.ts`, `gapAction.test.ts`, `replyDrafter.ts`, `evaluations.test.ts`, `vaultLlm.ts`, `FinanceTabs.tsx`, `vaultGround.test.ts`, `feedback.ts`, `log`, `feedback.test.ts`, `packCustomerComplaint.ts`, `burnCapsScript.ts`, `vaultTranscribe.test.ts`, `Parallel Build Lanes (multi-session)`, `vaultSealing.test.ts`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `Phase 15 — Sub-agent dispatch + generalized executor`, `opsSignals.test.ts`, `extractKind.ts`, `cockpit.ts`, `guardrails.test.ts`, `selfCheck`, `BlueprintCanvas.tsx`, `layout.tsx`, `Project State`, `vaultLlm.ts`, `dashboardSchema.test.ts`, `notificationMessage`, `vaultDigest.ts`, `media.ts`, `graph.test.ts`, `approvalsView.test.ts`, `worm.test.ts`, `vaultViewState.ts`, `reportsBusiness.ts`, `Plan 33-05: Auto-assembled reel — vault save + regenerate ordering`, `classify.ts`, `Dropzone.tsx`, `classify.ts`, `runCockpitAgent.test.ts`, `vaultLlm.ts`, `page.tsx`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `spendLedger.ts`, `assembly.ts`, `worm.ts`, `intake.test.ts`, `createdDocs.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `parseAssemblySidecar()` connect `assembly.ts` to `classify.ts`, `reportsGovernance.test.ts`, `officeText.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _12453 weakly-connected nodes found - possible documentation gaps or missing edges._
