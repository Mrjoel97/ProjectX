...
## Corpus Check
- 2062 files · ~4,000,263 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19488 nodes · 23016 edges · 1876 communities (1728 shown, 148 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42d393c8`
...
## Communities (1876 total, 148 thin omitted)
...
Cohesion: 0.04
Nodes (44): assertSubmitRateLimited, boom, briefingCountForThread, briefingSynopsisPresent, CalendarLifecycleFacts, CalendarLifecycleReadback, createdDocCountForThread, drainDailySpend (+36 more)
...
Cohesion: 0.03
Nodes (74): persistNextStepMemo(), retrier, contentHash(), rearmAfterFix(), Actual, actualValidator, afterCaptionLanding(), evaluateRenderTrigger() (+66 more)
...
Cohesion: 0.05
Nodes (41): ADR-0011, aggregateModules, modules, rateLimiterModules, T, DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult (+33 more)
...
Cohesion: 0.03
Nodes (69): RFC-2045, RFC-2047, googleCalendarToken(), DeliveryResult, send, ActionCtx, internalAction, base64Url() (+61 more)
...
Cohesion: 0.04
Nodes (67): tenantAction, EDGE, expand, NODE, upsertGraph, runVaultGround(), vaultGround, vaultGroundHydrated (+59 more)
...
Cohesion: 0.04
Nodes (44): BUCKET_WORD, card, CommandCenter(), ConnectedBriefing(), ConnectedStats(), CONSTRAINT_COPY, ConstraintCard(), CTA_DESTINATION (+36 more)
...
Cohesion: 0.05
Nodes (47): aggregateModules, modules, SkillStatus, AGENT_AUTHORABLE_SKILLS, AGENT_EVAL_SUITE, AgentAuthorableSkill, AgentSkillSource, BUSINESS_PROFILE_SKILL (+39 more)

### Community 25 - "classify.ts"
Cohesion: 0.06
Nodes (51): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+43 more)
...
Cohesion: 0.02
Nodes (94): byThread, insert, LatestBriefing, latestForTenant, ADR-0004, byThread, insert, ADR-0004 (+86 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (61): ADR-0016, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, __cockpitTurnPrompt, CRM_DUE_REFUSAL (+53 more)
...
Cohesion: 0.11
Nodes (21): BLOCKED, BlockedConnection, ADR-0007, AddGoalForm(), AskSpecialist(), DirectionBand(), fmtDuration(), fmtWhen() (+13 more)
...
Cohesion: 0.13
Nodes (19): BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), mergeBlueprint() (+11 more)

### Community 55 - "buildTelemetry.ts"
Cohesion: 0.09
Nodes (35): NAV, PasswordField(), TextField(), ArrowIcon(), base(), BellIcon(), BoltIcon(), BrainIcon() (+27 more)
...
Cohesion: 0.04
Nodes (49): activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan, ActivationResult, ActivationTarget (+41 more)

### Community 59 - "vaultGraph.ts"
Cohesion: 0.10
Nodes (25): AGENT_EXPECT_KEYS, argv, CANDIDATE_STATUSES, casesDir, evaluateExpect(), EVIDENCE_STATES, EXPECT_KEYS, KNOWN_FLAGS (+17 more)
...
Cohesion: 0.07
Nodes (34): repriceUsd(), logPlaneJson(), aggregateModules, deadLetters(), modules, rateLimiterModules, rawModules, T (+26 more)
...
Cohesion: 0.17
Nodes (20): assertKnownArgs(), EnvironmentAbort, fixturesDir, here, isPlainObject(), isStringArray(), KNOWN_FLAGS, loadRegistry() (+12 more)
...
Cohesion: 0.07
Nodes (25): admits(), commitProfile, converse, ConverseResult, currentProfileDoc(), currentTierRow(), extractProfile, firstSendOffer (+17 more)
...
Cohesion: 0.06
Nodes (31): Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work, Operational notes (+23 more)
...
Cohesion: 0.05
Nodes (60): backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier, FACT_KEYS, forTenant (+52 more)
...
Cohesion: 0.06
Nodes (35): adaptedBodies, $comment, status, $comment, inventoryCorrections, license, $comment, id (+27 more)
...
Cohesion: 0.07
Nodes (43): assertPackActivationEvidence(), planGlobalActivation(), newArtifactIds(), outcomeFor(), packArgs, PackRunResult, PackTurnArgs, preflightPrompt() (+35 more)
...
Cohesion: 0.17
Nodes (18): paginationBound(), pageBounded(), capped(), readAuditPage(), compareDashboardOrder(), CompleteDashboardBound, createDashboardBound(), dashboardCursorFor() (+10 more)
...
Cohesion: 0.10
Nodes (33): bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, convexSiteOrigin(), handleRenderRequest(), hasFtypMagic(), isRenderableCardText() (+25 more)
...
Cohesion: 0.03
Nodes (56): Activity, ActivityCard(), attRow, badge(), box, Briefing, BriefingItem, BriefingRow() (+48 more)
...
Cohesion: 0.03
Nodes (55): aggregateModules, coreSources, Harness, modules, PARTIAL_REASONS, rawSources, signed(), httpAction (+47 more)

### Community 145 - "skills.test.ts"
Cohesion: 0.04
Nodes (22): hooks, PENDING, render(), AdminView(), PendingRow, AdminPage(), KIND_HREF, NotificationsBanner() (+14 more)
...
Cohesion: 0.09
Nodes (40): inputStatesFor(), scorecardValue(), solvencyForTenant(), unitEconomicsForTenant(), burn(), activityFromSends(), CashFigure, CashInputs (+32 more)
...
Cohesion: 0.02
Nodes (100): scene(), cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, ensureThreadAndPlan(), executePlan, ExternalActionType (+92 more)
...
Cohesion: 0.12
Nodes (25): OperationsSection(), earliestAt(), readOperations(), DASHBOARD_STATE_COPY, DashboardBound, BoardPackInput, buildBoardPackMarkdown(), compareSnapshots() (+17 more)
...
Cohesion: 0.02
Nodes (43): finish, latestTurn, record, refuse, StepView, modules, T, modules (+35 more)
...
Cohesion: 0.11
Nodes (20): mockGoogle(), cleaned(), composeDocMemo(), DOC_REVIEW_SECTIONS, DocReviewConfidence, DocReviewSection, isConfidence(), isSection() (+12 more)
...
Cohesion: 0.11
Nodes (21): DisconnectGoogle(), ConnectionsPanel(), pill, row, ADR-0018, NarrativePanel(), isTabId(), page (+13 more)
...
Cohesion: 0.16
Nodes (15): CASH_INPUTS, BY_KEY, classifyProposal(), CONTACT_TARGETS, CurrentValue, PROFILE_WRITABLE_FIELDS, PROPOSAL_TARGETS, ProposalGuard (+7 more)
...
Cohesion: 0.05
Nodes (42): readLiveForTenant(), controls, coverage, globalRails, LimiterWindow, mediaLedger, readWindow(), setMasterKillSwitch (+34 more)

### Community 209 - "vaultDigest.ts"
Cohesion: 0.04
Nodes (70): attachToThread, decodeUtf8(), dictateToThread, extractVisual(), runIntake(), RunIntakeArgs, transcribeAudio(), fogIntegration() (+62 more)
...
Cohesion: 0.04
Nodes (66): numeric, activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal, financeSpineFor, inputs (+58 more)
...
Cohesion: 0.06
Nodes (21): cappedPipelineReader, modules, REAL_NOW, seedHealthyTenant(), shapelessReader, T, throwingReader, aggregateModules (+13 more)
...
Cohesion: 0.11
Nodes (15): ADR-009: Tier shapes the specialist PROMPT, not the offer set, Alternatives rejected, Consequences, Context, Decision, Deferred — and the supersession path, ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate, Alternatives rejected (+7 more)
...
Cohesion: 0.09
Nodes (22): agentAuthoringStateForThread, assertAtReview, assertBlocked, assertDeadLetter, assertDeadLetterReason, assertEvalCaseClean, assertFallback, assertFanoutAttachmentShared (+14 more)
...
Cohesion: 0.07
Nodes (21): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+13 more)
...
Cohesion: 0.05
Nodes (54): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), ApprovalsView(), AttachmentLinks, AwaitingCardBody(), AwaitingItem (+46 more)
...
Cohesion: 0.18
Nodes (14): DisconnectMicrosoft(), LINK, ConnectMicrosoftPage(), ADR-0018, hasMicrosoftScope(), isMicrosoftCallbackError(), MICROSOFT_CALLBACK_ERRORS, MICROSOFT_SCOPES (+6 more)
...
Cohesion: 0.10
Nodes (27): AGENT_WRITABLE_FIGURES, buildCockpitTools(), otherKindRefusal(), otherKindStaged(), parseSmoke(), SMOKE_ROUTES, SPENT_PLAN_STATUS, stripRePrefix() (+19 more)
...
### Community 324 - "setup"
Cohesion: 0.24
Nodes (9): KNOWN_FLAGS, main(), manifestPath, noticesPath, repoRoot, sha256(), snapshotFiles(), snapshotRoot (+1 more)
...
Cohesion: 0.10
Nodes (25): HealthCard(), Recommendation(), health, HomeHealth, HomeSummary, summary, UNAVAILABLE, DashboardPartialReason (+17 more)
...
Cohesion: 0.02
Nodes (92): auditCounts, backfillAuditCounts, countAudit, log, recentByType, aggregateModules, modules, modules (+84 more)
...
Cohesion: 0.18
Nodes (9): sourceFiles(), FileRecord, manifest, Pack, repoRoot, snapshotRoot, vendorRoot, walk() (+1 more)
...
### Community 360 - "COCKPIT_AGENT_SKILL"
Cohesion: 0.40
...
Cohesion: 0.53
Nodes (3): CashInputState, age(), financeSpineLine()
...
Cohesion: 0.10
Nodes (20): bubble(), ChatPane(), COCKPIT_STARTERS, messageText(), pinLabel(), PinState, BUSINESS_SIGNALS, chat (+12 more)
...
### Community 373 - "step"
Cohesion: 0.36
Nodes (7): AvailabilityRange, availabilityWindow(), eventIdFor(), GOOGLE_SCOPES, hasScope(), toRfc3339(), RFC-3339

### Community 374 - "Hot Path Rules"
Cohesion: 0.06
Nodes (34): flushTelemetry(), Fog, IntegrationContext, IntegrationInput, traced(), dependencies, ai, @ai-sdk/google (+26 more)
...
### Community 379 - "useSendCockpitMessage"
Cohesion: 0.28
...
### Community 389 - "ReelCanvas"
Cohesion: 0.16
Nodes (6): modules, SCHEMA, DataModel, Doc, Id, TableNames
...
Cohesion: 0.12
Nodes (17): aggregateModules, chunkScript(), executedTools(), modules, PACK_BODIES, packToolRecord(), PROBE_INPUTS, PROBE_NAMES (+9 more)

### Community 392 - "Phase 27 Plan 01: Upstream Pin and Provenance Summary"
Cohesion: 0.07
...
### Community 395 - "vaultGround.test.ts"
Cohesion: 0.08
Nodes (24): Agent Mode, Checklist, Convex Quickstart, Development vs Production, Environment variables, Install, Next.js (App Router), Next Steps (+16 more)
...
### Community 403 - "freshAccessToken"
Cohesion: 0.08
...
### Community 405 - "packBusinessPulse.ts"
Cohesion: 0.08
...
### Community 418 - "briefings.test.ts"
Cohesion: 0.09
...
### Community 419 - "Critical Pitfalls"
Cohesion: 0.09
...
### Community 420 - "Proactive weekly review (BEVL-03, 13-02)"
Cohesion: 0.09
...
### Community 422 - "Phase 14: Flagship Voice-Doc Workflow - Context"
Cohesion: 0.09
...
### Community 425 - "packSalesCallPrep.ts"
Cohesion: 0.09
...
### Community 426 - "Phase 15.1 Plan 07: Both Surfaces — the Conversation and the Facts Summary"
Cohesion: 0.09
...
### Community 430 - "Phase 21 Plan 04: The Owner Boundary Summary"
Cohesion: 0.09
...
### Community 431 - "Phase 21 Research: User-Authored Skills & Routines"
Cohesion: 0.09
...
### Community 432 - "Phase 26: Connected Product Pages - Research"
Cohesion: 0.09
...
### Community 433 - "Architecture Research"
Cohesion: 0.09
...
### Community 437 - "Phase 3.1: Cockpit Core — Research (AGENT-THREAD + TOOLS + ARTIFACTS lane)"
Cohesion: 0.10
...
### Community 438 - "Phase 3.1: Cockpit Core — Research (UI / Frontend lane)"
Cohesion: 0.10
...
### Community 440 - "Phase 15.1 Plan 01: Wave-0 Freeze — Fact-Derived Tier Summary"
Cohesion: 0.10
...
### Community 441 - "Phase 15.1 Plan 03: The Subtraction — No Caller-Supplied Tier Summary"
Cohesion: 0.10
...
### Community 443 - "Phase 19 Plan 10: Close the phase honestly Summary"
Cohesion: 0.10
...
### Community 444 - "Phase 19 Plan 13: Consent Record Gap Closure Summary"
Cohesion: 0.10
...
### Community 446 - "Phase 21 Plan 03: Exact Tenant Candidate Evaluation Summary"
Cohesion: 0.10
...
### Community 448 - "Verified defect inventory (the work list)"
Cohesion: 0.10
...
### Community 449 - "26-20 Task 2 — Command Center v2 and Phase 26 owner UAT (BLOCKING, open)"
Cohesion: 0.10
...
### Community 450 - "Implications for Roadmap"
Cohesion: 0.10
...
### Community 452 - "Phase 13 Plan 04: Live Verification Summary"
Cohesion: 0.10
...
### Community 453 - "Phase 15.1 Plan 05: The Tier Becomes Perceivable Summary"
Cohesion: 0.10
...
### Community 454 - "Phase 15.1 Plan 06: Ask, Don't Guess — the Conversational Turn Summary"
Cohesion: 0.10
...
### Community 455 - "Phase 15 Plan 03: The Governed Dispatcher Summary"
Cohesion: 0.10
...
### Community 457 - "Phase 17.1 Plan 02: Blueprint Substrate & the business-blueprint Skill Row Summary"
Cohesion: 0.10
...
### Community 458 - "Phase 25.1 Plan 05: Memo Rendering & Research Sources Summary"
Cohesion: 0.10
...
### Community 459 - "Fix Order"
Cohesion: 0.11
Nodes (18): 1. Bound your reads, 2. Read smaller shapes, 3. Break large mutations into batches, 4. Move heavy work to actions, 5. Trim return values, 6. Replace `ctx.runQuery` and `ctx.runMutation` with helper functions, 7. Avoid unnecessary `runAction` calls, Common Causes (+10 more)

### Community 460 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 461 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 466 - "Phase 14 Plan 04: The Doc-Grounded Mint Summary"
Cohesion: 0.11
...
### Community 467 - "Phase 15.1 Plan 04: The Rubric Follows the Table Summary"
Cohesion: 0.11
...
### Community 468 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.11
...
### Community 469 - "Phase 15 Plan 04: "Act on this" Runs the Specialist Summary"
Cohesion: 0.11
...
### Community 470 - "Phase 15 Plan 06: Runnable Specialist Bodies + a Multi-Pin Eval Gate Summary"
Cohesion: 0.11
...
### Community 471 - "Phase 17.1 Plan 03: Precedence, the Citation Gate and the Spine Summary"
Cohesion: 0.11
...
### Community 472 - "Phase 17.1 Plan 04: Blueprint Read Plane Summary"
Cohesion: 0.11
...
### Community 473 - "Phase 17 Plan 04: Approve-Only Calendar Enforcement Summary"
Cohesion: 0.11
...
### Community 474 - "17-08 SUMMARY — governed calendar management: management, minus Microsoft delete"
Cohesion: 0.11
...
### Community 475 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 477 - "Phase 19 Plan 09: Teach the Body, Owe the Fixture Summary"
Cohesion: 0.11
...
### Community 478 - "Phase 21 Plan 05: Routine v0 — Pinned Prompts Summary"
Cohesion: 0.11
...
### Community 479 - "Phase 25.1 Plan 04: Approvals Feedback Summary"
Cohesion: 0.11
...
### Community 480 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)

### Community 481 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 482 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 484 - "4. Codebase Integration Seams (with file:line)"
Cohesion: 0.11
...
### Community 485 - "Phase 3.5 Plan 02: Deferred Send — setSendTime Fast-Path Summary"
Cohesion: 0.11
...
### Community 486 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.11
...
### Community 487 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.11
...
### Community 488 - "Phase 8 Plan 06: Feedback Control + Optimizer Ops Panel Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+9 more)
...
### Community 490 - "Phase 14 Plan 03: Doc-Scoped Session + Retrieval Summary"
Cohesion: 0.11
...
### Community 492 - "Phase 15.2 Plan 05: The Live Phase Gate Summary"
Cohesion: 0.11
...
### Community 493 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 494 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 496 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.11
...
### Community 497 - "Phase 15 Plan 01: Wave-0 Freeze Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 498 - "Phase 15 Plan 02: Specialist Registry + The ONE Loop Seam Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 499 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 508 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.11
...
### Community 509 - "Phase 17.1 Plan 05: Governed Blueprint Draft Synthesis Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 510 - "Phase 17.1 Plan 07: Explicit Blueprint Spine Grounding Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 512 - "Phase 17.1 Plan 08: D2 Blueprint Confirmation Gate Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)

### Community 513 - "selfCheck"
Cohesion: 0.18
Nodes (17): applyOnly(), assertEvaluableCandidate(), assertKnownArgs(), buildTenantEvidence(), formatCost(), gatedSkillNames(), mergePinScopes(), parseOnlyFilters() (+9 more)

### Community 514 - "Phase 19.1 Plan 06: The CSV Import Panel Summary"
Cohesion: 0.11
...
### Community 515 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 516 - "Phase 33 Plan 09: media-director v3 — the specialist learns to write what the parsers read"
Cohesion: 0.11
...
### Community 517 - "Phase 33 Plan 13: The proposal stage gets a failure card, and the two parser edits get disclosed Summary"
Cohesion: 0.11
...
### Community 518 - "§A — The evaluations data-model split (plan-independent; write it now)"
Cohesion: 0.11
...
### Community 519 - "Phase 25 Plan 03: Isolation Gate Summary"
Cohesion: 0.12
...
### Community 520 - "Playbook: Skill Registry (versioned LLM prompts)"
Cohesion: 0.12
...
### Community 521 - "Convex Create Component"
Cohesion: 0.12
Nodes (16): Advanced Patterns, Authentication and environment access, Checklist, Choose the Shape, Client-facing API, Component Skeleton, Convex Create Component, Critical Rules (+8 more)

### Community 522 - "Design — Business Tier & Conversational Onboarding"
Cohesion: 0.12
...
### Community 523 - "Phase 01 Plan 06: DLQ + awaitEvent-Timeout Race Smoke Patterns Summary"
Cohesion: 0.12
...
### Community 524 - "Phase 2 Plan 07: Authenticated Surface Summary"
Cohesion: 0.12
...
### Community 525 - "Phase 03.10 Plan 05: Cockpit Reset + Honesty Summary"
Cohesion: 0.12
...
### Community 526 - "Phase 03.10 Plan 07: Post-Pick Trust Repair Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Gate Cycle (Task 2), Human Verify (Task 3), Issues Encountered (+8 more)

### Community 527 - "Phase 3.11 Plan 03: Delivery Threading Spine Summary"
Cohesion: 0.12
...
### Community 528 - "Phase 3.11 Plan 04: replyToMessage Tool Summary"
Cohesion: 0.12
...
### Community 529 - "Phase 3.1 Plan 08: Cockpit Cards + Chat Pane Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 530 - "Phase 03.2.1 Plan 03: Governed Cockpit Tool Set Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 531 - "Phase 03.2 Plan 04: Cockpit Name-Resolution Turn Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)

### Community 532 - "Phase 3.5 Plan 01: Deferred Send Foundation Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 533 - "Phase 3.5 Plan 03: Deferred Send — executePlan Scheduler Branch Summary"
Cohesion: 0.12
...
### Community 535 - "Phase 3.5 Plan 04: Deferred Send — E2E + Phase Close Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 543 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 545 - "Phase 3.7 Plan 09: Phase Close — inbox-digest v2 Eval-Gated & Human-Verified Summary"
Cohesion: 0.12
...
### Community 546 - "Phase 04 Plan 02: Attachment Extractor Skill Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 547 - "Phase 6 Plan 6: Live Voice Session Client Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 548 - "Phase 8 Plan 02: Feedback Capture + Skill-Version Attribution Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 549 - "Phase 8 Plan 04: Trajectory Export (PII-scrubbed) Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 550 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 553 - "Phase 11 Plan 04: Editable Business-Profile Page Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Deferred Issues, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+8 more)
...
### Community 558 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 559 - "Phase 13 Plan 02: The Weekly Proactive Review Cron Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)

### Community 560 - "Phase 13 Plan 03: The In-App Review Surface Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+8 more)
...
### Community 562 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 565 - "Phase 15.2 Plan 04: Staleness, the Graph Cap, and Failure Copy Summary"
Cohesion: 0.12
...
### Community 566 - "Phase 15.2 Plan 06: Per-Page Fan-Out Summary"
Cohesion: 0.12
...
### Community 567 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 570 - "Phase 17.1 Plan 06: Standing Cockpit Blueprint Context Summary"
Cohesion: 0.12
...
### Community 572 - "Phase 17 Plan 02: Google Calendar Adapter and Terminal Summary"
Cohesion: 0.12
...
### Community 573 - "Phase 17 Plan 09: Managed-event discovery and safe staging Summary"
Cohesion: 0.12
...
### Community 574 - "Phase 17: Calendar Actions Verification Report"
Cohesion: 0.12
...
### Community 575 - "Phase 19.1 Plan 05: pipelineTiles Reports Its Scan Bound Summary"
Cohesion: 0.12
...
### Community 576 - "Phase 20.2: Scene Timeline Reels — Code and Offline Evidence Summary"
Cohesion: 0.12
...
### Community 577 - "Phase 21 Plan 02: Tenant Candidate Write/Read and Effective Loading Summary"
Cohesion: 0.12
...
### Community 578 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 579 - "Migrations Component Reference"
Cohesion: 0.12
Nodes (15): Cancel a Running Migration, Check Migration Status, Configuration Options, Custom Batch Size, Define a Migration, Dry Run, Installation, Migrate a Subset Using an Index (+7 more)

### Community 580 - "OCC Conflict Resolution"
Cohesion: 0.12
Nodes (15): 1. Reduce read set size, 2. Split hot documents, 3. Move non-critical work to scheduled functions, 4. Combine competing writes, Broad read sets causing false conflicts, Common Causes, Core Principle, Fan-out from triggers or cascading writes (+7 more)

### Community 581 - "Convex Performance Audit"
Cohesion: 0.12
Nodes (15): 1. Scope the problem, 2. Trace the full read and write set, 3. Apply fixes from the relevant reference, 4. Fix sibling functions together, 5. Verify before finishing, Checklist, Convex Performance Audit, Escalate Larger Fixes (+7 more)
...
### Community 583 - "finance-update-fails-only-in-full-sequence.md"
Cohesion: 0.12
...
### Community 584 - "Phase 1 Plan 01: Foundation & Governance Substrate Summary"
Cohesion: 0.12
...
### Community 585 - "Phase 1 Plan 4: Skills Registry & Loader Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 586 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 587 - "Phase 2 Plan 02: Executive Agent LLM Surface Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 588 - "Phase 2 Plan 05: Gmail Delivery Integration Summary"
Cohesion: 0.12
...
### Community 589 - "Phase 2 Plan 6: Pipeline Spine + Operator Dead-Letter Surface Summary"
Cohesion: 0.12
...
### Community 590 - "Phase 03.10 Plan 02: Cockpit Panel Demotion Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 592 - "Phase 03.10 Plan 04: Cockpit Propose-Deadlock + Collapsible Brief Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 603 - "Phase 3.11 Plan 01: Inbox-Reply Groundwork Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 604 - "Phase 3.11 Plan 05: Withheld-Tool Activation (cockpit-agent teaches replyToMessage) Summary"
Cohesion: 0.12
...
### Community 606 - "Phase 3.11 Plan 06: Phase Close — Live In-Thread Reply Human-Verify Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 607 - "Phase 03.1 Plan 02: Cockpit Frontend + E2E Scaffolding Summary"
Cohesion: 0.12
...
### Community 608 - "Phase 03.1 Plan 03: emailIntent Slot-Filling Brain Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 609 - "Phase 3.1 Plan 04: Delivery Fan-out Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 610 - "Phase 03.1 Plan 09: Cockpit E2E + Human Verification Summary"
Cohesion: 0.12
...
### Community 613 - "Phase 3.1: Cockpit Core — Research (synthesized)"
Cohesion: 0.12
...
### Community 614 - "Phase 3.2 Plan 01: needs_resolution seam + pure contact-resolution helpers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 617 - "Phase 3.3 Plan 01: Attachment Generation Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 618 - "Phase 03.3 Plan 04: Attachment Tools + Propose Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 619 - "Phase 03.3 Plan 05: Attachment Send Fan-out + PLAN/REPORT Cards Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 620 - "Phase 03.3 Plan 06: Attachment Generation Phase Close Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 621 - "Implementation Decisions"
Cohesion: 0.12
...
### Community 623 - "Phase 03.6 Plan 02: EVAL-02 Read Side Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 638 - "Phase 03.7 Plan 07: Inbox Briefing Synopsis (the lede) Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 640 - "Phase 3.8 Plan 03: Lane 2 — Office Parsers Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 641 - "Phase 3.8 Plan 04: Lane 3 — Sweep + Vault UI + E2E Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 642 - "Phase 3.8 Plan 06: Integration — Merge, Prove Green, Heal Backlog Summary"
Cohesion: 0.12
...
### Community 643 - "Phase 3 Plan 01: Guardrails Domain Logic Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 644 - "Phase 3 Plan 05: Guardrails Phase-Gate Smoke Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 645 - "Phase 4 Plan 04: Backend Intake Spine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 646 - "Phase 4 Plan 05: Intake UI (IntakeControls.tsx + Playwright E2E) Summary"
Cohesion: 0.12
...
### Community 647 - "Phase 4 Plan 06: Phase Close (Task 1 of 3 — PAUSED AT CHECKPOINT) Summary"
Cohesion: 0.12
...
### Community 648 - "Phase 5 Plan 02: Vault Schema + RAG Instance + Graph-Extractor Skill Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 649 - "Phase 5 Plan 03: Graph Plane (extractGraph + vaultGraph) Summary"
Cohesion: 0.12
...
### Community 650 - "Phase 5 Plan 04: Vault Ingest Pipeline Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Authentication Gates, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered (+7 more)

### Community 651 - "Phase 5 Plan 07: Knowledge Vault Phase-Close Summary"
Cohesion: 0.12
...
### Community 652 - "Phase 6 Plan 01: Voice Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 653 - "Phase 6 Plan 02: Voice Data + Registry Skills Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 654 - "Phase 06 Plan 03: Voice Token Seam Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 655 - "Phase 06 Plan 04: Voice-Brief Drafter Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 657 - "Phase 6 Plan 05: Voice Session Engine Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 658 - "Phase 6 Plan 7: Post-Call Brief Review + Plan Handoff Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 664 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 665 - "Phase 7 Plan 02: Real WORM S3 Export Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 666 - "Phase 7 Plan 03: Fail-Closed Pipeline Review Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 667 - "Phase 7 Plan 04: Cockpit Resilience — Agent-Timeout Notification + Fail-Closed Revise Cap Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 668 - "Phase 8 Plan 07: SkillOpt Offline Batch Runner Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)

### Community 669 - "Phase 11 Plan 01: Onboarding + Business Profile Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 670 - "Phase 11 Plan 03: Conversational Onboarding & First-Run Gate Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 671 - "Phase 12 Plan 05: Gap → Approvable Next-Step Memo Summary"
Cohesion: 0.12
...
### Community 672 - "Phase 12 Plan 06: Eval Gate — Assessment Fixtures + Cockpit Teaching Summary"
Cohesion: 0.12
...
### Community 675 - "Phase 13 Plan 01: Proactive Review Foundations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 680 - "Architecture Patterns"
Cohesion: 0.12
...
### Community 681 - "Phase 16 Deferred Items"
Cohesion: 0.12
...
### Community 682 - "Phase 17 Plan 03: Governed Calendar Tool Surface Summary"
Cohesion: 0.12
...
### Community 683 - "Phase 18 Plan 01: Format parameterization + the HTML renderer Summary"
Cohesion: 0.12
...
### Community 684 - "Phase 19 Plan 03: The CAN-SPAM postal address Summary"
Cohesion: 0.12
...
### Community 686 - "Phase 25.1 Plan 01: renderReel Honest Terminals Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 687 - "Phase 25.1 Plan 02: Stuck-Work Watchdog Summary"
Cohesion: 0.12
...
### Community 688 - "Phase 25.1 Plan 03: Media Vault Persistence Summary"
Cohesion: 0.12
...
### Community 689 - "Phase 33 Plan 02: Plan-Row State + Governed Mutations Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 690 - "Phase 33 Plan 03: Persist Terminal + Money Gates Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)

### Community 691 - "Phase 33 Plan 04: Failure/Retry Backend Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+7 more)
...
### Community 695 - "Phase 33 Plan 08: Grounded citations and clear failure on the canvas Summary"
Cohesion: 0.12
...
### Community 696 - "Feature Research"
Cohesion: 0.12
...
### Community 697 - "Recommended Stack — per new capability"
Cohesion: 0.12
...
### Community 699 - "Context Handoff — 2026-07-27"
Cohesion: 0.13
...
### Community 700 - "Phase 1 Plan 2: Tenant-Scoping Substrate Summary"
Cohesion: 0.13
...
### Community 701 - "Phase 1 Plan 03: Insert-Only Audit Module Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 702 - "Phase 01 / Plan 05: Graphify Activation + Ponytail Discipline Summary"
Cohesion: 0.13
...
### Community 703 - "Phase 01 Plan 07: WORM Export Cron Stub Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 704 - "Phase 2 Plan 04: Review Gate Decision Union + Write-Once Telemetry Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+6 more)

### Community 705 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 706 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 707 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 708 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 714 - "Phase 03.2.1 Plan 01: Cockpit-Agent Skill Registry Seed Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 715 - "Phase 03.2.1 Plan 02: Recipient Tool-Internals Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 716 - "Phase 03.2.1 Plan 05: Clean FSM→Agent Cutover Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 717 - "Phase 03.2.1 Plan 06: Phase Close — Cockpit Playbook Rewrite + Live Human-Verify Summary"
Cohesion: 0.13
...
### Community 718 - "Phase 03.2 Plan 02: Transient Candidate Fields Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 719 - "Phase 03.2 Plan 03: Gmail Headers-Only Search Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 720 - "Phase 03.3 Plan 02: Attachment Content-Plane Extension Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 721 - "Phase 03.3 Plan 03: Attachment-Carrying Gmail Send Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 722 - "Phase 3.6 Plan 01: Agent Eval Gate — Activation Gate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 723 - "Phase 3.6 Plan 03: Pin + Cost Threading Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 724 - "Phase 3.6 Plan 04: Golden-Set Eval Harness Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 725 - "Phase 03.7 Plan 06: The Intelligent-Report Reshape Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 726 - "Phase 03.7 Plan 08: Reshaped BRIEFING Card Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 727 - "Phase 3.8 Plan 01: Wave-0 Extraction Contract Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 728 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 729 - "Phase 3 Plan 02: Guardrail Schema Rails Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 732 - "Phase 3 Plan 03: Guardrails Guard Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 733 - "Phase 3 Plan 04: LLM Guardrail Choke Point Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 734 - "Phase 4 Plan 01: Extraction Foundation + Intake Playbook Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 736 - "Phase 5 Plan 01: Vault Foundation Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 737 - "Phase 15.4 Plan 03: Governed Vault Preview and Import Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 739 - "Phase 5 Plan 06: Knowledge Vault Route Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 750 - "Phase 8 Plan 01: Self-Improvement Schema Substrate Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 751 - "Phase 8 Plan 03: Optimizer Eligibility (Trigger Policy) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 752 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 753 - "Phase 11 Plan 02: Onboarding Adapter (embed + retrieve + redaction) Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 755 - "Phase 12 Plan 01: Growth Diagnostic Math Port Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)
...
### Community 758 - "Phase 12 Plan 02: Framework Rubric Skill Registration Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 759 - "Phase 12 Plan 03: Business Evaluation Engine Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 760 - "Phase 12 Plan 04: Cockpit Evaluation Surface Summary"
Cohesion: 0.13
...
### Community 761 - "Phase 15.2 Research — Vault Universal Format Recognition & Extraction Fan-Out"
Cohesion: 0.13
...
### Community 762 - "15.3-09 — the Google Drive rail (VALT-13)"
Cohesion: 0.13
...
### Community 763 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 764 - "Phase 17 Calendar Actions — agent-operated live UAT runbook"
Cohesion: 0.13
...
### Community 767 - "Phase 18 Plan 04: The Vault Write Plane Summary"
Cohesion: 0.13
...
### Community 768 - "Phase 18 Plan 07: The Output Card Summary"
Cohesion: 0.13
...
### Community 769 - "Phase 19.1 Plan 03: fill-empty-only as a Flag on the ONE Writer Summary"
Cohesion: 0.13
...
### Community 770 - "Phase 19.1 Plan 04: matchExisting and importContacts Summary"
Cohesion: 0.13
...
### Community 771 - "Phase 22: Owner Authorization Primitive Verification Report"
Cohesion: 0.13
...
### Community 772 - "23-03 SUMMARY — the model can now draft a skill, and still cannot activate one"
Cohesion: 0.13
...
### Community 773 - "Phase 25 Plan 05: Microsoft Delivery Arm Summary"
Cohesion: 0.13
...
### Community 774 - "26-17 — Reports, connected end to end, and the nav that only lit after the owner said so"
Cohesion: 0.13
...
### Community 775 - "Implementation Decisions"
Cohesion: 0.13
...
### Community 778 - "Phase 33 Plan 01: Storyboard Parse Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 779 - "Project State"
Cohesion: 0.13
...
### Community 798 - "Roadmap: Pikar-AI"
Cohesion: 0.14
...
### Community 799 - "Pikar AI — Repository Conventions"
Cohesion: 0.15
...
### Community 807 - "cockpitAccess.test.ts"
Cohesion: 0.15
...
### Community 829 - "Phase 25 Plan 02: Beta Admission UI Summary"
Cohesion: 0.15
...
### Community 830 - "Phase 25 Plan 04: First-Send Projection Summary"
Cohesion: 0.15
...
### Community 831 - "Phase 25: Private Beta Productionization - Research"
Cohesion: 0.15
...
### Community 832 - "Phase 26 Plan 01: Shared Dashboard Contracts Summary"
Cohesion: 0.15
...
### Community 833 - "Phase 26 Plan 02: Additive Dashboard Schema Foundation Summary"
Cohesion: 0.15
...
### Community 837 - "Phase 26 Plan 03: Approvals State Transitions and Delivery Progress Summary"
Cohesion: 0.15
...
### Community 839 - "Phase 28: Connector-Backed Revenue Pack — Research"
Cohesion: 0.15
...
### Community 840 - "Phase 33 Plan 06: Reel-first canvas Summary"
Cohesion: 0.15
...
### Community 842 - "Phase 33 Plan 07: Guided intake and variations on the canvas Summary"
Cohesion: 0.15
...
### Community 850 - "External Integrations"
Cohesion: 0.17
...
### Community 896 - "WorkOS AuthKit"
Cohesion: 0.18
Nodes (10): Checklist, Concrete Steps, Files and Env Vars To Expect, Gotchas, Key Setup Areas, Production, Validation, What To Do (+2 more)

### Community 897 - "Convex Authentication Setup"
Cohesion: 0.18
Nodes (10): After Choosing a Provider, Checklist, Convex Authentication Setup, Core Pattern: Protecting Backend Functions, First Step: Choose the Auth Provider, Provider References, Reference Files, When Not to Use (+2 more)

### Community 898 - "calendarComplete.ts"
Cohesion: 0.20
...
### Community 947 - "Implementation Decisions"
Cohesion: 0.18
...
### Community 949 - "Phases 14–25 — gap ledger (re-derived 2026-08-17)"
Cohesion: 0.18
...
### Community 950 - "Codebase Concerns"
Cohesion: 0.20
...
### Community 951 - "Code Conventions"
Cohesion: 0.20
...
### Community 952 - "Email Chat Cockpit"
Cohesion: 0.20
...
### Community 953 - "Moat Strategy & Validated-Problem Discipline"
Cohesion: 0.20
...
### Community 954 - "Phase 2 Plan 03: Intake Trust Boundary Summary"
Cohesion: 0.20
...
### Community 961 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 963 - "Goal Achievement"
Cohesion: 0.20
...
### Community 964 - "Phase 3.8: Vault Document Extraction - Research"
Cohesion: 0.20
...
### Community 966 - "Plan 03.9-01 — Summary"
Cohesion: 0.20
...
### Community 968 - "Phase 03.9: Agent Activity Streaming — Research"
Cohesion: 0.20
...
### Community 970 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 971 - "reportsBusiness.test.ts"
Cohesion: 0.25
Nodes (5): modules, seedRequest(), seedTelemetry(), T0, WINDOW

### Community 972 - "Common Pitfalls"
Cohesion: 0.20
...
### Community 974 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 976 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 977 - "Goal Achievement"
Cohesion: 0.20
...
### Community 978 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 980 - "Phase 15.1 — Validation Strategy"
Cohesion: 0.20
...
### Community 981 - "Goal Achievement"
Cohesion: 0.20
...
### Community 982 - "Phase 15.2 Plan 01: Pure Recognition Layer Summary"
Cohesion: 0.20
...
### Community 983 - "Phase 15.2 — Validation Strategy"
Cohesion: 0.20
...
### Community 984 - "1. The budget wall — estimate, reservation, refund, intact refusal"
Cohesion: 0.20
...
### Community 987 - "Phase 16 Plan 08: Deterministic Research Degradation Summary"
Cohesion: 0.20
...
### Community 988 - "Phase 17.1: Business Blueprint — Corpus Synthesis & Agent Spine - Research"
Cohesion: 0.20
...
### Community 990 - "Phase 18 Plan 03: content-drafter skill row Summary"
Cohesion: 0.20
...
### Community 991 - "Phase 19.1 Plan 07: The Browser Proof Summary"
Cohesion: 0.20
...
### Community 992 - "Deferred items — Phase 19"
Cohesion: 0.20
...
### Community 997 - "Phase 20 Spike — Pikar-Ai MCP auth + pricing units"
Cohesion: 0.20
...
### Community 998 - "Phase 25 Plan 01: Beta Admission Trust Boundary Summary"
Cohesion: 0.20
...
### Community 999 - "Phase 25 — the owner gates"
Cohesion: 0.20
...
### Community 1000 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 1001 - "Common Pitfalls"
Cohesion: 0.20
...
### Community 1002 - "26-14 — truthful report metrics, and the audit that found the plan's own first draft lying"
Cohesion: 0.20
...
### Community 1003 - "Validation Architecture"
Cohesion: 0.20
...
### Community 1004 - "Phase 31: Marketing Surface and Funnel v0 — Validation Strategy"
Cohesion: 0.20
...
### Community 1005 - "Architecture Patterns"
Cohesion: 0.20
...
### Community 1006 - "2026-07-26-voice-doc-picker-design.md"
Cohesion: 0.22
...
### Community 1007 - "Technology Stack"
Cohesion: 0.22
...
### Community 1008 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 1009 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 1010 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 1011 - "Phase 3.2 Plan 06: Close Inbox-Reading Phase (Playbook + CKPT-01) Summary"
Cohesion: 0.22
...
### Community 1012 - "Phase 03.4 Plan 01: recipientBodies Content-Plane Foundation Summary"
Cohesion: 0.22
...
### Community 1013 - "Phase 03.4 Plan 02: personalizeRecipient Tool + Group Gate Summary"
Cohesion: 0.22
...
### Community 1014 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 1015 - "Phase 03.4 Plan 04: Phase Close — E2E + smoke distinct-body + playbook (CKPT-03) Summary"
Cohesion: 0.22
...
### Community 1016 - "Phase 3.5 — Validation Strategy"
Cohesion: 0.22
...
### Community 1017 - "Locked Decisions"
Cohesion: 0.22
...
### Community 1019 - "Phase 3.7 Plan 04: The BRIEFING Card + Offline E2E Summary"
Cohesion: 0.22
...
### Community 1022 - "Phase 4 Plan 03: Intake Schema + Transcription Pricing Summary"
Cohesion: 0.22
...
### Community 1023 - "Phase 7 Plan 05: User-Facing Notification Matrix Summary"
Cohesion: 0.22
...
### Community 1024 - "Phase 8 — Validation Strategy"
Cohesion: 0.22
...
### Community 1025 - "Phase 11 — Validation Strategy"
Cohesion: 0.22
...
### Community 1026 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1027 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Context"
Cohesion: 0.22
...
### Community 1029 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1031 - "15.3-06 — the folder digest (VALT-08, VALT-09, VALT-10)"
Cohesion: 0.22
...
### Community 1032 - "15.3-07 — the folder surface (VALT-05/06/08/10/11)"
Cohesion: 0.22
...
### Community 1033 - "15.3-08 — document identity classification (VALT-12)"
Cohesion: 0.22
...
### Community 1034 - "3. Data model, sealing, retrieval and digest staleness"
Cohesion: 0.22
...
### Community 1035 - "4. Document identity classification"
Cohesion: 0.22
...
### Community 1036 - "5. The Google Drive export rail"
Cohesion: 0.22
...
### Community 1040 - "Phase 16 Plan 07: The Vault Terminal Summary"
Cohesion: 0.22
...
### Community 1041 - "Architecture Patterns"
Cohesion: 0.22
...
### Community 1042 - "Phase 17 — Gap-Closure Validation Strategy"
Cohesion: 0.22
...
### Community 1043 - "Phase 18: Document & Content Creation - Research"
Cohesion: 0.22
...
### Community 1044 - "Common Pitfalls"
Cohesion: 0.22
...
### Community 1045 - "Phase 18 — Validation Strategy"
Cohesion: 0.22
...
### Community 1046 - "Phase 19: Contacts, CRM & Follow-ups — Research"
Cohesion: 0.22
...
### Community 1051 - "21-07 COMPLETE — the frozen candidate carries a passing held-out gate"
Cohesion: 0.22
...
### Community 1052 - "Phase 21: User-Authored Skills & Routines Verification Report"
Cohesion: 0.22
...
### Community 1053 - "Phase 22.1 Plan 05: Tenant Deletion Summary"
Cohesion: 0.22
...
### Community 1055 - "22-02 Summary — owner-gate the four Phase-8 endpoints"
Cohesion: 0.22
...
### Community 1056 - "Phase 22 — Validation Strategy"
Cohesion: 0.22
...
### Community 1057 - "Deferred items — phase 25.1"
Cohesion: 0.22
...
### Community 1058 - "1. The invite gate — `callbacks.createOrUpdateUser` (BETA-01) — **HIGH confidence, source-verified**"
Cohesion: 0.22
...
### Community 1059 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1060 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
Cohesion: 0.36
Nodes (8): abortEnv(), attemptCase(), authoringTenantFor(), overCap(), parse(), sleepSync(), waitForDispatch(), waitForResearchLanding()

### Community 1062 - "Plan 26-20: Command Center v2, owner-approved"
Cohesion: 0.22
...
### Community 1063 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
### Community 1064 - "Phase 27 Plan 01: Upstream Pin and Provenance Summary"
Cohesion: 0.22
...
### Community 1065 - "Phase 27 Plan 03: Pack Measurement Plane Summary"
Cohesion: 0.22
...
### Community 1066 - "Phase 27 Decision Memo — Curated Knowledge-Work Pack Pilot"
Cohesion: 0.22
...
### Community 1068 - "Phase 28 — Validation Strategy"
Cohesion: 0.22
...
### Community 1069 - "Phase 29 — Validation Strategy"
Cohesion: 0.22
...
### Community 1070 - "Plan 33-05: Auto-assembled reel — vault save + regenerate ordering"
Cohesion: 0.22
...
### Community 1071 - "Common Pitfalls"
Cohesion: 0.22
...
### Community 1072 - "DriveBrowser.tsx"
Cohesion: 0.25
Nodes (7): Crumb, DriveBrowser(), Entry, Node, Note, WHY, n()

### Community 1073 - "package.json"
Cohesion: 0.25
Nodes (7): exports, name, private, scripts, typecheck, type, version

### Community 1074 - "Packaged Convex Components"
Cohesion: 0.25
Nodes (7): Build Flow, Checklist, Default Approach, Package Exports, Packaged Convex Components, Testing, When to Choose This

### Community 1075 - "01-08 Summary — Public web surface (PARTIAL)"
Cohesion: 0.25
...
### Community 1076 - "Phase 1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1077 - "Phase 2: Thin End-to-End Slice - Research"
Cohesion: 0.25
...
### Community 1079 - "Phase 2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1080 - "Phase 03.10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1081 - "Phase 3.11 — Validation Strategy"
Cohesion: 0.25
...
### Community 1082 - "Phase 03.1 Plan 05: Cockpit Structural Shell Summary"
Cohesion: 0.25
...
### Community 1083 - "03.1-07-SUMMARY.md"
Cohesion: 0.25
...
### Community 1084 - "Phase 03.2.1: Agent-Driven Cockpit — Research"
Cohesion: 0.25
...
### Community 1085 - "Phase 03.2.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1086 - "Phase 3.2 — Validation Strategy"
Cohesion: 0.25
...
### Community 1087 - "Phase 3.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1088 - "Phase 3.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1089 - "Phase 3.6: Agent Eval Gate - Research"
Cohesion: 0.25
...
### Community 1090 - "Phase 3.6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1091 - "Phase 3.7 Plan 01: Pure Briefing Module Summary"
Cohesion: 0.25
...
### Community 1092 - "Phase 3.7 Plan 02: Gmail Read Plane + Briefing Content Plane Summary"
Cohesion: 0.25
...
### Community 1094 - "Phase 3.7 Plan 03: The Briefing Brain Summary"
Cohesion: 0.25
...
### Community 1095 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1096 - "Phase 03.8 — Validation Strategy"
Cohesion: 0.25
...
### Community 1098 - "Phase 03.9 — Validation Strategy"
Cohesion: 0.25
...
### Community 1099 - "Phase 3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1100 - "Phase 4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1101 - "Phase 5: Knowledge Vault & GraphRAG - Research"
Cohesion: 0.25
...
### Community 1102 - "Phase 5 — Validation Strategy"
Cohesion: 0.25
...
### Community 1103 - "Phase 6 — Validation Strategy"
Cohesion: 0.25
...
### Community 1104 - "Phase 7 — Validation Strategy"
Cohesion: 0.25
...
### Community 1105 - "Phase 10 Plan 01: Vault Grounding Hydration Summary"
Cohesion: 0.25
...
### Community 1106 - "Phase 10 Plan 02: searchVault Cockpit Grounding Tool Summary"
Cohesion: 0.25
...
### Community 1107 - "Phase 10 Plan 03: Vault-Grounding Source-Card Read-Side Summary"
Cohesion: 0.25
...
### Community 1108 - "Phase 10 — Validation Strategy"
Cohesion: 0.25
...
### Community 1109 - "Phase 12 — Validation Strategy"
Cohesion: 0.25
...
### Community 1110 - "Phase 13: Proactive In-App Review - Research"
Cohesion: 0.25
...
### Community 1111 - "Phase 13 — Validation Strategy"
Cohesion: 0.25
...
### Community 1118 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1119 - "Plan 14-06 Summary — the browser relay"
Cohesion: 0.25
...
### Community 1120 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.25
...
### Community 1121 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1125 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1127 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1128 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1129 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1130 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
### Community 1131 - "Phase 15 — Validation Strategy"
Cohesion: 0.25
...
### Community 1133 - "Phase 16 — Validation Strategy"
Cohesion: 0.25
...
### Community 1164 - "Phase 20 — provider evaluation"
Cohesion: 0.25
...
### Community 1165 - "5. NEW PITFALLS (extending `20-RESEARCH.md` §10, which still holds in full)"
Cohesion: 0.25
...
### Community 1166 - "22.1-01 Summary — Disconnect Google (revoke, then delete)"
Cohesion: 0.25
...
### Community 1167 - "22.1-02 Summary — per-tenant budget keying, with the ceiling kept"
Cohesion: 0.25
...
### Community 1168 - "Phase 22.1 Plan 03: CI Gate Summary"
Cohesion: 0.25
...
### Community 1169 - "Phase 22.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1170 - "Phase 22.1 — Goal Verification"
Cohesion: 0.25
...
### Community 1171 - "22-01 Summary — identity + owner substrate"
Cohesion: 0.25
...
### Community 1172 - "22-03 Summary — owner-only `/ops` presentation"
Cohesion: 0.25
...
### Community 1173 - "Phase 22 — live UAT evidence (GOVN-01)"
Cohesion: 0.25
...
### Community 1174 - "Phase 23 prerequisite gate — run 2026-08-18, before the first edit"
Cohesion: 0.25
...
### Community 1175 - "23-02 SUMMARY — the inert writer, built before anything can reach it"
Cohesion: 0.25
...
### Community 1176 - "25.1-07 — Live UAT checkpoint"
Cohesion: 0.25
...
### Community 1177 - "Phase 25.1 — Validation Strategy"
Cohesion: 0.25
...
### Community 1178 - "Phase 25 — Validation Strategy"
Cohesion: 0.25
...
### Community 1179 - "Phase 26 Plan 09: Tenant and Owner Cost Console Projections Summary"
Cohesion: 0.25
...
### Community 1180 - "26-11 — artifact provenance and the explicit trust promotion"
Cohesion: 0.25
...
### Community 1181 - "26-12 — the Content shelf: one bounded read plane over artifacts that already exist"
Cohesion: 0.25
...
### Community 1182 - "26-13.1 — the image lane, and the comment that hid it"
Cohesion: 0.25
...
### Community 1183 - "26-16 — the board pack: one transaction is the snapshot, and promotion is not a new authorship"
Cohesion: 0.25
...
### Community 1184 - "Phase 30 — Validation Strategy"
Cohesion: 0.25
...
### Community 1185 - "Phase 33: Media Creation UX Overhaul - Research"
Cohesion: 0.25
...
### Community 1186 - "Phase 33 — Validation Strategy"
Cohesion: 0.25
...
### Community 1190 - "PII Engine — v1 Decision"
Cohesion: 0.29
...
### Community 1191 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1192 - "03.11-01-PLAN.md"
Cohesion: 0.29
...
### Community 1193 - "assertSuiteIdentity"
Cohesion: 0.47
Nodes (6): assertSuiteIdentity(), codeOwnedSuite(), computeSuiteIdentity(), readSuiteManifest(), suiteIdentityFor(), writeSuiteManifest()

### Community 1194 - "runInspect"
Cohesion: 0.40
Nodes (6): checkExpectations(), configuredDeployment(), deploymentFingerprint(), foreignCollision(), runAgentSourceInspect(), runInspect()

### Community 1195 - "03.11-04-PLAN.md"
Cohesion: 0.29
...
### Community 1196 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1197 - "Validation Architecture"
Cohesion: 0.29
...
### Community 1198 - "Architecture Patterns"
Cohesion: 0.29
...
### Community 1199 - "Common Pitfalls"
Cohesion: 0.29
...
### Community 1200 - "Phase 12 — Deferred / Out-of-Scope Items"
Cohesion: 0.29
...
### Community 1203 - "Phase 15.1: Fact-Derived Tier & Conversational Onboarding — Research"
Cohesion: 0.29
...
### Community 1207 - "Phase 16: Research Sub-Agent & Web Research Verification Report"
Cohesion: 0.29
...
### Community 1208 - "The Injection Seam — per-caller verdict (HIGHEST-VALUE SECTION)"
Cohesion: 0.29
...
### Community 1210 - "Deviations from Plan"
Cohesion: 0.29
...
### Community 1211 - "6. The Pipeline route"
Cohesion: 0.29
...
### Community 1213 - "2. Q2 — VERCEL SANDBOX MECHANICS"
Cohesion: 0.29
...
### Community 1214 - "Phase 21 — live session 2026-08-18: what was executed, and what CANNOT be"
Cohesion: 0.29
...
### Community 1215 - "25-01 — security audit of the BETA-01 admission boundary"
Cohesion: 0.29
...
### Community 1216 - "Phase 26 Plan 06: Spend Ledger Core Summary"
Cohesion: 0.29
...
### Community 1218 - "26-13 Task 2 — Content artifact UAT (BLOCKING, open)"
Cohesion: 0.29
...
### Community 1219 - "Plan 26-19: the deterministic Command Center backend"
Cohesion: 0.29
...
### Community 1220 - "Phase 27 Validation Strategy"
Cohesion: 0.29
...
### Community 1221 - "ADR-010: `SPECIALIST_ROUTES` is a SUPERSET of what `diagnose()` emits"
Cohesion: 0.33
...
### Community 1226 - "calendar-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1227 - "first-login-second-attempt-auth-redirect.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1228 - "gmail-api-service-disabled.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1229 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1230 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1231 - "phase21-local-google-login-failure.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1232 - "production-frontend-rollback-after-media-release.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1233 - "convex-local-backend-preparing-functions.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1234 - "production-client-provided-address-not-absolute-url.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1235 - "03.11-02-PLAN.md"
Cohesion: 0.33
...
### Community 1236 - "03.11-03-PLAN.md"
Cohesion: 0.33
...
### Community 1237 - "Phase 03.5 Plan 05: Reschedule a Canceled Send Summary"
Cohesion: 0.33
...
### Community 1240 - "Phase 03.5 Plan 06: Far-Future Scheduling Cap Summary"
Cohesion: 0.33
...
### Community 1242 - "Deferred Items — Phase 03 Guardrails"
Cohesion: 0.33
...
### Community 1244 - "Growth OS Port (research priority #6 — what to scope)"
Cohesion: 0.33
...
### Community 1245 - "Inventory: what already exists"
Cohesion: 0.33
...
### Community 1246 - "Phase 14: Flagship Voice-Doc Workflow Verification Report"
Cohesion: 0.33
...
### Community 1252 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 1253 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1258 - "5. Media job + asset schema"
Cohesion: 0.33
...
### Community 1259 - "Phase 20: Media Canvas — RESEARCH DELTA (2026-08-01 re-scope)"
Cohesion: 0.33
...
### Community 1260 - "1. Q1 — THE TTS PROVIDER AND ITS PUBLISHED PRICE"
Cohesion: 0.33
...
### Community 1261 - "Validation Architecture (delta)"
Cohesion: 0.33
...
### Community 1262 - "Validation Architecture"
Cohesion: 0.33
...
### Community 1263 - "21-08 — the free half of the live gate: executed, except the half that cannot be"
Cohesion: 0.33
...
### Community 1264 - "26-05: Connected Approvals route, owner-verified"
Cohesion: 0.33
...
### Community 1265 - "Plan 26-18: Sales Pipeline navigation activation"
Cohesion: 0.33
Nodes (5): Change, External gate consumed, Plan 26-18: Sales Pipeline navigation activation, Rollback, Verification

### Community 1271 - "Phase 27 Plan 04: Business Pulse and Campaign Plan Summary"
Cohesion: 0.33
...
### Community 1272 - "Phase 27 Plan 06: Process/SOP Builder and Brand Review Summary"
Cohesion: 0.33
...
### Community 1273 - "Revenue Workflow Architecture"
Cohesion: 0.33
...
### Community 1275 - "Phases 14–25 milestone audit — 2026-08-20"
Cohesion: 0.33
...
### Community 1278 - "Convex"
Cohesion: 0.40
Nodes (4): Convex, Route to the Right Skill, Start Here, When Not to Use

### Community 1279 - "Scheduled Send"
Cohesion: 0.40
...
### Community 1281 - "Phase 02 — Deferred Items"
Cohesion: 0.40
...
### Community 1282 - "Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate"
Cohesion: 0.40
Nodes (4): Deviations, Key files, Plan 03.10-03 Summary — stalled-resolution recovery through the registry gate, Tasks

### Community 1283 - "Deferred Items — Phase 03.1 Cockpit Core"
Cohesion: 0.40
...
### Community 1286 - "Video Transcription (Lane 4)"
Cohesion: 0.40
...
### Community 1287 - "Phase 3.8 — Deferred items (out-of-scope discoveries)"
Cohesion: 0.40
...
### Community 1288 - "Standard Stack"
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, New workspace package, Standard Stack, Supporting

### Community 1289 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1290 - "10-01-PLAN.md"
Cohesion: 0.40
...
### Community 1293 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1294 - "Code Examples"
Cohesion: 0.40
...
### Community 1297 - "Phase 15.3: Vault Folders — Research"
Cohesion: 0.40
...
### Community 1302 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
### Community 1304 - "Union Blast Radius — the executor's walk"
Cohesion: 0.40
...
### Community 1307 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1308 - "1. The `crm_write` action type — the complete edit list"
Cohesion: 0.40
...
### Community 1309 - "3. The un-omittable CAN-SPAM footer"
Cohesion: 0.40
...
### Community 1310 - "4. The public unsubscribe route"
Cohesion: 0.40
...
### Community 1311 - "5. Schema + isolation"
Cohesion: 0.40
...
### Community 1312 - "7. The GATED_SKILLS serialization constraint"
Cohesion: 0.40
...
### Community 1315 - "11. Playbook (CLAUDE.md §9)"
Cohesion: 0.40
...
### Community 1316 - "1. fal.ai adapter mechanics + LIVE rates"
Cohesion: 0.40
...
### Community 1317 - "4. The budget rail, concretely — AND the D4 batch answer"
Cohesion: 0.40
...
### Community 1319 - "3. Q3 — THE CAPTIONS STEP"
Cohesion: 0.40
...
### Community 1320 - "User Constraints (from CONTEXT.md, 2026-08-01 re-scope)"
Cohesion: 0.40
...
### Community 1323 - "3. The BETA-05 isolation suite — schema-derived enumeration — **HIGH confidence, API-verified**"
Cohesion: 0.40
...
### Community 1324 - "4. Microsoft Graph — the mapping (DLVR-02)"
Cohesion: 0.40
...
### Community 1326 - "Production Secret Inventory (research Q5)"
Cohesion: 0.40
...
### Community 1327 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1328 - "Phase 27 Plan 05: Complaint Response and Sales Call Prep Summary"
Cohesion: 0.40
...
### Community 1329 - "Existing Architecture to Reuse"
Cohesion: 0.40
...
### Community 1330 - "Provider Suitability Gates"
Cohesion: 0.40
...
### Community 1331 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1332 - "Phase 33 — deferred items"
Cohesion: 0.40
...
### Community 1333 - "previewIndex"
Cohesion: 0.50
Nodes (3): OutputCard(), previewIndex(), llm

### Community 1334 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1335 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1336 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1337 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1338 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 1339 - "tsconfig.json"
Cohesion: 0.50
Nodes (3): exclude, extends, include
...
### Community 1342 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
...
### Community 1346 - "03.11-05-PLAN.md"
Cohesion: 0.50
...
### Community 1351 - "User Constraints"
Cohesion: 0.50
...
### Community 1357 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1362 - "User Constraints (from 14-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1364 - "15.1-05-PLAN.md"
Cohesion: 0.50
...
### Community 1366 - "User Constraints"
Cohesion: 0.50
...
### Community 1368 - "Deferred items — phase 15.3"
Cohesion: 0.50
...
### Community 1372 - "User Constraints (from 16-CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from 16-CONTEXT.md)

### Community 1373 - "The vault write path & freshness stamp (SC#2, SC#4, D7)"
Cohesion: 0.50
...
### Community 1380 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1382 - "Three OPEN Items"
Cohesion: 0.50
...
### Community 1383 - "The Existing Substrate — as it actually is today"
Cohesion: 0.50
...
### Community 1384 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)
...
### Community 1386 - "Re-Verification Summary"
Cohesion: 0.50
...
### Community 1387 - "2. The send-path suppression guard (SC#5) — the convergence map"
Cohesion: 0.50
...
### Community 1389 - "User Constraints (from 19-CONTEXT.md)"
Cohesion: 0.50
...
### Community 1391 - "2. Webhook authentication — CLOSES `20-PROVIDER-EVAL.md` §5 Q2"
Cohesion: 0.50
...
### Community 1392 - "7. The skill registry rows"
Cohesion: 0.50
...
### Community 1393 - "9. koda-stack media prompts (MIT) — the substance"
Cohesion: 0.50
...
### Community 1394 - "User Constraints (from CONTEXT.md)"
Cohesion: 0.50
Nodes (4): Claude's Discretion, Deferred Ideas (OUT OF SCOPE), Locked Decisions, User Constraints (from CONTEXT.md)

### Community 1395 - "4. THE REVISED JOB ECONOMICS"
Cohesion: 0.50
...
### Community 1400 - "Deterministic Finance Architecture"
Cohesion: 0.50
...
### Community 1404 - "Milestone: Marketing (Phases 31-32) — PULLED PRE-BETA 2026-08-07"
Cohesion: 0.50
...
### Community 1413 - "Standard Stack"
Cohesion: 0.67
Nodes (3): Core — all already installed; this phase adds NO dependency, Explicitly NOT used, Standard Stack

### Community 1419 - "Storage Decision Inputs (research priority #4 — planner decides)"
Cohesion: 0.67
...
### Community 1422 - "Code Examples"
Cohesion: 0.67
Nodes (3): Code Examples, Confidence from code, not prose, Provider endpoint containment

## Knowledge Gaps
- **12800 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+12795 more)
...
- **Why does `api` connect `skills.test.ts` to `functions.ts`, `page.tsx`, `v1 Requirements`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `guardrails.test.ts`, `Dropzone.tsx`, `classify.ts`, `buildCockpitTools`, `log`, `optimizerBreach.ts`, `DriveBrowser.tsx`, `buildTelemetry.ts`, `formatAbsolute`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `guardrails.test.ts`, `index.ts`, `Key files`, `classify.ts`, `index.ts`, `classify.ts`, `Phase Details - Milestone v2.0`, `intake.test.ts`, `skill-authoring.spec.ts`, `briefings.ts`, `metering.ts`, `Phase Details`, `skills.test.ts`, `evaluations.test.ts`, `feedback.ts`, `feedback.test.ts`, `page.tsx`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `extractKind.ts`, `skills.test.ts`, `feedback.test.ts`, `assembly.ts`, `SkillAuthoringPanel.tsx`, `isolation.test.ts`, `officeText.test.ts`, `vaultDigest.ts`, `approvalsView.test.ts`, `proposals.test.ts`, `vaultTranscribe.test.ts`, `render.test.ts`, `assembly.ts`, `DriveBrowser.tsx`, `Phase 3.11: Inbox Reply - Research`, `FinanceTabs.tsx`, `replyDrafter.ts`, `content.test.ts`, `ADR-007: Sub-agent capability is code-owned; the sub-agent prompt is registry-owned`, `vaultGround.test.ts`, `gmail.test.ts`, `approvalsView.test.ts`, `AdminView.tsx`, `Proactive weekly review (BEVL-03, 13-02)`, `dataModel.d.ts`, `research.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `pipeline-uat.spec.ts`, `media.ts`, `Phase 25 Plan 06: Mailbox Choice and Disconnect Posture Summary`, `Phase 24 Plan 01: ISO 9001 Evidence Map Foundation Summary`, `CommandCenter.tsx`, `ReportsView.tsx`, `Convex Quickstart`, `page.tsx`, `Phase 23 Research: Agent-Authored Skills`, `blueprint.test.ts`, `useSendCockpitMessage`, `reportPack.test.ts`, `FinanceTabs.tsx`, `packCustomerComplaint.ts`, `selfCheck`, `reportsBusiness.test.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `internal` connect `Convex Quickstart` to `Phase 3.11: Inbox Reply - Research`, `package.json`, `calendarComplete.ts`, `page.tsx`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `cockpitBlueprint.test.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `Project State`, `scan.ts`, `skills.test.ts`, `guardrails.ts`, `page.tsx`, `layout.tsx`, `skills.test.ts`, `cockpit-resolve.spec.ts`, `reportPack.test.ts`, `Dropzone.tsx`, `evaluations.test.ts`, `replyDrafter.ts`, `Validation Architecture`, `FinanceTabs.tsx`, `feedback.ts`, `vaultGround.test.ts`, `log`, `feedback.test.ts`, `packCustomerComplaint.ts`, `Proactive weekly review (BEVL-03, 13-02)`, `vaultSealing.test.ts`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `vaultDrive.ts`, `extractKind.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `cockpit.ts`, `skills.test.ts`, `guardrails.test.ts`, `selfCheck`, `assembly.ts`, `layout.tsx`, `intake.test.ts`, `vaultDigest.ts`, `media.ts`, `approvalsView.test.ts`, `Phase Details - Milestone v2.0`, `server.d.ts`, `classify.ts`, `Dropzone.tsx`, `vaultTranscribe.test.ts`, `classify.ts`, `012-media-route-and-the-reel.md`, `classify.ts`, `page.tsx`, `goals.test.ts`, `profileRedaction.test.ts`, `blueprint.test.ts`, `spendLedger.ts`, `assembly.ts`, `intake.test.ts`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _12832 weakly-connected nodes found - possible documentation gaps or missing edges._
