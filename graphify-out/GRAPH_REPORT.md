...
## Corpus Check
- 1491 files · ~2,550,335 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5228 nodes · 8311 edges · 401 communities (361 shown, 40 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d53019bd`
...
8. `tenantQuery` - 25 edges
9. `buildCockpitTools()` - 25 edges
10. `Phase Details - Milestone v2.0` - 24 edges
...
- `BlueprintCanvas()` --calls--> `segmentFill()`  [EXTRACTED]
  apps/web/app/(app)/dashboard/profile/BlueprintCanvas.tsx → packages/core/src/blueprintSegments.ts

## Import Cycles
- None detected.

## Communities (401 total, 40 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.12
Nodes (18): draftVoiceBrief, voiceSessions (table), abortSession, forceEndSession, getActiveSession, getSession, markEndedAbnormal, markEndedClean (+10 more)

### Community 1 - "package.json"
Cohesion: 0.08
Nodes (31): DEFAULT_CONFIG, FolderReserveRefusal, FolderReserveResult, getSafeTextByHash, ingestRemainingCents, ingestRemainingCentsInner(), mediaRemainingCents, mediaRemainingCentsInner() (+23 more)

### Community 2 - "page.tsx"
Cohesion: 0.04
Nodes (36): Activity, attRow, box, Briefing, BriefingItem, btn, categoryTag, chip (+28 more)
...
Cohesion: 0.12
Nodes (23): repriceUsd(), chooseMediaBatch(), CLIP_SET, counted(), estimateBatchUsd(), estimateMediaUsd(), MEDIA_DEFAULT_IMAGE, MEDIA_DEFAULT_STT (+15 more)
...
Cohesion: 0.07
Nodes (31): getGuardrailConfig(), batchToSubmit, buildSubmitBody(), captionsToSubmit, claimLine, clearRender(), CLIP_SECONDS_SET, EstimateLine (+23 more)
...
Cohesion: 0.07
Nodes (24): RFC-2045, RFC-2047, RFC-2822, buildMime(), FetchBodiesResult, fetchInboxBodies, getReplyTarget, HeaderRecord (+16 more)
...
Cohesion: 0.12
Nodes (24): seedDeck(), ArtDirection, Block, cellsOf(), CLIP_SECONDS, CLIP_SECONDS_SET, fail(), fieldOf() (+16 more)

### Community 14 - "page.tsx"
Cohesion: 0.09
Nodes (35): activateSkill, activateSkillVersion(), archiveSkill, getSkillVersion, recordEvalEvidence, seedSkills, ADR-0007, BMC_SKILL (+27 more)
...
Cohesion: 0.13
Nodes (8): BLUEPRINT_TEXT, code, modules, sources, classifyReviewDecision(), ReviewClassification, ReviewClassifierInput, ReviewDecision

### Community 20 - "buildCockpitTools"
Cohesion: 0.04
Nodes (46): log, { auth, signIn, signOut, store, isAuthenticated }, password, onCreateComplete, onPipelineComplete, httpAction, buildAuthorizeUrl(), deleteTokens (+38 more)
...
Cohesion: 0.08
Nodes (32): actOnGap, actOnGapInternal, ActOnGapResult, applyScorecardAnswer(), coerceScorecardValue(), EvaluationDelta, FALLBACK_SENTENCE, FINANCIAL_PATTERNS (+24 more)
...
Cohesion: 0.12
Nodes (18): BlueprintPanel(), BlueprintReport(), EMPTY_BLUEPRINT, formatConfirmedAt(), joinPhrases(), secondaryButton(), SEGMENT_COPY, SegmentLedger() (+10 more)
...
Cohesion: 0.23
Nodes (11): ActivityCard(), stepText(), bubble(), ChatPane(), messageText(), IntakeControls(), StorageId, PaperclipIcon() (+3 more)
...
Cohesion: 0.12
Nodes (25): ConfirmDecision, decideConfirm(), DerivedTier, deriveTier(), deserializeProfile(), FUNDING_STATES, inUnion(), isPersona() (+17 more)
...
Cohesion: 0.13
Nodes (20): BlueprintEntry, clip(), DerivedCandidate, deserializeBlueprint(), DroppedCandidate, FieldSpec, isBlueprintField(), marker() (+12 more)
...
Cohesion: 0.14
Nodes (11): OptimizerPanel(), REVIEW_OUTCOMES, unifiedDiff(), listNew, markResolved, evalSignals, getOptimizerStatus, setOptimizerEnabled (+3 more)
...
Cohesion: 0.09
Nodes (32): getActiveSkill, docForMint, mintClientSecret, MintResponse, calls, Captured, modules, ADR-0006 (+24 more)
...
Cohesion: 0.10
Nodes (23): classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch(), DriveFile, DriveImportResult (+15 more)
...
Cohesion: 0.09
Nodes (19): BLUEPRINT_FIELD_SET, BlueprintDraft, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult, candidatesSchema, ConfirmBlueprintResult, deriveCandidates (+11 more)
...
Cohesion: 0.04
Nodes (66): box, btn, Mode, deadLetterRecipient, deliverApprovedPlan, markPlanDone, send, prepare (+58 more)
...
Cohesion: 0.10
Nodes (34): NAV, PasswordField(), TextField(), ArrowIcon(), base(), BellIcon(), BoltIcon(), BrainIcon() (+26 more)
...
Cohesion: 0.06
Nodes (30): aggregateModules, ASSET, deck(), JOB_41(), mediaCode, modules, rateLimiterModules, RENDER_SIDECAR (+22 more)
...
Cohesion: 0.19
Nodes (11): runVaultGround(), categoryFor(), isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource, fuse(), FusionResult (+3 more)
...
Cohesion: 0.13
Nodes (18): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, readLayout(), VaultDoc (+10 more)
...
Cohesion: 0.07
Nodes (28): spineForTenant, graphEdges (table), graphNodes (table), getDoc, markReady, ownedDocsMeta, sealedDocIds, EDGE (+20 more)
...
Cohesion: 0.05
Nodes (38): cockpitAgent, ExternalActionType, ExternalArgs, FanoutArgs, isNonAgentThreadIdError(), listThreadMessages, proposeEmailPlan, reschedulePlan (+30 more)
...
Cohesion: 0.06
Nodes (35): preCall, recordSpend, RunIntakeArgs, insertArtifact, patchArtifact, tenantAction, applyClassification, countTerminal() (+27 more)

### Community 157 - "agentSteps.test.ts"
Cohesion: 0.09
Nodes (21): crons, runEvaluation, internalAction, base64Url(), flagExpiringTokens, dispatch, KINDS, insertReviewNotification (+13 more)
...
Cohesion: 0.04
Nodes (61): ADR-0016, insert, ACCENT, AgentSmokeOp, Att, briefSchema, BriefTurn, callTimeoutMsFor() (+53 more)
...
Cohesion: 0.12
Nodes (17): BEHAVIOR_PRESETS, BehaviorPreset, Tier, EvidenceVerdict, INCOMPLETE_MARKER, RESEARCH_TOOLS, ResolvedSpecialist, SPECIALIST_TOOLS (+9 more)
...
Cohesion: 0.12
Nodes (14): tenantProfiles (table), backfillLegacyTier, _docToFunding, _docToPreset, _docToSource, _docToStage, _docToTier, FACT_KEYS (+6 more)
...
Cohesion: 0.18
Nodes (10): notifyIfAgentTimeout(), ActionCtx, DatabaseReader, MutationCtx, QueryCtx, freshAccessToken(), byTenant(), logTierChange() (+2 more)

### Community 195 - "16-06-PLAN.md"
Cohesion: 0.33
Nodes (4): NOTE: there is deliberately no "unrecognized mime → { ok: false }" refusal any m, retryExtraction, sweepPendingExtraction, watchdogStalled
...
Cohesion: 0.09
Nodes (30): BLOCKED, BlockedConnection, ADR-0007, ConnectionsPanel(), pill, row, NarrativePanel(), isTabId() (+22 more)
...
Cohesion: 0.29
Nodes (10): centsFor(), estimateFile(), estimateFolderCents(), EstimateInput, FileEstimate, FolderEstimate, GRAPH_INPUT_TOKENS, modelUsd() (+2 more)
...
Cohesion: 0.11
Nodes (18): BusyRange, createEvent, CreateEventResult, freeBusy, FreeBusyResult, GoogleError, GoogleFreeBusy, RFC-3339 (+10 more)
...
Cohesion: 0.04
Nodes (56): finish, latestTurn, record, StepView, auditCounts, backfillAuditCounts, countAudit, ADR-0004 (+48 more)

### Community 216 - "vault-redesign.spec.ts"
Cohesion: 0.09
Nodes (33): buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), dispatchAndLand(), DispatchArgs, DispatchRefusal, DispatchResult (+25 more)
...
Cohesion: 0.31
Nodes (4): capClassifyText(), capGraphText(), capMB(), bfsNeighbors()
...
Cohesion: 0.03
Nodes (45): modules, T, aggregateModules, modules, modules, T, modules, modules (+37 more)

### Community 252 - "retention.ts"
Cohesion: 0.60
Nodes (4): retainUntilDate(), serializeAuditNdjson(), sortKeys(), wormObjectKey()

### Community 253 - "18-08: teach createDocument — certified live on 2026-08-08"
Cohesion: 0.33
...
### Community 254 - "xlsText.test.ts"
Cohesion: 0.50
Nodes (4): rows(), SALES, workbook(), xlsBytes()

### Community 255 - "driveEstimate.ts"
Cohesion: 0.60
Nodes (3): ASSUMED_FALLBACK_BYTES, DRIVE_NATIVE_ASSUMED_BYTES, estimatedBytesFor()

### Community 256 - "Post-Beta Knowledge-Work Expansion (Phases 27-30)"
Cohesion: 0.40
...
Cohesion: 0.27
Nodes (15): CHEAP_MODEL, chooseModel(), CostError, DEFAULT_MODEL, estimateCostUsd(), estimateTokens(), priceRealtime(), priceTranscription() (+7 more)

### Community 290 - "approvalsView.test.ts"
Cohesion: 0.05
Nodes (41): actionLabel(), ageLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), ApprovalsView(), AwaitingCard(), AwaitingItem, AwaitingPage (+33 more)

### Community 291 - "audit.test.ts"
Cohesion: 0.11
Nodes (23): Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME, StorageId, fmtReady() (+15 more)
...
Cohesion: 0.10
Nodes (14): DisconnectGoogle(), KIND_HREF, NotificationsBanner(), readSeen(), ReconnectBanner(), STATUS_COLOR, newCount, api (+6 more)
...
## Knowledge Gaps
- **2497 isolated node(s):** `Overview`, `Phase 26: Connected product pages`, `Phase 27: Curated Knowledge-Work Pack Pilot`, `Phase 28: Connector-Backed Revenue Pack`, `Phase 29: Unified Knowledge and Routines` (+2492 more)
...
- **Why does `api` connect `validateSubmit.ts` to `package.json`, `page.tsx`, `vaultFolders.test.ts`, `skills.ts`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `LiveSession.tsx`, `scan.ts`, `layout.tsx`, `index.ts`, `DriveBrowser.tsx`, `cockpit-resolve.spec.ts`, `Dropzone.tsx`, `evaluations.test.ts`, `Validation Architecture`, `Phase 11: Persona Onboarding & Business Profile - Research`, `vaultLlm.ts`, `buildCockpitTools`, `feedback.ts`, `approvalsView.test.ts`, `audit.test.ts`, `log`, `feedback.test.ts`, `Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary`, `calendar.test.ts`, `ApprovalsErrorBoundary`, `page.tsx`, `Pikar-AI`, `opsSignals.test.ts`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `Phase 3.10: Cockpit Conversation Repair - Research`, `Project State`, `vaultLlm.ts`, `getActiveSkill`, `notificationMessage`, `index.ts`, `opsSignals.test.ts`, `COCKPIT_AGENT_SKILL`, `Dropzone.tsx`, `proactiveReview.ts`, `index.ts`, `plans.test.ts`, `guardrails.test.ts`, `vaultExtract.ts`, `voiceDoc.test.ts`, `Critical Pitfalls`, `classify.ts`, `createdDocs.test.ts`, `vaultGround.test.ts`, `page.tsx`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `intake.test.ts`, `guardrails.ts`, `runCockpitAgent.test.ts`, `worm.test.ts`, `proactiveReview.test.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `internal` connect `intake.test.ts` to `functions.ts`, `package.json`, `documentDraft.test.ts`, `vaultFolders.test.ts`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `metering.ts`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `Project State`, `layout.tsx`, `index.ts`, `tenant.ts`, `buildCockpitTools`, `constants.ts`, `guardrails.test.ts`, `evaluations.test.ts`, `routing.ts`, `Validation Architecture`, `Validation Architecture`, `agentSteps.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `feedback.ts`, `log`, `Phase 03.2.1 Plan 04: runCockpitAgent Governed Tool-Loop Summary`, `calendar.test.ts`, `ApprovalsErrorBoundary`, `llm.ts`, `Implementation Decisions`, `Project State`, `buildTelemetry.ts`, `Phase 03.5 Plan 05: Reschedule a Canceled Send Summary`, `searchVaultSpine.test.ts`, `vaultLlm.ts`, `index.ts`, `Phase 7: Resilience & Operations Hardening - Research`, `Key files`, `COCKPIT_AGENT_SKILL`, `009-tier-shapes-the-specialist-prompt-not-the-offer-set.md`, `vault-redesign.spec.ts`, `Dropzone.tsx`, `buildTelemetry.ts`, `proactiveReview.ts`, `plans.test.ts`, `voiceDoc.test.ts`, `guardrails.test.ts`, `officeText.ts`, `Project State`, `Critical Pitfalls`, `vaultLlm.ts`, `page.tsx`, `vaultGround.test.ts`, `runCockpitAgent.test.ts`, `worm.test.ts`, `proactiveReview.test.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `BlueprintCanvas()` connect `DriveBrowser.tsx` to `vaultLlm.ts`?**
...
- **What connects `Overview`, `Phase 26: Connected product pages`, `Phase 27: Curated Knowledge-Work Pack Pilot` to the rest of the system?**
  _2529 weakly-connected nodes found - possible documentation gaps or missing edges._
