# Graph Report - pikar-lane-34  (2026-08-31)

## Corpus Check
- 2144 files · ~4,408,470 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20841 nodes · 25982 edges · 1865 communities (1795 shown, 70 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20ae5b7c`
...
1. `internal` - 145 edges
2. `api` - 140 edges
3. `internalMutation` - 54 edges
4. `tenantQuery` - 48 edges
5. `contentHash()` - 47 edges
6. `internalQuery` - 38 edges
7. `buildCockpitTools()` - 37 edges
8. `Playbook: Media Canvas (finished reels and standalone images)` - 37 edges
9. `internalAction` - 37 edges
10. `base()` - 29 edges
...
- `DriveBrowser()` --indirect_call--> `n()`  [INFERRED]
  apps/web/app/(app)/dashboard/vault/DriveBrowser.tsx → packages/core/src/blueprintPulse.ts
...
## Communities (1865 total, 70 thin omitted)

### Community 0 - "functions.ts"
Cohesion: 0.06
Nodes (40): ArtifactActions, ArtifactCard(), ArtifactCardData, browserTimeZone(), button, bytesLabel(), caps, card (+32 more)

### Community 1 - "package.json"
Cohesion: 0.02
Nodes (84): retrier, vaultIngestPool, workflow, BlockReason, LABELS, llmSpendCorrelation(), pipelineWorkflow, REQUEST_STATUS (+76 more)

### Community 2 - "page.tsx"
Cohesion: 0.05
Nodes (60): BlueprintCanvas(), clampScale(), HOME, Layout, nodeHeight(), Point, populatedBulletFields(), readLayout() (+52 more)
...
Cohesion: 0.07
Nodes (36): isSearchable(), SEARCHABLE_MIME, VaultCategory, VaultSource, capClassifyText(), capGraphText(), capMB(), ExtractionKind (+28 more)
...
Cohesion: 0.07
Nodes (33): bumpLanded(), classify(), classifyOne(), diffImport, DriveBrowseResult, DriveEntry, driveFetch(), DriveFile (+25 more)

### Community 8 - "ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages"
Cohesion: 0.04
Nodes (94): briefingSheet, capsTeal, snippetSheet, traceText, typeBadge, VaultDocButton(), ArtDirection, Block (+86 more)
...
Cohesion: 0.03
Nodes (62): RFC-2045, RFC-2047, notifyIfAgentTimeout(), DeliveryResult, send, internalAction, base64Url(), buildMime() (+54 more)
...
Cohesion: 0.02
Nodes (123): modules, modules, activateAgentCandidate, activateCandidate, activateSkill, activateSkillVersion(), activateTenantCandidate, ActivationPlan (+115 more)

### Community 13 - "Phase 03.7 — Validation Strategy"
Cohesion: 0.15
Nodes (20): OperationsSection(), DASHBOARD_STATE_COPY, DashboardBound, buildBoardPackMarkdown(), compareSnapshots(), Completeness, countCell(), coverageWord() (+12 more)

### Community 14 - "page.tsx"
Cohesion: 0.02
Nodes (141): finish, latestTurn, record, refuse, StepView, auditCounts, backfillAuditCounts, countAudit (+133 more)
...
Cohesion: 0.09
Nodes (21): ConnectedBriefing(), ConnectedStats(), HomeHealth, HomeSummary, LatestBriefing, LatestBriefingCard(), allClear(), BRIEFING (+13 more)
...
Cohesion: 0.14
Nodes (19): DIRECTORY_INPUT_ATTRIBUTES, Dropzone(), FileOutcome, PickedFolder, pillPrimary(), pillSecondary(), SEARCHABLE_MIME, StorageId (+11 more)
...
Cohesion: 0.06
Nodes (42): usdAt4s(), usdAt4s(), repriceUsd(), logPlaneJson(), aggregateModules, deadLetters(), modules, rateLimiterModules (+34 more)
...
Cohesion: 0.08
Nodes (29): aggregateModules, evaluateWithGap(), modules, profileDocText(), seedDoc(), seedDocReview(), workflowModules, workpoolModules (+21 more)
...
Cohesion: 0.09
Nodes (16): ErrorBoundary, CanvasPane(), capsTeal, panel, readStoredWorkspace(), REVIEW_TAB, StoredWorkspace, Tab (+8 more)
...
### Community 35 - "log"
Cohesion: 0.03
Nodes (94): ADR-0016, ACCENT, AGENT_WRITABLE_FIGURES, AgentSmokeOp, Att, briefSchema, BriefTurn, buildAgentContext() (+86 more)
...
Cohesion: 0.16
Nodes (18): InlineMarkdown(), MarkdownDocument(), tableCells(), buildDocFilename(), DocFormat, DocToken, esc(), exceedsByteCap() (+10 more)
...
Cohesion: 0.06
Nodes (70): heldAmountCopy(), deltaLine(), EvaluationCard(), day(), unwrap(), CONFIDENCE_RANK, CountFigure, Coverage (+62 more)

### Community 54 - "opsSignals.test.ts"
Cohesion: 0.05
Nodes (46): BUCKET_WORD, card, CommandCenter(), CONSTRAINT_COPY, ConstraintCard(), CTA_DESTINATION, floorCount(), heading (+38 more)

### Community 55 - "buildTelemetry.ts"
Cohesion: 0.07
Nodes (42): NAV, age(), AllTenantDeadLetters(), OptimizerPanel(), REVIEW_OUTCOMES, shortRef(), TenantCandidatesPanel(), unifiedDiff() (+34 more)

### Community 56 - "formatAbsolute"
Cohesion: 0.04
Nodes (37): migrations, captionStalled(), inFlight(), lastRenderActivity(), renderStalled(), runSweep, sweepStuckMediaJobs, sweepStuckPlans (+29 more)
...
Cohesion: 0.07
Nodes (50): AGENT_EXPECT_KEYS, applyOnly(), argv, assertEvaluableCandidate(), assertKnownArgs(), assertSuiteIdentity(), buildTenantEvidence(), CANDIDATE_STATUSES (+42 more)

### Community 61 - "guardrails.test.ts"
Cohesion: 0.07
Nodes (20): aggregateModules, auditRows(), call(), convexSrcDir, createdAudit(), createDocumentBlock(), expectCalendarStageEmpty(), fillProposable() (+12 more)
...
Cohesion: 0.06
Nodes (62): RFC-7009, datasetArg, environmentArg, hasCreatedAt(), hubspotRead, HubSpotReadEvidence, HubSpotReadResult, PARSERS (+54 more)
...
Cohesion: 0.03
Nodes (67): BLUEPRINT_FIELD_SET, BlueprintDraft, blueprintPulse, BlueprintPulseResult, blueprintState, BlueprintStateResult, buildBlueprintDraft, BuildBlueprintDraftResult (+59 more)
...
### Community 73 - "list"
Cohesion: 0.04
Nodes (72): ActivitySection(), caps, cardTitle, ConnectedActivity(), ConnectedHeadline(), ConnectedNumbers(), ConnectedSolvency(), ConnectedUnitEconomics() (+64 more)
...
Cohesion: 0.13
Nodes (22): paginationBound(), readLiveForTenant(), landPack, snapshot, business, capped(), earliestAt(), isFilled() (+14 more)

### Community 97 - "proactiveReview.ts"
Cohesion: 0.14
Nodes (16): exportTenantData, exportTenantData, modules, seedOverBudgetEarlyTable(), seedTwoTenants(), ClassifiedTenantTable, DeletableTenantTable, exportableTables (+8 more)
...
Cohesion: 0.05
Nodes (38): D2 is NOT weakened by the media occupant, Data flow, Dependencies & blast radius, `EXTERNAL_TARGETS` — a table, not a framework, How to change safely, How to verify, Invariants — what must never break, Key files (+30 more)
...
Cohesion: 0.09
Nodes (33): eventArg, forTenant, outcomeArg, packIdArg, record, base, modules, toMetricEvent() (+25 more)
...
Cohesion: 0.11
Nodes (19): AGENT_PROV, aggregateModules, BLUEPRINT_WITH_CONTRADICTING_CAC, cancelQueued(), frameworkFor(), MALFORMED_PERSONA_DOC, modules, profileDocText() (+11 more)
...
Cohesion: 0.05
Nodes (37): adaptedBodies, $comment, finalizedBy, hashedBytes, status, $comment, inventoryCorrections, license (+29 more)
...
Cohesion: 0.05
Nodes (35): burned(), location(), modules, resultOf(), ROUTED, stateRows(), newConnectionId(), callbackRedirectPath() (+27 more)

### Community 121 - "spendLedger.ts"
Cohesion: 0.05
Nodes (59): here, page, preview, previewSource, spec, flushTelemetry(), Fog, IntegrationContext (+51 more)
...
Cohesion: 0.06
Nodes (44): POST(), SH, SH, bearerMatches(), buildSandboxOptions(), burnCaptions(), Bytes, cardColorsOf() (+36 more)

### Community 127 - "intake.test.ts"
Cohesion: 0.04
Nodes (49): SubmittableSpec, aggregateModules, asA(), asB(), ASSET, BRIEF, deck(), land() (+41 more)
...
Cohesion: 0.04
Nodes (68): attachToThread, decodeUtf8(), dictateToThread, extractVisual(), runIntake(), RunIntakeArgs, transcribeAudio(), fogIntegration() (+60 more)
...
Cohesion: 0.03
Nodes (66): Activity, attRow, badge(), box, Briefing, BriefingItem, BriefingRow(), btn (+58 more)

### Community 137 - "Phase Details"
Cohesion: 0.12
Nodes (17): classifyDoc, classifySchema, DocIdentity, _docToDocType, ExtractedGraph, extractGraph, getDocText, GraphEdge (+9 more)

### Community 139 - "skillBodies.test.ts"
Cohesion: 0.08
Nodes (23): aggregateModules, modules, ADR-0018, validState(), buildMicrosoftAuthorizeUrl(), constantTimeEquals(), deleteTokens, disconnectMicrosoft (+15 more)

### Community 140 - "skills.test.ts"
Cohesion: 0.09
Nodes (48): AUTHORITY, cashOnHand, entityArg, environmentArg, gatedRead(), homeCurrency(), QbReadEvidence, queryPath() (+40 more)

### Community 145 - "skills.test.ts"
Cohesion: 0.07
Nodes (31): numeric, ACTABLE_PLAN_STATUS, actOnGap, actOnGapInternal, ActOnGapResult, applyActOnGap(), buildMemo(), byThread (+23 more)
...
Cohesion: 0.09
Nodes (31): docForMint, hangupCall, mintClientSecret, MintResponse, calls, Captured, modules, ADR-0006 (+23 more)
...
Cohesion: 0.11
Nodes (29): scene(), ASSEMBLY_VISUALS, AssemblyError, AssemblyReport, AssemblyScene, AssemblyVisual, isGovernedRender(), near() (+21 more)

### Community 156 - "Phase 11: Persona Onboarding & Business Profile - Research"
Cohesion: 0.05
Nodes (25): BillingPeriodId, Charge, ChargeKind, chargeValidator, INVOICE_LINE_LABELS, invoiceIdempotencyKey(), periodForPost, periodKeyFor() (+17 more)
...
Cohesion: 0.04
Nodes (69): assetUrls, batchToSubmit, buildSubmitBody(), byPlan, captionsToSubmit, claimLine, clearRender(), confirmClaim (+61 more)
...
Cohesion: 0.06
Nodes (44): BillingPanelView(), BillingState, body, card, checkoutNotice(), days(), heldBalancesFigure(), InvoiceAnswer (+36 more)
...
Cohesion: 0.03
Nodes (74): ADR-0011, controls, coverage, globalRails, LimiterWindow, mediaLedger, patchControls(), readWindow() (+66 more)
...
Cohesion: 0.09
Nodes (24): RecommendationCard(), ActivityCard(), stepText(), bubble(), ChatPane(), COCKPIT_STARTERS, messageText(), pinLabel() (+16 more)
...
Cohesion: 0.03
Nodes (90): digits(), POSTAL_REFUSAL, ShapePanel(), admits(), commitProfile, converse, ConverseResult, extractProfile (+82 more)
...
Cohesion: 0.10
Nodes (33): AUTHORITY, balanceOnHand, currenciesOf(), entityArg, environmentArg, gatedRead(), PayPalReadEvidence, readEntity (+25 more)
...
Cohesion: 0.14
Nodes (18): BlueprintPanel(), secondaryButton(), ConnectionsPanel(), pill, row, ADR-0018, NarrativePanel(), isTabId() (+10 more)

### Community 182 - "officeText.ts"
Cohesion: 0.07
Nodes (30): beginConnect, CallbackResult, classifyTokenFailure(), disconnect, disconnectForTenant, DisconnectOutcome, environmentArg, handleCallback (+22 more)
...
Cohesion: 0.16
Nodes (10): aggregateModules, asTenant(), harness(), ingest(), modules, rateLimiterModules, seeded(), workflowModules (+2 more)
...
Cohesion: 0.09
Nodes (26): beginConnect, checkGrantedFeatures(), classifyGrantSubject(), disconnect, disconnectForTenant, DisconnectOutcome, environmentArg, FeatureVerdict (+18 more)

### Community 191 - "feedback.test.ts"
Cohesion: 0.25
Nodes (8): 1. The preview was pinned to document #1, 2. A model reports its TOOL inventory as the PRODUCT's capability, 3. It claimed a format that does not exist, 4. A refusal that only the OTHER party could act on, How to verify, Still open, and NOT fixed here, The created-artifact surface — what the agent may say about it (2026-08-14), The interlock (2026-08-14) — two refusals `stageMediaPlan` was missing
...
Cohesion: 0.21
Nodes (13): here, page, panel, panelSource, adaptationBytes(), card, dim, SkillAuthoringPanel() (+5 more)
...
Cohesion: 0.11
Nodes (14): sources, EXEMPT_AUTH, LooseCall, NON_TENANT_LEADING, OWNER_ARGS, OWNER_SURFACE, PUBLIC_SURFACE, PUBLIC_UNAUTHENTICATED (+6 more)

### Community 202 - "officeText.test.ts"
Cohesion: 0.06
Nodes (32): Account binding, Callback ordering — this order is the contract, Credential key operations — setup, rotation, loss, Data flow, Dependencies & blast radius, Diagnostics — status and counts only, Disconnect: revoke first, delete second — and say which one worked, Generating and installing it (+24 more)
...
Cohesion: 0.03
Nodes (80): ensureThreadAndPlan(), persistNextStepMemo(), auditControl(), MutationCtx, contentHash(), storeAndLand(), Actual, actualValidator (+72 more)
...
Cohesion: 0.50
Nodes (3): refusalMessage(), PLAN_REFUSALS, DUE
...
Cohesion: 0.05
Nodes (33): billingStatus, checkoutParams(), Door, doorReturns, hostedSession(), hostedUrl(), invoices, portalLink (+25 more)
...
Cohesion: 0.18
Nodes (15): pageBounded(), resolve(), activeSkills, auditPage, readAuditPage(), wormExport, REGISTRY_SKILL_NAMES, compareDashboardOrder() (+7 more)
...
Cohesion: 0.12
Nodes (17): 23-02 — `publishAgentCandidate`, the inert writer, 23-04 — the eval gate an agent row must clear, 23-05 — the human-owner half of the agent gate, `hasPassingAgentTenantEvidence`, Holdout boundary, How to verify, Mutation evidence (23-01, all executed and restored — none left in the tree), Mutation evidence (23-02, all executed and restored) (+9 more)
...
Cohesion: 0.18
Nodes (6): aggregateModules, deleteTenantData, deleteTenantDataPage, modules, ProviderResult, TenantDeletionCursor
...
Cohesion: 0.06
Nodes (36): cancelScheduledPlan, clearChatHistory, cockpitAgent, discardPlan, executePlan, ExternalActionType, ExternalArgs, FanoutArgs (+28 more)
...
Cohesion: 0.09
Nodes (13): aggregateModules, body(), deliver(), ledger(), modules, netCollected(), phasesOf(), seedMappedTenant() (+5 more)
...
Cohesion: 0.09
Nodes (29): { auth, signIn, signOut, store, isAuthenticated }, google, microsoft, password, ADR-0018, mutation, query, AdmitArgs (+21 more)

### Community 248 - "vaultDrive.test.ts"
Cohesion: 0.05
Nodes (61): activity, applyFinanceClaims(), _docToField, _fieldToDoc, FinanceApplyRefusal, financeSpineFor, inputs, inputsFor (+53 more)
...
Cohesion: 0.11
Nodes (23): billingPeriodKey(), aggregateModules, backendSources, calls, mapCustomer(), mapped(), modules, openBillingCoverage() (+15 more)
...
Cohesion: 0.06
Nodes (46): BILLING_EVENT_PAGE_LIMIT, billingCoverageFor(), BillingMovementArgs, BillingPhase, ensureBillingCoverage(), ListBillingEventsArgs, listBillingEventsFor(), PHASES (+38 more)

### Community 254 - "Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary"
Cohesion: 0.12
Nodes (23): BusyRange, createEvent, EVENT_URL(), freeBusy, FreeBusyResult, googleCalendarToken(), googleDelete(), GoogleError (+15 more)

### Community 255 - "officeText.test.ts"
Cohesion: 0.17
Nodes (10): BillingPanel(), body, card, DataControls(), DeleteState, deleteTenantData, ExportState, exportTenantData (+2 more)

### Community 256 - "Phase 3.11: Inbox Reply - Research"
Cohesion: 0.12
Nodes (24): buildManageIntent(), CALENDAR_MANAGE_OPERATIONS, CALENDAR_PROVIDERS, CalendarDesiredState, CalendarInspection, CalendarManageIntent, CalendarManageOperation, CalendarManageResult (+16 more)
...
Cohesion: 0.17
Nodes (12): Cron jobs (`packages/backend/convex/crons.ts`), Data flow, Dependencies & blast radius, How to change safely, How to verify, Invariants — what must never break, Key files, Known gaps & deferred work (+4 more)
...
Cohesion: 0.13
Nodes (9): aggregateModules, cacFact, Item, modules, profileFact, rateLimiterModules, stageFact, workflowModules (+1 more)
...
Cohesion: 0.11
Nodes (13): aggregateModules, CalendarEventFields, convexSources, EventField, freeBusyArgs, manageProbeEnv(), modules, PlanStatus (+5 more)
...
Cohesion: 0.17
Nodes (15): DisconnectMicrosoft(), LINK, ConnectMicrosoftPage(), ADR-0018, hasMicrosoftScope(), isMicrosoftCallbackError(), MICROSOFT_CALLBACK_ERRORS, MICROSOFT_SCOPES (+7 more)

### Community 281 - "bfsNeighbors"
Cohesion: 0.09
Nodes (22): BusyRange, createEvent, freeBusy, graphConcurrencyProbe, GraphEvent, GraphTokenResult, inspectEvent, MicrosoftCreateResult (+14 more)
...
Cohesion: 0.27
Nodes (9): DigestRebuildControl(), DIRECTORY_INPUT_ATTRIBUTES, FolderOpenControl(), dropzoneSource, VaultBrowseAction, VaultBrowseActionId, vaultBrowseActions(), VaultBrowseControls() (+1 more)

### Community 287 - "ADR-014: Standalone images are a first-class `media` deliverable behind the existing human spend gate"
Cohesion: 0.24
Nodes (4): ADR-019: The scene timeline supersedes the uniform block deck, Consequences, Context, Decision
...
Cohesion: 0.14
Nodes (19): InputRow(), BudgetControl(), ControlRow(), CoverageClampNotice(), coverageCopy(), DeploymentSection(), FinanceStateNotice(), formatInstant() (+11 more)
...
Cohesion: 0.18
Nodes (5): aggregateModules, deliveringPlan(), managedRow(), modules, T
...
Cohesion: 0.18
Nodes (12): WorkflowPackCandidate, WorkflowPackOwnerPreview(), PackSourceView, STATE_MARK, render(), WorkflowPackPreflight(), OUTPUT_PROMISE, offer() (+4 more)

### Community 311 - "planTenantActivation"
Cohesion: 0.07
Nodes (27): answerDecision, blockedSummary, CASH_FIELD_BY_QUESTION, fieldValue(), listAwaiting, listCleared, listDecisions, listInFlight (+19 more)

### Community 312 - "dataModel.d.ts"
Cohesion: 0.06
Nodes (29): applyClassification, countTerminal(), deleteVaultDoc, docEntities, getDoc, getDocForExtraction, ingestExtractedText, ingestFromAttachment (+21 more)

### Community 313 - "research.ts"
Cohesion: 0.18
Nodes (9): KNOWLEDGE_WORK_PINNED_AT, KNOWLEDGE_WORK_PROVENANCE, KnowledgeWorkProvenance, FileRecord, manifest, Pack, repoRoot, snapshotRoot (+1 more)

### Community 314 - "ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages"
Cohesion: 0.14
Nodes (14): artifactById, card(), KINDS_BY_LANE, Lane, LANE_BY_KIND, laneArg, listArtifacts, promotion() (+6 more)
...
Cohesion: 0.12
Nodes (18): signed(), buildAuthorizeUrl(), deleteTokens, disconnectGoogle, flagExpiringTokens, getForDelivery, getTokens, gmailConnectUrl (+10 more)
...
Cohesion: 0.11
Nodes (18): Carried forward — NOT resolved by this approval, Could NOT verify — do not treat as fact, Evidence URLs, Half 1 — no read-only scope exists (unchanged, verified), Half 2 — production is an APPROVAL gate, not a self-assessment (STRONGER than recorded), Lane gate status — 2026-08-28 (28-06), Operational note for future re-verification, Owner decision — `approved_production`, 2026-08-27 — **on OWNER ATTESTATION** (+10 more)
...
Cohesion: 0.01
Nodes (80): modules, T, aggregateModules, modules, modules, modules, T, BLUEPRINT_TEXT (+72 more)

### Community 330 - "microsoft.ts"
Cohesion: 0.11
Nodes (18): Better: a non-Extension read-only route EXISTS, Could NOT verify — do not treat as fact, DOC HAZARD — Stripe contradicts itself, and the stale page is the one Aug-5 cited, Evidence URLs, MATERIAL CEILING — API read-request allocation, Owner decision — `approved_production`, 2026-08-27 — **OWNER OVERRIDE**, Re-review triggers, Read surface for plan 28-07 (if admitted) (+10 more)
...
Cohesion: 0.40
Nodes (4): DatabaseWriter, QueryCtx, logTenantActivation(), probeSourcesFor()

### Community 339 - "cockpitBlueprint.test.ts"
Cohesion: 0.12
Nodes (21): CompleteDashboardBound, createDashboardMoney(), DashboardMoney, DashboardMoneyPhase, DashboardOrderKey, DashboardPageState, DashboardRefusalReason, DashboardTimeZoneSource (+13 more)
...
Cohesion: 0.07
Nodes (33): activeButton, AuditPage, Business, BusinessSection(), button, caps, card, GovernanceSection() (+25 more)

### Community 348 - "profileRedaction.test.ts"
Cohesion: 0.12
Nodes (13): aggregateModules, businessOverview, capacityPlan, cashPosition, corpusRoot, goalsAndScorecard, modules, pricing (+5 more)
...
Cohesion: 0.12
Nodes (16): 28-05 status — 2026-08-28: the TEST EXISTS, the ANSWER DOES NOT, Could NOT verify — do not treat as fact, DOC HAZARD — HubSpot contradicts itself on the token endpoint, Evidence URLs, HubSpot — provider suitability record, Install caps (the actual cost of staying unlisted), Open condition — carried, NOT resolved by this approval, Owner decision — `approved_production`, 2026-08-27 (+8 more)
...
Cohesion: 0.06
Nodes (16): hooks, PENDING, render(), AdminView(), PendingRow, AdminPage(), DisconnectGoogle(), KIND_HREF (+8 more)
...
### Community 383 - "deltaLine"
Cohesion: 0.10
Nodes (13): cappedPipelineReader, modules, REAL_NOW, shapelessReader, T, throwingReader, BLUEPRINT_TEXT, modules (+5 more)
...
Cohesion: 0.08
Nodes (13): modules, SCHEMA, DataModel, Doc, Id, TableNames, aggregateModules, FACT_NUMBERS (+5 more)
...
Cohesion: 0.17
Nodes (9): button, connectPage, data, msButton, msConnectPage, panel, privacyPage, profilePage (+1 more)
...
Cohesion: 0.15
Nodes (13): Connected page gates, Data flow, Dependencies & blast radius, Focused backend gates, How to change safely, How to verify, Known gaps & deferred work, Operational notes (+5 more)

### Community 417 - "workflowPackDiscovery.test.ts"
Cohesion: 0.50
Nodes (3): deletableTables(), schemaSource, schemaTables
...
Cohesion: 0.09
Nodes (30): hubspotConditions(), modules, rawSources, sealArgs(), admissionPermits(), ADMISSIONS, CAPS, ELIGIBILITY_REASONS (+22 more)
...
Cohesion: 0.17
Nodes (10): aggregateModules, completeJourney(), modules, provUsage(), rateLimiterModules, T, textStep(), toolStep() (+2 more)
...
### Community 433 - "Implementation Decisions"
Cohesion: 0.22
Nodes (9): Approvals — owner-APPROVED (Plan 26-05, Task 2 closed 2026-08-08), Approvals read contract, Approvals type scale — inline styles must quote the mockup, not invent, Finance becomes a three-tab shell (cash-business-finance Task 1), Finance ledger contract, Finance projections and owner controls (26-09), Invariants — what must never break, The connected Cost route (26-10) (+1 more)
...
### Community 438 - "Phase 15.3 Plan 04: Folder Ingest Orchestration Summary"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (7): Discovery and staging order (17-09), How to verify, Invariants, Phase 17 gap closure — the `calendar_manage` substrate (17-05), The card cannot name the original event yet, and says so, The inert seam, and who replaces it, What this plan did NOT do
...
Cohesion: 0.33
Nodes (6): Lane gate status — 2026-08-28 (plan 28-07), The API version pin has NO DEFAULT, deliberately, The open condition is IMPLEMENTED, not closed, The poll budget, sized against the allocation, What the owner must set for a live run, What the route turned out to be

### Community 455 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.18
Nodes (5): ADR-002: Insert-only audit log with redaction-safe payloads; WORM immutability lives outside Convex, Alternatives rejected, Consequences, Context, Decision
...
### Community 459 - "Phase 7 Plan 06: Resilience & Ops Hardening — Phase Close (autonomous portion)"
Cohesion: 0.09
...
### Community 460 - "Phase 8 Plan 05: SkillOpt Write-Back (candidate + evidence) Summary"
Cohesion: 0.09
...
### Community 468 - "Phase 15.3 Plan 01: Schema, Requirements and Roadmap Summary"
Cohesion: 0.09
...
### Community 469 - "Phase 15.3 Plan 03: The Folder Budget Wall Summary"
Cohesion: 0.09
...
### Community 473 - "Phase 17.1 Plan 01: Blueprint Structural Half Summary"
Cohesion: 0.40
...
Cohesion: 0.04
Nodes (98): salvageNote(), buildSpecialistPrompt(), cap(), Ctx, deckRefusalBody(), deckTokenCounts(), dispatchAndLand(), DispatchArgs (+90 more)
...
### Community 533 - "Implementation Decisions"
Cohesion: 0.11
...
### Community 551 - "17-08 SUMMARY — governed calendar management: management, minus Microsoft delete"
Cohesion: 0.11
...
### Community 560 - "Convex Migration Helper"
Cohesion: 0.11
Nodes (17): Adding Index, Adding New Table, Adding Optional Field, Breaking Changes: The Deployment Workflow, Common Migration Patterns, Common Pitfalls, Convex Migration Helper, Don't Delete Data (+9 more)
...
### Community 562 - "Phase 03.10 Plan 06: Cockpit Conversational Memory Summary"
Cohesion: 0.11
...
### Community 563 - "Phase 3.11 Plan 02: Reply-Drafter Skill + Toolless draftReply Summary"
Cohesion: 0.11
...
### Community 573 - "Phase 15.2 Plan 07: Legacy XLS via SheetJS Summary"
Cohesion: 0.11
...
### Community 578 - "Phase 15 Plan 05: The Generalized Action Executor Summary"
Cohesion: 0.11
Nodes (17): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics (+9 more)
...
### Community 615 - "Phase 3.6 Plan 05: Phase Gate Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
### Community 646 - "Phase 15.3 Plan 02: Vault Read Survivability + Cap Single-Source Summary"
Cohesion: 0.12
Nodes (16): Accomplishments, Auto-fixed Issues, Decisions Made, Dependency graph, Deviations from Plan, Issues Encountered, Metrics, Next Phase Readiness (+8 more)
...
Cohesion: 0.17
Nodes (15): sourceFiles(), walk(), entry(), derivedConstantFor(), KNOWN_FLAGS, lf(), loadDerived(), main() (+7 more)
...
### Community 670 - "Phase 2 Plan 01: Phase-2 Data Substrate Summary"
Cohesion: 0.12
...
### Community 695 - "Implementation Decisions"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (26): runVaultGround(), vaultGround, vaultGroundHydrated, buildGeminiEmbedRequest(), buildOpenAIEmbedRequest(), buildOpenRouterEmbedRequest(), embedBackoffMs(), embeddingContentHash() (+18 more)
...
### Community 723 - "Phase 7 Plan 01: Wave-0 Foundation Summary"
Cohesion: 0.12
Nodes (15): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+7 more)
...
### Community 771 - "Phase 03.10 Plan 01: gmail.search Fixture Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 772 - "Phase 03.1 Plan 01: Cockpit Backend Contracts Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 773 - "Phase 03.1 Plan 06: Plans Adapter + Cockpit Draft Seam Summary"
Cohesion: 0.13
Nodes (14): Accomplishments, Decisions Made, Dependency graph, Deviations from Plan, Files Created/Modified, Issues Encountered, Metrics, Next Phase Readiness (+6 more)

### Community 774 - "Phase 3.1: Cockpit Core — Research (Pure `emailIntent` Module)"
Cohesion: 0.13
...
### Community 832 - "Phase 18 Plan 06: The createDocument Tool Summary"
Cohesion: 0.14
...
### Community 838 - "Architecture Patterns"
Cohesion: 0.14
...
### Community 846 - "Phase 20 Plan 20: Finance Fingerprint Reconciliation Summary"
Cohesion: 0.14
...
Cohesion: 0.15
Nodes (13): Accomplishments, Admin links to `/ops` rather than consolidating it, Decisions Made, Deviations from Plan, Files Created/Modified, Follow-up error handling has a narrower ceiling, Next Phase Readiness, Performance (+5 more)
...
Cohesion: 0.18
Nodes (11): actionLabel(), ApprovalKindBadge(), ApprovalsStateNotice(), AwaitingSection(), emailApprovalActionLabel(), persistentOutcomes(), ResolvedOutcomeCard(), BodyProps (+3 more)
...
Cohesion: 0.20
Nodes (9): CreateEventResult, ManageEventResult, manageEventResult(), onCreateComplete, onManageComplete, REFUSAL_MESSAGE, ADR-0023, CALENDAR_FAILURE_CODES (+1 more)
...
Cohesion: 0.20
Nodes (4): aggregateModules, code, modules, sources
...
### Community 1013 - "Phase 8 Plan 08: Phase Close (playbook DoD + proof-of-life dry-run) Summary"
Cohesion: 0.20
...
### Community 1015 - "Phase 10 Plan 04: Teach the Agent WHEN to Ground Summary"
Cohesion: 0.20
...
### Community 1017 - "Phase 14 — Validation Strategy"
Cohesion: 0.20
...
### Community 1018 - "Common Pitfalls"
Cohesion: 0.20
...
### Community 1025 - "n"
Cohesion: 0.36
Nodes (7): main(), MUSIC_EXTS, MUSIC_SRC, readMusicLibrary(), step(), n(), counted()
...
Cohesion: 0.39
Nodes (9): AwaitingCardBody(), browserTimeZone(), ClearedRow(), formatAbsoluteInstant(), parseScheduleInput(), previewText(), ScheduleComposer(), ScheduledRow() (+1 more)
...
### Community 1055 - "Agent Eval Gate (Phase 3.6)"
Cohesion: 0.22
...
### Community 1057 - "Phase 3.10: Cockpit Conversation Repair - Context"
Cohesion: 0.22
...
### Community 1058 - "Phase 3.1 — Validation Strategy"
Cohesion: 0.22
...
### Community 1062 - "Phase 03.4 Plan 03: executePlan Seed Override + PLAN Card Per-Recipient Bodies Summary"
Cohesion: 0.22
...
### Community 1105 - "Phase 26 Plan 07: Reasoning and Ingest Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1106 - "Phase 26 Plan 08: Media Rail Ledger Instrumentation Summary"
Cohesion: 0.22
...
### Community 1107 - "Plan 26-20: Command Center v2, owner-approved"
Cohesion: 0.22
...
### Community 1108 - "Phase 26 — Validation Strategy"
Cohesion: 0.22
...
Cohesion: 0.09
Nodes (29): CategoryTabs(), discussPillStyle(), DocGrid(), docLabel(), fmtSize(), folderChip(), MoveDocId, MoveFolderId (+21 more)
...
### Community 1162 - "Plan 14-05 Summary — the findings producer"
Cohesion: 0.25
...
### Community 1164 - "Plan 14-07 Summary — the entry point and the in-call context"
Cohesion: 0.25
...
### Community 1165 - "Plan 14-08 Summary — the post-call outcome"
Cohesion: 0.25
...
### Community 1167 - "2. The four live-only verifications — RUNNABLE DEBT (recorded during 15.1-07)"
Cohesion: 0.25
...
### Community 1169 - "Phase 15.3 — Validation Strategy"
Cohesion: 0.25
...
### Community 1170 - "Phase 15.3: Vault Folders Verification Report"
Cohesion: 0.25
...
### Community 1171 - "Phase 15.4 — Validation Strategy"
Cohesion: 0.25
...
### Community 1172 - "Phase 15: Sub-Agent Dispatch & Generalized Action Executor - Research"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (6): Crumb, DriveBrowser(), Entry, Node, Note, WHY

### Community 1206 - "failureCopy.ts"
Cohesion: 0.29
Nodes (6): COPY, GENERIC, INGEST, MISSING, PARSE_FAILED, PAUSED
...
### Community 1245 - "Advanced Component Patterns"
Cohesion: 0.33
Nodes (5): Advanced Component Patterns, Class-based client wrappers, Deriving validators from schema, Function Handles for callbacks, Static configuration with a globals table

### Community 1246 - "Hybrid Convex Components"
Cohesion: 0.33
Nodes (5): Checklist, Default Advice, Hybrid Convex Components, Risks, What This Means
...
### Community 1251 - "google-drive-connection-unresponsive.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms

### Community 1252 - "media-generation-access-and-routing.md"
Cohesion: 0.33
Nodes (5): Current Focus, Eliminated, Evidence, Resolution, Symptoms
...
### Community 1320 - "Validation Architecture"
Cohesion: 0.40
Nodes (5): Phase Requirements → Test Map, Sampling Rate, Test Framework, Validation Architecture, Wave 0 Gaps

### Community 1321 - "Sources"
Cohesion: 0.40
...
### Community 1323 - "Code Examples (verified, in-repo)"
Cohesion: 0.40
...
Cohesion: 0.50
Nodes (3): rollupCode(), codeOf(), nonBlankLines()
...
## Knowledge Gaps
- **13304 isolated node(s):** `graphify-mcp`, `LINK`, `KIND_HREF`, `ADR-0018`, `PendingRow` (+13299 more)
...
- **Why does `api` connect `cashSpine.ts` to `functions.ts`, `package.json`, `page.tsx`, `Phase 03.2 Plan 03: Gmail Headers-Only Search Summary`, `ADR-001: Convex as the data + orchestration plane, with thin adapters over pure-TS packages`, `emailIntent.ts`, `guardrails.ts`, `layout.tsx`, `tenant.ts`, `buildCockpitTools`, `Dropzone.tsx`, `Validation Architecture`, `reportsGovernance.test.ts`, `buildCockpitTools`, `log`, `opsSignals.test.ts`, `buildTelemetry.ts`, `guardrails.test.ts`, `layout.tsx`, `vaultLlm.ts`, `list`, `index.ts`, `notificationMessage`, `Key files`, `failureCopy.ts`, `classify.ts`, `http.ts`, `vaultLlm.ts`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `intake.test.ts`, `briefings.ts`, `metering.ts`, `skillBodies.test.ts`, `evaluations.test.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `routing.ts`, `feedback.test.ts`, `page.tsx`, `Parallel Build Lanes (multi-session)`, `Phase 15 — Sub-agent dispatch + generalized executor`, `DriveBrowser.tsx`, `fmtItemTime`, `officeText.ts`, `extractKind.ts`, `vaultSweep.test.ts`, `index.ts`, `SkillAuthoringPanel.tsx`, `Project State`, `isolation.test.ts`, `crmCard.test.ts`, `approvalsView.test.ts`, `proposals.test.ts`, `contacts.test.ts`, `createdDocs.test.ts`, `profileRedaction.test.ts`, `vaultDrive.test.ts`, `assembly.ts`, `DriveBrowser.tsx`, `notificationTemplates.ts`, `reviewThreshold.ts`, `Phase 25 — the owner gates`, `replyDrafter.ts`, `vaultGround.test.ts`, `approvalsView.test.ts`, `vaultDrive.test.ts`, `AdminView.tsx`, `planTenantActivation`, `dataModel.d.ts`, `pipeline-uat.spec.ts`, `How to verify`, `dashboardSchema.test.ts`, `actionType.ts`, `media.ts`, `ReportsView.tsx`, `DriveBrowser.tsx`, `n`, `deltaLine`, `Architecture Research`, `ReconnectBanner.tsx`, `opsSignals.test.ts`, `FinanceTabs.tsx`, `Phase 15 Plan 03: The Governed Dispatcher Summary`, `packCustomerComplaint.ts`, `selfCheck`, `proactiveReview.test.ts`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `internal` connect `dashboardSchema.test.ts` to `package.json`, `briefings.ts`, `Playbook: Email Chat Cockpit`, `deltaLine`, `emailIntent.ts`, `Project State`, `skillBodies.test.ts`, `guardrails.ts`, `skills.test.ts`, `page.tsx`, `reviewThreshold.ts`, `layout.tsx`, `skills.test.ts`, `Phase Details`, `Dropzone.tsx`, `Phase 19 Plan 10: Close the phase honestly Summary`, `bfsNeighbors`, `classify.ts`, `Phase 11: Persona Onboarding & Business Profile - Research`, `Validation Architecture`, `gapAction.test.ts`, `FinanceTabs.tsx`, `feedback.ts`, `replyDrafter.ts`, `log`, `feedback.test.ts`, `vaultDrive.test.ts`, `Phase 15 Plan 03: The Governed Dispatcher Summary`, `packCustomerComplaint.ts`, `Parallel Build Lanes (multi-session)`, `calendarComplete.ts`, `vaultSealing.test.ts`, `Phase 3.1: Cockpit Core — Research (Delivery lane)`, `officeText.ts`, `formatAbsolute`, `dataModel.d.ts`, `extractKind.ts`, `guardrails.test.ts`, `vaultSweep.test.ts`, `selfCheck`, `tenant.ts`, `layout.tsx`, `Project State`, `vaultLlm.ts`, `searchVaultSpine.test.ts`, `notificationMessage`, `crmCard.test.ts`, `vaultExtract.ts`, `vaultDigest.ts`, `media.ts`, `approvalsView.test.ts`, `classify.ts`, `profileRedaction.test.ts`, `15.3-04 — folder orchestration (VALT-05, VALT-06, VALT-08)`, `proactiveReview.test.ts`, `vaultDrive.test.ts`, `classify.ts`, `createdDocs.test.ts`, `gapAction.test.ts`, `http.ts`, `vaultLlm.ts`, `evaluations.test.ts`, `Playbook: Audit Log & Dead-Letter Pipeline`, `n`, `Phase Details - Milestone v2.0`, `blueprint.test.ts`, `spendLedger.ts`, `assembly.ts`, `vaultTranscribe.test.ts`, `Phase 15.1 Plan 02: The Tier's Home — `convex/tenantProfile.ts` Summary`, `intake.test.ts`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `n()` connect `n` to `page.tsx`, `log`, `briefings.ts`, `Proactive weekly review (BEVL-03, 13-02)`, `index.ts`, `DriveBrowser.tsx`, `vaultGraph.ts`, `buildCockpitTools`?**
...
- **What connects `graphify-mcp`, `Return per-step incoming/passed and the final output.`, `Accept 5 (percent) or 0.05 (fraction); return a 0-1 fraction.` to the rest of the system?**
  _13337 weakly-connected nodes found - possible documentation gaps or missing edges._
