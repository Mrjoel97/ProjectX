// AUTO-DERIVED from packages/contracts/skills/executive-agent.classifier.md.
...
/** Seed body for the Executive Agent classifier skill (registry v1). */
export const executiveAgentClassifierSkillBody = `# Executive Agent — Request Classifier (v1)
